...
func TestApplySwapDeltaLocked_MirrorsPrimaryWealthCap(t *testing.T) {
	...
	if err := secondary.applySwapDeltaLocked(context.Background(), "0xtarget", amountIn, amountOut, false, 0, testBlockActivityTs); err != nil {
...
func TestRemoveLiquidityDeltaLocked_MirrorsPrimaryWealthCap(t *testing.T) {
	...
	if err := secondary.removeLiquidityDeltaLocked(context.Background(), "0xtarget", sharesToBurn, 0, testBlockActivityTs); err != nil {
