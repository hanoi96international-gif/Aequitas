...
en:{
  ...
  'pools-desc':'Transfer fees go 100% to UBI. Swap fees are split 40% validators / 30% liquidity providers / 30% UBI. Demurrage and wealth-cap overflow go 100% to UBI. Nobody can pay out of a pool — not even with its key; only the protocol distributes, daily.',
  ...
  'phases-desc':'The wealth cap uses a bootstrap multiplier during Phase 0: max(5, min(N, 25))× the fair share (1,000 AEQ per human). With 1–4 humans: 5× the fair share. Each new human adds 1×. At 25+ humans: locks permanently at 25×. Phase 1+ maintains 25× fixed. All transitions trigger automatically by human count — not a manual governance flip.',
  ...
  'ubi-title':'5. UNIVERSAL BASIC INCOME','ubi-box':'Sources: Swap fees (30%) · Wealth cap overflow · Demurrage · Inactive escrow<br><br>Daily: UBI Pool divided equally among all registered humans. Pool resets to zero after each distribution and refills continuously.',
  ...
  'ubi-hero-sub-empty':'Pool empty since last 20:00 payout — fills from swap fees (30% of 0.1%), demurrage after 3 months idle, and wealth-cap overflow.',
  ...
  'ubi-src-dem':'Demurrage','ubi-src-dem-d':'Idle AEQ (3+ months inactive) decays at 0.5%/month on the part above your 1,000 AEQ fair share. 100% of the decayed amount goes to UBI.',
  'ubi-src-cap':'Wealth cap overflow','ubi-src-cap-d':'Wallets exceeding 25× the fair share (25,000 AEQ) have the excess confiscated instantly. 100% flows to UBI immediately.',
  'ubi-pool-desc':'100% of transfer fees + 30% of swap fees + 100% of demurrage and wealth-cap overflow → split equally among all verified humans every 24 hours.',
...
de:{
  'ubi-src-tx':'Überweisungsgebühren','ubi-src-tx-d':'Jede AEQ-Überweisung zahlt 0,1 % obendrauf (bei sehr großen Guthaben mehr). Die ganze Gebühr fließt hierher.','pool-badge-v':'40 % der Swap-Gebühren','pool-badge-l':'30 % der Swap-Gebühren','pool-badge-u':'alle Umverteilung','pool-next':'⏰ Nächste:','treasury-retired':'Die frühere Schatzkammer ist seit dem 24.09.2026 stillgelegt: Sie bekommt nichts mehr, und niemand kann aus ihr auszahlen. Restbestand:','x-flow-1':'● Überweisung → 100 % UBI','x-flow-2':'● Demurrage, Deckel → 100 % UBI','x-flow-3':'● Swap → 30 % UBI','x-flow-4':'40 % Validatoren · 30 % LP',
  ...
  'ubi-hero-sub-empty':'Pool leer seit der letzten 20:00-Ausschüttung — füllt sich aus Swap-Gebühren (30% von 0,1%), Demurrage nach 3 Monaten Inaktivität und Vermögensobergrenze-Überschuss.',
  ...
  'ubi-src-dem':'Demurrage','ubi-src-dem-d':'Inaktives AEQ (3+ Monate) verfällt mit 0,5%/Monat — nur der Teil über deinem fairen Anteil von 1.000 AEQ. Der verfallene Betrag geht zu 100% an UBI.',
  'ubi-src-cap':'Vermögensobergrenze-Überschuss','ubi-src-cap-d':'Wallets die den Vermögensdeckel (max(5,min(N,25))× Durchschnitt) überschreiten werden sofort gekappt. 100% fließt direkt an UBI.',
  ...
  'ubi-pool-desc':'100 % der Überweisungsgebühren + 30 % der Swap-Gebühren + 100 % aus Demurrage und Vermögensobergrenze → gleichmäßig an alle verifizierten Menschen, alle 24 Stunden.',
  ...
  'expl-heading':'Block-Explorer'},
es:{
  'ubi-src-tx':'Comisiones de transferencia','ubi-src-tx-d':'Cada transferencia de AEQ paga un 0,1 % adicional (más en saldos muy grandes). La comisión entera va aquí.','pool-badge-v':'40 % del swap','pool-badge-l':'30 % del swap','pool-badge-u':'toda la redistribución','pool-next':'⏰ Próximo:','treasury-retired':'La antigua tesorería está retirada desde el 24/09/2026: no recibe nada y nadie puede pagar desde ella. Saldo restante:','x-flow-1':'● Transferencia → 100 % UBI','x-flow-2':'● Demurrage, tope → 100 % UBI','x-flow-3':'● Swap → 30 % UBI','x-flow-4':'40 % validadores · 30 % LP',
  ...
  'pools-desc':'Las comisiones de transferencia van 100 % al UBI. Las tarifas de swap se reparten 40% validadores / 30% proveedores de liquidez / 30% UBI. El demurrage y el excedente del límite de riqueza van 100% al UBI. Nadie puede pagar desde un pool, ni siquiera con su clave; solo el protocolo distribuye, a diario.',
  ...
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100 % de las comisiones de transferencia + 30 % de las de swap + 100 % del demurrage y del exceso sobre el tope de riqueza → repartido por igual entre todos los humanos verificados cada 24 horas.',
  'phases-title':'Fases del Protocolo',
  'phases-desc':'En Fase 0, el límite de riqueza usa un multiplicador de arranque: max(5, min(N, 25))× saldo promedio. Con 1–4 humanos: 5× promedio. Cada nuevo humano añade 1×. A 25+ humanos: fijado permanentemente en 25×. Fase 1+ mantiene 25× fijo. Todas las transiciones son automáticas según el número de humanos — no un interruptor manual de gobernanza.',
  ...
  'ubi-src-dem':'Demurrage','ubi-src-dem-d':'AEQ inactivo (3+ meses) decae al 0,5%/mes en la parte que supera tu parte justa de 1.000 AEQ. El 100% del importe decaído va al UBI.',
  'ubi-src-cap':'Desbordamiento del Límite','ubi-src-cap-d':'Wallets que superan el límite de riqueza (max(5,min(N,25))× promedio) son confiscadas al instante. El 100% fluye al UBI.',
...
ru:{
  ...
  'pools-desc':'Комиссии за переводы — 100% в UBI. Комиссии свопа: 40% валидаторам / 30% поставщикам ликвидности / 30% в UBI. Демередж и превышение лимита богатства — 100% в UBI. Никто не может выплачивать из пула — даже с его ключом; распределяет только протокол, ежедневно.',
  ...
  'ubi-pool':'Пул UBI','ubi-pool-desc':'100% комиссий за переводы + 30% комиссий свопа + 100% демереджа и превышения лимита богатства → поровну всем верифицированным людям каждые 24 часа.',
  ...
  'ubi-title':'5. УНИВЕРСАЛЬНЫЙ БАЗОВЫЙ ДОХОД — Ежедневное Перераспределение','ubi-box':'Источники: Комиссии свопов (30%) · Превышение лимита богатства · Демередж · Эскроу после 4 лет<br><br>Ежедневно: весь пул UBI делится поровну между всеми зарегистрированными людьми. Пул сбрасывается и сразу наполняется снова.',
  ...
  'phases-desc':'В Фазе 0 лимит богатства использует скользящий Bootstrap-множитель: max(5, min(N, 25))× средний баланс. При 1–4 людях: 5× средний. Каждый новый человек прибавляет 1×. При 25+ людях: фиксируется навсегда на 25×. Фаза 1+ сохраняет 25× фиксированным. Переходы автоматические по числу людей — не ручной переключатель управления.',
  'p0':'Bootstrap · &lt;100 людей · Лимит богатства: max(5,min(N,25))× средний · Скользит 5×→25× до 25-го человека · Сейчас активен',
  'p1':'Рост · 100–10 000 людей · Лимит богатства: 25× справедливой доли = 25 000 AEQ',
  ...
  'ubi-src-dem':'Демередж','ubi-src-dem-d':'Неактивный AEQ (3+ месяца) убывает на 0,5%/месяц — только часть сверх справедливой доли в 1 000 AEQ. 100% убывшей суммы идёт в UBI.',
  'ubi-src-cap':'Превышение Лимита Богатства','ubi-src-cap-d':'Кошельки превышающие лимит (max(5,min(N,25))× средний) конфискуются мгновенно. 100% поступает в UBI немедленно.',
...
zh:{
  'ubi-src-tx':'转账手续费','ubi-src-tx-d':'每笔 AEQ 转账额外支付 0.1%（余额极大时更高）。全部手续费进入此处。','pool-badge-v':'兑换费 40%','pool-badge-l':'兑换费 30%','pool-badge-u':'全部再分配','pool-next':'⏰ 下次：','treasury-retired':'原国库自 2026年9月24日起已停用：不再接收任何资金，任何人都无法从中支出。剩余余额：','x-flow-1':'● 转账费 → 100% UBI','x-flow-2':'● 滞留费、上限 → 100% UBI','x-flow-3':'● 兑换费 → 30% UBI','x-flow-4':'40% 验证者 · 30% LP',
  ...
  'pools-title':'再分配池',
  'pools-desc':'转账手续费100%进入UBI。兑换费用分配：40%验证者 / 30%流动性提供者 / 30% UBI。滞期费和财富上限溢出100%进入UBI。任何人都不能从池中支出——即使持有其密钥；只有协议每日分配。',
  ...
  'ubi-pool':'UBI池','ubi-pool-desc':'100% 的转账手续费 + 30% 的兑换手续费 + 100% 的滞留费和财富上限溢出 → 每 24 小时平均分配给所有已验证真人。',
  'phases-title':'协议阶段',
  ...
  'ubi-title':'5. 普遍基本收入 — 每日再分配','ubi-box':'UBI池收入来源：<br>· AEQ↔tUSD AMM池所有互换费用的30%<br>· 财富上限执行的溢出<br>· 非活跃账户的滞期费<br>· 4年后释放的非活跃托管<br><br>分配：每24小时，整个UBI池余额在所有注册的经过验证的人类中平均分配。池重置为零并立即开始从持续的协议活动中重新填充。',
  ...
  'phases-desc':'启动阶段（阶段 0）财富上限使用滑动乘数：max(5,min(N,25))×平均余额 — 1–4 人时为 5×，每增加 1 人加 1×，25+ 人时达到完整 25×。阶段 1+ 保持 25×。所有过渡按人类数量自动触发——不是手动治理开关。',
  ...
  'ubi-src-dem':'滞期费','ubi-src-dem-d':'不活跃AEQ（3+个月）超出1,000 AEQ公平份额的部分以0.5%/月衰减。衰减金额100%进入UBI。',
  'ubi-src-cap':'财富上限溢出','ubi-src-cap-d':'超过max(5,min(N,25))×平均余额的钱包立即被没收超额部分。100%立即流入UBI。',
...
id:{
  ...
  'pools-desc':'Biaya transfer 100% ke UBI. Biaya swap dibagi 40% validator / 30% penyedia likuiditas / 30% UBI. Demurrage dan kelebihan batas kekayaan 100% ke UBI. Tidak ada yang bisa membayar dari pool — bahkan dengan kuncinya; hanya protokol yang membagikan, setiap hari.',
  ...
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100% biaya transfer + 30% biaya swap + 100% demurrage dan kelebihan batas kekayaan → dibagi rata kepada semua manusia terverifikasi setiap 24 jam.',
  ...
  'ubi-src-dem':'Demurrage','ubi-src-dem-d':'AEQ tidak aktif (3+ bulan) berkurang 0,5%/bulan pada bagian di atas bagian adil 1.000 AEQ. 100% jumlah yang berkurang masuk ke UBI.',
  'ubi-src-cap':'Overflow Batas Kekayaan','ubi-src-cap-d':'Dompet yang melebihi batas kekayaan (max(5,min(N,25))× rata-rata) langsung disita kelebihannya. 100% mengalir ke UBI segera.',
...
it:{
  'ubi-src-tx':'Commissioni di trasferimento','ubi-src-tx-d':'Ogni trasferimento di AEQ paga lo 0,1% in più (di più per saldi molto grandi). L’intera commissione va qui.','pool-badge-v':'40% dello swap','pool-badge-l':'30% dello swap','pool-badge-u':'tutta la redistribuzione','pool-next':'⏰ Prossimo:','treasury-retired':'L’ex tesoreria è dismessa dal 24/09/2026: non riceve nulla e nessuno può pagare da essa. Saldo residuo:','x-flow-1':'● Trasferimenti → 100% UBI','x-flow-2':'● Demurrage, tetto → 100% UBI','x-flow-3':'● Swap → 30% UBI','x-flow-4':'40% validatori · 30% LP',
  'x-consensus-ghostdag-knightdag':'◆ Consenso: GHOSTDAG + KNIGHTDAG',
  ...
  'pools-desc':'Le commissioni di trasferimento vanno al 100% all’UBI. Le commissioni di swap sono suddivise 40% validatori / 30% fornitori di liquidità / 30% UBI. Demurrage ed eccedenza del limite di ricchezza vanno al 100% all\'UBI. Nessuno può pagare da un pool, nemmeno con la sua chiave; solo il protocollo distribuisce, ogni giorno.',
  ...
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100% delle commissioni di trasferimento + 30% di quelle di swap + 100% del demurrage e dell’eccedenza oltre il tetto di ricchezza → diviso equamente tra tutti gli umani verificati ogni 24 ore.',
  ...
  'ubi-src-dem':'Demurrage','ubi-src-dem-d':'AEQ inattivo (3+ mesi) decade dello 0,5%/mese sulla parte oltre la tua quota equa di 1.000 AEQ. Il 100% dell\'importo decaduto va all\'UBI.',
  'ubi-src-cap':'Overflow Limite di Ricchezza','ubi-src-cap-d':'I wallet che superano max(5,min(N,25))× il saldo medio hanno l\'eccesso confiscato istantaneamente. Il 100% fluisce all\'UBI.',
...
tr:{
  'ubi-src-tx':'Transfer ücretleri','ubi-src-tx-d':'Her AEQ transferi üstüne %0,1 öder (çok büyük bakiyelerde daha fazla). Ücretin tamamı buraya gelir.','pool-badge-v':'takas ücretinin %40','pool-badge-l':'takas ücretinin %30','pool-badge-u':'tüm yeniden dağıtım','pool-next':'⏰ Sonraki:','treasury-retired':'Eski hazine 24.09.2026 tarihinden beri devre dışı: hiçbir şey almaz ve kimse ondan ödeme yapamaz. Kalan bakiye:','x-flow-1':'● Transfer → %100 UBI','x-flow-2':'● Demuraj, tavan → %100 UBI','x-flow-3':'● Takas → %30 UBI','x-flow-4':'%40 validator · %30 LP',
  ...
  'pools-desc':'Transfer ücretlerinin tamamı UBI’ye gider. Takas ücretleri: %40 doğrulayıcılar / %30 likidite sağlayıcılar / %30 UBI. Gecikme ücreti ve servet tavanı taşması %100 UBI\'ya gider. Kimse bir havuzdan ödeme yapamaz — anahtarıyla bile; yalnızca protokol her gün dağıtır.',
  ...
  'ubi-pool':'UBI Havuzu','ubi-pool-desc':'Transfer ücretlerinin tamamı + takas ücretlerinin %30 kadarı + demuraj ve servet tavanı fazlasının tamamı → her 24 saatte bir tüm doğrulanmış insanlara eşit dağıtılır.',
  'phases-title':'Protokol Aşamaları',
  'phases-desc':'Aşama 0\'da servet tavanı bir bootstrap çarpanı kullanır: max(5, min(N, 25))× ortalama bakiye. 1–4 insanla: 5× ortalama. Her yeni insan 1× ekler. 25+ insanda: kalıcı olarak 25×\'e sabitlenir. Aşama 1+ 25×\'i sabit tutar. Tüm geçişler insan sayısına göre otomatiktir — elle yönetişim anahtarı değil.',
  ...
  'ubi-title':'5. EVRENSEL TEMEL GELİR — Günlük Yeniden Dağıtım','ubi-box':'UBI Havuzu Gelir Kaynakları:<br>· AEQ↔tUSD AMM havuzundan tüm takas ücretlerinin %30\'si<br>· Servet tavanı uygulamasından taşma<br>· Hareketsiz hesaplardan gecikme ücretleri<br>· 4 yıl sonra serbest bırakılan hareketsiz emanet<br><br>Dağıtım: Her 24 saatte bir, tüm UBI Havuzu bakiyesi tüm kayıtlı doğrulanmış insanlar arasında eşit olarak bölünür.',
  ...
  'ubi-src-dem':'Gecikme Ücreti','ubi-src-dem-d':'Hareketsiz AEQ (3+ ay), 1.000 AEQ adil payın üzerindeki kısmında ayda %0,5 bozunur. Bozunan miktarın %100\'ü UBI\'ya gider.',
  'ubi-src-cap':'Servet Tavanı Taşması','ubi-src-cap-d':'Servet tavanını (max(5,min(N,25))× ortalama) aşan cüzdanlar anında kesilir. %100\'si UBI\'ya akar.',
...
fr:{
  'ubi-src-tx':'Frais de virement','ubi-src-tx-d':'Chaque virement d’AEQ paie 0,1 % en plus (davantage pour les très gros soldes). La totalité des frais va ici.','pool-badge-v':'40 % des frais de swap','pool-badge-l':'30 % des frais de swap','pool-badge-u':'toute la redistribution','pool-next':'⏰ Prochain :','treasury-retired':'L’ancienne trésorerie est retirée depuis le 24/09/2026 : elle ne reçoit plus rien et personne ne peut payer depuis elle. Solde restant :','x-flow-1':'● Virements → 100 % UBI','x-flow-2':'● Demurrage, plafond → 100 % UBI','x-flow-3':'● Swap → 30 % UBI','x-flow-4':'40 % validateurs · 30 % LP',
  'x-consensus-ghostdag-knightdag':'◆ Consensus : GHOSTDAG + KNIGHTDAG',
  ...
  'pools-desc':'Frais de virement : 100 % à l’UBI. Frais de swap : 40% validateurs / 30% fournisseurs de liquidité / 30% UBI. Demurrage et dépassement du plafond : 100% à l\'UBI. Personne ne peut payer depuis un pool, même avec sa clé ; seul le protocole distribue, chaque jour.',
  ...
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100 % des frais de virement + 30 % des frais de swap + 100 % du demurrage et du dépassement du plafond de richesse → partagés à parts égales entre tous les humains vérifiés toutes les 24 heures.',
  'phases-title':'Phases du protocole',
  'phases-desc':'Plafond bootstrap Phase 0 : max(5, min(N, 25))× solde moyen. 1–4 humains : 5×. Chaque humain ajoute 1×. 25+ humains : verrouillé à 25×. Transitions automatiques selon le nombre d\'humains — pas un interrupteur de gouvernance manuel.',
  ...
  'ubi-title':'5. REVENU DE BASE UNIVERSEL','ubi-box':'Sources : Frais de swap (30%) · Dépassement du plafond · Demurrage<br><br>Quotidien : Pool UBI divisé également entre tous les humains. Pool remis à zéro après chaque distribution.',
  ...
  'ubi-src-dem':'Demurrage','ubi-src-dem-d':'AEQ inactif (3+ mois) décroît de 0,5%/mois sur la part au-delà de ta part équitable de 1 000 AEQ. 100% du montant décroissant va à l\'UBI.',
  'ubi-src-cap':'Dépassement du Plafond','ubi-src-cap-d':'Portefeuilles dépassant le plafond immédiatement rognés. 100% afflue vers l\'UBI.',
...
pt:{
  ...
  'pools-desc':'Taxas de transferência: 100% para o UBI. Taxas de swap: 40% validadores / 30% provedores de liquidez / 30% UBI. Demurrage e excesso do teto: 100% para o UBI. Ninguém pode pagar a partir de um pool — nem com a sua chave; só o protocolo distribui, diariamente.',
  ...
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100% das taxas de transferência + 30% das taxas de swap + 100% do demurrage e do excedente do teto de riqueza → dividido igualmente entre todos os humanos verificados a cada 24 horas.',
  'phases-title':'Fases do Protocolo',
  'phases-desc':'Teto bootstrap Fase 0: max(5, min(N, 25))× saldo médio. 1–4 humanos: 5×. Cada humano +1×. 25+ humanos: travado em 25×. Transições automáticas pelo número de humanos — não um interruptor manual de governação.',
  ...
  'ubi-title':'5. RENDA BÁSICA UNIVERSAL','ubi-box':'Fontes: Taxas de swap (30%) · Excesso do teto · Demurrage<br><br>Diário: Pool UBI dividido igualmente entre todos os humanos. Pool zera após cada distribuição.',
  ...
  'ubi-src-dem':'Demurrage','ubi-src-dem-d':'AEQ inativo (3+ meses) decai 0,5%/mês na parte acima da sua parte justa de 1.000 AEQ. 100% do valor decaído vai para UBI.',
  'ubi-src-cap':'Excesso do Teto','ubi-src-cap-d':'Carteiras que excedem o teto são imediatamente cortadas. 100% flui para UBI.',
...
ar:{
  ...
  'phases-desc':'في المرحلة 0 يستخدم سقف الثروة مضاعفاً متحركاً: max(5, min(N, 25)) × متوسط الرصيد. مع 1–4 بشر: 5×. كل إنسان جديد يضيف 1×. عند 25+ يُثبَّت عند 25×. الانتقالات تلقائية بعدد البشر — لا مفتاح حوكمة يدوي.',
  ...
  'pools-desc':'رسوم التحويل 100٪ لـ UBI. رسوم المبادلة: 40% للمدققين / 30% لمزودي السيولة / 30% لـ UBI. التلاشي وفائض سقف الثروة 100% لـ UBI. لا يمكن لأحد الصرف من مجمع — حتى بمفتاحه؛ البروتوكول وحده يوزع يومياً.',
  ...
  'ubi-pool':'مجمع UBI','ubi-pool-desc':'100٪ من رسوم التحويل + 30٪ من رسوم المبادلة + 100٪ من رسوم الركود وفائض سقف الثروة → تُقسَّم بالتساوي على جميع البشر الموثّقين كل 24 ساعة.',
  ...
  'ubi-title':'5. الدخل الأساسي الشامل','ubi-box':'المصادر: رسوم المبادلة (30%) · فائض السقف · التلاشي<br><br>يومياً: مجمع UBI مقسّم بالتساوي بين جميع البشر المسجلين. يُعاد ضبط المجمع بعد كل توزيع.',
  ...
  'ubi-src-dem':'التلاشي','ubi-src-dem-d':'AEQ الخامل (3+ أشهر) يتلاشى 0.5%/شهر على الجزء الذي يتجاوز حصتك العادلة البالغة 1000 AEQ. 100% من المتلاشي يذهب لـ UBI.',
  'ubi-src-cap':'فائض السقف','ubi-src-cap-d':'المحافظ التي تتجاوز السقف تُقلَّص فوراً. 100% يتدفق إلى UBI.',
...
hi:{
  'ubi-src-tx':'ट्रांसफ़र शुल्क','ubi-src-tx-d':'हर AEQ ट्रांसफ़र ऊपर से 0.1% देता है (बहुत बड़े बैलेंस पर अधिक)। पूरा शुल्क यहाँ आता है।','pool-badge-v':'स्वैप शुल्क का 40%','pool-badge-l':'स्वैप शुल्क का 30%','pool-badge-u':'पूरा पुनर्वितरण','pool-next':'⏰ अगला:','treasury-retired':'पुराना ख़ज़ाना 24.09.2026 से बंद है: उसे कुछ नहीं मिलता और कोई उससे भुगतान नहीं कर सकता। शेष राशि:','x-flow-1':'● ट्रांसफ़र → 100% UBI','x-flow-2':'● डेमरेज, सीमा → 100% UBI','x-flow-3':'● स्वैप → 30% UBI','x-flow-4':'40% वैलिडेटर · 30% LP',
  ...
  'phases-desc':'चरण 0 में धन सीमा स्लाइडिंग गुणक उपयोग करती है: max(5, min(N, 25)) × औसत बैलेंस। 1–4 मनुष्यों के साथ: 5×। हर नया मनुष्य 1× जोड़ता है। 25+ पर स्थायी रूप से 25×। बदलाव मनुष्यों की संख्या से स्वचालित — कोई मैनुअल गवर्नेंस स्विच नहीं।',
  ...
  'pools-desc':'ट्रांसफ़र शुल्क 100% UBI को। स्वैप शुल्क: 40% वैलिडेटर / 30% तरलता प्रदाता / 30% UBI। डेमरेज और धन सीमा अधिशेष 100% UBI में। कोई भी पूल से भुगतान नहीं कर सकता — उसकी कुंजी से भी नहीं; केवल प्रोटोकॉल प्रतिदिन वितरित करता है।',
  ...
  'ubi-pool':'UBI पूल','ubi-pool-desc':'ट्रांसफ़र शुल्क का 100% + स्वैप शुल्क का 30% + डेमरेज और संपत्ति सीमा से अधिक का 100% → हर 24 घंटे में सभी सत्यापित इंसानों में बराबर बाँटा जाता है।',
  ...
  'ubi-title':'5. यूनिवर्सल बेसिक इनकम','ubi-box':'स्रोत: स्वैप शुल्क (30%) · सीमा अधिशेष · डेमरेज<br><br>दैनिक: UBI पूल सभी पंजीकृत मनुष्यों में समान रूप से विभाजित। प्रत्येक वितरण के बाद पूल शून्य हो जाता है।',
  ...
  'ubi-src-dem':'डेमरेज','ubi-src-dem-d':'निष्क्रिय AEQ (3+ माह) 1,000 AEQ के उचित हिस्से से ऊपर वाले भाग पर 0.5%/माह क्षय होता है। क्षयित राशि का 100% UBI में जाता है।',
  'ubi-src-cap':'सीमा अधिशेष','ubi-src-cap-d':'सीमा से अधिक वॉलेट तुरंत कटते हैं। 100% UBI में प्रवाहित होता है।',
