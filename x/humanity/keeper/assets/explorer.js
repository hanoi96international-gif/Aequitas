...
en:{
  ...
  'logo-sub':'PROOF OF HUMANITY','live':'LIVE','phase0-badge':'Phase 0 · honest','nav-register':'Register','foot-launched':'Launched June 2026','foot-phase':'Phase 0','foot-quote':'Money exists because people exist. Nothing more, nothing less.',
  'reg-title':'🔐 Register as a Verified Human',
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Phase 0 disclaimer</div>Phase 0: Sybil resistance today rests mainly on nullifier dedup, device-/source-bound secrets, and the proof/attestation path. Face matching and mandatory MPC duplicate checks are roadmap/calibration — not the binding launch state. Double registration via new devices or bypassed biometric paths remains a known residual risk in Phase 0; do not claim “impossible” or “zero Sybil.”',
  'reg-sub':'Join the Aequitas network and receive your 1,000 AEQ start grant. Registration is one-time and permanent. Phase 0: honest about where duplicate protection stands today.',
  'app-title':'REGISTRATION VIA ANDROID APP',
  'app-text':'Registration today: wallet + bound identity source (typically device secret) and a proof/attestation path to the chain. Face matching against a real gallery and mandatory MPC are roadmap/calibration — not the binding Phase 0 state. Your <strong style="color:var(--gold)">1,000 AEQ credited automatically</strong> upon verification. <strong style="color:var(--gold)">Note:</strong> see the Phase 0 disclaimer near the register button.',
  ...
  'k-bio':'Face','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'Proof System','k-conf':'Confirmation','k-conf-v':'Within 1 second (1 block)',
  'k-sybil':'Sybil Protection','k-sybil-v':'Phase 0: nullifier + device-/source-bound · face gallery = roadmap',
  ...
  'h-sybil':'Sybil Resistance — Current State','h-sybil-t':'The nullifier is derived from the bound identity source (typically a device secret in Phase 0), so the same source cannot register twice. That is not the same claim as “the same face cannot register twice.” Until face-gallery matching is calibrated and binding, a second device — or a bypassed biometric path — remains a known residual risk. The cryptography on the nullifier is exact; cross-device uniqueness is not yet a measured biometric fact.',
  ...
  'h-bio-hw':'Identity Verification Roadmap','h-bio-hw-t':'Today (Phase 0): device-/source-bound secret + proof/attestation path to the chain. Face matching across independent services by quorum is roadmap/calibration — not the binding Ist state. Planned: that calibration (~1000 impostor pairs before quoting rates), and a duplicate check in which no service holds a whole template.',
  'reg-humans':'Registered Humans','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
'swap-sell-label':'Sell','swap-receive-label':'Receive',
  ...
  'faq-title':'❓ FAQ','faq-q1':'Is my biometric data safe?','faq-a1':'Phase 0 does not rely on a live face-vs-all gallery. Dedup rests on a nullifier bound to a device-/source-bound identity plus the proof/attestation path. When Face mode is enabled later, matching services may process captures under calibrated thresholds — do not treat “images discarded / encrypted template only” as an absolute today. Honest limit: Face matching and mandatory MPC are roadmap/calibration; double registration via new devices remains a known residual risk.',
  'faq-q1b':'Does registration prove I am a unique real person?','faq-a1b':'Not yet as a hard biometric uniqueness number. Phase 0 proves the bound identity source is unused (nullifier), not that a calibrated face match against everyone has run. Face-vs-all by independent services is roadmap/calibration — better than device keys alone once live, but not the binding launch claim. Error rates need ~1000 impostor pairs before any FAR can honestly be quoted.',
  'faq-q2':'Can I register with a different wallet later?','faq-a2':'No. A registration is permanently bound to one wallet. The nullifier (from the bound identity source — typically a device secret in Phase 0, face-derived when Face mode is live) is spent once; registering again on another wallet would be a second identity for the same source.',
...
de:{
  ...
  'bv-what-d':'Im Face-Galerie-Pfad (Roadmap, nicht der verbindliche Phase-0-Pfad) soll ein Gesicht dich nie als Bild erreichen: die Aufnahme wird nach der Prüfung verworfen, und deine Maschine speichert eine verschlüsselte Vorlage davon. Es gibt einen Modus mit geteilten Anteilen, in dem deine Maschine nur einen additiven Anteil einer 64-Byte-Skizze hielte — für sich genommen von Rauschen nicht zu unterscheiden, gemeinsam mit deinem Komitee verglichen, sodass keiner mehr erfährt als die Antwort. Er ist gebaut und geprüft, aber <strong style="color:var(--text)">noch nicht scharf</strong>, weil seine Schwelle nie kalibriert wurde. Bis dahin hielte jeder Verifier eine ganze verschlüsselte Vorlage — und das sagen wir lieber, als einen Schutz anzudeuten, den du noch nicht gibst. Die Phase-0-Registrierung selbst ruht auf geräte-/quellengebundenen Secrets + Nullifier, nicht auf diesem Galerie-Pfad.',
  ...
  'logo-sub':'MENSCHLICHKEITSNACHWEIS','live':'LIVE','phase0-badge':'Phase 0 · ehrlich','nav-register':'Registrieren','foot-launched':'Gestartet im Juni 2026','foot-phase':'Phase 0','foot-quote':'Geld existiert, weil Menschen existieren. Nicht mehr und nicht weniger.',
  'reg-title':'🔐 Als verifizierter Mensch registrieren',
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Phase-0-Disclaimer</div>Phase 0: Sybil-Schutz basiert derzeit vor allem auf Nullifier-Dedup und geräte-/quellengebundenen Secrets sowie dem Proof-/Attest-Pfad. Face-Matching und verpflichtende MPC-Duplikatprüfung sind Roadmap/Kalibrierung — nicht der verbindliche Launch-Zustand. Doppelregistrierung über neue Geräte oder umgangene Biometrie-Pfade ist in Phase 0 ein bekanntes Restrisiko; bitte keine Aussagen „unmöglich“ oder „Zero Sybil“.',
  'reg-sub':'Tritt dem Aequitas-Netzwerk bei und erhalte deine 1.000 AEQ Startzuteilung. Registrierung ist einmalig und dauerhaft. Phase 0: ehrlich über den Stand von Duplikat-Schutz.',
  'app-title':'REGISTRIERUNG NUR ÜBER ANDROID-APP',
  'app-text':'Registrierung heute: Wallet + gebundene Identity-Quelle (typisch Device-Secret) und Proof-/Attest-Pfad zur Chain. Face-Matching gegen echte Galerie und verpflichtendes MPC sind Roadmap/Kalibrierung — nicht der verbindliche Phase-0-Zustand. Deine <strong style="color:var(--gold)">1.000 AEQ werden nach der Verifikation automatisch gutgeschrieben</strong>. <strong style="color:var(--gold)">Hinweis:</strong> siehe Phase-0-Disclaimer beim Registrieren-Button.',
  ...
  'k-bio':'Gesicht','never-stored':'Phase 0: geräte-/quellengebundene Secrets + Nullifier — kein absolutes „Bilder verworfen / nur Template“',
  'k-proof':'Beweissystem','k-conf':'Bestätigung','k-conf-v':'Innerhalb von 1 Sekunde (1 Block)',
  'k-sybil':'Sybil-Schutz','k-sybil-v':'Phase 0: Nullifier + geräte-/quellengebunden · Face-Galerie = Roadmap',
  's-height':'Blockhöhe',
  ...
  'reg-humans':'Registrierte Menschen','h-desc':'Jede Adresse unten ist eine erfolgreiche Phase-0-Registrierung mit genau 1.000 AEQ. Dedup heute: Nullifier + Proof-/Attest-Pfad — Face-Galerie-Matching ist Roadmap. Das Register ist permanent und on-chain.',
  ...
  'h-sybil':'Sybil-Resistenz — Aktueller Stand','h-sybil-t':'Der Nullifier wird aus der gebundenen Identitätsquelle abgeleitet (in Phase 0 typisch ein Device-Secret) — dieselbe Quelle kann sich nicht zweimal registrieren. Das ist nicht die Behauptung „dasselbe Gesicht kann sich nicht zweimal registrieren“. Bis Face-Galerie-Matching kalibriert und verbindlich ist, bleibt ein Zweitgerät — oder ein umgangener Biometrie-Pfad — ein bekanntes Restrisiko. Die Kryptografie am Nullifier ist exakt; geräteübergreifende Einzigartigkeit ist noch keine gemessene biometrische Tatsache.',
  ...
  'h-bio-hw':'Identitätsverifikation — Roadmap','h-bio-hw-t':'Heute (Phase 0): geräte-/quellengebundenes Secret + Proof-/Attest-Pfad zur Chain. Face-Matching über unabhängige Dienste per Quorum ist Roadmap/Kalibrierung — nicht der verbindliche Ist-Zustand. Geplant: genau diese Kalibrierung (~1000 Impostor-Paare, bevor Raten genannt werden) und eine Duplikatsprüfung, bei der kein Dienst eine ganze Vorlage hält.',
  ...
  'faq-title':'❓ FAQ','faq-q1':'Sind meine biometrischen Daten sicher?','faq-a1':'Phase 0 stützt sich nicht auf eine Live-Face-vs-all-Galerie. Dedup läuft über Nullifier an einer geräte-/quellengebundenen Identity plus Proof-/Attest-Pfad. Wenn Face später aktiv ist, können Matching-Dienste Captures unter kalibrierten Schwellen verarbeiten — „Bilder verworfen / nur Template“ ist heute kein Absolutclaim. Ehrliche Grenze: Face-Matching und verpflichtendes MPC sind Roadmap/Kalibrierung; Doppel-Reg über neue Geräte bleibt Restrisiko.',
  'faq-q1b':'Beweist die Registrierung, dass ich ein einzigartiger echter Mensch bin?','faq-a1b':'Noch nicht als harte biometrische Eindeutigkeitszahl. Phase 0 beweist, dass die gebundene Identity-Quelle unbenutzt ist (Nullifier) — nicht, dass ein kalibrierter Face-Match gegen alle gelaufen ist. Face-vs-all durch unabhängige Dienste ist Roadmap/Kalibrierung — später stärker als reine Device-Keys, aber nicht der verbindliche Launch-Claim. Fehlerraten brauchen ~1000 Impostor-Paare, bevor eine FAR ehrlich zitierbar ist.',
  'faq-q2':'Kann ich mich später mit einer anderen Wallet registrieren?','faq-a2':'Nein. Eine Registrierung ist dauerhaft an eine Wallet gebunden. Der Nullifier (aus der gebundenen Identity-Quelle — in Phase 0 typisch Device-Secret, face-abgeleitet wenn Face live ist) wird einmal verbraucht; erneute Registrierung auf eine andere Wallet wäre eine zweite Identität für dieselbe Quelle.',
...
es:{
  ...
  'logo-sub':'PRUEBA DE HUMANIDAD','live':'EN VIVO','phase0-badge':'Phase 0 · honesto','nav-register':'Registrarse','foot-launched':'Lanzada en junio de 2026','foot-phase':'Phase 0','foot-quote':'El dinero existe porque existen las personas. Nada más, nada menos.',
  ...
  'k-bio':'Rostro','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'Sistema de Prueba','k-conf':'Confirmación','k-conf-v':'En 1 segundo (1 bloque)',
  'k-sybil':'Protección Sybil','k-sybil-v':'Fase 0: nullifier + vinculado a dispositivo/fuente · galería facial = hoja de ruta',
  ...
  'reg-humans':'Humanos Registrados','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
  ...
  'h-sybil':'Resistencia Sybil — Estado Actual','h-sybil-t':'El nullifier se deriva de la fuente de identidad vinculada (en Fase 0, típicamente un secreto de dispositivo), así que la misma fuente no puede registrarse dos veces. Eso no es lo mismo que afirmar que «el mismo rostro no puede registrarse dos veces». Hasta que el emparejamiento de galería facial esté calibrado y sea vinculante, un segundo dispositivo — o una vía biométrica omitida — sigue siendo un riesgo residual conocido. La criptografía del nullifier es exacta; la unicidad entre dispositivos aún no es un hecho biométrico medido.',
  ...
  'h-bio-hw':'Hoja de Ruta de Verificación de Identidad','h-bio-hw-t':'Hoy (Fase 0): secreto vinculado a dispositivo/fuente + ruta de prueba/atestación hacia la cadena. El emparejamiento facial entre servicios independientes por quórum es hoja de ruta/calibración — no el estado Ist vinculante. Previsto: esa calibración (~1000 pares impostor antes de citar tasas) y una comprobación de duplicados en la que ningún servicio conserve una plantilla completa.',
...
ru:{
  ...
  'logo-sub':'ДОКАЗАТЕЛЬСТВО ЧЕЛОВЕЧНОСТИ','live':'ОНЛАЙН','phase0-badge':'Phase 0 · честно','nav-register':'Регистрация','foot-launched':'Запущена в июне 2026 года','foot-phase':'Phase 0','foot-quote':'Деньги существуют, потому что существуют люди. Не больше и не меньше.',
  ...
  'k-bio':'Лицо','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'Система Доказательств','k-conf':'Подтверждение','k-conf-v':'В течение 1 секунды (1 блок)',
  'k-sybil':'Защита от Сибилл','k-sybil-v':'Фаза 0: nullifier + привязка к устройству/источнику · галерея лиц = дорожная карта',
  ...
  'h-sybil':'Устойчивость к Sybil — Текущее Состояние','h-sybil-t':'Нуллификатор выводится из привязанного источника личности (в Фазе 0 обычно секрет устройства), поэтому один и тот же источник нельзя зарегистрировать дважды. Это не утверждение «одно и то же лицо нельзя зарегистрировать дважды». Пока сопоставление с галереей лиц не откалибровано и не является обязательным, второе устройство — или обойдённый биометрический путь — остаётся известным остаточным риском. Криптография нуллификатора точна; междоустройственная уникальность ещё не измеренный биометрический факт.',
  ...
  'h-bio-hw':'Дорожная Карта Верификации Личности','h-bio-hw-t':'Сегодня (Фаза 0): секрет, привязанный к устройству/источнику + путь proof/attestation к цепи. Сопоставление лиц независимыми службами по кворуму — дорожная карта/калибровка, а не обязательное «как есть». Планируется: эта калибровка (~1000 импостор-пар до указания долей ошибок) и проверка дубликатов, при которой ни одна служба не хранит целый шаблон.',
  'reg-humans':'Зарегистрированные Люди','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
zh:{
  ...
  'logo-sub':'人类证明','live':'实时','phase0-badge':'Phase 0 · 诚实','nav-register':'注册','foot-launched':'2026 年 6 月上线','foot-phase':'Phase 0','foot-quote':'金钱之所以存在，是因为人存在。不多，也不少。',
  ...
  'k-bio':'面部','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'证明系统','k-conf':'确认','k-conf-v':'1秒内（1个区块）',
  'k-sybil':'女巫攻击防护','k-sybil-v':'阶段 0：nullifier + 设备/来源绑定 · 面部图库 = 路线图',
  's-height':'区块高度',
  's-humans':'已验证人类',
  ...
  'h-sybil':'女巫攻击抵御——当前状态','h-sybil-t':'nullifier 由绑定的身份来源派生（阶段 0 通常为设备密钥），因此同一来源无法注册两次。这并不等于断言「同一张脸无法注册两次」。在面部图库匹配完成校准并成为约束条件之前，第二台设备——或被绕过的生物识别路径——仍是已知的残余风险。nullifier 上的密码学是精确的；跨设备唯一性尚不是可测量的生物特征事实。',
  'h-global':'全球金融包容','h-global-t':'无需银行账户、无需信用卡、无需任何加密货币经验。只要一部带摄像头的安卓智能手机。Aequitas 的设计目标是让地球上的每个人都能使用。',
  'h-bio-hw':'身份验证路线图','h-bio-hw-t':'当前（阶段 0）：设备/来源绑定密钥 + 面向链的证明/见证路径。独立服务按法定多数进行的面部匹配属于路线图/校准——不是具约束力的现状。计划中：完成该校准（约 1000 组冒名配对后再给出比率），以及一种没有任何服务持有完整模板的重复检测。',
  'reg-humans':'已注册人类','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
id:{
  ...
  'logo-sub':'BUKTI KEMANUSIAAN','live':'LANGSUNG','phase0-badge':'Phase 0 · jujur','nav-register':'Daftar','foot-launched':'Diluncurkan Juni 2026','foot-phase':'Phase 0','foot-quote':'Uang ada karena manusia ada. Tidak lebih, tidak kurang.',
  ...
  'k-bio':'Wajah','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'Sistem Bukti','k-conf':'Konfirmasi','k-conf-v':'Dalam 1 detik (1 blok)',
  'k-sybil':'Perlindungan Sybil','k-sybil-v':'Fase 0: nullifier + terikat perangkat/sumber · galeri wajah = peta jalan',
  ...
  'h-sybil':'Ketahanan Sybil — Kondisi Saat Ini','h-sybil-t':'Nullifier diturunkan dari sumber identitas terikat (pada Fase 0 biasanya rahasia perangkat), sehingga sumber yang sama tidak dapat didaftarkan dua kali. Itu bukan klaim yang sama dengan «wajah yang sama tidak dapat didaftarkan dua kali». Sampai pencocokan galeri wajah dikalibrasi dan mengikat, perangkat kedua — atau jalur biometrik yang dilewati — tetap risiko residual yang diketahui. Kriptografi pada nullifier bersifat pasti; keunikan lintas perangkat belum menjadi fakta biometrik terukur.',
  ...
  'h-bio-hw':'Peta Jalan Verifikasi Identitas','h-bio-hw-t':'Saat ini (Fase 0): rahasia terikat perangkat/sumber + jalur proof/attest ke rantai. Pencocokan wajah oleh layanan independen secara kuorum adalah peta jalan/kalibrasi — bukan keadaan Ist yang mengikat. Direncanakan: kalibrasi tersebut (~1000 pasangan impostor sebelum menyebut tingkat kesalahan), dan pemeriksaan duplikat di mana tidak ada layanan yang memegang templat utuh.',
  'reg-humans':'Manusia Terdaftar','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
it:{
  ...
  'logo-sub':'PROVA DI UMANITÀ','live':'LIVE','phase0-badge':'Phase 0 · onesto','nav-register':'Registrati','foot-launched':'Lanciata a giugno 2026','foot-phase':'Phase 0','foot-quote':'Il denaro esiste perché esistono le persone. Niente di più, niente di meno.',
  ...
  'k-bio':'Volto','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'Sistema di Prova','k-conf':'Conferma','k-conf-v':'Entro 1 secondo (1 blocco)',
  'k-sybil':'Protezione Sybil','k-sybil-v':'Fase 0: nullifier + legato a dispositivo/fonte · galleria volti = roadmap',
  ...
  'h-sybil':'Resistenza Sybil — Stato Attuale','h-sybil-t':'Il nullifier deriva dalla fonte di identità vincolata (in Fase 0 tipicamente un segreto di dispositivo), quindi la stessa fonte non può registrarsi due volte. Non è la stessa affermazione di «lo stesso volto non può registrarsi due volte». Finché il matching sulla galleria volti non è calibrato e vincolante, un secondo dispositivo — o un percorso biometrico aggirato — resta un rischio residuale noto. La crittografia sul nullifier è esatta; l\'unicità tra dispositivi non è ancora un fatto biometrico misurato.',
  ...
  'h-bio-hw':'Roadmap di Verifica dell\'Identità','h-bio-hw-t':'Oggi (Fase 0): segreto legato a dispositivo/fonte + percorso di prova/attestazione verso la catena. Il matching del volto tra servizi indipendenti per quorum è roadmap/calibrazione — non lo stato Ist vincolante. In programma: quella calibrazione (~1000 coppie impostore prima di citare tassi) e un controllo duplicati in cui nessun servizio possiede un modello intero.',
  'reg-humans':'Umani Registrati','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
tr:{
  ...
  'logo-sub':'İNSANLIK KANITI','live':'CANLI','phase0-badge':'Phase 0 · dürüst','nav-register':'Kaydol','foot-launched':'Haziran 2026\'da başlatıldı','foot-phase':'Phase 0','foot-quote':'Para, insanlar var olduğu için vardır. Ne fazlası, ne eksiği.',
  ...
  'k-bio':'Yüz','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'Kanıt Sistemi','k-conf':'Onay','k-conf-v':'1 saniye içinde (1 blok)',
  'k-sybil':'Sybil Koruması','k-sybil-v':'Aşama 0: nullifier + cihaz/kaynak bağlı · yüz galerisi = yol haritası',
  ...
  'h-sybil':'Sybil Direnci — Mevcut Durum','h-sybil-t':'Nullifier, bağlı kimlik kaynağından türetilir (Aşama 0\'da tipik olarak cihaz sırrı); aynı kaynak iki kez kaydolamaz. Bu, «aynı yüz iki kez kaydolamaz» iddiasıyla aynı değildir. Yüz galerisi eşleştirmesi kalibre edilip bağlayıcı olana dek ikinci bir cihaz — veya atlanmış bir biyometri yolu — bilinen bir art risk olarak kalır. Nullifier üzerindeki kriptografi kesindir; cihazlar arası teklik henüz ölçülmüş bir biyometrik olgu değildir.',
  ...
  'h-bio-hw':'Kimlik Doğrulama Yol Haritası','h-bio-hw-t':'Bugün (Aşama 0): cihaz/kaynak bağlı sır + zincire proof/attest yolu. Bağımsız servisler arasında yeter sayıyla yüz eşleştirme yol haritası/kalibrasyondur — bağlayıcı Ist durumu değildir. Planlanan: bu kalibrasyon (oran vermeden önce ~1000 sahte çift) ve hiçbir servisin tam şablon tutmadığı bir kopya denetimi.',
  'reg-humans':'Kayıtlı İnsanlar','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
fr:{
  ...
  'logo-sub':'PREUVE D\'HUMANITÉ','live':'EN DIRECT','phase0-badge':'Phase 0 · honnête','nav-register':'S\'inscrire','foot-launched':'Lancée en juin 2026','foot-phase':'Phase 0','foot-quote':'L\'argent existe parce que les gens existent. Rien de plus, rien de moins.',
  ...
  'k-bio':'Visage','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'Système de preuve','k-conf':'Confirmation','k-conf-v':'En 1 seconde (1 bloc)',
  'k-sybil':'Protection Sybil','k-sybil-v':'Phase 0 : nullifier + lié à l\'appareil/source · galerie faciale = feuille de route',
  ...
  'h-sybil':'Résistance Sybil — État Actuel','h-sybil-t':'Le nullifier est dérivé de la source d\'identité liée (en Phase 0, typiquement un secret d\'appareil), donc la même source ne peut pas s\'enregistrer deux fois. Ce n\'est pas la même affirmation que « le même visage ne peut pas s\'enregistrer deux fois ». Tant que l\'appariement à la galerie faciale n\'est pas calibré et contraignant, un second appareil — ou un chemin biométrique contourné — reste un risque résiduel connu. La cryptographie du nullifier est exacte ; l\'unicité inter-appareils n\'est pas encore un fait biométrique mesuré.',
  ...
  'h-bio-hw':'Feuille de Route de Vérification d\'Identité','h-bio-hw-t':'Aujourd\'hui (Phase 0) : secret lié à l\'appareil/source + chemin de preuve/attestation vers la chaîne. L\'appariement facial par des services indépendants en quorum est feuille de route/calibration — pas l\'état Ist contraignant. Prévu : cette calibration (~1000 paires d\'imposteurs avant de citer des taux) et un contrôle de doublons où aucun service ne détient un gabarit entier.',
  'reg-humans':'Humains inscrits','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
pt:{
  ...
  'logo-sub':'PROVA DE HUMANIDADE','live':'AO VIVO','phase0-badge':'Phase 0 · honesto','nav-register':'Registar','foot-launched':'Lançada em junho de 2026','foot-phase':'Phase 0','foot-quote':'O dinheiro existe porque as pessoas existem. Nada mais, nada menos.',
  ...
  'k-bio':'Rosto','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'Sistema de Prova','k-conf':'Confirmação','k-conf-v':'Em 1 segundo (1 bloco)',
  'k-sybil':'Proteção Sybil','k-sybil-v':'Fase 0: nullifier + ligado a dispositivo/fonte · galeria facial = roteiro',
  ...
  'h-sybil':'Resistência Sybil — Estado Atual','h-sybil-t':'O nullifier deriva da fonte de identidade vinculada (na Fase 0, tipicamente um segredo de dispositivo), pelo que a mesma fonte não pode registar-se duas vezes. Isso não é a mesma afirmação de «o mesmo rosto não pode registar-se duas vezes». Até o emparelhamento da galeria facial estar calibrado e vinculativo, um segundo dispositivo — ou um caminho biométrico contornado — permanece um risco residual conhecido. A criptografia do nullifier é exata; a unicidade entre dispositivos ainda não é um facto biométrico medido.',
  ...
  'h-bio-hw':'Roteiro de Verificação de Identidade','h-bio-hw-t':'Hoje (Fase 0): segredo ligado a dispositivo/fonte + caminho de prova/atestação para a cadeia. Emparelhamento facial por serviços independentes em quórum é roteiro/calibração — não o estado Ist vinculativo. Previsto: essa calibração (~1000 pares de impostores antes de citar taxas) e uma verificação de duplicados em que nenhum serviço detém um modelo inteiro.',
  'reg-humans':'Humanos Registrados','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
ar:{
  ...
  'logo-sub':'إثبات الإنسانية','live':'مباشر','phase0-badge':'Phase 0 · بصراحة','nav-register':'تسجيل','foot-launched':'أُطلقت في يونيو 2026','foot-phase':'Phase 0','foot-quote':'المال موجود لأن الناس موجودون. لا أكثر ولا أقل.',
  ...
  'k-bio':'الوجه','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'نظام الأدلة','k-conf':'التأكيد','k-conf-v':'خلال ثانية واحدة (كتلة واحدة)',
  'k-sybil':'حماية Sybil','k-sybil-v':'المرحلة 0: nullifier + مرتبط بالجهاز/المصدر · معرض الوجوه = خارطة طريق',
  ...
  'h-sybil':'مقاومة Sybil — الوضع الحالي','h-sybil-t':'يُشتق المُبطِل من مصدر الهوية المرتبط (في المرحلة 0 عادة سرّ الجهاز)، لذا لا يمكن تسجيل المصدر نفسه مرتين. هذا ليس ادّعاء «لا يمكن تسجيل الوجه نفسه مرتين». إلى أن تُعايَر مطابقة معرض الوجوه وتصبح مُلزمة، يبقى جهاز ثانٍ — أو مسار حيويّ متجاوَز — خطراً متبقياً معروفاً. التشفير على المُبطِل دقيق؛ والفرادة عبر الأجهزة ليست بعد حقيقة حيوية مقيسة.',
  ...
  'h-bio-hw':'خارطة طريق التحقق من الهوية','h-bio-hw-t':'اليوم (المرحلة 0): سرّ مرتبط بالجهاز/المصدر + مسار إثبات/تصديق إلى السلسلة. مطابقة الوجوه عبر خدمات مستقلة بالنصاب خارطة طريق/معايرة — وليست الحالة القائمة الملزمة. المخطط: هذه المعايرة (~1000 زوج منتحل قبل ذكر المعدّلات)، وفحص تكرار لا تحتفظ فيه أي خدمة بقالب كامل.',
  'reg-humans':'البشر المسجلون','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
...
hi:{
  ...
  'logo-sub':'मानवता का प्रमाण','live':'लाइव','phase0-badge':'Phase 0 · ईमानदार','nav-register':'रजिस्टर','foot-launched':'जून 2026 में शुरू','foot-phase':'Phase 0','foot-quote':'पैसा इसलिए है क्योंकि लोग हैं। न इससे ज़्यादा, न इससे कम।',
  ...
  'k-bio':'चेहरा','never-stored':'Phase 0: device-/source-bound secrets + nullifier — not “images discarded / template only” as absolute',
  'k-proof':'प्रमाण प्रणाली','k-conf':'पुष्टि','k-conf-v':'1 सेकंड के भीतर (1 ब्लॉक)',
  'k-sybil':'Sybil सुरक्षा','k-sybil-v':'चरण 0: nullifier + डिवाइस/स्रोत-बद्ध · फेस गैलरी = रोडमैप',
  's-height':'ब्लॉक हाइट',
  ...
  'h-sybil':'Sybil प्रतिरोध — वर्तमान स्थिति','h-sybil-t':'nullifier बाउंड पहचान-स्रोत से व्युत्पन्न होता है (चरण 0 में आमतौर पर डिवाइस सीक्रेट), इसलिए वही स्रोत दो बार पंजीकृत नहीं हो सकता। यह दावा नहीं है कि «वही चेहरा दो बार पंजीकृत नहीं हो सकता»। जब तक फेस-गैलरी मिलान कैलिब्रेट और बाध्यकारी नहीं होता, दूसरा डिवाइस — या बायपास किया बायोमेट्रिक पथ — ज्ञात अवशिष्ट जोखिम बना रहता है। nullifier पर क्रिप्टोग्राफी सटीक है; क्रॉस-डिवाइस विशिष्टता अभी मापी गई बायोमेट्रिक सच्चाई नहीं है।',
  ...
  'h-bio-hw':'पहचान सत्यापन रोडमैप','h-bio-hw-t':'आज (चरण 0): डिवाइस/स्रोत-बद्ध सीक्रेट + चेन तक प्रूफ/अटेस्ट पथ। स्वतंत्र सेवाओं द्वारा कोरम से फेस मिलान रोडमैप/कैलिब्रेशन है — बाध्यकारी Ist स्थिति नहीं। नियोजित: वही कैलिब्रेशन (~1000 इम्पोस्टर जोड़े दर बताने से पहले), और डुप्लिकेट जाँच जिसमें कोई सेवा पूरा टेम्पलेट न रखे।',
  'reg-humans':'रजिस्टर्ड मनुष्य','h-desc':'Every address below is a successful Phase 0 registration credited with exactly 1,000 AEQ. Dedup today rests on nullifiers + the proof/attest path — face-gallery matching is roadmap. The registry is permanent and on-chain.',
