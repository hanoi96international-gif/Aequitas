...
en:{
  ...
  's-uptime':'Uptime','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
...
de:{
  ...
  's-uptime':'Laufzeit','s-uptime-sub':'Node v0.3.0 · Contabo-VPS-Knoten · je eigene PostgreSQL',
...
es:{
  ...
  's-uptime':'Tiempo Activo','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
...
ru:{
  ...
  's-uptime':'Время Работы','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
  ...
  'path-node-title':'Я Оператор Ноды','path-node-desc':'Хочу запустить полную ноду, участвовать в производстве блоков и зарабатывать из 40%-ного пула валидаторов.','path-node-steps':'1. Зарегистрироваться как человек (обязательно)<br>2. Установить PRIMARY_NODE_URL=https://aequitas.digital<br>3. Развернуть на Contabo/Hetzner/любом VPS<br>4. Ежедневно зарабатывать из пула валидаторов',
...
zh:{
  ...
  's-uptime':'运行时间','s-uptime-sub':'节点 v0.3.0 · Contabo VPS · 各自独立PostgreSQL',
  ...
  'path-node-title':'我是节点运营商','path-node-desc':'我想运行完整节点，参与区块生产，并从40%验证者池中获利。','path-node-steps':'1. 注册为人类（必须）<br>2. 设置PRIMARY_NODE_URL=https://aequitas.digital<br>3. 部署在Contabo/Hetzner/任意VPS<br>4. 每日从验证者池获利',
...
id:{
  ...
  's-uptime':'Waktu Aktif','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
...
tr:{
  ...
  's-uptime':'Çalışma Süresi','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
...
fr:{
  ...
  's-uptime':'Disponibilité','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
  ...
  'path-node-title':'Je suis un Opérateur de Nœud','path-node-desc':'Je veux exécuter un nœud complet, participer à la production de blocs et gagner du pool de validateurs à 40%.','path-node-steps':'1. S\'inscrire en tant qu\'humain (obligatoire)<br>2. Définir PRIMARY_NODE_URL=https://aequitas.digital<br>3. Déployer sur Contabo/Hetzner/tout VPS<br>4. Gagner quotidiennement du pool de validateurs',
...
pt:{
  ...
  's-uptime':'Disponibilidade','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
  ...
  'path-node-title':'Sou um Operador de Node','path-node-desc':'Quero executar um node completo, participar na produção de blocos e ganhar do pool de validadores de 40%.','path-node-steps':'1. Registar como humano (obrigatório)<br>2. Definir PRIMARY_NODE_URL=https://aequitas.digital<br>3. Implementar em Contabo/Hetzner/qualquer VPS<br>4. Ganhar diariamente do pool de validadores',
...
ar:{
  ...
  's-uptime':'وقت التشغيل','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
  ...
  'path-node-title':'أنا مشغّل عقدة','path-node-desc':'أريد تشغيل عقدة كاملة والمشاركة في إنتاج الكتل والكسب من مجموعة المتحققين 40%.','path-node-steps':'1. التسجيل كإنسان (مطلوب)<br>2. تعيين PRIMARY_NODE_URL=https://aequitas.digital<br>3. النشر على Contabo/Hetzner/أي VPS<br>4. الكسب اليومي من مجموعة المتحققين',
...
hi:{
  ...
  's-uptime':'अपटाइम','s-uptime-sub':'Node v0.3.0 · Contabo VPS nodes · own PostgreSQL each',
