...
en:{
  ...
  'x-phase-transitions-are-automatic-8212':'Phase transitions are automatic — triggered by human count thresholds, enforced by the protocol. No governance vote, no admin key.',
  ...
  'priv-bar':'🔒 Phase 1 · Face check by quorum · Signed attestation required · Groth16 ZKP · Images discarded after checking',
  'conn-wallet':'CONNECTED WALLET','proof-recv':'⚡ ZK PROOF RECEIVED','proof-hint':'Connect wallet to register',
  'btn-conn':'🦊 CONNECT METAMASK','btn-reg':'🔐 REGISTER ON-CHAIN','reg-apk-note':'Phase 1: registration needs the app with the face check (app.apk from this site, v1.6.0 or newer).',
  ...
  'k-sybil':'Sybil Protection','k-sybil-v':'Phase 1: one identity per face · attestation required · threshold not yet calibrated',
...
de:{
  ...
  'x-phase-transitions-are-automatic-8212':'Phasenwechsel erfolgen automatisch — ausgelöst durch Schwellen der Menschenzahl, durchgesetzt vom Protokoll. Keine Governance-Abstimmung, kein Admin-Schlüssel.',
  ...
  'priv-bar':'🔒 Phase 1 · Gesichtsprüfung per Quorum · Signierte Bescheinigung Pflicht · Groth16-ZKP · Bilder nach der Prüfung verworfen',
  'conn-wallet':'VERBUNDENE WALLET','proof-recv':'⚡ ZK-BEWEIS EMPFANGEN','proof-hint':'Wallet verbinden um zu registrieren',
  'btn-conn':'🦊 METAMASK VERBINDEN','btn-reg':'🔐 ON-CHAIN REGISTRIEREN','reg-apk-note':'Phase 1: die Registrierung braucht die App mit Gesichtsprüfung (app.apk von dieser Seite, v1.6.0 oder neuer).',
  ...
  'k-sybil':'Sybil-Schutz','k-sybil-v':'Phase 1: eine Identität pro Gesicht · Bescheinigung Pflicht · Schwelle noch nicht kalibriert',
  's-height':'Blockhöhe',
...
es:{
  ...
  'x-phase-transitions-are-automatic-8212':'Los cambios de fase son automáticos — activados por umbrales de número de humanos y aplicados por el protocolo. Sin votación de gobernanza, sin clave de administrador.',
  ...
  'priv-bar':'🔒 Phase 1 · Verificación facial por quórum · Groth16 ZKP · Imágenes descartadas tras la comprobación · Un registro por persona',
  'conn-wallet':'WALLET CONECTADA','proof-recv':'⚡ PRUEBA ZK RECIBIDA','proof-hint':'Conecte su wallet para registrarse',
  'btn-conn':'🦊 CONECTAR METAMASK','btn-reg':'🔐 REGISTRAR ON-CHAIN','reg-apk-note':'Phase 1: el registro requiere la app con verificación facial (app.apk de este sitio, v1.6.0 o posterior).',
...
ru:{
  ...
  'x-phase-transitions-are-automatic-8212':'Смена фаз происходит автоматически — по порогам числа людей и обеспечивается протоколом. Без голосования, без админ-ключа.',
  ...
  'priv-bar':'🔒 Phase 1 · Проверка лица кворумом · Groth16 ZKP · Изображения удаляются после проверки · Одна регистрация на человека',
  'conn-wallet':'ПОДКЛЮЧЁННЫЙ КОШЕЛЁК','proof-recv':'⚡ ZK-ДОКАЗАТЕЛЬСТВО ПОЛУЧЕНО','proof-hint':'Подключите кошелёк для регистрации',
  'btn-conn':'🦊 ПОДКЛЮЧИТЬ METAMASK','btn-reg':'🔐 ЗАРЕГИСТРИРОВАТЬ ОН-ЧЕЙН','reg-apk-note':'Phase 1: для регистрации нужно приложение с проверкой лица (app.apk с этого сайта, v1.6.0 или новее).',
...
zh:{
  ...
  'x-phase-transitions-are-automatic-8212':'阶段转换是自动的——由人数阈值触发，由协议执行。无需治理投票，没有管理员密钥。',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Phase 1 声明</div>Phase 1：自 2026-08-25 起，证明服务器拒绝任何没有比对法定多数签名证明的注册 — 换一部手机不再能让同一张脸获得第二个账户。尚未成立的部分：该日期之前注册的账户没有人脸模板，原则上可以用新钱包再次注册；错误率尚未校准（需要约 1,000 组冒名配对）；活体检测为转头指令，更强的深度伪造防御正在校准中。请将「一人一账户」理解为「已核验、并明示限制」，而非「无法绕过」。 从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何实现——可靠、保护隐私、且无需智能手机也能使用；硬件和时间表尚未确定。',
  ...
  'priv-bar':'🔒 Phase 1 · 面部核验由法定多数完成 · Groth16 ZKP · 图像核验后即丢弃 · 每人一次注册',
  'conn-wallet':'已连接钱包','proof-recv':'⚡ 已收到ZK证明','proof-hint':'连接钱包以注册',
  'btn-conn':'🦊 连接 METAMASK','btn-reg':'🔐 链上注册','reg-apk-note':'Phase 1：注册需要带人脸核验的应用（本站 app.apk，v1.6.0 或更新）。',
  ...
  'h-bio-hw':'身份验证路线图','h-bio-hw-t':'当前（测试版）：由独立比对服务完成的面部核验，须达成法定多数一致。其阈值尚未用真实采集数据校准 — 在给出任何数字之前需要约 1000 组冒名配对。计划中：完成该校准，以及一种没有任何服务持有完整模板的重复检测。 从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何实现——可靠、保护隐私、且无需智能手机也能使用；硬件和时间表尚未确定。',
  ...
  'gini-what-title':'什么是基尼系数？','gini-what-text':'由意大利统计学家科拉多·基尼于1912年提出。通过将实际余额与假设的完全平等基线进行比较来衡量财富分配。范围：0（人人均等）到1（一人独占）。世界银行、经合组织、联合国用于比较各国。参考值：比特币≈0.85 · 南非（世界纪录）≈0.63 · 美国≈0.41 · 德国≈0.31 · 北欧≈0.27 · Aequitas长期目标：基尼系数低于0.30。','gini-calc-title':'如何计算Aequitas指数','gini-calc-text':'收集所有已验证真人的 AEQ 余额。公式计算所有可能余额对之间的平均绝对差，并以人口平方（n²）和平均余额（x̄）归一化。结果 0–1 乘以 100 = Aequitas 指数。节点根据实时余额计算；每次每日基本收入发放后都会保存一个快照，用于历史图表。','gini-why-title':'为什么选择基尼系数','gini-why-text':'简单的“最富与最穷之比”很容易被操纵：10,000 个钱包可能显示差距很小，而 90% 的 AEQ 却集中在 100 人手中——基尼系数能发现这一点，比值却不能。它用一个任何人都能复算的数字概括全部已验证真人的分布。它是测量值，而不是调节杠杆：阶段和财富上限取决于注册人数，再分配规则固定在协议中。任何人都无法改动读数。',
  ...
  'faq-q1b':'注册能证明我是独特的真实人类吗？','faq-a1b':'比设备密钥所能做到的更好，但尚不能用数字证明。面部会由必须达成一致的独立服务与所有既有注册进行比对，因此同一个人换第二部手机也会被识破 — 这是设备密钥从来做不到的。尚未确定的是错误率：比对阈值未用真实采集数据校准，这需要约 1000 组冒名配对。 已知且有限的例外：人脸核验启用前（2026-08-25）注册的账户没有人脸模板。 从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何实现——可靠、保护隐私、且无需智能手机也能使用；硬件和时间表尚未确定。',
...
id:{
  ...
  'x-phase-transitions-are-automatic-8212':'Pergantian fase terjadi otomatis — dipicu ambang jumlah manusia, ditegakkan oleh protokol. Tanpa voting tata kelola, tanpa kunci admin.',
  ...
  'priv-bar':'🔒 Phase 1 · Pemeriksaan wajah oleh kuorum · Groth16 ZKP · Gambar dibuang setelah pemeriksaan · Satu pendaftaran per orang',
  'conn-wallet':'DOMPET TERHUBUNG','proof-recv':'⚡ BUKTI ZK DITERIMA','proof-hint':'Hubungkan dompet untuk mendaftar',
  'btn-conn':'🦊 HUBUNGKAN METAMASK','btn-reg':'🔐 DAFTAR ON-CHAIN','reg-apk-note':'Phase 1: pendaftaran memerlukan aplikasi dengan pemeriksaan wajah (app.apk dari situs ini, v1.6.0 atau lebih baru).',
...
it:{
  ...
  'x-phase-transitions-are-automatic-8212':'I passaggi di fase sono automatici — attivati da soglie di numero di umani e applicati dal protocollo. Nessun voto di governance, nessuna chiave di amministratore.',
  'x-postgresql-persistent':'PostgreSQL (persistente)',
  'x-protocol-v7':'📜 Protocol V7',
  ...
  'priv-bar':'🔒 Phase 1 · Verifica del volto per quorum · Groth16 ZKP · Immagini scartate dopo la verifica · Una registrazione per persona',
  'conn-wallet':'WALLET CONNESSO','proof-recv':'⚡ PROVA ZK RICEVUTA','proof-hint':'Connetta il wallet per registrarsi',
  'btn-conn':'🦊 CONNETTI METAMASK','btn-reg':'🔐 REGISTRA ON-CHAIN','reg-apk-note':'Phase 1: la registrazione richiede l\'app con verifica del volto (app.apk da questo sito, v1.6.0 o successiva).',
...
tr:{
  ...
  'x-phase-transitions-are-automatic-8212':'Aşama geçişleri otomatiktir — insan sayısı eşikleriyle tetiklenir, protokol tarafından uygulanır. Yönetişim oylaması yok, yönetici anahtarı yok.',
  ...
  'priv-bar':'🔒 Phase 1 · Yüz denetimi yeter sayıyla · Groth16 ZKP · Görüntüler denetimden sonra atılır · Kişi başına bir kayıt',
  'conn-wallet':'BAĞLI CÜZDAN','proof-recv':'⚡ ZK KANITI ALINDI','proof-hint':'Kayıt için cüzdanınızı bağlayın',
  'btn-conn':'🦊 METAMASK BAĞLA','btn-reg':'🔐 ZİNCİRE KAYIT OL','reg-apk-note':'Phase 1: kayıt için yüz doğrulamalı uygulama gerekir (bu sitedeki app.apk, v1.6.0 veya daha yeni).',
...
fr:{
  ...
  'x-phase-transitions-are-automatic-8212':'Les changements de phase sont automatiques — déclenchés par des seuils de nombre d’humains, appliqués par le protocole. Pas de vote de gouvernance, pas de clé d’administration.',
  ...
  'priv-bar':'🔒 Phase 1 · Vérification du visage par quorum · Groth16 ZKP · Images écartées après vérification · Un enregistrement par personne',
  'conn-wallet':'PORTEFEUILLE CONNECTÉ','proof-recv':'⚡ PREUVE ZK REÇUE','proof-hint':'Connecter un portefeuille pour s\'inscrire',
  'btn-conn':'🦊 CONNECTER METAMASK','btn-reg':'🔐 INSCRIPTION ON-CHAIN','reg-apk-note':'Phase 1 : l\'inscription nécessite l\'app avec contrôle du visage (app.apk de ce site, v1.6.0 ou plus récent).',
...
pt:{
  ...
  'x-phase-transitions-are-automatic-8212':'As mudanças de fase são automáticas — acionadas por limiares de número de humanos e aplicadas pelo protocolo. Sem votação de governança, sem chave de administrador.',
  'x-postgresql-persistent':'PostgreSQL (persistente)',
  'x-protocol-v7':'📜 Protocol V7',
  ...
  'priv-bar':'🔒 Phase 1 · Verificação do rosto por quórum · Groth16 ZKP · Imagens descartadas após a verificação · Um registo por pessoa',
  'conn-wallet':'CARTEIRA CONECTADA','proof-recv':'⚡ PROVA ZK RECEBIDA','proof-hint':'Conectar carteira para registrar',
  'btn-conn':'🦊 CONECTAR METAMASK','btn-reg':'🔐 REGISTRAR ON-CHAIN','reg-apk-note':'Phase 1: o registo requer a app com verificação facial (app.apk deste site, v1.6.0 ou mais recente).',
  'btn-wc':'🔗 CONECTAR WALLETCONNECT',
...
ar:{
  ...
  'x-phase-transitions-are-automatic-8212':'الانتقال بين المراحل تلقائي — تطلقه عتبات عدد البشر ويفرضه البروتوكول. لا تصويت حوكمة ولا مفتاح مسؤول.',
  ...
  'priv-bar':'🔒 Phase 1 · التحقق من الوجه بالنصاب · Groth16 ZKP · تُتلَف الصور بعد التحقق · تسجيل واحد لكل شخص',
  'conn-wallet':'المحفظة المتصلة','proof-recv':'⚡ تم استلام دليل ZK','proof-hint':'ربط محفظة للتسجيل',
  'btn-conn':'🦊 ربط METAMASK','btn-reg':'🔐 التسجيل ON-CHAIN','reg-apk-note':'Phase 1: يتطلب التسجيل التطبيق مع التحقق من الوجه (app.apk من هذا الموقع، v1.6.0 أو أحدث).',
...
hi:{
  ...
  'x-phase-transitions-are-automatic-8212':'चरण परिवर्तन स्वचालित हैं — मनुष्यों की संख्या की सीमाओं से शुरू होते हैं और प्रोटोकॉल द्वारा लागू होते हैं। कोई शासन मतदान नहीं, कोई एडमिन कुंजी नहीं।',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Phase 1 अस्वीकरण</div>Phase 1: 25.08.2026 से प्रूफ़ सर्वर मिलान कोरम के हस्ताक्षरित सत्यापन के बिना हर पंजीकरण अस्वीकार करता है — दूसरा फ़ोन अब उसी चेहरे को दूसरा खाता नहीं देता। जो अभी लागू नहीं है: उस तारीख़ से पहले के खातों के पास चेहरे का टेम्पलेट नहीं है और वे सिद्धांततः नए वॉलेट से दोबारा पंजीकरण कर सकते हैं; त्रुटि दरें कैलिब्रेट नहीं हैं (~1,000 इम्पोस्टर जोड़े चाहिए); जीवंतता जाँच सिर घुमाना है, मज़बूत डीपफ़ेक बचाव कैलिब्रेट हो रहे हैं। «एक इंसान, एक खाता» को «जाँचा गया, बताई गई सीमाओं के साथ» पढ़ें — «असंभव» नहीं। दीर्घकाल में Aequitas आइरिस स्कैन पर निर्भर करेगा, ताकि सचमुच एक व्यक्ति = एक पंजीकरण सुनिश्चित हो सके। इसे कैसे लागू किया जाए — भरोसेमंद, निजता की रक्षा करते हुए और स्मार्टफ़ोन के बिना भी — इस पर अभी काम चल रहा है; हार्डवेयर और समय-सीमा अभी तय नहीं हैं।',
  ...
  'priv-bar':'🔒 Phase 1 · कोरम द्वारा चेहरे की जाँच · Groth16 ZKP · जाँच के बाद छवियाँ हटाई गईं · प्रति व्यक्ति एक पंजीकरण',
  'conn-wallet':'कनेक्टेड वॉलेट','proof-recv':'⚡ ZK प्रमाण प्राप्त','proof-hint':'रजिस्टर करने के लिए वॉलेट कनेक्ट करें',
  'btn-conn':'🦊 METAMASK कनेक्ट करें','btn-reg':'🔐 ON-CHAIN रजिस्टर करें','reg-apk-note':'Phase 1: पंजीकरण के लिए चेहरा जाँच वाला ऐप चाहिए (इस साइट का app.apk, v1.6.0 या नया)।',
  ...
  'h-bio-hw':'पहचान सत्यापन रोडमैप','h-bio-hw-t':'आज (बीटा): स्वतंत्र मिलान सेवाओं के माध्यम से चेहरे की जाँच, जिन्हें कोरम से सहमत होना होता है। इसकी सीमा अभी वास्तविक कैप्चर पर कैलिब्रेट नहीं है — कोई भी संख्या बताने से पहले लगभग 1000 इम्पोस्टर जोड़े चाहिए। नियोजित: वही कैलिब्रेशन, और एक डुप्लिकेट जाँच जिसमें कोई सेवा पूरा टेम्पलेट न रखे। दीर्घकाल में Aequitas आइरिस स्कैन पर निर्भर करेगा, ताकि सचमुच एक व्यक्ति = एक पंजीकरण सुनिश्चित हो सके। इसे कैसे लागू किया जाए — भरोसेमंद, निजता की रक्षा करते हुए और स्मार्टफ़ोन के बिना भी — इस पर अभी काम चल रहा है; हार्डवेयर और समय-सीमा अभी तय नहीं हैं।',
