...
en:{
  ...
  'ubi-src-dem':'Idle-money levy','ubi-src-dem-d':'People above 5,000 AEQ (0.5%/month), businesses above 1.5 months\' turnover (0.5–2%/month) and other addresses (1%/month). Settled daily, 100% goes to UBI. From 1 Oct 2026.',
...
de:{
  ...
  'dem-text':'<p>Historische Vorbilder: Das Wörgl-Experiment (Österreich, 1932) nutzte Schwundgeld und senkte die Arbeitslosigkeit in einem Jahr um 25 %. Der Chiemgauer (Deutschland, 2003) läuft seit über 20 Jahren erfolgreich mit einem ähnlichen Mechanismus.</p><p>Diese Regeln gelten ab 1. Oktober 2026. Bis dahin gilt die bisherige Regel: 0,5 %/Monat auf den Teil über dem fairen Anteil nach 3 Monaten ohne Aktivität.</p>',
  ...
  'ubi-src-dem':'Liegegeld','ubi-src-dem-d':'Menschen über 5.000 AEQ (0,5 %/Monat), Unternehmen über 1,5 Monatsumsätzen (0,5–2 %/Monat) und sonstige Adressen (1 %/Monat). Täglich verrechnet, 100 % gehen ins UBI. Ab 1. Okt. 2026.',
...
es:{
  ...
  'ubi-src-dem':'Gravamen por dinero parado','ubi-src-dem-d':'Personas por encima de 5.000 AEQ (0,5 %/mes), empresas por encima de 1,5 meses de facturación (0,5–2 %/mes) y otras direcciones (1 %/mes). Se liquida a diario, el 100 % va a la renta básica. Desde el 1 oct. 2026.',
...
ru:{
  ...
  'ubi-src-dem':'Сбор за лежащие деньги','ubi-src-dem-d':'Люди сверх 5 000 AEQ (0,5 %/мес.), бизнес сверх 1,5 месячного оборота (0,5–2 %/мес.) и прочие адреса (1 %/мес.). Рассчитывается ежедневно, 100 % идёт в базовый доход. С 1 окт. 2026.',
...
zh:{
  ...
  'dem-text':'<p>历史先例：沃尔格尔实验（奥地利，1932 年）使用带滞期费的货币，一年内将失业率降低了 25%。基姆高尔币（德国，2003 年）采用类似机制成功运行了 20 多年。</p><p>这些规则自 2026 年 10 月 1 日起生效。在此之前沿用原规则：3 个月无活动后，对超过公平份额的部分每月收取 0.5%。</p>',
  ...
  'ubi-src-dem':'闲置资金费','ubi-src-dem-d':'超过 5,000 AEQ 的个人（每月 0.5%）、超过 1.5 个月营业额的企业（每月 0.5–2%）和其他地址（每月 1%）。每日结算，100% 进入基本收入。自 2026 年 10 月 1 日起。',
...
id:{
  ...
  'dem-text':'<p>Preseden sejarah: eksperimen Wörgl (Austria, 1932) memakai mata uang demurrage dan menurunkan pengangguran 25% dalam setahun. Chiemgauer (Jerman, 2003) telah berjalan sukses lebih dari 20 tahun dengan mekanisme serupa.</p><p>Aturan ini berlaku sejak 1 Oktober 2026. Sebelum itu berlaku aturan lama: 0,5%/bln atas bagian di atas bagian adil setelah 3 bulan tanpa aktivitas.</p>',
  ...
  'ubi-src-dem':'Pungutan uang mengendap','ubi-src-dem-d':'Orang di atas 5.000 AEQ (0,5%/bulan), usaha di atas 1,5 bulan omzet (0,5–2%/bulan), dan alamat lain (1%/bulan). Diselesaikan setiap hari, 100% masuk ke pendapatan dasar. Mulai 1 Okt 2026.',
...
it:{
  ...
  'dem-text':'<p>Precedente storico: l’esperimento di Wörgl (Austria, 1932) usò una moneta con demurrage e ridusse la disoccupazione del 25% in un anno. Il Chiemgauer (Germania, 2003) funziona con successo da oltre 20 anni con un meccanismo simile.</p><p>Queste regole valgono dal 1° ottobre 2026. Fino ad allora vale la regola precedente: 0,5%/mese sulla parte oltre la giusta quota dopo 3 mesi senza attività.</p>',
  ...
  'ubi-src-dem':'Prelievo sul denaro fermo','ubi-src-dem-d':'Persone oltre 5.000 AEQ (0,5 %/mese), imprese oltre 1,5 mesi di fatturato (0,5–2 %/mese) e altri indirizzi (1 %/mese). Regolato ogni giorno, il 100 % va al reddito di base. Dal 1° ott. 2026.',
...
tr:{
  ...
  'ubi-src-dem':'Bekleyen para kesintisi','ubi-src-dem-d':'5.000 AEQ üzerindeki insanlar (ayda %0,5), 1,5 aylık ciro üzerindeki işletmeler (ayda %0,5–2) ve diğer adresler (ayda %1). Her gün hesaplanır, %100 temel gelire gider. 1 Ekim 2026\'dan itibaren.',
...
fr:{
  ...
  'dem-text':'<p>Précédent historique : l’expérience de Wörgl (Autriche, 1932) a utilisé une monnaie à démurrage et réduit le chômage de 25 % en un an. Le Chiemgauer (Allemagne, 2003) fonctionne avec succès depuis plus de 20 ans selon un mécanisme similaire.</p><p>Ces règles s’appliquent à partir du 1er octobre 2026. D’ici là, l’ancienne règle vaut : 0,5 %/mois sur la part au-delà de la juste part après 3 mois sans activité.</p>',
  ...
  'ubi-src-dem':'Prélèvement sur l’argent dormant','ubi-src-dem-d':'Personnes au-delà de 5 000 AEQ (0,5 %/mois), entreprises au-delà de 1,5 mois de chiffre d’affaires (0,5–2 %/mois) et autres adresses (1 %/mois). Réglé chaque jour, 100 % vont au revenu de base. À partir du 1er oct. 2026.',
...
pt:{
  ...
  'ubi-src-dem':'Encargo sobre dinheiro parado','ubi-src-dem-d':'Pessoas acima de 5.000 AEQ (0,5 %/mês), empresas acima de 1,5 mês de faturação (0,5–2 %/mês) e outros endereços (1 %/mês). Liquidado diariamente, 100 % vai para a renda básica. A partir de 1 out. 2026.',
...
ar:{
  ...
  'ubi-src-dem':'اقتطاع المال الراكد','ubi-src-dem-d':'الأفراد فوق 5,000 AEQ (0.5%/شهريًا)، والشركات فوق 1.5 شهر من المبيعات (0.5–2%/شهريًا)، والعناوين الأخرى (1%/شهريًا). تُسوّى يوميًا، و100% تذهب إلى الدخل الأساسي. اعتبارًا من 1 أكتوبر 2026.',
...
hi:{
  ...
  'ubi-src-dem':'रुके पैसे की कटौती','ubi-src-dem-d':'5,000 AEQ से ऊपर लोग (0.5%/महीना), 1.5 महीने के कारोबार से ऊपर व्यवसाय (0.5–2%/महीना) और अन्य पते (1%/महीना)। रोज़ाना निपटाया जाता है, 100% बुनियादी आय में जाता है। 1 अक्टूबर 2026 से।',
