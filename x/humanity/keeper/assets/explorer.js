...
en:{
  ...
  'app-text':'Registration captures your face and a short liveness sequence (random head-turn) with the phone camera. Two independent matching services check that a living person is present and that this face is not already registered; they must agree, and the proof server accepts the registration only with their signed attestation. A Groth16 ZK proof then carries the result to the chain without revealing anything about you. Your <strong style="color:var(--gold)">1,000 AEQ credited automatically</strong> upon verification. <strong style="color:var(--gold)">Note:</strong> the named limits (accounts from before 25 Aug 2026, uncalibrated threshold, head-turn liveness) are in the disclaimer near the register button.',
  's1t':'Connect','s1d':'The app records your face and a short liveness sequence (random head-turn) and sends them to independent matching services. They check that a living person is present and compare the face against everyone registered since the face check began. The images are discarded after processing.',
  ...
  'k-bio':'Face','never-stored':'Images discarded after checking — an encrypted template is kept by each matching service',
  ...
  'h-sybil':'Sybil Resistance — Current State','h-sybil-t':'Since 25 Aug 2026 the nullifier is derived from the bio_hash of your face and the proof server refuses a registration without the matching quorum\'s signed attestation — so the same face cannot be registered twice, across devices as well, which a device key never could. Two named limits: accounts registered before that date have no face template (a known, bounded exception), and the matching threshold has not been calibrated against real captures: the cryptography is exact, the biometrics underneath it is a measurement whose error rate has not been quantified. Liveness today is a random head-turn challenge; stronger deepfake defenses are being calibrated.',
  ...
  'h-bio-hw':'Identity Verification Roadmap','h-bio-hw-t':'Today (Beta): a face check across independent matching services that must agree by quorum, and a proof server that refuses registrations without their signed attestation. Its threshold has not yet been calibrated against real captures — that needs about 1000 impostor pairs before any number is quoted. Planned: that calibration, liveness beyond the head-turn (flash colours, pulse, parallax), a staged grant for uncertain captures, and a duplicate check in which no service holds a whole template. Long term, Aequitas will rely on iris scans to truly guarantee one person, one registration. How that can be implemented reliably and privacy-preserving is being worked on now; hardware and timing are not decided yet.',
...
'swap-sell-label':'Sell','swap-receive-label':'Receive',
  ...
  'faq-title':'❓ FAQ','faq-q1':'Is my biometric data safe?','faq-a1':'Your face is captured and sent to independent matching services — that is the only way “one person, one account” can be checked at all. The images are processed and then discarded; they are not stored. What is kept is a mathematical template, encrypted at rest. One honest limit, stated rather than hidden: each matching service holds a whole encrypted template, because comparing needs one. A split-share mode in which no single service holds a whole one is built and runs in shadow, not yet as the binding check.',
  'faq-q1b':'Does registration prove I am a unique real person?','faq-a1b':'Better than a device key ever could, and not yet provable as a number. Since 25 Aug 2026 the face is compared against every registration made since then by independent services that must agree, and the proof server refuses a registration without their signed attestation — so the same person on a second phone is caught, which a device key never could. Two named limits: accounts registered before that date have no face template (a known, bounded exception), and the error rate is not established: the threshold has not been calibrated on real captures, which needs about 1,000 impostor pairs. Liveness today is a random head-turn challenge; stronger deepfake defenses are being calibrated. Long term, Aequitas will rely on iris scans to truly guarantee one person, one registration. How that can be implemented reliably and privacy-preserving is being worked on now; hardware and timing are not decided yet.',
...
de:{
  ...
  'bv-what-d':'Ein Gesicht erreicht Sie nie als Bild: die Aufnahme wird nach der Prüfung verworfen, und Ihre Maschine speichert eine verschlüsselte Vorlage davon. Es gibt einen Modus mit geteilten Anteilen, in dem Ihre Maschine nur einen additiven Anteil einer 64-Byte-Skizze hielte — für sich genommen von Rauschen nicht zu unterscheiden, gemeinsam mit Ihrem Komitee verglichen, sodass keiner mehr erfährt als die Antwort. Er ist gebaut und geprüft, aber <strong style="color:var(--text)">noch nicht scharf</strong>, weil seine Schwelle nie kalibriert wurde. Bis dahin hält jeder Verifier eine ganze verschlüsselte Vorlage — und das sagen wir lieber, als einen Schutz anzudeuten, den es noch nicht gibt.',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Beta-Hinweis</div>Beta: Seit dem 25.08.2026 weist der Proof-Server jede Registrierung ohne signierte Bescheinigung des Vergleichs-Quorums ab — ein zweites Telefon gibt demselben Gesicht kein zweites Konto mehr. Was noch nicht gilt: Konten von vor diesem Datum haben kein Gesichts-Template und könnten sich grundsätzlich auf einer neuen Wallet erneut registrieren; Fehlerraten sind nicht kalibriert (dafür braucht es ~1.000 Impostor-Paare); Lebendigkeit ist eine Kopfdreh-Aufgabe, stärkere Deepfake-Abwehr wird kalibriert. „Ein Mensch, ein Konto“ heißt „geprüft, mit benannten Grenzen“ — nicht „unumgehbar“. Langfristig setzt Aequitas auf den Iris-Scan, um wirklich 1 Mensch = 1 Registrierung zu gewährleisten. Wie das zuverlässig und datenschutzfreundlich umgesetzt werden kann, daran wird derzeit gearbeitet; Hardware und Zeitplan stehen noch nicht fest.',
  'beta-why':'<strong>Wozu die Beta dient:</strong> Sie prüft, ob ein Mensch wiedererkannt werden kann, ohne dass jemand sein Bild behält. Das Foto wird direkt nach der Prüfung gelöscht. Ziel ist, dass kein einzelner Dienst je das volle Gesichts-Template hat, sondern nur einen Teil, der allein nichts aussagt, und dass eine zweite Registrierung desselben Menschen trotzdem erkannt wird. Das ist die Grundlage für den Iris-Scan, der nach demselben Prinzip arbeiten wird. <strong>Stand heute:</strong> Das Foto wird gelöscht. Der geteilte Vergleich ist gebaut und getestet, aber noch nicht aktiv; bis dahin speichert jeder Vergleichsdienst ein vollständiges, verschlüsseltes Template. Die Fehlerraten sind noch nicht kalibriert.',
  ...
  'app-text':'Die Registrierung nimmt Ihr Gesicht und eine kurze Lebendigkeitssequenz (zufällige Kopfdrehung) mit der Handykamera auf. Zwei unabhängige Vergleichsdienste prüfen, dass ein lebender Mensch vor der Kamera ist und dieses Gesicht nicht schon registriert ist; sie müssen sich einig sein, und der Proof-Server nimmt die Registrierung nur mit ihrer signierten Bescheinigung an. Ein Groth16-ZK-Beweis trägt das Ergebnis dann auf die Chain, ohne etwas über Sie preiszugeben. Ihre <strong style="color:var(--gold)">1.000 AEQ werden automatisch gutgeschrieben</strong>, sobald die Prüfung durch ist. <strong style="color:var(--gold)">Hinweis:</strong> die benannten Grenzen (Konten von vor dem 25.08.2026, unkalibrierte Schwelle, Kopfdreh-Lebendigkeit) stehen im Disclaimer neben dem Registrieren-Knopf.',
  's1t':'Verbinden','s1d':'Die App nimmt Ihr Gesicht und eine kurze Lebendigkeitssequenz (zufällige Kopfdrehung) auf und schickt sie an unabhängige Vergleichsdienste. Die prüfen, dass ein lebender Mensch vor der Kamera ist, und vergleichen das Gesicht mit allen seit Beginn der Gesichtsprüfung Registrierten. Die Bilder werden nach der Verarbeitung verworfen.',
  ...
  'k-bio':'Gesicht','never-stored':'Bilder nach der Prüfung verworfen — jeder Vergleichsdienst behält ein verschlüsseltes Template',
  ...
  'h-sybil':'Sybil-Resistenz — Aktueller Stand','h-sybil-t':'Seit dem 25.08.2026 wird der Nullifier aus der bio_hash Ihres Gesichts abgeleitet, und der Proof-Server weist eine Registrierung ohne die signierte Bescheinigung des Vergleichs-Quorums ab — dasselbe Gesicht lässt sich also nicht zweimal registrieren, auch nicht über ein zweites Gerät, was ein Geräteschlüssel nie konnte. Zwei benannte Grenzen: Konten von vor diesem Datum haben kein Gesichts-Template (eine bekannte, begrenzte Ausnahme), und die Vergleichsschwelle ist nicht an echten Aufnahmen kalibriert: die Kryptographie ist exakt, die Biometrie darunter ist eine Messung, deren Fehlerrate nicht beziffert ist. Lebendigkeit ist heute eine zufällige Kopfdreh-Aufgabe; stärkere Deepfake-Abwehr wird kalibriert.',
  ...
  'h-bio-hw':'Identitätsverifikation — Roadmap','h-bio-hw-t':'Heute (Beta): eine Gesichtsprüfung über unabhängige Vergleichsdienste, die sich per Quorum einig sein müssen, und ein Proof-Server, der Registrierungen ohne ihre signierte Bescheinigung abweist. Die Schwelle ist noch nicht an echten Aufnahmen kalibriert — dafür braucht es etwa 1000 Impostor-Paare, bevor irgendeine Zahl genannt wird. Geplant: diese Kalibrierung, Lebendigkeit über die Kopfdrehung hinaus (Blitzfarben, Puls, Parallaxe), ein gestaffelter Zuschuss bei unsicheren Aufnahmen und eine Duplikatprüfung, bei der kein Dienst ein ganzes Template hält. Langfristig setzt Aequitas auf den Iris-Scan, um wirklich 1 Mensch = 1 Registrierung zu gewährleisten. Wie das zuverlässig und datenschutzfreundlich umgesetzt werden kann, daran wird derzeit gearbeitet; Hardware und Zeitplan stehen noch nicht fest.',
  ...
  'faq-title':'❓ FAQ','faq-q1':'Sind meine biometrischen Daten sicher?','faq-a1':'Dein Gesicht wird aufgenommen und an unabhängige Vergleichsdienste geschickt — nur so lässt sich „ein Mensch, ein Konto“ überhaupt prüfen. Die Bilder werden verarbeitet und dann verworfen; sie werden nicht gespeichert. Was bleibt, ist ein mathematisches Template, verschlüsselt abgelegt. Eine ehrliche Grenze, gesagt statt versteckt: jeder Vergleichsdienst hält ein ganzes verschlüsseltes Template, weil Vergleichen eines braucht. Ein Split-Share-Modus, in dem kein einzelner Dienst ein ganzes hält, ist gebaut und läuft im Schatten — noch nicht als verbindliche Prüfung.',
  'faq-q1b':'Beweist die Registrierung, dass ich ein einzigartiger echter Mensch bin?','faq-a1b':'Besser, als ein Geräteschlüssel es je konnte, und noch nicht als Zahl belegbar. Seit dem 25.08.2026 wird das Gesicht von unabhängigen Diensten, die sich einig sein müssen, mit jeder seitdem erfolgten Registrierung verglichen, und der Proof-Server weist eine Registrierung ohne deren signierte Bescheinigung ab — dieselbe Person auf einem zweiten Telefon fällt also auf, was ein Geräteschlüssel nie konnte. Zwei benannte Grenzen: Konten von vor diesem Datum haben kein Gesichts-Template (eine bekannte, begrenzte Ausnahme), und die Fehlerrate ist nicht ermittelt: die Schwelle ist nicht an echten Aufnahmen kalibriert, dafür braucht es etwa 1.000 Impostor-Paare. Lebendigkeit ist heute eine zufällige Kopfdreh-Aufgabe; stärkere Deepfake-Abwehr wird kalibriert. Langfristig setzt Aequitas auf den Iris-Scan, um wirklich 1 Mensch = 1 Registrierung zu gewährleisten. Wie das zuverlässig und datenschutzfreundlich umgesetzt werden kann, daran wird derzeit gearbeitet; Hardware und Zeitplan stehen noch nicht fest.',
...
es:{
  ...
  'bv-what-d':'Ningún rostro le llega como imagen: la captura se descarta tras la comprobación y su máquina guarda una plantilla cifrada de ella. Existe un modo de reparto en el que su máquina solo tendría una parte aditiva de un esbozo de 64 bytes —indistinguible del ruido por sí sola, comparada conjuntamente con su comité de modo que ninguno aprenda más que la respuesta—. Está construido y probado, pero <strong style="color:var(--text)">aún no está activo</strong>, porque su umbral nunca se ha calibrado. Hasta entonces, cada verificador guarda una plantilla cifrada completa, y preferimos decirlo a insinuar una protección que aún no existe.',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Aviso beta</div>Beta: desde el 25/08/2026 el servidor de pruebas rechaza todo registro sin la atestación firmada del quórum de comparación — un segundo teléfono ya no da una segunda cuenta al mismo rostro. Lo que aún no se cumple: las cuentas anteriores a esa fecha no tienen plantilla facial y en principio podrían registrarse de nuevo con otra cartera; las tasas de error no están calibradas (hacen falta ~1.000 pares de impostores); la prueba de vida es un giro de cabeza, las defensas más fuertes contra deepfakes están en calibración. Lea «un humano, una cuenta» como «verificado, con límites declarados» — no como «imposible de eludir». A largo plazo, Aequitas apostará por el escaneo de iris para garantizar de verdad una persona, un registro. Ahora se trabaja en cómo implementarlo de forma fiable y respetuosa con la privacidad; el hardware y los plazos aún no están decididos.',
  'beta-why':'<strong>Para qué sirve la beta:</strong> comprueba si una persona puede ser reconocida de nuevo sin que nadie guarde su imagen. La foto se borra justo después de la verificación. El objetivo es que ningún servicio tenga nunca la plantilla facial completa, solo una parte que por sí sola no dice nada, y que aun así se detecte un segundo registro de la misma persona. Es la base para el escaneo de iris, que funcionará igual. <strong>Situación actual:</strong> la foto se borra; la comparación repartida está construida y probada, pero aún no activa, así que por ahora cada servicio de comparación guarda una plantilla completa y cifrada; las tasas de error aún no están calibradas.',
  ...
  'app-text':'Al registrarse, la cámara capta su rostro y una breve secuencia de vitalidad. Servicios de comparación independientes comprueban que hay una persona viva y que ese rostro no está ya registrado; deben coincidir por quórum. Una prueba ZK Groth16 lleva luego el resultado a la cadena sin revelar nada sobre usted. Sus <strong style="color:var(--gold)">1.000 AEQ se acreditan automáticamente</strong> tras la verificación. <strong style="color:var(--gold)">Nota:</strong> el umbral de comparación aún no está calibrado con capturas reales — ver las preguntas frecuentes.',
  's1t':'Conectar','s1d':'La app graba su rostro y una breve secuencia de vitalidad y los envía a servicios de comparación independientes. Estos comprueban que hay una persona viva delante y comparan el rostro con todos los ya registrados. Las imágenes se descartan tras el procesamiento.',
  ...
  'k-bio':'Rostro','never-stored':'Imágenes descartadas tras la comprobación — se conserva una plantilla cifrada',
...
ru:{
  ...
  'bv-what-d':'Лицо никогда не приходит к вам как изображение: снимок удаляется после проверки, а ваша машина хранит его зашифрованный шаблон. Существует режим разделённых долей, в котором ваша машина хранила бы лишь одну аддитивную долю 64-байтового эскиза — сама по себе неотличимая от шума, сравниваемая совместно с вашим комитетом так, что никто не узнаёт больше ответа. Он создан и проверен, но <strong style="color:var(--text)">пока не включён</strong>, потому что его порог никогда не калибровался. До тех пор каждый верификатор хранит целый зашифрованный шаблон — и мы предпочитаем сказать это, чем намекать на защиту, которую вы пока не даёте.',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Оговорка бета-версии</div>Бета: с 25.08.2026 сервер доказательств отклоняет любую регистрацию без подписанного подтверждения кворума сравнения — второй телефон больше не даёт тому же лицу второй счёт. Что пока не выполняется: счета, созданные до этой даты, не имеют шаблона лица и в принципе могли бы зарегистрироваться снова на новый кошелёк; частота ошибок не откалибрована (нужно ~1 000 импостор-пар); проверка живости — поворот головы, более сильная защита от дипфейков калибруется. Читайте «один человек — один счёт» как «проверено, с названными ограничениями», а не как «невозможно обойти». В долгосрочной перспективе Aequitas будет опираться на сканирование радужной оболочки глаза, чтобы действительно гарантировать: один человек — одна регистрация. Сейчас идёт работа над тем, как реализовать это надёжно и с защитой данных; оборудование и сроки ещё не определены.',
  'beta-why':'<strong>Зачем нужна бета-версия:</strong> она проверяет, можно ли узнать человека повторно так, чтобы никто не хранил его изображение. Фото удаляется сразу после проверки. Цель — чтобы ни одна служба никогда не имела полного шаблона лица, а только часть, которая сама по себе ничего не значит, и чтобы вторая регистрация того же человека всё равно обнаруживалась. Это основа для сканирования радужной оболочки, которое будет работать так же. <strong>Состояние сегодня:</strong> фото удаляется; разделённое сравнение создано и протестировано, но ещё не включено, поэтому пока каждая служба сравнения хранит полный зашифрованный шаблон; частота ошибок ещё не откалибрована.',
  ...
  's1t':'Подключить','s1d':'Приложение снимает ваше лицо и короткую последовательность для проверки живости и отправляет их независимым службам сравнения. Те проверяют, что перед камерой живой человек, и сравнивают лицо со всеми уже зарегистрированными. После обработки изображения удаляются.',
  ...
  'k-bio':'Лицо','never-stored':'Снимки удаляются после проверки — хранится зашифрованный шаблон',
...
zh:{
  ...
  'bv-what-d':'面部不会以图像形式送到你这里：图像在核对后即被丢弃，你的机器保存的是它的加密模板。存在一种分片模式，其中你的机器只保存一份 64 字节草图的加性分片——单独看来与噪声无异，与你的委员会共同比对，任何一方都只知道结论。该模式已构建并经过测试，但<strong style="color:var(--text)">尚未启用</strong>，因为其阈值从未校准。在此之前，每个验证者都持有一份完整的加密模板——我们宁愿直说，也不愿暗示一种你尚未提供的保护。',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Beta 声明</div>Beta：自 2026-08-25 起，证明服务器拒绝任何没有比对法定多数签名证明的注册 — 换一部手机不再能让同一张脸获得第二个账户。尚未成立的部分：该日期之前注册的账户没有人脸模板，原则上可以用新钱包再次注册；错误率尚未校准（需要约 1,000 组冒名配对）；活体检测为转头指令，更强的深度伪造防御正在校准中。请将「一人一账户」理解为「已核验、并明示限制」，而非「无法绕过」。 从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何可靠且保护隐私地实现；硬件和时间表尚未确定。',
  'beta-why':'<strong>Beta 的目的：</strong>检验能否在无人保留照片的情况下再次识别同一个人。照片在核验后立即删除。目标是任何单个服务都不持有完整的人脸模板，只持有单独看毫无意义的一部分，同时仍能发现同一个人的第二次注册。这是虹膜扫描的基础，虹膜扫描将按同样的原理工作。<strong>目前状态：</strong>照片会被删除；分片比对已构建并测试，但尚未启用，因此目前每个比对服务仍保存一份完整的加密模板；错误率尚未校准。',
  ...
  's1t':'连接','s1d':'应用会录制你的面部和一小段活体检测序列，并发送给独立的比对服务。它们核验镜头前是活人，并将该面部与所有已注册者比对。图像在处理后即被丢弃。',
  ...
  'k-bio':'面部','never-stored':'核对后图像即丢弃 —— 保留一份加密模板',
  ...
  'h-bio-hw':'身份验证路线图','h-bio-hw-t':'当前（测试版）：由独立比对服务完成的面部核验，须达成法定多数一致。其阈值尚未用真实采集数据校准 — 在给出任何数字之前需要约 1000 组冒名配对。计划中：完成该校准，以及一种没有任何服务持有完整模板的重复检测。 从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何可靠且保护隐私地实现；硬件和时间表尚未确定。',
  ...
  'faq-q1b':'注册能证明我是独特的真实人类吗？','faq-a1b':'比设备密钥所能做到的更好，但尚不能用数字证明。面部会由必须达成一致的独立服务与所有既有注册进行比对，因此同一个人换第二部手机也会被识破 — 这是设备密钥从来做不到的。尚未确定的是错误率：比对阈值未用真实采集数据校准，这需要约 1000 组冒名配对。 已知且有限的例外：人脸核验启用前（2026-08-25）注册的账户没有人脸模板。 从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何可靠且保护隐私地实现；硬件和时间表尚未确定。',
...
id:{
  ...
  'bv-what-d':'Wajah tidak pernah sampai kepada Anda sebagai gambar: citranya dibuang setelah diperiksa, dan mesin Anda menyimpan templat terenkripsi darinya. Ada mode berbagi-bagian di mana mesin Anda hanya akan menyimpan satu bagian aditif dari sketsa 64 byte — sendirian tak terbedakan dari derau, dibandingkan bersama komite Anda sehingga tak seorang pun tahu lebih dari jawabannya. Mode itu sudah dibangun dan diuji, tetapi <strong style="color:var(--text)">belum aktif</strong>, karena ambangnya tak pernah dikalibrasi. Sampai saat itu, setiap verifier menyimpan satu templat terenkripsi utuh — dan kami lebih baik mengatakannya daripada menyiratkan perlindungan yang belum Anda berikan.',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Peringatan beta</div>Beta: sejak 25-08-2026 server bukti menolak setiap pendaftaran tanpa atestasi bertanda tangan dari kuorum pencocokan — ponsel kedua tidak lagi memberi akun kedua untuk wajah yang sama. Yang belum berlaku: akun dari sebelum tanggal itu tidak punya templat wajah dan pada prinsipnya bisa mendaftar lagi dengan dompet baru; laju kesalahan belum dikalibrasi (perlu ~1.000 pasangan impostor); deteksi kehidupan berupa putar kepala, pertahanan deepfake yang lebih kuat sedang dikalibrasi. Bacalah “satu manusia, satu akun” sebagai “diperiksa, dengan batas yang disebutkan” — bukan “mustahil dilewati”. Dalam jangka panjang, Aequitas akan mengandalkan pemindaian iris untuk benar-benar menjamin satu orang, satu pendaftaran. Cara menerapkannya secara andal dan menjaga privasi sedang dikerjakan saat ini; perangkat keras dan jadwalnya belum ditentukan.',
  'beta-why':'<strong>Untuk apa beta ini:</strong> menguji apakah seseorang bisa dikenali kembali tanpa ada yang menyimpan fotonya. Foto dihapus segera setelah pemeriksaan. Tujuannya: tidak ada satu layanan pun yang memegang templat wajah utuh, hanya bagian yang sendiri tidak berarti apa-apa, dan pendaftaran kedua oleh orang yang sama tetap terdeteksi. Ini fondasi untuk pemindaian iris, yang akan bekerja dengan cara yang sama. <strong>Keadaan saat ini:</strong> foto dihapus; pencocokan terbagi sudah dibangun dan diuji tetapi belum aktif, jadi untuk sementara setiap layanan pencocokan menyimpan templat utuh yang terenkripsi; laju kesalahan belum dikalibrasi.',
  ...
  's1t':'Hubungkan','s1d':'Aplikasi merekam wajah Anda dan urutan pendeteksian keaslian singkat, lalu mengirimkannya ke layanan pencocokan independen. Mereka memeriksa bahwa ada orang hidup di depan kamera dan membandingkan wajah dengan semua yang sudah terdaftar. Gambar dibuang setelah diproses.',
  ...
  'k-bio':'Wajah','never-stored':'Gambar dibuang setelah pemeriksaan — templat terenkripsi disimpan',
...
it:{
  ...
  'bv-what-d':'Nessun volto Le arriva come immagine: la ripresa viene scartata dopo il controllo e la Sua macchina conserva un modello cifrato. Esiste una modalità a quote condivise in cui la Sua macchina conserverebbe solo una quota additiva di uno schizzo da 64 byte — da sola indistinguibile dal rumore, confrontata insieme al Suo comitato così che nessuno impari più della risposta. È realizzata e collaudata, ma <strong style="color:var(--text)">non ancora attiva</strong>, perché la sua soglia non è mai stata calibrata. Fino ad allora ogni verificatore conserva un modello cifrato intero, e preferiamo dirlo piuttosto che lasciar intendere una protezione che ancora non esiste.',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Avvertenza beta</div>Beta: dal 25/08/2026 il server delle prove rifiuta ogni registrazione senza l\'attestazione firmata del quorum di confronto — un secondo telefono non dà più un secondo account allo stesso volto. Ciò che non vale ancora: gli account precedenti a quella data non hanno un modello del volto e in linea di principio potrebbero registrarsi di nuovo con un altro wallet; i tassi di errore non sono tarati (servono ~1.000 coppie impostore); la prova di vitalità è una rotazione della testa, difese più forti contro i deepfake sono in taratura. Legga «un umano, un account» come «verificato, con limiti dichiarati» — non come «impossibile da aggirare». Nel lungo periodo Aequitas punterà sulla scansione dell’iride per garantire davvero una persona, una registrazione. Si sta lavorando ora a come realizzarla in modo affidabile e rispettoso della privacy; hardware e tempi non sono ancora decisi.',
  'beta-why':'<strong>A cosa serve la beta:</strong> verifica se una persona può essere riconosciuta di nuovo senza che nessuno conservi la sua immagine. La foto viene cancellata subito dopo la verifica. L\'obiettivo è che nessun singolo servizio abbia mai il modello del volto completo, ma solo una parte che da sola non dice nulla, e che una seconda registrazione della stessa persona venga comunque rilevata. È la base per la scansione dell\'iride, che funzionerà allo stesso modo. <strong>Stato attuale:</strong> la foto viene cancellata; il confronto ripartito è costruito e testato ma non ancora attivo, quindi per ora ogni servizio di confronto conserva un modello completo e cifrato; i tassi di errore non sono ancora tarati.',
  ...
  'app-text':'Alla registrazione la fotocamera acquisisce il Suo volto e una breve sequenza di vitalità. Servizi di confronto indipendenti verificano che ci sia una persona viva e che quel volto non sia già registrato; devono concordare per quorum. Una prova ZK Groth16 porta poi il risultato sulla catena senza rivelare nulla di Lei. I Suoi <strong style="color:var(--gold)">1.000 AEQ vengono accreditati automaticamente</strong> dopo la verifica. <strong style="color:var(--gold)">Nota:</strong> la soglia di confronto non è ancora calibrata su acquisizioni reali — veda le FAQ qui sotto.',
  's1t':'Connettere','s1d':'L\'app registra il Suo volto e una breve sequenza di vitalità e li invia a servizi di confronto indipendenti. Questi verificano che davanti ci sia una persona viva e confrontano il volto con tutti i già registrati. Le immagini vengono scartate dopo l\'elaborazione.',
  ...
  'k-bio':'Volto','never-stored':'Immagini scartate dopo il controllo — resta un modello cifrato',
...
tr:{
  ...
  'bv-what-d':'Bir yüz size hiçbir zaman görüntü olarak ulaşmaz: görüntü denetimden sonra atılır ve makineniz onun şifreli bir şablonunu saklar. Makinenizin yalnızca 64 baytlık bir taslağın tek bir toplamsal payını tutacağı bir pay-paylaşım kipi vardır — tek başına gürültüden ayırt edilemez, komitenizle birlikte karşılaştırılır ve hiçbiriniz yanıttan fazlasını öğrenmez. Kurulmuş ve sınanmıştır, ancak <strong style="color:var(--text)">henüz etkin değildir</strong>, çünkü eşiği hiç kalibre edilmedi. O zamana dek her doğrulayıcı bütün bir şifreli şablon tutar — ve henüz vermediğiniz bir korumayı ima etmektense bunu söylemeyi yeğleriz.',
  ...
  'beta-why':'<strong>Beta ne için:</strong> bir insanın, kimse fotoğrafını saklamadan yeniden tanınıp tanınamayacağını test eder. Fotoğraf kontrolden hemen sonra silinir. Amaç, hiçbir tek servisin tam yüz şablonuna sahip olmaması, yalnızca tek başına anlamsız bir parçayı tutması ve aynı kişinin ikinci kaydının yine de fark edilmesidir. Bu, aynı ilkeyle çalışacak iris taramasının temelidir. <strong>Bugünkü durum:</strong> fotoğraf silinir; bölünmüş karşılaştırma yapıldı ve test edildi ama henüz etkin değil, bu yüzden şimdilik her eşleştirme servisi tam ve şifreli bir şablon saklar; hata oranları henüz ayarlanmadı.',
  ...
  's1t':'Bağlan','s1d':'Uygulama yüzünüzü ve kısa bir canlılık dizisini kaydeder ve bağımsız eşleştirme servislerine gönderir. Bunlar karşıda canlı bir insan olduğunu denetler ve yüzü kayıtlı herkesle karşılaştırır. Görüntüler işlendikten sonra atılır.',
  ...
  'k-bio':'Yüz','never-stored':'Görüntüler denetimden sonra atılır — şifreli bir şablon saklanır',
  ...
  'h-bio-hw':'Kimlik Doğrulama Yol Haritası','h-bio-hw-t':'Bugün (beta): yeter sayıyla anlaşması gereken bağımsız eşleştirme servisleri üzerinden bir yüz denetimi. Eşiği gerçek kayıtlarla henüz kalibre edilmedi — herhangi bir sayı verilmeden önce yaklaşık 1000 sahte çift gerekir. Planlanan: bu kalibrasyon ve hiçbir servisin tam şablon tutmadığı bir kopya denetimi. Uzun vadede Aequitas, gerçekten bir insan = bir kayıt ilkesini güvence altına almak için iris taramasına dayanacak. Bunun güvenilir ve gizliliği koruyarak nasıl uygulanacağı şu anda üzerinde çalışılıyor; donanım ve zamanlama henüz belli değil.',
...
fr:{
  ...
  'bv-what-d':'Aucun visage ne vous parvient sous forme d\'image : la prise de vue est écartée après vérification, et votre machine conserve un gabarit chiffré. Il existe un mode à parts partagées où votre machine ne détiendrait qu\'une part additive d\'une esquisse de 64 octets — à elle seule indiscernable du bruit, comparée conjointement avec votre comité de sorte que personne n\'apprenne plus que la réponse. Il est réalisé et éprouvé, mais <strong style="color:var(--text)">pas encore actif</strong>, car son seuil n\'a jamais été étalonné. D\'ici là, chaque vérificateur conserve un gabarit chiffré entier, et nous préférons le dire plutôt que de laisser croire à une protection que vous n\'offrez pas encore.',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Avertissement bêta</div>Bêta : depuis le 25/08/2026, le serveur de preuves refuse toute inscription sans l\'attestation signée du quorum de comparaison — un second téléphone ne donne plus un second compte au même visage. Ce qui n\'est pas encore vrai : les comptes antérieurs à cette date n\'ont pas de gabarit du visage et pourraient en principe se réinscrire avec un nouveau portefeuille ; les taux d\'erreur ne sont pas étalonnés (il faut ~1 000 paires d\'imposteurs) ; la preuve de vie est un mouvement de tête, des défenses plus fortes contre les deepfakes sont en étalonnage. Lis « un humain, un compte » comme « vérifié, avec des limites nommées » — pas comme « impossible à contourner ». À long terme, Aequitas misera sur le scan de l’iris pour garantir réellement une personne, une inscription. La manière de le mettre en œuvre de façon fiable et respectueuse de la vie privée est en cours d’élaboration ; le matériel et le calendrier ne sont pas encore fixés.',
  'beta-why':'<strong>À quoi sert la bêta :</strong> elle teste si une personne peut être reconnue à nouveau sans que personne ne garde son image. La photo est supprimée juste après le contrôle. L\'objectif est qu\'aucun service ne détienne jamais le gabarit complet du visage, seulement une part qui seule ne dit rien, et qu\'une seconde inscription de la même personne soit tout de même détectée. C\'est la base du scan de l\'iris, qui fonctionnera de la même façon. <strong>Où on en est :</strong> la photo est supprimée ; la comparaison répartie est construite et testée mais pas encore active, donc pour l\'instant chaque service de comparaison garde un gabarit complet et chiffré ; les taux d\'erreur ne sont pas encore étalonnés.',
  ...
  'app-text':'À l\'inscription, la caméra capture votre visage et une courte séquence de vivacité. Des services de comparaison indépendants vérifient qu\'une personne vivante est présente et que ce visage n\'est pas déjà enregistré ; ils doivent s\'accorder par quorum. Une preuve ZK Groth16 porte ensuite le résultat sur la chaîne sans rien révéler de vous. Vos <strong style="color:var(--gold)">1 000 AEQ sont crédités automatiquement</strong> après vérification. <strong style="color:var(--gold)">Note :</strong> le seuil de comparaison n\'est pas encore calibré sur des captures réelles — voir la FAQ ci-dessous.',
  's1t':'Connecter','s1d':'L\'application enregistre votre visage et une courte séquence de vivacité, puis les envoie à des services de comparaison indépendants. Ceux-ci vérifient qu\'une personne vivante est présente et comparent le visage à toutes les personnes déjà enregistrées. Les images sont écartées après traitement.',
  ...
  'k-bio':'Visage','never-stored':'Images écartées après vérification — un gabarit chiffré est conservé',
...
pt:{
  ...
  'bv-what-d':'Nenhum rosto lhe chega como imagem: a captação é descartada após a verificação e a sua máquina guarda um modelo cifrado dela. Existe um modo de partilha em que a sua máquina guardaria apenas uma parte aditiva de um esboço de 64 bytes — por si só indistinguível de ruído, comparada em conjunto com o seu comité para que ninguém saiba mais do que a resposta. Está construído e testado, mas <strong style="color:var(--text)">ainda não está ativo</strong>, porque o seu limiar nunca foi calibrado. Até lá, cada verificador guarda um modelo cifrado inteiro — e preferimos dizê-lo a insinuar uma proteção que ainda não existe.',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Aviso beta</div>Beta: desde 25/08/2026 o servidor de provas recusa qualquer registo sem a atestação assinada do quórum de comparação — um segundo telemóvel já não dá uma segunda conta ao mesmo rosto. O que ainda não se verifica: as contas anteriores a essa data não têm modelo facial e, em princípio, poderiam registar-se de novo noutra carteira; as taxas de erro não estão calibradas (são precisos ~1.000 pares de impostores); a prova de vida é um movimento de cabeça, defesas mais fortes contra deepfakes estão em calibração. Leia «um humano, uma conta» como «verificado, com limites declarados» — não como «impossível de contornar». A longo prazo, a Aequitas vai apostar no scan da íris para garantir de facto uma pessoa, um registo. Está-se a trabalhar agora em como implementá-lo de forma fiável e respeitadora da privacidade; o hardware e o calendário ainda não estão decididos.',
  'beta-why':'<strong>Para que serve a beta:</strong> testa se uma pessoa pode ser reconhecida de novo sem que ninguém guarde a sua imagem. A foto é apagada logo após a verificação. O objetivo é que nenhum serviço tenha alguma vez o modelo facial completo, apenas uma parte que sozinha nada diz, e que um segundo registo da mesma pessoa seja mesmo assim detetado. É a base para o scan da íris, que funcionará da mesma forma. <strong>Situação atual:</strong> a foto é apagada; a comparação repartida está construída e testada, mas ainda não ativa, por isso, por agora, cada serviço de comparação guarda um modelo completo e cifrado; as taxas de erro ainda não estão calibradas.',
  ...
  's1t':'Conectar','s1d':'A aplicação grava o seu rosto e uma curta sequência de vivacidade e envia-os a serviços de comparação independentes. Estes verificam que está uma pessoa viva à frente e comparam o rosto com todos os já registados. As imagens são descartadas após o processamento.',
  ...
  'k-bio':'Rosto','never-stored':'Imagens descartadas após a verificação — guarda-se um modelo cifrado',
...
ar:{
  ...
  'bv-what-d':'لا يصلك وجه بوصفه صورة قطّ: تُتلف الصورة بعد الفحص، وتحتفظ آلتك بقالب مُعمّى لها. يوجد نمط حصص مقسَّمة تحتفظ فيه آلتك بحصة جمعية واحدة فقط من رسم بحجم 64 بايت — لا تُميَّز وحدها عن الضجيج، وتُقارَن بالاشتراك مع لجنتك بحيث لا يعرف أحدكم أكثر من الجواب. وقد بُني هذا النمط واخْتُبر، لكنه <strong style="color:var(--text)">غير مفعَّل بعد</strong>، لأن عتبته لم تُعاير قط. وحتى ذلك الحين يحتفظ كل مدقق بقالب مُعمّى كامل — ونفضّل قول ذلك على الإيحاء بحماية لا تقدّمها بعد.',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">تنبيه النسخة التجريبية</div>النسخة التجريبية: منذ 2026-08-25 يرفض خادم البراهين أي تسجيل بلا شهادة موقَّعة من نصاب المطابقة — لم يعد الهاتف الثاني يمنح الوجه نفسه حساباً ثانياً. ما لا يصح بعد: الحسابات السابقة لذلك التاريخ لا تملك قالب وجه ويمكنها مبدئياً التسجيل مجدداً بمحفظة جديدة؛ نسب الخطأ غير مُعايَرة (يلزم نحو 1,000 زوج منتحل)؛ فحص الحيوية هو تدوير الرأس، ودفاعات أقوى ضد التزييف العميق قيد المعايرة. اقرأ «إنسان واحد، حساب واحد» بمعنى «مُتحقَّق منه، بحدود مُعلنة» — لا بمعنى «يستحيل تجاوزه». على المدى البعيد ستعتمد Aequitas على مسح قزحية العين لضمان مبدأ شخص واحد = تسجيل واحد فعلاً. يجري العمل حالياً على كيفية تنفيذ ذلك بشكل موثوق يحمي الخصوصية؛ ولم يُحسم بعد أمر الأجهزة ولا الجدول الزمني.',
  'beta-why':'<strong>الغرض من النسخة التجريبية:</strong> تختبر ما إذا كان يمكن التعرّف على الشخص مجدداً دون أن يحتفظ أحد بصورته. تُحذف الصورة مباشرة بعد التحقق. الهدف ألّا تملك أي خدمة منفردة قالب الوجه كاملاً أبداً، بل جزءاً لا معنى له وحده، وأن يُكتشف مع ذلك التسجيل الثاني للشخص نفسه. هذا هو الأساس لمسح قزحية العين الذي سيعمل بالمبدأ نفسه. <strong>الوضع اليوم:</strong> تُحذف الصورة؛ المقارنة المجزّأة مبنية ومختبرة لكنها غير مفعّلة بعد، لذلك تحتفظ كل خدمة مطابقة حالياً بقالب كامل مشفّر؛ معدلات الخطأ لم تُعايَر بعد.',
  ...
  's1t':'ربط','s1d':'يسجّل التطبيق وجهك ومقطعاً قصيراً للتحقق من الحيوية ويرسلهما إلى خدمات مطابقة مستقلة. تتحقق هذه الخدمات من وجود شخص حي أمام الكاميرا وتقارن الوجه بجميع المسجّلين. تُتلَف الصور بعد المعالجة.',
  ...
  'k-bio':'الوجه','never-stored':'تُتلف الصور بعد الفحص — ويُحتفظ بقالب مُعمّى',
  ...
  'h-bio-hw':'خارطة طريق التحقق من الهوية','h-bio-hw-t':'اليوم (إصدار تجريبي): تحقق من الوجه عبر خدمات مطابقة مستقلة يجب أن تتفق بالنصاب. لم تُعايَر عتبتها بعد على عمليات التقاط حقيقية — يلزم نحو 1000 زوج منتحل قبل ذكر أي رقم. المخطط: هذه المعايرة، وفحص تكرار لا تحتفظ فيه أي خدمة بقالب كامل. على المدى البعيد ستعتمد Aequitas على مسح قزحية العين لضمان مبدأ شخص واحد = تسجيل واحد فعلاً. يجري العمل حالياً على كيفية تنفيذ ذلك بشكل موثوق يحمي الخصوصية؛ ولم يُحسم بعد أمر الأجهزة ولا الجدول الزمني.',
...
hi:{
  ...
  'bv-what-d':'कोई चेहरा आप तक छवि के रूप में कभी नहीं पहुँचता: जाँच के बाद छवि हटा दी जाती है, और आपकी मशीन उसका एक कूटबद्ध टेम्पलेट रखती है। एक साझा-हिस्सा विधा मौजूद है जिसमें आपकी मशीन 64-बाइट रेखाचित्र का केवल एक योगात्मक हिस्सा रखती — अकेले में शोर से अभेद्य, आपकी समिति के साथ मिलकर तुलना, ताकि किसी को उत्तर से अधिक पता न चले। वह बनी और परखी हुई है, पर <strong style="color:var(--text)">अभी सक्रिय नहीं</strong>, क्योंकि उसकी सीमा कभी अंशांकित नहीं हुई। तब तक हर सत्यापक एक पूरा कूटबद्ध टेम्पलेट रखता है — और हम ऐसी सुरक्षा का संकेत देने के बजाय यह कहना बेहतर समझते हैं जो आप अभी दे नहीं रहे।',
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">बीटा अस्वीकरण</div>बीटा: 25.08.2026 से प्रूफ़ सर्वर मिलान कोरम के हस्ताक्षरित सत्यापन के बिना हर पंजीकरण अस्वीकार करता है — दूसरा फ़ोन अब उसी चेहरे को दूसरा खाता नहीं देता। जो अभी लागू नहीं है: उस तारीख़ से पहले के खातों के पास चेहरे का टेम्पलेट नहीं है और वे सिद्धांततः नए वॉलेट से दोबारा पंजीकरण कर सकते हैं; त्रुटि दरें कैलिब्रेट नहीं हैं (~1,000 इम्पोस्टर जोड़े चाहिए); जीवंतता जाँच सिर घुमाना है, मज़बूत डीपफ़ेक बचाव कैलिब्रेट हो रहे हैं। «एक इंसान, एक खाता» को «जाँचा गया, बताई गई सीमाओं के साथ» पढ़ें — «असंभव» नहीं। दीर्घकाल में Aequitas आइरिस स्कैन पर निर्भर करेगा, ताकि सचमुच एक व्यक्ति = एक पंजीकरण सुनिश्चित हो सके। इसे भरोसेमंद और निजता-सुरक्षित तरीके से कैसे लागू किया जाए, इस पर अभी काम चल रहा है; हार्डवेयर और समय-सीमा अभी तय नहीं हैं।',
  'beta-why':'<strong>बीटा किसलिए है:</strong> यह जाँचता है कि किसी व्यक्ति को दोबारा पहचाना जा सकता है या नहीं, बिना किसी के उसकी तस्वीर रखे। जाँच के तुरंत बाद फ़ोटो मिटा दी जाती है। लक्ष्य यह है कि किसी भी एक सेवा के पास कभी पूरा चेहरा-टेम्पलेट न हो, केवल एक हिस्सा जो अकेले कुछ नहीं बताता, और फिर भी उसी व्यक्ति का दूसरा पंजीकरण पकड़ा जाए। यही आइरिस स्कैन की नींव है, जो इसी सिद्धांत पर काम करेगा। <strong>आज की स्थिति:</strong> फ़ोटो मिटा दी जाती है; बँटी हुई तुलना बनी और परखी गई है, पर अभी सक्रिय नहीं है, इसलिए फ़िलहाल हर मिलान सेवा एक पूरा, एन्क्रिप्टेड टेम्पलेट रखती है; त्रुटि दरें अभी कैलिब्रेट नहीं हुई हैं।',
  ...
  's1t':'कनेक्ट','s1d':'ऐप आपका चेहरा और एक छोटा जीवंतता अनुक्रम रिकॉर्ड करता है और उन्हें स्वतंत्र मिलान सेवाओं को भेजता है। वे जाँचते हैं कि सामने कोई जीवित व्यक्ति है और चेहरे की तुलना पहले से पंजीकृत सभी लोगों से करते हैं। प्रोसेसिंग के बाद छवियाँ हटा दी जाती हैं।',
  ...
  'k-bio':'चेहरा','never-stored':'जाँच के बाद छवियाँ हटा दी जाती हैं — एक कूटबद्ध टेम्पलेट रखा जाता है',
  ...
  'h-bio-hw':'पहचान सत्यापन रोडमैप','h-bio-hw-t':'आज (बीटा): स्वतंत्र मिलान सेवाओं के माध्यम से चेहरे की जाँच, जिन्हें कोरम से सहमत होना होता है। इसकी सीमा अभी वास्तविक कैप्चर पर कैलिब्रेट नहीं है — कोई भी संख्या बताने से पहले लगभग 1000 इम्पोस्टर जोड़े चाहिए। नियोजित: वही कैलिब्रेशन, और एक डुप्लिकेट जाँच जिसमें कोई सेवा पूरा टेम्पलेट न रखे। दीर्घकाल में Aequitas आइरिस स्कैन पर निर्भर करेगा, ताकि सचमुच एक व्यक्ति = एक पंजीकरण सुनिश्चित हो सके। इसे भरोसेमंद और निजता-सुरक्षित तरीके से कैसे लागू किया जाए, इस पर अभी काम चल रहा है; हार्डवेयर और समय-सीमा अभी तय नहीं हैं।',
