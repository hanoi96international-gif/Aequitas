...
en:{
  ...
  'dem-grace-k':'Free amounts','dem-grace-v':'People: 5,000 AEQ of savings · Businesses: 1.5 months\' turnover, at least 2,000 AEQ; no levy in the first 30 days',
  'dem-reset-k':'Turnover','dem-reset-v':'Average of the last 90 days. Purchases count up to 1,000 AEQ per person and month; between businesses only the surplus counts, so circles add nothing; wages, own payments and exchanges into AEQ do not count',
...
de:{
  ...
  'dem-grace-k':'Freibeträge','dem-grace-v':'Menschen: 5.000 AEQ Erspartes · Unternehmen: 1,5 Monatsumsätze, mindestens 2.000 AEQ; in den ersten 30 Tagen kein Liegegeld',
  'dem-reset-k':'Umsatz','dem-reset-v':'Durchschnitt der letzten 90 Tage. Einkäufe zählen bis 1.000 AEQ je Mensch und Monat; zwischen Unternehmen zählt nur der Überschuss, Kreise bringen also nichts; Löhne, eigene Einzahlungen und Umtausch in AEQ zählen nicht',
...
es:{
  ...
  'dem-grace-k':'Importes libres','dem-grace-v':'Personas: 5.000 AEQ de ahorros · Empresas: 1,5 meses de facturación, mínimo 2.000 AEQ; sin gravamen los primeros 30 días',
  'dem-reset-k':'Facturación','dem-reset-v':'Media de los últimos 90 días. Las compras cuentan hasta 1.000 AEQ por persona y mes; entre empresas solo cuenta el excedente, así que los círculos no suman nada; salarios, ingresos propios y cambio a AEQ no cuentan',
...
ru:{
  ...
  'dem-grace-k':'Бесплатные суммы','dem-grace-v':'Люди: 5 000 AEQ сбережений · Бизнес: 1,5 месячного оборота, не меньше 2 000 AEQ; в первые 30 дней сбора нет',
  'dem-reset-k':'Оборот','dem-reset-v':'Среднее за последние 90 дней. Покупки учитываются до 1 000 AEQ на человека в месяц; между компаниями — только превышение, поэтому круги ничего не дают; зарплаты, собственные взносы и обмен в AEQ не учитываются',
...
zh:{
  ...
  'dem-grace-k':'免征额','dem-grace-v':'个人：5,000 AEQ 储蓄 · 企业：1.5 个月营业额，至少 2,000 AEQ；头 30 天不收费',
  'dem-reset-k':'营业额','dem-reset-v':'最近 90 天的平均值。每人每月购买最多计入 1,000 AEQ；企业之间只计净额，所以兜圈毫无收获；工资、自己的注资和兑换成 AEQ 不计入',
...
id:{
  ...
  'dem-grace-k':'Jumlah bebas','dem-grace-v':'Orang: tabungan 5.000 AEQ · Usaha: 1,5 bulan omzet, minimal 2.000 AEQ; tanpa pungutan pada 30 hari pertama',
  'dem-reset-k':'Omzet','dem-reset-v':'Rata-rata 90 hari terakhir. Pembelian dihitung hingga 1.000 AEQ per orang per bulan; antar-usaha hanya surplusnya, jadi putaran tidak menambah apa pun; gaji, setoran sendiri, dan penukaran ke AEQ tidak dihitung',
...
it:{
  ...
  'dem-grace-k':'Importi liberi','dem-grace-v':'Persone: 5.000 AEQ di risparmi · Imprese: 1,5 mesi di fatturato, almeno 2.000 AEQ; nessun prelievo nei primi 30 giorni',
  'dem-reset-k':'Fatturato','dem-reset-v':'Media degli ultimi 90 giorni. Gli acquisti contano fino a 1.000 AEQ per persona al mese; tra imprese conta solo l’eccedenza, quindi i giri non aggiungono nulla; stipendi, versamenti propri e cambio in AEQ non contano',
...
tr:{
  ...
  'dem-grace-k':'Muaf tutarlar','dem-grace-v':'İnsanlar: 5.000 AEQ birikim · İşletmeler: 1,5 aylık ciro, en az 2.000 AEQ; ilk 30 günde kesinti yok',
  'dem-reset-k':'Ciro','dem-reset-v':'Son 90 günün ortalaması. Alışverişler kişi başı ayda 1.000 AEQ\'ya kadar sayılır; işletmeler arasında yalnızca fazlası, bu yüzden döngüler hiçbir şey katmaz; maaşlar, kendi yatırımlarınız ve AEQ\'ya çevirme sayılmaz',
...
fr:{
  ...
  'dem-grace-k':'Montants libres','dem-grace-v':'Personnes : 5 000 AEQ d’épargne · Entreprises : 1,5 mois de chiffre d’affaires, au moins 2 000 AEQ ; pas de prélèvement les 30 premiers jours',
  'dem-reset-k':'Chiffre d’affaires','dem-reset-v':'Moyenne des 90 derniers jours. Les achats comptent jusqu’à 1 000 AEQ par personne et par mois ; entre entreprises seul l’excédent compte, les circuits n’apportent donc rien ; salaires, versements propres et échange en AEQ ne comptent pas',
...
pt:{
  ...
  'dem-grace-k':'Valores livres','dem-grace-v':'Pessoas: 5.000 AEQ de poupança · Empresas: 1,5 mês de faturação, no mínimo 2.000 AEQ; sem taxa nos primeiros 30 dias',
  'dem-reset-k':'Faturação','dem-reset-v':'Média dos últimos 90 dias. As compras contam até 1.000 AEQ por pessoa e mês; entre empresas só conta o excedente, por isso círculos não acrescentam nada; salários, entradas próprias e troca para AEQ não contam',
...
ar:{
  ...
  'dem-grace-k':'المبالغ المعفاة','dem-grace-v':'الأفراد: 5,000 AEQ من المدخرات · الشركات: 1.5 شهر من المبيعات، 2,000 AEQ على الأقل؛ لا رسم في أول 30 يومًا',
  'dem-reset-k':'المبيعات','dem-reset-v':'متوسط آخر 90 يومًا. تُحتسب المشتريات حتى 1,000 AEQ لكل شخص شهريًا؛ وبين الشركات الفائض فقط، فلا تضيف الدوائر شيئًا؛ ولا تُحتسب الأجور والمدفوعات الذاتية والاستبدال إلى AEQ',
...
hi:{
  ...
  'dem-grace-k':'मुक्त राशि','dem-grace-v':'लोग: 5,000 AEQ बचत · व्यवसाय: 1.5 महीने का कारोबार, कम से कम 2,000 AEQ; पहले 30 दिनों में कोई शुल्क नहीं',
  'dem-reset-k':'कारोबार','dem-reset-v':'पिछले 90 दिनों का औसत। ख़रीद हर व्यक्ति पर हर महीने 1,000 AEQ तक गिनी जाती है; व्यवसायों के बीच सिर्फ़ अधिशेष, इसलिए घुमाने से कुछ नहीं जुड़ता; वेतन, अपनी जमा और AEQ में बदलना नहीं गिना जाता',
