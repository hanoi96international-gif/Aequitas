...
en:{
  ...
  'reg-sub':'Join the Aequitas network and receive your 1,000 AEQ start grant. Registration is one-time and permanent. Beta: a live face check by independent matching services is the gate — see the disclaimer for the named limits.',
  'app-title':'REGISTRATION VIA ANDROID APP',
  'app-text':'Registration captures your face and a short liveness sequence (blink, a glance to a random side, colour flashes on the screen) with the phone camera. Two independent matching services check that this face is not already registered; both must agree, and the proof server accepts the registration only with their signed attestations. A Groth16 ZK proof then carries the result to the chain without revealing anything about you. Your <strong style="color:var(--gold)">1,000 AEQ are credited automatically</strong> upon verification. <strong style="color:var(--gold)">Note:</strong> the named limits (older accounts without a face, uncalibrated threshold, liveness not yet fully binding) are in the disclaimer near the register button.',
  ...
  's2t':'Prove','s2d':'A Groth16 ZK proof commits your bio_hash into commitment = keccak256(bioHash‖wallet) without revealing it. The proof server issues it only against the matching services\' signed attestation, and the nullifier derived from it can be spent once — so the same face cannot count twice.',
  ...
  'priv-bar':'🔒 Beta · Face check by quorum · Signed attestation required · Groth16 ZKP · Images discarded after checking',
  'conn-wallet':'CONNECTED WALLET','proof-recv':'⚡ ZK PROOF RECEIVED','proof-hint':'Connect wallet to register',
  'btn-conn':'🦊 CONNECT METAMASK','btn-reg':'🔐 REGISTER ON-CHAIN','reg-apk-note':'Beta: registration needs the app with the face check (app.apk from this site, v1.6.0 or newer).',
...
de:{
  ...
  'reg-sub':'Treten Sie dem Aequitas-Netz bei und erhalten Sie Ihren 1.000-AEQ-Startzuschuss. Die Registrierung ist einmalig und dauerhaft. Beta: eine Live-Gesichtsprüfung durch unabhängige Vergleichsdienste ist das Tor — die benannten Grenzen stehen im Disclaimer.',
  'app-title':'REGISTRIERUNG NUR ÜBER ANDROID-APP',
  'app-text':'Die Registrierung nimmt mit der Handykamera Ihr Gesicht und eine kurze Lebendigkeitsfolge auf (Blinzeln, Blick zu einer zufälligen Seite, Farbblitze auf dem Bildschirm). Zwei unabhängige Vergleichsdienste prüfen, dass dieses Gesicht noch nicht registriert ist; beide müssen zustimmen, und der Proof-Server nimmt die Registrierung nur mit ihren signierten Bescheinigungen an. Ein Groth16-ZK-Beweis bringt das Ergebnis dann auf die Kette, ohne etwas über Sie preiszugeben. Ihre <strong style="color:var(--gold)">1.000 AEQ werden nach der Prüfung automatisch gutgeschrieben</strong>. <strong style="color:var(--gold)">Hinweis:</strong> Die benannten Grenzen (ältere Konten ohne Gesicht, unkalibrierte Schwelle, Lebendigkeit noch nicht vollständig verbindlich) stehen im Hinweis beim Registrieren-Knopf.',
  ...
  's2t':'Beweisen','s2d':'Ein Groth16-ZK-Beweis bindet Ihre bio_hash in commitment = keccak256(bioHash‖wallet), ohne sie preiszugeben. Der Proof-Server stellt ihn nur gegen die signierte Bescheinigung der Vergleichsdienste aus, und der daraus abgeleitete Nullifier lässt sich genau einmal verbrauchen — dasselbe Gesicht zählt also nicht zweimal.',
  ...
  'priv-bar':'🔒 Beta · Gesichtsprüfung per Quorum · Signierte Bescheinigung Pflicht · Groth16-ZKP · Bilder nach der Prüfung verworfen',
  'conn-wallet':'VERBUNDENE WALLET','proof-recv':'⚡ ZK-BEWEIS EMPFANGEN','proof-hint':'Wallet verbinden um zu registrieren',
  'btn-conn':'🦊 METAMASK VERBINDEN','btn-reg':'🔐 ON-CHAIN REGISTRIEREN','reg-apk-note':'Beta: die Registrierung braucht die App mit Gesichtsprüfung (app.apk von dieser Seite, v1.6.0 oder neuer).',
  'btn-wc':'🔗 WALLETCONNECT VERBINDEN',
  'reg-log-hint':'// Öffnen Sie die Aequitas Android App, um Ihren Beweis zu erstellen, und kehren Sie dann hierher zurück...',
...
es:{
  ...
  'reg-sub':'Únase a la red Aequitas y reciba su asignación inicial de 1.000 AEQ. El registro es único y permanente. Beta: la puerta es una verificación facial en vivo por servicios de comparación independientes — los límites declarados están en el aviso.',
  'app-title':'REGISTRO SOLO VÍA APP ANDROID',
  'app-text':'El registro captura con la cámara del teléfono su rostro y una breve secuencia de prueba de vida (parpadeo, una mirada a un lado al azar, destellos de color en la pantalla). Dos servicios de comparación independientes comprueban que ese rostro no está ya registrado; ambos deben coincidir, y el servidor de pruebas acepta el registro solo con sus atestaciones firmadas. Una prueba ZK Groth16 lleva luego el resultado a la cadena sin revelar nada sobre usted. Sus <strong style="color:var(--gold)">1.000 AEQ se acreditan automáticamente</strong> tras la verificación. <strong style="color:var(--gold)">Nota:</strong> los límites declarados (cuentas antiguas sin rostro, umbral sin calibrar, prueba de vida aún no del todo vinculante) están en el aviso junto al botón de registro.',
  ...
  's2t':'Probar','s2d':'Una prueba ZK Groth16 compromete su bio_hash en commitment = keccak256(bioHash‖wallet) sin revelarlo. El nullifier se deriva de ese hash, así que el mismo rostro no puede contar dos veces — ver las preguntas frecuentes.',
  ...
  'priv-bar':'🔒 Beta · Verificación facial por quórum · Groth16 ZKP · Imágenes descartadas tras la comprobación · Un registro por persona',
  'conn-wallet':'WALLET CONECTADA','proof-recv':'⚡ PRUEBA ZK RECIBIDA','proof-hint':'Conecte su wallet para registrarse',
  'btn-conn':'🦊 CONECTAR METAMASK','btn-reg':'🔐 REGISTRAR ON-CHAIN','reg-apk-note':'Beta: el registro requiere la app con verificación facial (app.apk de este sitio, v1.6.0 o posterior).',
  'btn-wc':'🔗 CONECTAR WALLETCONNECT',
  'reg-log-hint':'// Abra la App Android Aequitas para generar su prueba y luego regrese aquí...',
...
ru:{
  ...
  'reg-sub':'Присоединяйтесь к сети Aequitas и получите стартовые 1 000 AEQ. Регистрация однократная и постоянная. Бета: пропуском служит живая проверка лица независимыми службами сравнения — названные ограничения см. в оговорке.',
  'app-title':'РЕГИСТРАЦИЯ ТОЛЬКО ЧЕРЕЗ ANDROID-ПРИЛОЖЕНИЕ',
  'app-text':'При регистрации камера телефона снимает ваше лицо и короткую последовательность проверки живости (моргание, взгляд в случайную сторону, цветовые вспышки на экране). Две независимые службы сравнения проверяют, что это лицо ещё не зарегистрировано; обе должны согласиться, и сервер доказательств принимает регистрацию только с их подписанными подтверждениями. Затем доказательство Groth16 ZK переносит результат в цепь, ничего не раскрывая о вас. Ваши <strong style="color:var(--gold)">1000 AEQ начисляются автоматически</strong> после проверки. <strong style="color:var(--gold)">Примечание:</strong> названные ограничения (старые счета без лица, неоткалиброванный порог, проверка живости ещё не полностью обязательна) указаны в оговорке у кнопки регистрации.',
  ...
  's2t':'Доказать','s2d':'Доказательство Groth16 фиксирует ваш bio_hash в commitment = keccak256(bioHash‖wallet), не раскрывая его. Нуллификатор выводится из этого хеша, поэтому одно и то же лицо не может засчитаться дважды — см. FAQ ниже.',
  ...
  'priv-bar':'🔒 Бета · Проверка лица кворумом · Groth16 ZKP · Изображения удаляются после проверки · Одна регистрация на человека',
  'conn-wallet':'ПОДКЛЮЧЁННЫЙ КОШЕЛЁК','proof-recv':'⚡ ZK-ДОКАЗАТЕЛЬСТВО ПОЛУЧЕНО','proof-hint':'Подключите кошелёк для регистрации',
  'btn-conn':'🦊 ПОДКЛЮЧИТЬ METAMASK','btn-reg':'🔐 ЗАРЕГИСТРИРОВАТЬ ОН-ЧЕЙН','reg-apk-note':'Бета: для регистрации нужно приложение с проверкой лица (app.apk с этого сайта, v1.6.0 или новее).',
...
zh:{
  ...
  'reg-sub':'加入 Aequitas 网络，领取 1,000 AEQ 起步发放。注册一次性且永久。Beta：门槛是独立比对服务的实时人脸核验 — 明示的限制见声明。',
  'app-title':'仅通过安卓应用注册',
  'app-text':'注册时用手机摄像头采集你的人脸和一段简短的活体序列（眨眼、随机向一侧看、屏幕颜色闪光）。两个独立的比对服务检查这张脸尚未注册；两者须同时同意，证明服务器只在收到它们的签名证明后才接受注册。随后 Groth16 零知识证明将结果带上链，不泄露关于你的任何信息。核验通过后，你的 <strong style="color:var(--gold)">1,000 AEQ 将自动入账</strong>。<strong style="color:var(--gold)">注意：</strong> 明示的限制（没有人脸的旧账户、未校准的阈值、活体检测尚未完全具有约束力）写在注册按钮旁的声明中。',
  's1t':'连接','s1d':'应用录制你的人脸和一段简短的活体序列（眨眼、随机向一侧看、颜色闪光），并发送给两个独立的比对服务。它们将这张脸与所有带人脸注册的人进行比对。照片在几秒内丢弃，只保留 64 字节的摘要。',
  's2t':'证明','s2d':'Groth16 零知识证明将你的 bio_hash 提交为 commitment = keccak256(bioHash‖wallet)，而不泄露它。nullifier 由该哈希派生，因此同一张面部无法被计入两次 — 详见下方常见问题。',
  's3t':'领取','s3d':'在 Aequitas BlockDAG 上约 1 秒内确认注册 · 立即记入 1,000 AEQ · 身份永久记录为经过验证的人类',
  'priv-bar':'🔒 Beta · 面部核验由法定多数完成 · Groth16 ZKP · 图像核验后即丢弃 · 每人一次注册',
  'conn-wallet':'已连接钱包','proof-recv':'⚡ 已收到ZK证明','proof-hint':'连接钱包以注册',
  'btn-conn':'🦊 连接 METAMASK','btn-reg':'🔐 链上注册','reg-apk-note':'Beta：注册需要带人脸核验的应用（本站 app.apk，v1.6.0 或更新）。',
...
id:{
  ...
  'reg-sub':'Bergabunglah dengan jaringan Aequitas dan terima hibah awal 1.000 AEQ. Pendaftaran sekali dan permanen. Beta: gerbangnya adalah pemeriksaan wajah langsung oleh layanan pencocokan independen — batas yang disebutkan ada di peringatan.',
  'app-title':'PENDAFTARAN HANYA MELALUI APLIKASI ANDROID',
  'app-text':'Pendaftaran merekam wajah Anda dan urutan singkat deteksi kehidupan (berkedip, melirik ke sisi acak, kilatan warna di layar) dengan kamera ponsel. Dua layanan pencocokan independen memeriksa bahwa wajah ini belum terdaftar; keduanya harus setuju, dan server bukti menerima pendaftaran hanya dengan atestasi bertanda tangan mereka. Bukti ZK Groth16 lalu membawa hasilnya ke rantai tanpa mengungkap apa pun tentang Anda. <strong style="color:var(--gold)">1.000 AEQ Anda dikreditkan otomatis</strong> setelah verifikasi. <strong style="color:var(--gold)">Catatan:</strong> batas yang disebutkan (akun lama tanpa wajah, ambang belum dikalibrasi, deteksi kehidupan belum sepenuhnya mengikat) ada di peringatan dekat tombol daftar.',
  ...
  's2t':'Buktikan','s2d':'Bukti ZK Groth16 mengikat bio_hash Anda ke commitment = keccak256(bioHash‖wallet) tanpa mengungkapkannya. Nullifier diturunkan dari hash itu, sehingga wajah yang sama tidak dapat dihitung dua kali — lihat FAQ di bawah.',
  ...
  'priv-bar':'🔒 Beta · Pemeriksaan wajah oleh kuorum · Groth16 ZKP · Gambar dibuang setelah pemeriksaan · Satu pendaftaran per orang',
  'conn-wallet':'DOMPET TERHUBUNG','proof-recv':'⚡ BUKTI ZK DITERIMA','proof-hint':'Hubungkan dompet untuk mendaftar',
  'btn-conn':'🦊 HUBUNGKAN METAMASK','btn-reg':'🔐 DAFTAR ON-CHAIN','reg-apk-note':'Beta: pendaftaran memerlukan aplikasi dengan pemeriksaan wajah (app.apk dari situs ini, v1.6.0 atau lebih baru).',
...
it:{
  ...
  'reg-sub':'Si unisca alla rete Aequitas e riceva il Suo accredito iniziale di 1.000 AEQ. La registrazione è unica e permanente. Beta: il cancello è una verifica del volto dal vivo di servizi di confronto indipendenti — i limiti dichiarati sono nell\'avvertenza.',
  'app-title':'REGISTRAZIONE SOLO VIA APP ANDROID',
  'app-text':'La registrazione acquisisce con la fotocamera del telefono il Suo volto e una breve sequenza di vitalità (battito di ciglia, uno sguardo verso un lato casuale, lampi di colore sullo schermo). Due servizi di confronto indipendenti verificano che questo volto non sia già registrato; devono concordare entrambi, e il server delle prove accetta la registrazione solo con le loro attestazioni firmate. Una prova ZK Groth16 porta poi il risultato sulla catena senza rivelare nulla su di Lei. I Suoi <strong style="color:var(--gold)">1.000 AEQ vengono accreditati automaticamente</strong> dopo la verifica. <strong style="color:var(--gold)">Nota:</strong> i limiti dichiarati (account vecchi senza volto, soglia non tarata, vitalità non ancora del tutto vincolante) sono nell\'avvertenza vicino al pulsante di registrazione.',
  ...
  's2t':'Prova','s2d':'Una prova ZK Groth16 impegna il Suo bio_hash in commitment = keccak256(bioHash‖wallet) senza rivelarlo. Il nullifier deriva da quell\'hash, quindi lo stesso volto non può contare due volte — veda le FAQ qui sotto.',
  ...
  'priv-bar':'🔒 Beta · Verifica del volto per quorum · Groth16 ZKP · Immagini scartate dopo la verifica · Una registrazione per persona',
  'conn-wallet':'WALLET CONNESSO','proof-recv':'⚡ PROVA ZK RICEVUTA','proof-hint':'Connetta il wallet per registrarsi',
  'btn-conn':'🦊 CONNETTI METAMASK','btn-reg':'🔐 REGISTRA ON-CHAIN','reg-apk-note':'Beta: la registrazione richiede l\'app con verifica del volto (app.apk da questo sito, v1.6.0 o successiva).',
  'btn-wc':'🔗 CONNETTI WALLETCONNECT',
  'reg-log-hint':'// Apra l\'App Android Aequitas per generare la Sua prova, poi torni qui...',
...
tr:{
  ...
  'reg-sub':'Aequitas ağına katılın ve 1.000 AEQ başlangıç ödemenizi alın. Kayıt tek seferlik ve kalıcıdır. Beta: kapı, bağımsız eşleştirme servislerinin canlı yüz doğrulamasıdır — belirtilen sınırlar uyarıda.',
  'app-title':'KAYIT YALNIZCA ANDROİD UYGULAMASI İLE',
  'app-text':'Kayıt, telefon kamerasıyla yüzünüzü ve kısa bir canlılık dizisini (göz kırpma, rastgele bir yana bakış, ekranda renk flaşları) kaydeder. İki bağımsız eşleştirme servisi bu yüzün henüz kayıtlı olmadığını kontrol eder; ikisi de onaylamalıdır ve kanıt sunucusu kaydı yalnızca imzalı onaylarıyla kabul eder. Ardından bir Groth16 ZK kanıtı, hakkınızda hiçbir şey açığa çıkarmadan sonucu zincire taşır. <strong style="color:var(--gold)">1.000 AEQ</strong> doğrulamadan sonra otomatik olarak hesabınıza geçer. <strong style="color:var(--gold)">Not:</strong> belirtilen sınırlar (yüzü olmayan eski hesaplar, ayarlanmamış eşik, henüz tam bağlayıcı olmayan canlılık) kayıt düğmesinin yanındaki uyarıda.',
  ...
  's2t':'Kanıtla','s2d':'Bir Groth16 ZK kanıtı bio_hash değerinizi commitment = keccak256(bioHash‖wallet) içine, açığa çıkarmadan bağlar. Nullifier bu özetten türetilir; aynı yüz iki kez sayılamaz — aşağıdaki SSS bölümüne bakın.',
  ...
  'priv-bar':'🔒 Beta · Yüz denetimi yeter sayıyla · Groth16 ZKP · Görüntüler denetimden sonra atılır · Kişi başına bir kayıt',
  'conn-wallet':'BAĞLI CÜZDAN','proof-recv':'⚡ ZK KANITI ALINDI','proof-hint':'Kayıt için cüzdanınızı bağlayın',
  'btn-conn':'🦊 METAMASK BAĞLA','btn-reg':'🔐 ZİNCİRE KAYIT OL','reg-apk-note':'Beta: kayıt için yüz doğrulamalı uygulama gerekir (bu sitedeki app.apk, v1.6.0 veya daha yeni).',
  'btn-wc':'🔗 WALLETCONNECT BAĞLA',
  'reg-log-hint':'// Kanıtınızı oluşturmak için Aequitas Android Uygulamasını açın, ardından buraya dönün...',
...
fr:{
  ...
  'reg-disclaimer':'<div style="font-weight:800;color:var(--gold);margin-bottom:6px;font-size:0.88rem">Avertissement bêta</div>Bêta : depuis le 25/08/2026, le serveur de preuves refuse toute inscription sans les attestations signées des deux services de comparaison — un second téléphone ne donne plus un second compte au même visage. Ce qui n\'est pas encore vrai : les comptes antérieurs à cette date ne sont couverts qu\'une fois que leur titulaire ajoute son visage dans l\'app (sans nouvelle allocation) ; d\'ici là, ils pourraient en principe se réinscrire avec un nouveau portefeuille. Les taux d\'erreur ne sont pas étalonnés (il faut ~1 000 paires d\'imposteurs). Preuve de vie : seule la consigne du regard est contraignante aujourd\'hui ; flashs de couleur, pouls et parallaxe sont mesurés mais ne décident pas encore. Lisez « un humain, un compte » comme « vérifié, avec des limites nommées » — pas comme « impossible à contourner ». À long terme, Aequitas misera sur le scan de l’iris pour garantir réellement une personne, une inscription. La manière de le mettre en œuvre de façon fiable et respectueuse de la vie privée est en cours d’élaboration ; le matériel et le calendrier ne sont pas encore fixés.',
  ...
  'reg-sub':'Rejoignez le réseau Aequitas et recevez votre allocation de départ de 1 000 AEQ. L\'inscription est unique et permanente. Bêta : la porte est un contrôle du visage en direct par des services de comparaison indépendants — les limites nommées sont dans l\'avertissement.',
  'app-title':'INSCRIPTION VIA L\'APPLICATION ANDROID',
  'app-text':'L\'inscription capture avec la caméra du téléphone votre visage et une courte séquence de preuve de vie (un clignement, un regard vers un côté au hasard, des flashs de couleur à l\'écran). Deux services de comparaison indépendants vérifient que ce visage n\'est pas déjà inscrit ; tous deux doivent être d\'accord, et le serveur de preuves n\'accepte l\'inscription qu\'avec leurs attestations signées. Une preuve ZK Groth16 porte ensuite le résultat sur la chaîne sans rien révéler de vous. Vos <strong style="color:var(--gold)">1 000 AEQ sont crédités automatiquement</strong> après vérification. <strong style="color:var(--gold)">Note :</strong> les limites nommées (anciens comptes sans visage, seuil non étalonné, preuve de vie pas encore entièrement contraignante) figurent dans l\'avertissement près du bouton d\'inscription.',
  ...
  's2t':'Prouver','s2d':'Une preuve ZK Groth16 engage votre bio_hash dans commitment = keccak256(bioHash‖wallet) sans le révéler. Le nullifier est dérivé de ce hachage, donc le même visage ne peut pas compter deux fois — voir la FAQ ci-dessous.',
  ...
  'priv-bar':'🔒 Bêta · Vérification du visage par quorum · Groth16 ZKP · Images écartées après vérification · Un enregistrement par personne',
  'conn-wallet':'PORTEFEUILLE CONNECTÉ','proof-recv':'⚡ PREUVE ZK REÇUE','proof-hint':'Connecter un portefeuille pour s\'inscrire',
  'btn-conn':'🦊 CONNECTER METAMASK','btn-reg':'🔐 INSCRIPTION ON-CHAIN','reg-apk-note':'Bêta : l\'inscription nécessite l\'app avec contrôle du visage (app.apk de ce site, v1.6.0 ou plus récent).',
...
pt:{
  ...
  'reg-sub':'Junte-se à rede Aequitas e receba a sua atribuição inicial de 1.000 AEQ. O registo é único e permanente. Beta: a porta é uma verificação facial ao vivo por serviços de comparação independentes — os limites declarados estão no aviso.',
  'app-title':'REGISTRO VIA APLICATIVO ANDROID',
  'app-text':'O registo capta com a câmara do telemóvel o seu rosto e uma curta sequência de prova de vida (piscar os olhos, um olhar para um lado aleatório, flashes de cor no ecrã). Dois serviços de comparação independentes verificam que esse rosto ainda não está registado; ambos têm de concordar, e o servidor de provas só aceita o registo com as suas atestações assinadas. Uma prova ZK Groth16 leva depois o resultado para a cadeia sem revelar nada sobre si. Os seus <strong style="color:var(--gold)">1.000 AEQ são creditados automaticamente</strong> após a verificação. <strong style="color:var(--gold)">Nota:</strong> os limites declarados (contas antigas sem rosto, limiar não calibrado, prova de vida ainda não totalmente vinculativa) estão no aviso junto ao botão de registo.',
  ...
  's2t':'Provar','s2d':'Uma prova ZK Groth16 compromete o seu bio_hash em commitment = keccak256(bioHash‖wallet) sem o revelar. O nullifier deriva desse hash, portanto o mesmo rosto não pode contar duas vezes — ver as perguntas frequentes abaixo.',
  ...
  'priv-bar':'🔒 Beta · Verificação do rosto por quórum · Groth16 ZKP · Imagens descartadas após a verificação · Um registo por pessoa',
  'conn-wallet':'CARTEIRA CONECTADA','proof-recv':'⚡ PROVA ZK RECEBIDA','proof-hint':'Conectar carteira para registrar',
  'btn-conn':'🦊 CONECTAR METAMASK','btn-reg':'🔐 REGISTRAR ON-CHAIN','reg-apk-note':'Beta: o registo requer a app com verificação facial (app.apk deste site, v1.6.0 ou mais recente).',
  'btn-wc':'🔗 CONECTAR WALLETCONNECT',
...
ar:{
  ...
  'reg-sub':'انضم إلى شبكة Aequitas واحصل على منحة البداية 1,000 AEQ. التسجيل لمرة واحدة ودائم. النسخة التجريبية: البوابة هي تحقق حي من الوجه لدى خدمات مطابقة مستقلة — الحدود المُعلنة في التنبيه.',
  'app-title':'التسجيل عبر تطبيق أندرويد',
  'app-text':'يلتقط التسجيل بكاميرا الهاتف وجهك وتسلسلاً قصيراً لفحص الحيوية (رمشة، نظرة إلى جانب عشوائي، ومضات ألوان على الشاشة). تتحقق خدمتا مطابقة مستقلتان من أن هذا الوجه غير مسجّل بعد؛ يجب أن تتفقا معاً، ولا يقبل خادم البراهين التسجيل إلا بشهادتيهما الموقَّعتين. ثم ينقل برهان Groth16 ZK النتيجة إلى السلسلة دون كشف أي شيء عنك. تُضاف <strong style="color:var(--gold)">1000 AEQ تلقائياً</strong> بعد التحقق. <strong style="color:var(--gold)">ملاحظة:</strong> الحدود المُعلنة (حسابات قديمة بلا وجه، عتبة غير مُعايَرة، فحص حيوية غير ملزم بالكامل بعد) مذكورة في التنبيه قرب زر التسجيل.',
  ...
  's2t':'إثبات','s2d':'يلتزم إثبات Groth16 بقيمة bio_hash الخاصة بك ضمن commitment = keccak256(bioHash‖wallet) دون كشفها. يُشتق المُبطِل من هذا الهاش، لذا لا يمكن احتساب الوجه نفسه مرتين — انظر الأسئلة الشائعة أدناه.',
  's3t':'استلام','s3d':'تأكيد التسجيل على BlockDAG Aequitas خلال ثانية · إيداع 1,000 AEQ فوراً · هويتك مسجّلة دائماً كإنسان موثّق',
  'priv-bar':'🔒 النسخة التجريبية · التحقق من الوجه بالنصاب · Groth16 ZKP · تُتلَف الصور بعد التحقق · تسجيل واحد لكل شخص',
  'conn-wallet':'المحفظة المتصلة','proof-recv':'⚡ تم استلام دليل ZK','proof-hint':'ربط محفظة للتسجيل',
  'btn-conn':'🦊 ربط METAMASK','btn-reg':'🔐 التسجيل ON-CHAIN','reg-apk-note':'النسخة التجريبية: يتطلب التسجيل التطبيق مع التحقق من الوجه (app.apk من هذا الموقع، v1.6.0 أو أحدث).',
...
hi:{
  ...
  'reg-sub':'Aequitas नेटवर्क से जुड़ें और अपना 1,000 AEQ शुरुआती अनुदान पाएँ। पंजीकरण एक बार और स्थायी है। बीटा: द्वार स्वतंत्र मिलान सेवाओं की लाइव चेहरा जाँच है — बताई गई सीमाएँ अस्वीकरण में हैं।',
  'app-title':'एंड्रॉयड ऐप के माध्यम से रजिस्ट्रेशन',
  'app-text':'पंजीकरण फ़ोन कैमरे से आपका चेहरा और एक छोटा जीवंतता क्रम (पलक झपकाना, किसी यादृच्छिक दिशा में देखना, स्क्रीन पर रंग-चमक) कैप्चर करता है। दो स्वतंत्र मिलान सेवाएँ जाँचती हैं कि यह चेहरा पहले से पंजीकृत नहीं है; दोनों का सहमत होना ज़रूरी है, और प्रूफ़ सर्वर केवल उनके हस्ताक्षरित सत्यापनों के साथ पंजीकरण स्वीकार करता है। फिर एक Groth16 ZK प्रमाण आपके बारे में कुछ भी उजागर किए बिना परिणाम को चेन तक ले जाता है। सत्यापन के बाद आपके <strong style="color:var(--gold)">1,000 AEQ स्वतः जमा हो जाते हैं</strong>। <strong style="color:var(--gold)">ध्यान दें:</strong> बताई गई सीमाएँ (बिना चेहरे वाले पुराने खाते, अकैलिब्रेटेड सीमा, जीवंतता अभी पूरी तरह बाध्यकारी नहीं) पंजीकरण बटन के पास की चेतावनी में हैं।',
  ...
  's2t':'सिद्ध करें','s2d':'एक Groth16 ZK प्रमाण आपके bio_hash को commitment = keccak256(bioHash‖wallet) में बिना उजागर किए प्रतिबद्ध करता है। nullifier उसी हैश से व्युत्पन्न होता है, इसलिए वही चेहरा दो बार नहीं गिना जा सकता — नीचे FAQ देखें।',
  ...
  'priv-bar':'🔒 बीटा · कोरम द्वारा चेहरे की जाँच · Groth16 ZKP · जाँच के बाद छवियाँ हटाई गईं · प्रति व्यक्ति एक पंजीकरण',
  'conn-wallet':'कनेक्टेड वॉलेट','proof-recv':'⚡ ZK प्रमाण प्राप्त','proof-hint':'रजिस्टर करने के लिए वॉलेट कनेक्ट करें',
  'btn-conn':'🦊 METAMASK कनेक्ट करें','btn-reg':'🔐 ON-CHAIN रजिस्टर करें','reg-apk-note':'बीटा: पंजीकरण के लिए चेहरा जाँच वाला ऐप चाहिए (इस साइट का app.apk, v1.6.0 या नया)।',
