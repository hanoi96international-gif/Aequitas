...
es:{
  ...
  'bv-guide-lang-note':'Los pasos siguientes están en inglés. Las secciones de arriba —qué es esto, qué protege y de qué te haces responsable— están en tu idioma.',
  'bv-what-d':'Ningún rostro te llega como imagen: la captura se descarta tras la comprobación y tu máquina guarda una plantilla cifrada de ella. Existe un modo de reparto en el que tu máquina solo tendría una parte aditiva de un esbozo de 64 bytes —indistinguible del ruido por sí sola, comparada conjuntamente con tu comité de modo que ninguno aprenda más que la respuesta—. Está construido y probado, pero <strong style="color:var(--text)">aún no está activo</strong>, porque su umbral nunca se ha calibrado. Hasta entonces, cada verificador guarda una plantilla cifrada completa, y preferimos decirlo a insinuar una protección que aún no ofreces.',
  ...
  'reg-sub':'Únete a la red Aequitas y recibe tu asignación inicial de 1.000 AEQ. El registro es único y permanente. Phase 1: la puerta es una verificación facial en vivo por servicios de comparación independientes — los límites declarados están en el aviso.',
  ...
  's1t':'Conectar','s1d':'La app graba tu rostro y una breve secuencia de vitalidad y los envía a servicios de comparación independientes. Estos comprueban que hay una persona viva delante y comparan el rostro con todos los ya registrados. Las imágenes se descartan tras el procesamiento.',
  's2t':'Probar','s2d':'Una prueba ZK Groth16 compromete tu bio_hash en commitment = keccak256(bioHash‖wallet) sin revelarlo. El nullifier se deriva de ese hash, así que el mismo rostro no puede contar dos veces — ver las preguntas frecuentes.',
  ...
  'swap-title':'🔄 Intercambiar AEQ ↔ tUSD','swap-sub':'Intercambia AEQ por tUSD (un dólar de prueba simulado) a través del pool de liquidez nativo. Los intercambios pagan una comisión del 0,1%; las transferencias ordinarias de AEQ también pagan un 0,1% de comisión de protocolo, que va íntegramente a la renta básica (sin gas EVM).',
...
id:{
  ...
  'bv-desc':'Validator menjamin bahwa <strong style="color:var(--text)">angkanya cocok</strong>. Ia tidak menjamin satu hal yang menopang segalanya: bahwa <strong style="color:var(--text)">tak seorang pun mendaftar dua kali</strong>. Tanpa itu, “satu manusia, satu penghasilan” hanyalah slogan — buku besarnya benar sempurna dan sama sekali tak berharga. Hari ini janji itu bertumpu pada sangat sedikit mesin, dan setiap mesin yang kamu tambahkan membuatnya lebih sulit dipatahkan. Dua peran yang memikulnya — <strong style="color:var(--text)">verifier</strong> yang memutuskan apakah sebuah wajah sudah terdaftar, dan <strong style="color:var(--text)">koordinator</strong> yang mengumpulkan keputusan itu — berjalan di server yang sama. Panduan ini menyiapkan keduanya.',
  ...
  'bv-guide-lang-note':'Langkah-langkah di bawah dalam bahasa Inggris. Bagian di atas — apa ini, apa yang dilindunginya, dan apa yang kamu tanggung — ada dalam bahasamu.',
  'bv-what-d':'Wajah tidak pernah sampai kepadamu sebagai gambar: citranya dibuang setelah diperiksa, dan mesinmu menyimpan templat terenkripsi darinya. Ada mode berbagi-bagian di mana mesinmu hanya akan menyimpan satu bagian aditif dari sketsa 64 byte — sendirian tak terbedakan dari derau, dibandingkan bersama komitemu sehingga tak seorang pun tahu lebih dari jawabannya. Mode itu sudah dibangun dan diuji, tetapi <strong style="color:var(--text)">belum aktif</strong>, karena ambangnya tak pernah dikalibrasi. Sampai saat itu, setiap verifier menyimpan satu templat terenkripsi utuh — dan kami lebih baik mengatakannya daripada menyiratkan perlindungan yang belum kamu berikan.',
  ...
  'h-zkp':'Sistem Bukti ZK','h-zkp-t':'Aequitas memakai Groth16 di BN128 — kurva yang sama dengan Ethereum dan Zcash. Bukti: ~200 byte. Verifikasi: ~10 ms. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). Nullifier berasal dari wajah, bukan dari ponsel: perangkat kedua tidak membuat orang yang sama bisa mendaftar lagi, dan kehilangan ponsel tidak menghilangkan pendaftaranmu. Poseidon dipakai alih-alih perkalian karena nullifier sirkuit terdahulu dapat dibalik — siapa pun bisa memulihkan bioHash darinya.',
...
it:{
  ...
  'bv-guide-lang-note':'I passaggi qui sotto sono in inglese. Le sezioni sopra — che cos\'è, che cosa protegge e di che cosa ti fai carico — sono nella tua lingua.',
  'bv-what-d':'Nessun volto ti arriva come immagine: la ripresa viene scartata dopo il controllo e la tua macchina conserva un modello cifrato. Esiste una modalità a quote condivise in cui la tua macchina conserverebbe solo una quota additiva di uno schizzo da 64 byte — da sola indistinguibile dal rumore, confrontata insieme al tuo comitato così che nessuno impari più della risposta. È realizzata e collaudata, ma <strong style="color:var(--text)">non ancora attiva</strong>, perché la sua soglia non è mai stata calibrata. Fino ad allora ogni verificatore conserva un modello cifrato intero, e preferiamo dirlo piuttosto che lasciar intendere una protezione che non stai ancora offrendo.',
  ...
  'logo-sub':'PROVA DI UMANITÀ','live':'LIVE','phase0-badge':'Phase 1 · verifica del volto','nav-register':'Registrati','foot-launched':'Lanciata a giugno 2026','foot-phase':'Phase 1','foot-quote':'Il denaro esiste perché esistono le persone. Niente di più, niente di meno.',
  ...
  'reg-sub':'Unisciti alla rete Aequitas e ricevi il tuo accredito iniziale di 1.000 AEQ. La registrazione è unica e permanente. Phase 1: il cancello è una verifica del volto dal vivo di servizi di confronto indipendenti — i limiti dichiarati sono nell\'avvertenza.',
  ...
  's1t':'Connetti','s1d':'L\'app registra il tuo volto e una breve sequenza di vitalità e li invia a servizi di confronto indipendenti. Questi verificano che davanti ci sia una persona viva e confrontano il volto con tutti i già registrati. Le immagini vengono scartate dopo l\'elaborazione.',
  's2t':'Prova','s2d':'Una prova ZK Groth16 impegna il tuo bio_hash in commitment = keccak256(bioHash‖wallet) senza rivelarlo. Il nullifier deriva da quell\'hash, quindi lo stesso volto non può contare due volte — vedi le FAQ qui sotto.',
...
tr:{
  ...
  'swap-title':'🔄 AEQ ↔ tUSD Takas Et','swap-sub':'Yerel likidite havuzu üzerinden AEQ\'yu tUSD (simüle edilmiş test doları) ile takas et. Takaslar %0,1 ücret öder; normal AEQ transferleri de tamamı temel gelire giden %0,1 protokol ücreti öder (EVM gas yok).',
...
fr:{
  ...
  'reg-sub':'Rejoins le réseau Aequitas et reçois ton allocation de départ de 1 000 AEQ. L\'inscription est unique et permanente. Phase 1 : la porte est un contrôle du visage en direct par des services de comparaison indépendants — les limites nommées sont dans l\'avertissement.',
  ...
  's2t':'Prouver','s2d':'Une preuve ZK Groth16 engage ton bio_hash dans commitment = keccak256(bioHash‖wallet) sans le révéler. Le nullifier est dérivé de ce hachage, donc le même visage ne peut pas compter deux fois — voir la FAQ ci-dessous.',
