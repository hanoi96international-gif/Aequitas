...
en:{
  ...
  'x-phase-2-10-000-humans':'Phase 2 (10,000+ humans):',
  'x-phase-3-1m-humans-gini':'Phase 3 (1M+ humans and Gini below 0.30):',
  'nr-intro':'Currently the network runs on 2 active validators, each on its own server with its own database, with MERGE events from both. Only registered humans can run validator nodes — this is a security requirement. The steps below are goals tied to the protocol phases: the protocol sets the phase automatically, but it does not yet enforce a minimum number of nodes.',
  'nr-0':'Two independent Contabo servers, each with its own database and its own proof server. Trust established through code transparency. Any registered human can already join as a validator — no application, no stake.',
  'nr-1':'More independent node operators; each earns a share of the validator pool (40% of swap fees).',
  'nr-2':'Goal: at least 10 independent node operators.',
  'nr-3':'Goal: a fully decentralized BlockDAG — no single operator can censor or halt the chain.',
  'nr-outro':'The node operator guide (PDF) is available on the Network tab. Each new node operator earns from the validator pool — the more nodes, the more resilient the network.',
  ...
  'bv-desc':'A validator secures that the <strong style="color:var(--text)">numbers add up</strong>. It does not secure the one thing everything else rests on: that <strong style="color:var(--text)">nobody registers twice</strong>. Without that, “one human, one income” is only a slogan — the ledger would be perfectly correct and completely worthless. Today that promise rests on very few machines, and every one you add makes it harder to break. The two roles that carry it — the <strong style="color:var(--text)">verifier</strong> that decides whether a face is already enrolled, and the <strong style="color:var(--text)">coordinator</strong> that collects those decisions — run on the same server. This guide sets up both.',
  'bv-guide-sub':'Step by step · No cryptography knowledge required · About 45 minutes, most of it waiting',
  ...
  'x-0-1-split-40-30':'0.1% · split 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10,000 &#8211; 1M humans. Goal: at least 10 independent node operators.',
  'x-100-8211-10-000-humans':'100 &#8211; 10,000 humans. Cap 25×. Goal: more independent node operators.',
  'x-100-maximum-concentration':'100 = maximum concentration',
  'x-1m-humans-global-ubi-at':'1M+ humans and a Gini below 0.30 — both must hold. Global basic income at scale.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas implements this mathematically. Every verified human receives exactly 1,000 AEQ — billionaire or subsistence farmer, no exceptions. Fixed rules — the idle-money levy, the wealth cap and the daily basic income — keep inequality from accumulating indefinitely. The Gini coefficient is computed from the live balances and can be checked by anyone.',
  ...
  'x-comparable-to-the-usa-0':'Comparable to the USA (~0.41) or France (~0.32). Within the range of most developed economies.',
  ...
  'x-demurrage-0-5-mo':'Idle-money levy (0.5–1%/mo)',
  ...
  'x-healthier-than-most-nations-on':'Healthier than most nations on Earth. Comparable to Scandinavia (~0.27) and Germany (~0.31).',
  'x-higher-than-most-european-nations':'Higher than most European nations — comparable to Brazil (~0.53). The rules do not change with the index; the idle-money levy and the wealth cap work continuously.',
  'x-honest-limitation':'Honest limitation:',
  'x-why-sybil-resistance':'Why Sybil resistance?','x-how-it-works':'How It Works',
  ...
  'x-bio-hash-random':'random value, issued after the face check (not derived from the face)',
  ...
  'x-swap-fees-0-1':'Transfer & swap fees (0.1%)',
  'x-sybil-resistance-8212-current-state':'Sybil Resistance &#8212; Current State, Honestly',
  'x-the-4-redistribution-mechanisms':'The 3 redistribution pools',
  ...
  'x-worse-than-any-country-on':'Worse than any country on Earth (South Africa record: ~0.63). Approaching Bitcoin (~0.85). With few registered humans this happens quickly; the rules stay the same.',
  ...
  'reg-sub':'Join the Aequitas network and receive your 1,000 AEQ start grant. Registration is one-time and permanent. It is in beta: checked, with named limits — see the beta notice below.',
  'app-title':'REGISTRATION VIA ANDROID APP',
  'app-text':'Registration runs only in the Android app: a short face capture, checked by two independent matching services. After that, <strong style="color:var(--gold)">1,000 AEQ are credited automatically</strong>. What is and is not stored: step 1 and the beta notice below.',
  's1t':'Connect','s1d':'The app records your face and a short liveness sequence (blink, a glance to a random side, colour flashes) and sends them to two independent matching services. They compare the face against everyone registered with a face. The photo is discarded within seconds; only a 64-byte sketch is kept.',
  's2t':'Prove','s2d':'A Groth16 ZK proof binds your bio_hash into a commitment (Poseidon of bio_hash, wallet and a salt) without revealing it. The proof server only issues it with the wallet binding and the two services\' signed attestations, and the nullifier can be spent once — so the same face does not count twice.',
  ...
  'priv-bar':'🔒 Beta · Face check by 2 independent services · 2 signed attestations required · Groth16 ZKP · Only a 64-byte sketch kept',
  'conn-wallet':'CONNECTED WALLET','proof-recv':'⚡ ZK PROOF RECEIVED','proof-hint':'Connect wallet to register',
  'btn-conn':'🦊 CONNECT METAMASK','btn-reg':'🔐 REGISTER ON-CHAIN','reg-apk-note':'Registration needs the app with the face check (app.apk from this site; use the current version so that a rejection shows its objection code).',
  'btn-wc':'🔗 CONNECT WALLETCONNECT',
  'reg-log-hint':'// The app registers you by itself. The buttons above are only needed if a link with a finished proof brought you here.',
  'reg-details':'Registration Details','k-network':'Network','k-chainid':'Chain ID','k-grant':'UBI Grant',
  'k-fee':'Gas Fee','free':'0.1% protocol fee — no EVM gas','k-limit':'Registrations','k-limit-v':'Once per person · permanent · immutable',
  'k-bio':'Face','never-stored':'Photos discarded within seconds — each matching service keeps only a 64-byte sketch',
  'k-proof':'Proof System','k-conf':'Confirmation','k-conf-v':'Within 1 second (1 block)',
  'k-sybil':'Sybil Protection','k-sybil-v':'Beta: one identity per face · attestation required · threshold not yet calibrated',
  's-height':'Block Height',
  's-humans':'Verified Humans',
  's-supply':'Total Supply',
  's-uptime':'Uptime',
  ...
  'gini-calc-text':'All AEQ balances of verified humans are collected. The formula computes the mean absolute difference between every possible pair of balances, normalized by population squared (n²) and the mean balance (x̄). Result 0–1 multiplied by 100 = Aequitas Index. The node computes it from the live balances; after every daily basic-income payout a snapshot is stored for the history chart.',
  ...
  'pools-desc':'Transfer fees go 100% to UBI. Swap fees are split 40% validators / 30% liquidity providers / 30% UBI. The idle-money levy, the 2% exit levy and cap overflow go 100% to UBI. Nobody can pay out of a pool, not even with its key; only the protocol distributes, daily.',
  'vel-pool':'Validators Pool','vel-pool-desc':'40% of swap fees → every verified human who runs a validator gets an equal share, weighted only by the minutes their node was online that day.',
  'liq-pool':'Liquidity Pool','liq-pool-desc':'30% of swap fees → AEQ/tUSD liquidity providers, proportional to their LP share. Deeper liquidity = lower price impact for everyone.',
  'ubi-pool':'UBI Pool',
  'phases-title':'Protocol Phases',
  'phases-desc':'The cap for people uses a bootstrap multiplier during Phase 0: max(5, min(N, 25))× the fair share (1,000 AEQ per human). With 1–4 humans: 5× the fair share. Each new human adds 1×. At 25+ humans: locks permanently at 25× = 25,000 AEQ. All transitions trigger automatically by human count. The cap applies to people only: businesses have no fixed limit and pay the idle-money levy instead; other addresses may hold at most 1,000 AEQ.',
  ...
  'p3':'Maturity · 1M+ humans and Gini below 0.30 · Wealth Cap: 25× the fair share = 25,000 AEQ',
  'wealth-cap-explain':'The cap for people in Phase 0 (Bootstrap) is max(5, min(N, 25))× the fair share of 1,000 AEQ, where N = registered humans. 1–4 humans: 5×. Each new human adds 1×. 25+ humans: 25× = 25,000 AEQ, permanently. Businesses have no fixed cap (they pay the idle-money levy); other addresses hold at most 1,000 AEQ.',
  'demurrage-title':'Idle-money levy: an incentive to circulate',
  'demurrage-desc':'From 26 September 2026 money that sits idle pays a small levy that depends on the account type. Everyday life and normal saving stay untouched, and the levy goes 100% to the basic income.',
  'dem-rate-k':'Rates','dem-rate-v':'People: 0.5%/month above 5,000 AEQ · Businesses: 0.5%/month above 1.5 months\' turnover, 1% above 3 months\' turnover · Other addresses: 1%/month',
  ...
  'guard-text':'<p>What if someone cannot access their device for months? A trusted Guardian — another verified human — can confirm they are still alive, without any transaction rights.</p>',
  ...
  'dem-title':'3. IDLE-MONEY LEVY: Anti-Hoarding Mechanism',
  'dem-box':'People: 0.5%/month only on the part above 5,000 AEQ; everyday life and saving stay untouched<br>Businesses: up to 1.5 months\' turnover free (at least 2,000 AEQ), then 0.5%/month, above 3 months\' turnover 1%/month<br>Other addresses: 1%/month, at most 250 AEQ<br>Settled daily, 100% to the basic income (not burned)',
  'dem-text':'<p>Historical precedent: The Wörgl experiment (Austria, 1932) used a demurrage currency and reduced unemployment by 25% in one year. The Chiemgauer (Germany, 2003) has operated successfully for over 20 years using a similar mechanism.</p><p>These rules apply from 26 September 2026. Until then the previous rule holds: 0.5%/month on the part above the fair share after 3 months without activity.</p>',
  'cap-title':'4. WEALTH CAP — Mathematical Fairness','cap-box':'Cap for people: max(5,min(N,25))× the fair share (1,000 AEQ)<br>1–4 humans: 5× · +1× per human · 25+: 25× permanently<br>Excess instantly redistributed · Businesses: no fixed cap, idle-money levy instead · Other addresses: at most 250 AEQ',
  'ubi-title':'5. UNIVERSAL BASIC INCOME','ubi-box':'Sources: Transfer fees (100%) · Swap fees (30%) · Idle-money levy · Exit levy (2%) · Cap overflow · Inactive escrow<br><br>Daily: UBI Pool divided equally among all registered humans. Pool resets to zero after each distribution and refills continuously.',
  ...
  'usp-c1-title':'0.1% fee · no EVM gas','usp-c1-desc':'No ETH/MATIC gas to register. Transfers use a 0.1% protocol fee (live from the node) — not “zero cost forever.”',
  'usp-c2-title':'1,000 AEQ for every human','usp-c2-desc':'Billionaire or subsistence farmer — everyone gets exactly 1,000 AEQ. Not more, not less. The same start for everyone, fixed in the code.',
  ...
  'ubi-hero-sub-empty':'Pool empty since last 20:00 payout. It fills from transfer fees, swap fees (30% of 0.1%), the idle-money levy, the exit levy and cap overflow.',
  ...
  'ubi-src-swap':'30% Swap Fees','ubi-src-swap-d':'Every AEQ↔tUSD swap contributes 30% of its 0.1% fee here. More trading activity = faster pool fill.',
  'ubi-src-dem':'Idle-money levy','ubi-src-dem-d':'People above 5,000 AEQ (0.5%/month), businesses above 1.5 months\' turnover (0.5–1%/month) and other addresses (1%/month). Settled daily, 100% goes to UBI. From 26 Sep 2026.',
  'ubi-src-cap':'Wealth cap overflow','ubi-src-cap-d':'People above the cap (25× the fair share = 25,000 AEQ; lower while fewer than 25 humans are registered: 1,000 AEQ per human, at least 5,000) have the excess redistributed instantly. 100% flows to UBI. Businesses have no fixed cap.',
  'ubi-pool-desc':'100% of transfer fees + 30% of swap fees + 100% of the idle-money levy, exit levy and cap overflow → split equally among all verified humans every 24 hours.',
  'pools4-header':'THE THREE REDISTRIBUTION POOLS',
  'swap-title':'🔄 Swap AEQ ↔ tUSD',
  'swap-sub':'Exchange AEQ for tUSD (a simulated test-dollar) through the native liquidity pool. A 0.1% fee applies to swaps; ordinary AEQ transfers also carry a 0.1% protocol fee (no EVM gas).',
  ...
  'swap-ubi':'30% UBI','swap-validators':'40% Validators','swap-treasury':'0% Treasury',
  ...
  'v7-intro-text':'AequitasV7 is the protocol\'s EVM interface on chain ID 1926. Balances, registration, and fees are enforced by the Go L1; the contract is not the sole source of truth. Live transfers settle in the chain layer (no EVM gas; 0.1% protocol fee).',
'swap-sell-label':'Sell','swap-receive-label':'Receive',
  ...
  'faq-title':'❓ FAQ','faq-q1':'Is my biometric data safe?','faq-a1':'Your face is captured and sent to two independent matching services — that is the only way “one person, one account” can be checked at all. The photo and the full face description are discarded within seconds; they are not stored. What is kept is a 64-byte sketch (512 yes/no values): the face cannot be reconstructed from it, but it recognises a returning person, so it is treated as biometric data. One honest limit, stated rather than hidden: each service holds the whole sketch. A split mode in which no single service holds it whole is built and tested, not yet the binding check.',
  ...
  'faq-q2':'Can I register with a different wallet later?','faq-a2':'No. A registration is permanently bound to one wallet address. That is intentional: the nullifier derived from your face is spent exactly once, so registering again on another wallet would be a second identity for the same person.',
  'faq-q3':'What happens if I lose my phone?','faq-a3':'Your AEQ remains in your wallet — it is tied to your private key, not your phone. You can still access your wallet via MetaMask with your seed phrase. Your registration is tied to your face, not to the device, so a new phone does not cost you your registration.',
  'path-title':'Choose Your Path','path-human-title':'I am a Human','path-human-desc':'I want to register, receive 1,000 AEQ, and join the basic income network.','path-human-steps':'1. Download the Aequitas Android App<br>2. Take the short live face check in the app<br>3. Connect MetaMask<br>4. Receive 1,000 AEQ once the check passes',
...
de:{
  ...
  'x-phase-2-10-000-humans':'Phase 2 (ab 10.000 Menschen):',
  'x-phase-3-1m-humans-gini':'Phase 3 (ab 1 Mio. Menschen und Gini unter 0,30):',
  'nr-intro':'Derzeit läuft das Netz auf 2 aktiven Validatoren, jeder auf eigenem Server mit eigener Datenbank, mit MERGE-Ereignissen von beiden. Nur registrierte Menschen können Validator-Knoten betreiben — das ist eine Sicherheitsanforderung. Die Schritte unten sind Ziele, die an die Protokollphasen geknüpft sind: Das Protokoll bestimmt die Phase automatisch, setzt aber noch keine Mindestzahl an Knoten durch.',
  'nr-0':'Zwei unabhängige Contabo-Server, jeder mit eigener Datenbank und eigenem Proof-Server. Vertrauen durch offenen Code. Jeder registrierte Mensch kann schon jetzt als Validator beitreten — ohne Antrag, ohne Einsatz.',
  'nr-1':'Mehr unabhängige Knotenbetreiber; jeder erhält einen Anteil am Validator-Pool (40 % der Swap-Gebühren).',
  'nr-2':'Ziel: mindestens 10 unabhängige Knotenbetreiber.',
  'nr-3':'Ziel: ein vollständig dezentraler BlockDAG — kein einzelner Betreiber kann die Kette zensieren oder anhalten.',
  'nr-outro':'Die Anleitung für Knotenbetreiber (PDF) steht im Reiter Netzwerk. Jeder neue Knotenbetreiber verdient am Validator-Pool mit — je mehr Knoten, desto widerstandsfähiger das Netz.',
  ...
  'bv-desc':'Ein Validator sichert, dass die <strong style="color:var(--text)">Zahlen stimmen</strong>. Er sichert nicht das eine, worauf alles andere ruht: dass sich <strong style="color:var(--text)">niemand zweimal anmeldet</strong>. Ohne das ist „ein Mensch, ein Einkommen“ nur ein Spruch — das Hauptbuch wäre vollkommen richtig und vollkommen wertlos. Heute hängt diese Zusage an sehr wenigen Maschinen, und jede weitere macht sie schwerer zu brechen. Die beiden Rollen, die sie tragen — der <strong style="color:var(--text)">Verifier</strong>, der entscheidet, ob ein Gesicht schon eingeschrieben ist, und der <strong style="color:var(--text)">Coordinator</strong>, der diese Entscheidungen einsammelt — laufen auf demselben Server. Diese Anleitung richtet beide ein.',
  'bv-guide-sub':'Schritt für Schritt · Keine Kryptokenntnisse nötig · Etwa 45 Minuten, meist Wartezeit',
  'bv-honest-d':'Dieser Teil ist Beta, und die Grenzen sind echt. Der gemeinsame Vergleich verbraucht kryptografisches Einwegmaterial, und eine Lieferung reicht derzeit für einige Dutzend Registrierungen, bevor Nachschub nötig ist — der vertrauliche Weg bewährt sich also zuerst im Kleinen, nicht bei Millionen. Der Aufwand wächst außerdem mit der Zahl der Eingeschriebenen. Wir veröffentlichen diese Zahlen, statt sie zu runden: ein System, das nach Ihrem Gesicht fragt, hat kein Recht darauf, unklar zu bleiben, was es kann und was noch nicht.',
  'bv-honest-t':'Wo das heute steht — unverblümt',
  'bv-status-d':'Der Quelltext des Verifiers ist <strong style="color:var(--text)">noch nicht öffentlich</strong>, die Schritte unten kann heute also nicht jeder gehen. Sie stehen trotzdem schon hier, weil ein Entwurf prüfbar sein sollte, bevor er läuft, nicht danach. Wer einen betreiben möchte, meldet sich in der Telegram-Gruppe von der Startseite. Dieses Repository zu öffnen ist das, was den Leitfaden von einem Plan zu einer Einladung macht — und es ist das Nächste, was wir Ihnen schulden.',
  'bv-status-t':'Stand: geschlossene Beta — bitte vor dem Anfangen lesen',
  'bv-title':'Ein Validator allein genügt nicht — und das ist der Grund',
  'bv-guide-lang-note':'Die Schritte unten sind auf Englisch. Die Abschnitte darüber — worum es geht, was geschützt wird und wofür Sie einstehen — stehen in Ihrer Sprache.',
  'bv-what-d':'Ein Gesicht kommt nie als Bild bei Ihnen an: Das Bild wird nach der Prüfung verworfen, und Ihre Maschine speichert nur einen 64-Byte-Auszug davon (512 Ja/Nein-Werte) — genug, um einen Wiederkehrer zu erkennen, zu wenig, um ein Gesicht nachzubauen. Es gibt einen geteilten Modus, in dem Ihre Maschine nur einen additiven Anteil dieses Auszugs hielte — für sich allein nicht von Rauschen zu unterscheiden, gemeinsam mit Ihrem Komitee verglichen, sodass niemand mehr erfährt als die Antwort. Er ist gebaut und getestet, aber <strong style="color:var(--text)">noch nicht aktiv</strong>, weil seine Schwelle nie kalibriert wurde. Bis dahin hält jeder Verifier den ganzen Auszug, und das sagen wir lieber, als einen Schutz anzudeuten, den Sie noch nicht geben.',
  'bv-what-t':'Was Sie halten würden — und was Sie nie zu sehen bekommen',
  ...
  'x-0-1-split-40-30':'0,1 % · Aufteilung 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10.000 &#8211; 1 Mio. Menschen. Ziel: mindestens 10 unabhängige Knotenbetreiber.',
  'x-100-8211-10-000-humans':'100 &#8211; 10.000 Menschen. Obergrenze 25×. Ziel: mehr unabhängige Knotenbetreiber.',
  'x-100-maximum-concentration':'100 = maximale Konzentration',
  'x-1m-humans-global-ubi-at':'Ab 1 Mio. Menschen und Gini unter 0,30 — beides muss erfüllt sein. Globales Grundeinkommen im großen Maßstab.',
  
  
  
  'x-active-validators':'Aktive Validatoren',
  'x-add-aequitas-chain-to-metamask':'Fügen Sie die Aequitas-Chain zu MetaMask hinzu, um Ihr AEQ-Guthaben zu sehen, Überweisungen zu senden und direkt aus Browser oder Handy-Wallet mit dem V7-Vertrag zu arbeiten.',
  ...
  'x-aequitas-chain':'Aequitas Chain',
  'x-aequitas-chain-blockdag':'Aequitas-Chain (BlockDAG)',
  'x-aequitas-implements-this-mathematically-ever':'Aequitas setzt das mathematisch um. Jeder verifizierte Mensch erhält genau 1.000 AEQ — Milliardär oder Kleinbauer, ohne Ausnahme. Feste Regeln — Liegegeld, Vermögensdeckel und tägliches Grundeinkommen — verhindern, dass sich Ungleichheit unbegrenzt anhäuft. Der Gini-Koeffizient wird aus den aktuellen Guthaben berechnet und ist für jeden überprüfbar.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'Vergleichbar mit den USA (~0,41) oder Frankreich (~0,32). Im Bereich der meisten entwickelten Volkswirtschaften.',
  ...
  'x-demurrage-0-5-mo':'Liegegeld (0,5–1 %/Monat)',
  ...
  'co-pernode-d':'Eine Autorisierung, die auf einem Knoten steht, wandert nicht zu den anderen — es gibt dafür weder Transaktion noch Gossip. Eine replizierte Vertrauensliste wäre genau die zentrale Instanz, ohne die dieses System gebaut ist: jeder Betreiber entscheidet selbst, wessen Bescheinigungen sein Knoten annimmt. Der Preis ist, dass Ihre Autorisierung an jeden Knoten muss, der sie gelten lassen soll. Die Unterschrift selbst ist übertragbar — einmal unterschreiben, überallhin senden; ein übersprungener Knoten weist Sie einfach weiter ab.',
  'co-law-t':'Was Sie über andere Menschen erfahren — und was daraus folgt',
  'co-law-d':'Die Aufnahme läuft durch Sie hindurch; Sie reichen sie weiter und behalten nichts. Aber Sie allein kennen die Zuordnung von Wallet-Adresse und Marker für die Menschen, die über Sie registrieren — darum muss Ihr Marker-Schlüssel Ihrer bleiben: geteilt könnte jeder Betreiber zu jeder öffentlichen Adresse den Marker ausrechnen und nachschlagen, wessen Gesicht dazugehört. Es heißt außerdem, dass Sie für diese Menschen <strong style="color:var(--text)">datenschutzrechtlich Verantwortlicher</strong> werden. Nicht wir. Auskunft, Löschung und Widerspruch laufen bei Ihnen auf, und das ist keine Formalie.',
  'co-limit-t':'Die eine Einschränkung, die daraus folgt',
  'co-limit-d':'Löschung über die Wallet-Adresse findet nur der Coordinator, bei dem die Einschreibung entstanden ist: Ihr Marker hängt an Ihrem Schlüssel, ein anderer Coordinator leitet für dieselbe Adresse einen anderen ab. Ein „nicht gefunden" von woanders heißt deshalb „nicht hier registriert", nicht „nicht registriert" — und die Antwort sagt das auch. Der Weg über die eigene bio_hash, derjenige, der dem Menschen selbst gehört und keinen Betreiber braucht, funktioniert bei jedem Coordinator, weil diese Kennung dieselbe bleibt.',
  ...
  'x-hash-wallet':'Hash / Wallet',
  'x-healthier-than-most-nations-on':'Gesünder als die meisten Länder der Erde. Vergleichbar mit Skandinavien (~0,27) und Deutschland (~0,31).',
  'x-higher-than-most-european-nations':'Höher als in den meisten europäischen Ländern — vergleichbar mit Brasilien (~0,53). Die Regeln ändern sich nicht mit dem Index; Liegegeld und Vermögensdeckel wirken ständig.',
  'x-honest-limitation':'Ehrliche Einschränkung:',
  'x-why-sybil-resistance':'Warum Sybil-Resistenz?','x-how-it-works':'Wie es funktioniert',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'Zufallswert, ausgestellt nach der Gesichtsprüfung (nicht aus dem Gesicht abgeleitet)',
  ...
  'x-phase-transitions-are-automatic-8212':'Das Protokoll bestimmt die Phase automatisch — Phase 0 bis 2 nach der Zahl der Menschen, Phase 3 erst bei 1 Mio. Menschen und einem Gini unter 0,30. Keine Governance-Abstimmung, kein Admin-Schlüssel. Die Phase ist ein Status: Vermögensobergrenze und Liegegeld hängen nicht davon ab, und die Knoten-Ziele setzt noch kein Code durch.',
  'x-postgresql-persistent':'PostgreSQL (dauerhaft)',
  'x-protocol-v7':'📜 Protocol V7',
  'x-provide-aeq-tusd-liquidity-to':'Stellen Sie AEQ/tUSD-Liquidität bereit und erhalten Sie 30 % aller Tauschgebühren, täglich ausgeschüttet.',
  ...
  'x-swap-fees-0-1':'Überweisungs- & Swap-Gebühren (0,1 %)',
  'x-sybil-resistance-8212-current-state':'Sybil-Abwehr &#8212; der ehrliche Stand',
  'x-the-4-redistribution-mechanisms':'Die drei Umverteilungs-Töpfe',
  ...
  'x-ubi-pool-20':'Grundeinkommens-Topf',
  ...
  'x-worse-than-any-country-on':'Schlechter als jedes Land der Erde (Rekord Südafrika: ~0,63). Nähert sich Bitcoin (~0,85). Mit wenigen registrierten Menschen passiert das schnell; die Regeln bleiben dieselben.',
  ...
  'reg-sub':'Treten Sie dem Aequitas-Netz bei und erhalten Sie Ihren 1.000-AEQ-Startzuschuss. Die Registrierung ist einmalig und dauerhaft. Sie ist in der Beta: geprüft, mit benannten Grenzen — siehe Beta-Hinweis unten.',
  'app-title':'REGISTRIERUNG NUR ÜBER ANDROID-APP',
  'app-text':'Die Registrierung läuft nur in der Android-App: eine kurze Gesichtsaufnahme, geprüft von zwei unabhängigen Vergleichsdiensten. Danach werden <strong style="color:var(--gold)">1.000 AEQ automatisch gutgeschrieben</strong>. Was gespeichert wird und was nicht: Schritt 1 und der Beta-Hinweis unten.',
  's1t':'Verbinden','s1d':'Die App nimmt Ihr Gesicht und eine kurze Lebendigkeitsfolge auf (Blinzeln, Blick zu einer zufälligen Seite, Farbblitze) und schickt sie an zwei unabhängige Vergleichsdienste. Diese vergleichen das Gesicht mit allen, die mit Gesicht registriert sind. Das Foto wird nach Sekunden verworfen; nur ein 64-Byte-Auszug bleibt.',
  's2t':'Beweisen','s2d':'Ein Groth16-ZK-Beweis bindet Ihre bio_hash in ein Commitment (Poseidon aus bio_hash, Wallet und einem Salz), ohne sie preiszugeben. Der Proof-Server stellt ihn nur mit der Wallet-Bindung und den signierten Bescheinigungen der beiden Dienste aus, und der Nullifier lässt sich genau einmal verbrauchen — dasselbe Gesicht zählt nicht zweimal.',
  's3t':'Erhalten','s3d':'Registrierung auf Aequitas BlockDAG innerhalb von 1 Sekunde bestätigt · 1.000 AEQ sofort gutgeschrieben · Ihre Identität ist dauerhaft als verifizierter Mensch gespeichert',
  'priv-bar':'🔒 Beta · Gesichtsprüfung durch 2 unabhängige Dienste · 2 signierte Bescheinigungen Pflicht · Groth16-ZKP · Nur ein 64-Byte-Auszug bleibt',
  'conn-wallet':'VERBUNDENE WALLET','proof-recv':'⚡ ZK-BEWEIS EMPFANGEN','proof-hint':'Wallet verbinden um zu registrieren',
  'btn-conn':'🦊 METAMASK VERBINDEN','btn-reg':'🔐 ON-CHAIN REGISTRIEREN','reg-apk-note':'Die Registrierung braucht die App mit Gesichtsprüfung (app.apk von dieser Seite; nehmen Sie die aktuelle Version, damit eine Abweisung ihre Widerspruchs-Kennung zeigt).',
  'btn-wc':'🔗 WALLETCONNECT VERBINDEN',
  'reg-log-hint':'// Die App registriert Sie selbst. Die Knöpfe oben brauchen Sie nur, wenn ein Link mit fertigem Beweis Sie hierher gebracht hat.',
  'reg-details':'Registrierungsdetails','k-network':'Netzwerk','k-chainid':'Chain-ID','k-grant':'UBI-Zuteilung',
  'k-fee':'Gasgebühr','free':'0,1 % Protokollgebühr — kein EVM-Gas','k-limit':'Registrierungen','k-limit-v':'Einmal pro Mensch · permanent · unveränderlich',
  'k-bio':'Gesicht','never-stored':'Fotos nach Sekunden verworfen — jeder Vergleichsdienst behält nur einen 64-Byte-Auszug',
  'k-proof':'Beweissystem','k-conf':'Bestätigung','k-conf-v':'Innerhalb von 1 Sekunde (1 Block)',
  'k-sybil':'Sybil-Schutz','k-sybil-v':'Beta: eine Identität pro Gesicht · Bescheinigung Pflicht · Schwelle noch nicht kalibriert',
  's-height':'Blockhöhe',
  's-humans':'Verifizierte Menschen',
  's-supply':'Gesamtmenge',
  's-uptime':'Laufzeit',
  ...
  'reg-humans':'Registrierte Menschen','h-desc':'Jede Adresse unten ist ein registrierter Mensch mit genau 1.000 AEQ Gutschrift. Seit dem 25.08.2026 durchläuft jede Registrierung eine Gesichtsprüfung gegen alle seitdem erfolgten Registrierungen durch unabhängige Dienste, belegt mit einem ZK-Beweis; Konten von vor diesem Datum wurden ohne Gesichts-Template registriert — eine bekannte, begrenzte Ausnahme. Das Register ist dauerhaft, unveränderlich und on-chain.',
  'no-humans':'Noch keine Menschen registriert.\n\nLaden Sie die Aequitas Android App herunter und seien Sie der erste Mensch auf der Chain!',
  ...
  'gini-what-text':'Entwickelt vom italienischen Statistiker Corrado Gini (1912). Misst die Vermögensverteilung durch Vergleich mit einer perfekt gleichen Verteilung — visualisiert als Lorenz-Kurve. Skala: 0 (alle halten gleich viel) bis 1 (eine Person hält alles). Genutzt von Weltbank, OECD, UN. Referenzwerte: Bitcoin ≈ 0,85 · Südafrika (Weltrekord) ≈ 0,63 · USA ≈ 0,41 · Deutschland ≈ 0,31 · Schweden ≈ 0,27 · Aequitas-Langzeitziel: Gini unter 0,30 — vergleichbar mit Skandinavien und Deutschland, durchgesetzt durch den Vermögensdeckel (Bootstrap: gleitender Deckel 5×→25× pro Mensch). Phase 3 (Reife) wird erst mit 1 Mio. Menschen und einem Gini unter 0,30 erreicht.',
  'gini-calc-title':'Wie wird der Aequitas-Index berechnet?',
  'gini-calc-text':'Alle AEQ-Guthaben verifizierter Menschen werden erfasst. Die Formel berechnet die mittlere absolute Differenz zwischen allen möglichen Paaren von Guthaben, normiert mit der Bevölkerung zum Quadrat (n²) und dem mittleren Guthaben (x̄). Ergebnis 0–1 mal 100 = Aequitas-Index. Der Knoten berechnet ihn aus den aktuellen Guthaben; nach jeder täglichen Grundeinkommens-Auszahlung wird ein Stand für den Verlaufsgraphen gespeichert.',
  'gini-why-title':'Warum Gini — und nicht eine einfachere Kennzahl?',
  'gini-why-text':'Ein einfaches Verhältnis „Reichste zu Ärmste“ lässt sich leicht austricksen: 10.000 Wallets könnten eine geringe Spanne zeigen, während 90 % der AEQ in 100 Händen liegen — der Gini erkennt das, ein Verhältnis nicht. Er erfasst die gesamte Verteilung über alle verifizierten Menschen in einer Zahl, die jeder nachrechnen kann. Er ist eine Messung, kein Stellhebel: Phasen und Vermögensdeckel richten sich nach der Zahl registrierter Menschen, und die Umverteilungsregeln stehen fest im Protokoll. Niemand kann den Messwert verändern.',
  ...
  'pools-desc':'Überweisungsgebühren gehen zu 100 % ins UBI. Swap-Gebühren werden aufgeteilt: 40 % Validatoren / 30 % Liquiditätsgeber / 30 % UBI. Liegegeld, die Ausstiegsabgabe von 2 % und Überschüsse über der Grenze gehen zu 100 % ins UBI. Niemand kann aus einem Topf auszahlen, auch nicht mit dessen Schlüssel; nur das Protokoll verteilt, täglich.',
  'vel-pool':'Validatoren-Pool',
  'liq-pool':'Liquiditäts-Pool',
  'ubi-pool':'UBI-Pool',
  'phases-title':'Protokollphasen',
  'phases-desc':'Die Grenze für Menschen nutzt in Phase 0 einen Startmultiplikator: max(5, min(N, 25))× den fairen Anteil (1.000 AEQ pro Mensch). Bei 1–4 Menschen: 5× der faire Anteil. Jeder neue Mensch fügt 1× hinzu. Ab 25 Menschen: dauerhaft 25× = 25.000 AEQ. Alle Übergänge laufen automatisch nach Anzahl der Menschen. Die Grenze gilt nur für Menschen: Unternehmen haben keine feste Grenze und zahlen stattdessen Liegegeld; sonstige Adressen halten höchstens 1.000 AEQ.',
  ...
  'p3':'Reife · ab 1 Mio. Menschen und Gini unter 0,30 · Vermögensobergrenze: 25× Fair Share = 25.000 AEQ',
  'wealth-cap-explain':'Die Grenze für Menschen in Phase 0 (Start) ist max(5, min(N, 25))× der faire Anteil von 1.000 AEQ, wobei N = registrierte Menschen. 1–4 Menschen: 5×. Jeder neue Mensch fügt 1× hinzu. Ab 25 Menschen: dauerhaft 25× = 25.000 AEQ. Unternehmen haben keine feste Grenze (sie zahlen Liegegeld); sonstige Adressen halten höchstens 1.000 AEQ.',
  'demurrage-title':'Liegegeld: ein Anreiz zum Umlauf',
  'demurrage-desc':'Ab 26. September 2026 zahlt Geld, das liegen bleibt, eine kleine Abgabe, die von der Kontoart abhängt. Alltag und normales Sparen bleiben unberührt, und die Abgabe geht zu 100 % ins Grundeinkommen.',
  'dem-rate-k':'Sätze','dem-rate-v':'Menschen: 0,5 %/Monat über 5.000 AEQ · Unternehmen: 0,5 %/Monat über 1,5 Monatsumsätzen, 1 % über 3 Monatsumsätzen · Sonstige Adressen: 1 %/Monat',
  ...
  'bootstrap-title':'Neuen Node verbinden','bootstrap-desc':'Für einen eigenen Aequitas-Node ist kein Einstiegspunkt zu konfigurieren — die Validator-Adressen sind fest eingebaut. Ihr Node registriert sich automatisch, synchronisiert den vollständigen Chain-Zustand und nimmt an der Blockproduktion teil. PRIMARY_NODE_URL nur setzen, wenn Sie bewusst einen bestimmten Einstiegspunkt festlegen wollen.',
  ...
  'ca-desc':'AequitasV7 stellt die on-chain Register-Oberfläche bereit (Nullifier, Registrierungen, Vermögensobergrenze und Demurrage-Parameter). Salden, Register und Fees setzt die Go-L1 durch; der Contract ist die EVM-Schnittstelle, nicht die alleinige Wahrheit. Live-Transfers verbucht der Chain-Layer: der Knoten fängt den ERC-20-Aufruf ab, bevor er die EVM erreicht, und schreibt ins Go-Ledger — sekundenschnell, kein EVM-Gas, 0,1 % Protokollgebühr.<br><br>Der BioVerifier-Contract empfängt Groth16-Zero-Knowledge-Beweise die vollständig auf dem Android-Gerät des Nutzers erzeugt werden. Er verifiziert mathematisch on-chain in ~10 ms dass der eingereichte Nullifier korrekt aus einem Geheimnis des Registrierenden abgeleitet wurde, und die Kette weist jeden bereits gesehenen Nullifier ab — ohne jemals seinen Namen, seine Identität oder seine biometrischen Daten zu erfahren. Das schließt eine zweite Anmeldung aus derselben Identitätsquelle aus (Beta: der Nullifier ist gesichtsgebunden, und der Proof-Server verlangt die signierte Bescheinigung des Vergleichs-Quorums). Registrierung braucht kein EVM-Gas; Transfers tragen 0,1 % Protokollgebühr — der Beweis ist das, was das Gerät verlässt.<br><br>Genau diese Kombination ist das Neue: Die Regeln und das Identitätsquellen-Nullifier-Register liegen in einem Contract, den der Betreiber nicht beiläufig umschreiben kann, und der Code, der sie ausführt, ist offen und aus diesem Repository reproduzierbar. Alles davon ist von jedem überprüfbar. Vertrauen erfordert weiterhin der Betrieb der Knoten selbst, und der ehrliche Weg, das zu verringern, sind mehr unabhängige Validatoren — nicht ein stärkerer Satz an dieser Stelle.',
  ...
  'h-zkp':'Zero-Knowledge-Proof-System','h-zkp-t':'Aequitas nutzt Groth16 auf BN128 — dieselbe Kurve wie Ethereum und Zcash. Beweis: ~200 Byte. Prüfung: ~10 ms. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). Der Nullifier stammt vom Gesicht, nicht vom Telefon: ein zweites Gerät hilft demselben Menschen nicht zu einer zweiten Anmeldung, und ein verlorenes Telefon kostet die Registrierung nicht. Poseidon statt Multiplikation, weil der Nullifier der früheren Schaltung umkehrbar war — jeder hätte daraus den bioHash zurückrechnen können.',
  'h-sybil':'Sybil-Resistenz — Aktueller Stand','h-sybil-t':'Seit dem 25.08.2026 weist der Proof-Server eine Registrierung ohne die signierten Bescheinigungen der beiden Vergleichsdienste ab — dasselbe Gesicht lässt sich also nicht zweimal registrieren, auch nicht über verschiedene Geräte, was ein Geräteschlüssel nie konnte. Zwei benannte Grenzen: Konten von vor diesem Datum sind erst erfasst, wenn ihr Inhaber das Gesicht in der App nachzieht, und die Vergleichsschwelle ist nicht an echten Aufnahmen kalibriert: Die Kryptografie ist exakt, die Biometrie darunter eine Messung, deren Fehlerrate nicht beziffert ist. Lebendigkeit: Verbindlich ist heute nur die Blick-Aufgabe; Farbblitze, Puls und Parallaxe werden gemessen und entscheiden nach der Kalibrierung mit.',
  ...
  'h-bio-hw':'Identitätsverifikation — Roadmap','h-bio-hw-t':'Heute (Beta): eine Gesichtsprüfung durch zwei unabhängige Vergleichsdienste, die beide zustimmen müssen, und ein Proof-Server, der Registrierungen ohne ihre signierten Bescheinigungen abweist. Gespeichert wird nur ein 64-Byte-Auszug, nie das Foto oder ein ganzes Template. Die Schwelle ist noch nicht an echten Aufnahmen kalibriert — dafür braucht es etwa 1000 Impostor-Paare, bevor irgendeine Zahl genannt wird. Geplant: diese Kalibrierung, verbindliche Lebendigkeit aus den Signalen, die schon gemessen werden (Farbblitze, Puls, Parallaxe), ein gestaffelter Zuschuss bei unsicheren Aufnahmen und eine Duplikatprüfung, bei der kein Dienst auch nur den ganzen Auszug hält. Langfristig setzt Aequitas auf den Iris-Scan, um wirklich 1 Mensch = 1 Registrierung zu gewährleisten. Wie das zuverlässig und datenschutzfreundlich umgesetzt werden kann, daran wird derzeit gearbeitet; Hardware und Zeitplan stehen noch nicht fest.',
  ...
  'dem-title':'3. LIEGEGELD: Schutz gegen Horten',
  'dem-box':'Menschen: 0,5 %/Monat nur auf den Teil über 5.000 AEQ; Alltag und Sparen bleiben unberührt<br>Unternehmen: bis 1,5 Monatsumsätze frei (mindestens 2.000 AEQ), dann 0,5 %/Monat, über 3 Monatsumsätzen 1 %/Monat<br>Sonstige Adressen: 1 %/Monat, höchstens 250 AEQ<br>Täglich verrechnet, 100 % ins Grundeinkommen (nicht vernichtet)',
  'dem-text':'<p>Historische Vorbilder: Das Wörgl-Experiment (Österreich, 1932) nutzte Schwundgeld und senkte die Arbeitslosigkeit in einem Jahr um 25 %. Der Chiemgauer (Deutschland, 2003) läuft seit über 20 Jahren erfolgreich mit einem ähnlichen Mechanismus.</p><p>Diese Regeln gelten ab 26. September 2026. Bis dahin gilt die bisherige Regel: 0,5 %/Monat auf den Teil über dem fairen Anteil nach 3 Monaten ohne Aktivität.</p>',
  'cap-title':'4. VERMÖGENSOBERGRENZE — Mathematische Fairness-Durchsetzung','cap-box':'Grenze für Menschen: max(5,min(N,25))× der faire Anteil (1.000 AEQ)<br>1–4 Menschen: 5× · +1× pro Mensch · ab 25: dauerhaft 25×<br>Überschuss wird sofort umverteilt · Unternehmen: keine feste Grenze, dafür Liegegeld · Sonstige Adressen: höchstens 250 AEQ',
  'ubi-title':'5. UNIVERSELLES GRUNDEINKOMMEN — Tägliche Umverteilung','ubi-box':'Quellen: Überweisungsgebühren (100 %) · Swap-Gebühren (30 %) · Liegegeld · Ausstiegsabgabe (2 %) · Überschuss über der Grenze · Inaktivitäts-Treuhand<br><br>Täglich: Der UBI-Topf wird zu gleichen Teilen an alle registrierten Menschen verteilt. Danach steht er auf null und füllt sich laufend neu.',
  ...
  'swap-sub':'Tauschen Sie AEQ gegen tUSD (ein simulierter Test-Dollar) über den nativen Liquiditäts-Pool. 0,1% Gebühr für Swaps; gewöhnliche AEQ-Transfers tragen ebenfalls 0,1 % Protokollgebühr (kein EVM-Gas).',
  'swap-priv-bar':'🔒 0,1% Swap-Gebühr · AEQ-Transfers 0,1 % Protokollgebühr (kein EVM-Gas) · tUSD Testwährung ohne realen Wert',
  ...
  'swap-addliq-title':'Liquidität bereitstellen','swap-addliq-desc':'Zahlen Sie als Erste oder Erster ein — Ihr Verhältnis legt den Startpreis fest.',
  ...
  'swap-lp-pct-label':'% Ihrer Position','swap-lp-youget':'Sie erhalten','swap-btn-removeliq':'🔥 LIQUIDITÄT ENTFERNEN',
  ...
  'amm-text':'Wenn Sie AEQ gegen tUSD tauschen, wächst die AEQ-Reserve und die tUSD-Reserve schrumpft — ihr Produkt bleibt immer gleich k. Jeder Swap bewegt den Preis. Größere Swaps relativ zur Pool-Größe führen zu größerer Preisauswirkung. Die 0,1% Gebühr wird vor Anwendung der Formel abgezogen — so verdient der Pool an jedem Trade.',
  'swap-fee-bps':'Swap-Gebühr',
  'swap-pools-addr-title':'Tokenomics-Pool-Adressen',
  'swap-validators':'Validatoren (40%)','swap-lps':'Liquiditätsanbieter (30%)','swap-ubi':'UBI-Pool (30%)','swap-treasury':'Schatzkammer (0%)',
  ...
  'ubi-hero-sub-empty':'Topf leer seit der letzten Ausschüttung um 20:00. Er füllt sich aus Überweisungsgebühren, Swap-Gebühren (30 % von 0,1 %), Liegegeld, Ausstiegsabgabe und Überschüssen über der Grenze.',
  ...
  'ubi-src-swap':'Swap-Gebühren','ubi-src-swap-d':'Jeder AEQ↔tUSD-Swap trägt 30% seiner 0,1% Gebühr bei. Mehr Handelsaktivität = schnelleres Auffüllen.',
  'ubi-src-dem':'Liegegeld','ubi-src-dem-d':'Menschen über 5.000 AEQ (0,5 %/Monat), Unternehmen über 1,5 Monatsumsätzen (0,5–1 %/Monat) und sonstige Adressen (1 %/Monat). Täglich verrechnet, 100 % gehen ins UBI. Ab 26. Sept. 2026.',
  'ubi-src-cap':'Vermögensobergrenze-Überschuss','ubi-src-cap-d':'Bei Menschen über dem Deckel (25× der faire Anteil = 25.000 AEQ; niedriger, solange weniger als 25 Menschen registriert sind: 1.000 AEQ je Mensch, mindestens 5.000) wird der Überschuss sofort umverteilt. 100 % fließen ins Grundeinkommen. Unternehmen haben keinen festen Deckel.',
  'pools4-header':'Die drei Umverteilungs-Pools',
  'vel-pool-desc':'40 % der Swap-Gebühren → jeder verifizierte Mensch, der einen Validator betreibt, bekommt den gleichen Anteil – gewichtet nur nach den Minuten, die sein Knoten an dem Tag online war.',
  'liq-pool-desc':'30 % der Swap-Gebühren → Anbieter von AEQ/tUSD-Liquidität, anteilig nach ihrem LP-Anteil. Tiefere Liquidität = geringere Preisauswirkung für alle.',
  'ubi-pool-desc':'100 % der Überweisungsgebühren + 30 % der Swap-Gebühren + 100 % von Liegegeld, Ausstiegsabgabe und Überschuss über der Grenze → alle 24 Stunden zu gleichen Teilen an alle verifizierten Menschen.',
  'ubi-see-above':'siehe Countdown oben','ubi-timer-above':'⏰ Countdown oben angezeigt',
  ...
  'usp-c1-title':'0,1 % Gebühr · kein EVM-Gas','usp-c1-desc':'Kein ETH/MATIC-Gas zur Registrierung. Transfers: 0,1 % Protokollgebühr (live vom Node) — nicht „kostenlos für immer“.',
  'usp-c2-title':'1.000 AEQ für jeden Menschen','usp-c2-desc':'Millionär oder Subsistenzlandwirt — jeder erhält exakt 1.000 AEQ. Nicht mehr, nicht weniger. Der gleiche Start für alle, im Code festgelegt.',
  'usp-c3-title':'Für alle zugänglich','usp-c3-desc':'Kein Bankkonto, keine Kreditkarte, kein Ausweis, keine zusätzliche Hardware — nur die Kamera, die Ihr Android-Telefon ohnehin hat.',
  'usp-c4-title':'Täglich UBI empfangen','usp-c4-desc':'Nach der Registrierung erhalten Sie automatisch täglich einen Anteil der UBI-Ausschüttung — jeden Tag, ohne Aktion, solange Sie AEQ halten.',
  'v7-intro-title':'Was ist AequitasV7?',
  'v7-intro-text':'AequitasV7 ist die EVM-Schnittstelle des Protokolls auf Chain ID 1926. Salden, Register und Fees setzt die Go-L1 durch — der Contract ist nicht die alleinige Wahrheit. Live-Transfers werden vom Chain-Layer verbucht (kein EVM-Gas, 0,1 % Protokollgebühr).',
  ...
  'guard-set-lbl':'Guardian festlegen / ändern','guard-set-hint':'Muss ein registrierter Aequitas-Mensch sein · 7-Tage-Zeitsperre · Guardian kann nur Ihre Lebendigkeit bestätigen, nicht auf Guthaben zugreifen · Max. 3 Schützlinge pro Guardian',
  'guard-confirm-lbl':'Lebendig bestätigen (Als Guardian)','guard-confirm-hint':'Falls Ihr Schützling keinen Zugang zu seiner Wallet hat, bestätigen Sie seine Lebendigkeit, um zu verhindern, dass Gelder nach 910 Tagen Inaktivität ins Escrow überführt werden.','guard-recover-btn':'🔓 AUS ESCROW ZURÜCKFORDERN',
  'faq-title':'❓ FAQ','faq-q1':'Sind meine biometrischen Daten sicher?','faq-a1':'Ihr Gesicht wird aufgenommen und an zwei unabhängige Vergleichsdienste geschickt — nur so lässt sich „ein Mensch, ein Konto“ überhaupt prüfen. Foto und vollständige Gesichtsbeschreibung werden nach Sekunden verworfen, nicht gespeichert. Was bleibt, ist ein 64-Byte-Auszug (512 Ja/Nein-Werte): Aus ihm lässt sich das Gesicht nicht rekonstruieren, er erkennt aber einen Wiederkehrer, deshalb gilt er als biometrisches Datum. Eine ehrliche Grenze, genannt statt versteckt: Jeder Dienst hält den ganzen Auszug. Ein geteilter Modus, in dem kein einzelner Dienst ihn ganz hat, ist gebaut und getestet, aber noch nicht die verbindliche Prüfung.',
  'faq-q1b':'Beweist die Registrierung, dass ich ein einzigartiger echter Mensch bin?','faq-a1b':'Besser, als ein Geräteschlüssel es je konnte, und noch nicht als Zahl belegbar. Seit dem 25.08.2026 vergleichen zwei unabhängige Dienste das Gesicht, die beide zustimmen müssen, und der Proof-Server weist eine Registrierung ohne ihre signierten Bescheinigungen ab — derselbe Mensch auf einem zweiten Telefon wird also erkannt, was ein Geräteschlüssel nie konnte. Zwei benannte Grenzen: Konten von vor diesem Datum sind erst erfasst, wenn ihr Inhaber das Gesicht in der App nachzieht (ohne neuen Zuschuss), und die Fehlerrate steht nicht fest: Die Schwelle ist nicht an echten Aufnahmen kalibriert, dafür braucht es etwa 1.000 Impostor-Paare. Lebendigkeit: Verbindlich ist heute nur die Blick-Aufgabe; stärkere Signale werden gemessen und kalibriert. Langfristig setzt Aequitas auf den Iris-Scan, um wirklich 1 Mensch = 1 Registrierung zu gewährleisten. Wie das zuverlässig und datenschutzfreundlich umgesetzt werden kann, daran wird derzeit gearbeitet; Hardware und Zeitplan stehen noch nicht fest.',
  'faq-q2':'Kann ich mich später mit einer anderen Wallet registrieren?','faq-a2':'Nein. Eine Registrierung ist dauerhaft an eine Wallet-Adresse gebunden. Das ist Absicht: der aus Ihrem Gesicht abgeleitete Nullifier wird genau einmal verbraucht; eine erneute Registrierung auf eine andere Wallet wäre eine zweite Identität für dieselbe Person.',
  'faq-q3':'Was passiert, wenn ich mein Handy verliere?','faq-a3':'Ihre AEQ bleiben in Ihrem Wallet — sie hängen an Ihrem privaten Schlüssel, nicht an Ihrem Handy. Sie erreichen Ihr Wallet weiterhin über MetaMask mit Ihrer Seed-Phrase. Ihre Registrierung hängt an Ihrem Gesicht, nicht am Gerät; ein neues Handy kostet Sie also nicht Ihre Registrierung.',
  'path-title':'Wählen Sie Ihren Weg','path-human-title':'Ich bin ein Mensch','path-human-desc':'Ich möchte mich registrieren, 1.000 AEQ erhalten und dem Grundeinkommensnetzwerk beitreten.','path-human-steps':'1. Aequitas Android App herunterladen<br>2. In der App die kurze Live-Gesichtsprüfung machen<br>3. MetaMask verbinden<br>4. 1.000 AEQ erhalten, sobald die Prüfung bestanden ist',
...
es:{
  ...
  'x-phase-2-10-000-humans':'Fase 2 (más de 10.000 personas):',
  'x-phase-3-1m-humans-gini':'Fase 3 (más de 1 M de personas y Gini &lt; 0,30):',
  'nr-intro':'Actualmente la red funciona con 2 validadores activos, cada uno en su propio servidor con su propia base de datos, con eventos MERGE de ambos. Solo personas registradas pueden operar nodos validadores; es un requisito de seguridad. Los pasos siguientes son objetivos ligados a las fases del protocolo: el protocolo fija la fase automáticamente, pero aún no impone un número mínimo de nodos.',
  'nr-0':'Dos servidores Contabo independientes, cada uno con su propia base de datos y su propio servidor de pruebas. Confianza mediante código transparente. Cualquier persona registrada ya puede unirse como validador, sin solicitud ni depósito.',
  'nr-1':'Más operadores de nodo independientes; cada uno recibe una parte del fondo de validadores (40 % de las comisiones de intercambio).',
  'nr-2':'Objetivo: al menos 10 operadores de nodo independientes.',
  'nr-3':'Objetivo: un BlockDAG totalmente descentralizado; ningún operador puede censurar ni detener la cadena.',
  'nr-outro':'La guía para operadores de nodo (PDF) está en la pestaña Red. Cada nuevo operador gana del fondo de validadores: cuantos más nodos, más resistente la red.',
  ...
  'bv-desc':'Un validador garantiza que las <strong style="color:var(--text)">cuentas cuadren</strong>. No garantiza aquello sobre lo que descansa todo lo demás: que <strong style="color:var(--text)">nadie se registre dos veces</strong>. Sin eso, «una persona, una renta» es solo un lema: el libro mayor sería perfectamente correcto y completamente inútil. Hoy esa promesa se sostiene sobre muy pocas máquinas, y cada una que usted añada la hace más difícil de romper. Los dos papeles que la sostienen —el <strong style="color:var(--text)">verificador</strong>, que decide si un rostro ya está inscrito, y el <strong style="color:var(--text)">coordinador</strong>, que reúne esas decisiones— corren en el mismo servidor. Esta guía instala ambos.',
  'bv-guide-sub':'Paso a paso · Sin conocimientos de criptografía · Unos 45 minutos, la mayoría esperando',
  'bv-honest-d':'Esta parte está en beta y los límites son reales. La comparación conjunta consume material criptográfico de un solo uso, y una entrega cubre por ahora unas pocas decenas de registros antes de necesitar más: la vía confidencial se demuestra primero a pequeña escala, no en millones. El trabajo crece además con el número de personas inscritas. Publicamos estas cifras en lugar de redondearlas: un sistema que pide su rostro no tiene derecho a ser vago sobre lo que puede y lo que todavía no.',
  'bv-honest-t':'Dónde está esto hoy — sin rodeos',
  'bv-status-d':'El código del verificador <strong style="color:var(--text)">aún no es público</strong>, así que hoy no todo el mundo puede completar los pasos de abajo. Se publican ahora porque un diseño debe poder revisarse antes de desplegarse, no después. Si desea poner uno en marcha, pregunte en el grupo de Telegram enlazado en la portada. Abrir este repositorio es lo que convertirá esta guía de un plan en una invitación, y es lo siguiente que les debemos.',
  'bv-status-t':'Estado: beta cerrada — léalo antes de empezar',
  'bv-title':'Con un validador no basta, y esta es la razón',
  'bv-guide-lang-note':'Los pasos siguientes están en inglés. Las secciones de arriba —qué es esto, qué protege y de qué se hace usted responsable— están en su idioma.',
  'bv-what-d':'Un rostro nunca le llega como imagen: la imagen se descarta tras la comprobación y su máquina guarda solo un extracto de 64 bytes (512 valores sí/no) — suficiente para reconocer a quien vuelve, insuficiente para reconstruir un rostro. Existe un modo repartido en el que su máquina guardaría solo una parte aditiva de ese extracto — por sí sola indistinguible del ruido, comparada conjuntamente con su comité para que nadie sepa más que la respuesta. Está construido y probado, pero <strong style="color:var(--text)">aún no está activo</strong>, porque su umbral nunca se ha calibrado. Hasta entonces cada verificador guarda el extracto completo, y preferimos decirlo antes que insinuar una protección que usted aún no da.',
  'bv-what-t':'Qué tendría usted — y qué no vería nunca',
  ...
  'x-0-1-split-40-30':'0,1 % · reparto 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10.000 &#8211; 1 M de personas. Objetivo: al menos 10 operadores de nodo independientes.',
  'x-100-8211-10-000-humans':'100 &#8211; 10.000 personas. Tope 25×. Objetivo: más operadores de nodo independientes.',
  'x-100-maximum-concentration':'100 = concentración máxima',
  'x-1m-humans-global-ubi-at':'Más de 1 M de personas y Gini por debajo de 0,30: deben cumplirse ambas. Renta básica mundial a gran escala.',
  
  
  
  'x-active-validators':'Validadores activos',
  'x-add-aequitas-chain-to-metamask':'Añada la cadena Aequitas a MetaMask para ver su saldo AEQ, enviar transacciones e interactuar con el contrato V7 desde el navegador o el monedero móvil.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas lo implementa matemáticamente. Cada humano verificado recibe exactamente 1.000 AEQ — multimillonario o agricultor de subsistencia, sin excepciones. Reglas fijas — la tasa sobre dinero inmóvil, el tope de riqueza y la renta básica diaria — impiden que la desigualdad se acumule sin límite. El coeficiente de Gini se calcula a partir de los saldos actuales y cualquiera puede comprobarlo.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'Comparable con EE. UU. (~0,41) o Francia (~0,32). Dentro del rango de la mayoría de las economías desarrolladas.',
  ...
  'x-demurrage-0-5-mo':'Tasa sobre dinero inmóvil (0,5–1 %/mes)',
  ...
  'co-pernode-d':'Una autorización escrita en un nodo no viaja a los demás: no hay transacción para ello ni difusión. Una lista de confianza replicada sería exactamente la autoridad central sin la que está construido este sistema: cada operador decide por sí mismo qué certificaciones acepta su nodo. El coste es que su autorización debe enviarse a cada nodo que deba honrarla. La firma es transferible: se firma una vez y se envía a todas partes; un nodo que usted omita seguirá rechazándole.',
  'co-law-t':'Lo que usted sabe sobre otras personas — y lo que se deriva de ello',
  'co-law-d':'La captura pasa por usted; usted la entrega y no guarda nada. Pero solo usted tiene la correspondencia entre dirección de cartera y marcador para quienes se registran a través de usted, y por eso su clave de marcador debe seguir siendo suya: compartida, cualquier operador podría calcular el marcador de cualquier dirección pública y averiguar de quién es el rostro. También significa que usted se convierte en <strong style="color:var(--text)">responsable del tratamiento</strong> de esas personas según el RGPD. No nosotros. Las solicitudes de acceso, supresión y oposición le llegan a usted, y eso no es una formalidad.',
  'co-limit-t':'La única limitación que esto crea',
  'co-limit-d':'La supresión por dirección de cartera solo funciona en el coordinador donde se hizo la inscripción: su marcador depende de su clave, y otro coordinador deriva uno distinto para la misma dirección. Un «no encontrado» desde otro sitio significa «no registrado aquí», no «no registrado» — y la respuesta lo dice. La vía a través del propio bio_hash, la que pertenece a la persona y no necesita operador alguno, funciona en cualquier coordinador, porque ese identificador no cambia.',
  ...
  'x-healthier-than-most-nations-on':'Más sano que la mayoría de los países. Comparable con Escandinavia (~0,27) y Alemania (~0,31).',
  'x-higher-than-most-european-nations':'Más alto que en la mayoría de los países europeos — comparable con Brasil (~0,53). Las reglas no cambian con el índice; la tasa sobre dinero inmóvil y el tope de riqueza actúan de forma continua.',
  'x-honest-limitation':'Limitación reconocida:',
  'x-why-sybil-resistance':'¿Por qué resistencia Sybil?','x-how-it-works':'Cómo funciona',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'valor aleatorio, emitido tras la verificación facial (no derivado del rostro)',
  ...
  'x-metamask-mobile-if-aeq-shows':'📱 MetaMask Mobile: si AEQ muestra 0 tras añadirla, elimine la red y vuelva a añadirla con el botón de arriba.',
  ...
  'x-phase-transitions-are-automatic-8212':'El protocolo fija la fase automáticamente: de la 0 a la 2 según el número de personas, la 3 solo con 1 M de personas y un Gini por debajo de 0,30. Sin votación de gobernanza, sin clave de administrador. La fase es un estado: el límite de riqueza y la tasa por dinero inactivo no dependen de ella, y ningún código impone todavía los objetivos de nodos.',
  'x-postgresql-persistent':'PostgreSQL (persistente)',
  'x-protocol-v7':'📜 Protocol V7',
  'x-provide-aeq-tusd-liquidity-to':'Aporte liquidez AEQ / tUSD para ganar el 30 % de todas las comisiones de intercambio, repartidas a diario.',
  ...
  'x-swap-fees-0-1':'Comisiones de transferencia y swap (0,1 %)',
  'x-sybil-resistance-8212-current-state':'Resistencia Sybil &#8212; el estado actual, con franqueza',
  'x-the-4-redistribution-mechanisms':'Los 3 fondos de redistribución',
  ...
  'x-ubi-pool-20':'Fondo de renta básica',
  ...
  'x-worse-than-any-country-on':'Peor que cualquier país del mundo (récord de Sudáfrica: ~0,63). Se acerca a Bitcoin (~0,85). Con pocos humanos registrados esto ocurre rápido; las reglas siguen siendo las mismas.',
  ...
  'reg-sub':'Únase a la red Aequitas y reciba su asignación inicial de 1.000 AEQ. El registro es único y permanente. Está en beta: verificado, con límites declarados; vea el aviso beta más abajo.',
  'app-title':'REGISTRO SOLO VÍA APP ANDROID',
  'app-text':'El registro solo se hace en la app de Android: una breve captura del rostro, comprobada por dos servicios de comparación independientes. Después se <strong style="color:var(--gold)">acreditan automáticamente 1.000 AEQ</strong>. Qué se guarda y qué no: paso 1 y el aviso beta más abajo.',
  's1t':'Conectar','s1d':'La app graba su rostro y una breve secuencia de prueba de vida (parpadeo, una mirada a un lado al azar, destellos de color) y los envía a dos servicios de comparación independientes. Estos comparan el rostro con todas las personas registradas con rostro. La foto se descarta en segundos; solo se guarda un extracto de 64 bytes.',
  's2t':'Probar','s2d':'Una prueba ZK Groth16 vincula su bio_hash en un commitment (Poseidon de bio_hash, cartera y una sal) sin revelarlo. El servidor de pruebas solo la emite con el vínculo de la cartera y las atestaciones firmadas de los dos servicios, y el nullifier solo se puede usar una vez: el mismo rostro no cuenta dos veces.',
  's3t':'Recibir','s3d':'Registro confirmado en el BlockDAG de Aequitas en 1 segundo · 1.000 AEQ acreditados instantáneamente · su identidad queda permanentemente registrada',
  'priv-bar':'🔒 Beta · Verificación facial por 2 servicios independientes · 2 atestaciones firmadas obligatorias · ZKP Groth16 · Solo se guarda un extracto de 64 bytes',
  'conn-wallet':'WALLET CONECTADA','proof-recv':'⚡ PRUEBA ZK RECIBIDA','proof-hint':'Conecte su wallet para registrarse',
  'btn-conn':'🦊 CONECTAR METAMASK','btn-reg':'🔐 REGISTRAR ON-CHAIN','reg-apk-note':'El registro requiere la app con verificación facial (app.apk de este sitio; use la versión actual para que un rechazo muestre su código de reclamación).',
  'btn-wc':'🔗 CONECTAR WALLETCONNECT',
  'reg-log-hint':'// La app le registra por sí misma. Los botones de arriba solo hacen falta si llegó aquí mediante un enlace con una prueba ya generada.',
  'reg-details':'Detalles del Registro','k-network':'Red','k-chainid':'ID de Cadena','k-grant':'Subsidio UBI',
  'k-fee':'Tarifa de Gas','free':'0,1% comisión de protocolo — sin gas EVM','k-limit':'Registros','k-limit-v':'Una vez por persona · permanente · inmutable',
  'k-bio':'Rostro','never-stored':'Fotos descartadas en segundos — cada servicio de comparación guarda solo un extracto de 64 bytes',
  ...
  'gini-what-title':'¿Qué es el Coeficiente de Gini?','gini-what-text':'Desarrollado por el estadístico italiano Corrado Gini (1912). Mide la distribución de la riqueza comparando los saldos reales con una línea base hipotéticamente igualitaria — visualizado como la curva de Lorenz. Escala: 0 (todos tienen lo mismo) a 1 (una persona lo tiene todo). Usado por el Banco Mundial, la OCDE y la ONU para comparar países. Valores de referencia: Bitcoin ≈ 0,85 · Sudáfrica (récord mundial) ≈ 0,63 · EE.UU. ≈ 0,41 · Alemania ≈ 0,31 · Escandinavia ≈ 0,27 · Objetivo a largo plazo de Aequitas: Gini por debajo de 0,30 — comparable a los países escandinavos, impuesto por el límite de riqueza. La fase 3 (madurez) solo se alcanza con 1 M de personas y un Gini por debajo de 0,30.',
  'gini-calc-title':'¿Cómo se calcula el Índice Aequitas?','gini-calc-text':'Se recogen todos los saldos de AEQ de los humanos verificados. La fórmula calcula la diferencia absoluta media entre todos los pares posibles de saldos, normalizada por la población al cuadrado (n²) y el saldo medio (x̄). Resultado 0–1 multiplicado por 100 = Índice Aequitas. El nodo lo calcula a partir de los saldos actuales; tras cada pago diario de la renta básica se guarda un registro para el gráfico histórico.',
  'gini-why-title':'¿Por qué Gini — y no una métrica más simple?','gini-why-text':'Una simple relación entre el más rico y el más pobre es fácil de manipular: 10.000 carteras podrían mostrar poca dispersión mientras el 90 % de los AEQ está en 100 manos — el Gini lo detecta, una relación no. Recoge toda la distribución entre todos los humanos verificados en un número que cualquiera puede recalcular. Es una medición, no una palanca de control: las fases y el tope de riqueza dependen del número de humanos registrados, y las reglas de redistribución están fijadas en el protocolo. Nadie puede alterar la lectura.',
  ...
  'pools-desc':'Las comisiones de transferencia van 100 % al UBI. Las comisiones de swap se reparten 40 % validadores / 30 % proveedores de liquidez / 30 % UBI. El gravamen por dinero parado, el gravamen de salida del 2 % y el excedente sobre el límite van 100 % al UBI. Nadie puede pagar desde un fondo, ni siquiera con su clave; solo el protocolo reparte, a diario.',
  'vel-pool':'Pool Validadores','vel-pool-desc':'40 % de las comisiones de swap → cada humano verificado que opera un validador recibe la misma parte, ponderada solo por los minutos que su nodo estuvo en línea ese día.',
  'liq-pool':'Pool Liquidez','liq-pool-desc':'30 % de las comisiones de swap → proveedores de liquidez AEQ/tUSD, en proporción a su participación LP. Más liquidez = menor impacto en el precio para todos.',
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100 % de las comisiones de transferencia + 30 % de las de swap + 100 % del gravamen por dinero parado, del de salida y del excedente → repartido por igual entre todas las personas verificadas cada 24 horas.',
  'phases-title':'Fases del Protocolo',
  'phases-desc':'El límite para personas usa en la Fase 0 un multiplicador de arranque: max(5, min(N, 25))× la parte justa (1.000 AEQ por persona). Con 1–4 personas: 5×. Cada nueva persona suma 1×. Desde 25 personas: fijo en 25× = 25.000 AEQ para siempre. Todas las transiciones se activan automáticamente según el número de personas. El límite solo vale para personas: las empresas no tienen límite fijo y pagan en su lugar el gravamen por dinero parado; otras direcciones tienen como máximo 1.000 AEQ.',
  ...
  'p3':'Madurez · más de 1 M de personas y Gini por debajo de 0,30 · Límite de Riqueza: 25× la parte justa = 25.000 AEQ',
  'wealth-cap-explain':'El límite para personas en la Fase 0 (arranque) es max(5, min(N, 25))× la parte justa de 1.000 AEQ, donde N = personas registradas. 1–4 personas: 5×. Cada nueva persona suma 1×. Desde 25: 25× = 25.000 AEQ para siempre. Las empresas no tienen límite fijo (pagan el gravamen por dinero parado); otras direcciones tienen como máximo 1.000 AEQ.',
  'btn-download-app':'DESCARGAR APP AEQUITAS',
  'swap-title':'🔄 Intercambiar AEQ ↔ tUSD','swap-sub':'Intercambie AEQ por tUSD (un dólar de prueba simulado) a través del pool de liquidez nativo. Los intercambios pagan una comisión del 0,1%; las transferencias ordinarias de AEQ también pagan un 0,1% de comisión de protocolo, que va íntegramente a la renta básica (sin gas EVM).',
  'swap-priv-bar':'🔒 0,1% comisión de swap · Transferencias AEQ 0,1% protocolo (sin gas EVM) · tUSD moneda de prueba',
  'swap-your-aeq':'Su AEQ','swap-your-tusd':'Su tUSD',
  'swap-fee-est':'Comisión de protocolo (0,1%)','swap-details-hdr':'Detalles del Swap',
  'swap-out-lbl':'Recibe (est.)','swap-impact-lbl':'Impacto en precio','swap-rate-lbl':'Tipo de cambio',
  ...
  'swap-log-hint':'// Conecte su wallet para intercambiar...',
  ...
  'swap-addliq-title':'Proporcionar Liquidez','swap-addliq-desc':'Sea el primero en depositar — su proporción establece el precio inicial.','swap-btn-addliq':'💧 AGREGAR LIQUIDEZ',
  'swap-lp-title':'Su posición LP','swap-lp-share':'Participación del Pool','swap-lp-withdrawable':'Retirable',
  'swap-lp-pct-label':'% de su posición','swap-lp-youget':'Recibirás','swap-btn-removeliq':'🔥 RETIRAR LIQUIDEZ',
  ...
  'swap-validators':'Validadores (40%)','swap-lps':'Proveedores de Liquidez (30%)','swap-ubi':'Pool UBI (30%)','swap-treasury':'Tesorería (0%)',
  ...
  'ubi-hero-sub-empty':'Fondo vacío desde el último pago de las 20:00. Se llena con comisiones de transferencia, comisiones de swap (30 % del 0,1 %), el gravamen por dinero parado, el gravamen de salida y el excedente sobre el límite.',
  'ubi-time-bar-lbl':'Tiempo hasta el pago diario (20:00, hora de Berlín)',
  ...
  'ubi-src-swap':'Comisiones de Swap','ubi-src-swap-d':'Cada swap AEQ↔tUSD contribuye el 30% de su comisión de 0,1%. Más actividad = llenado más rápido.',
  'ubi-src-dem':'Gravamen por dinero parado','ubi-src-dem-d':'Personas por encima de 5.000 AEQ (0,5 %/mes), empresas por encima de 1,5 meses de facturación (0,5–1 %/mes) y otras direcciones (1 %/mes). Se liquida a diario, el 100 % va a la renta básica. Desde el 26 sept. 2026.',
  'ubi-src-cap':'Desbordamiento del Límite','ubi-src-cap-d':'A las personas por encima del tope (25× la parte justa = 25.000 AEQ; menos mientras haya menos de 25 humanos registrados: 1.000 AEQ por humano, al menos 5.000) se les redistribuye el exceso al instante. El 100 % va a la renta básica. Las empresas no tienen tope fijo.',
  'pools4-header':'LOS TRES POOLS DE REDISTRIBUCIÓN',
  'ubi-see-above':'ver countdown arriba','ubi-timer-above':'⏰ countdown mostrado arriba',
  'usp-headline':'Por primera vez en la historia — todos empiezan igual',
  'usp-sub':'Si tiene un smartphone Android, cumple los requisitos. Sin banco, sin conocimientos cripto, sin inversión.',
  'usp-c1-title':'0,1 % de comisión · sin gas EVM','usp-c1-desc':'Registrarse no cuesta gas de ETH/MATIC. Las transferencias pagan una comisión de protocolo del 0,1 % (en vivo desde el nodo), no «gratis para siempre».',
  'usp-c2-title':'1.000 AEQ para cada humano','usp-c2-desc':'Multimillonario o agricultor de subsistencia: todos reciben exactamente 1.000 AEQ. Ni más ni menos. El mismo comienzo para todos, fijado en el código.',
  'usp-c3-title':'Accesible para todos','usp-c3-desc':'Sin cuenta bancaria, sin tarjeta de crédito, sin documento de identidad, sin hardware adicional — solo la cámara que ya tiene su teléfono Android.',
  'usp-c4-title':'UBI diario para siempre','usp-c4-desc':'Tras registrarse recibe automáticamente una parte diaria de los pagos UBI — cada día, sin ninguna acción requerida.',
  ...
  'demurrage-desc':'Desde el 26 de septiembre de 2026 el dinero que se queda parado paga un pequeño gravamen según el tipo de cuenta. La vida diaria y el ahorro normal no se tocan, y el gravamen va 100 % a la renta básica.',
  'dem-rate-k':'Tasas','dem-rate-v':'Personas: 0,5 %/mes por encima de 5.000 AEQ · Empresas: 0,5 %/mes por encima de 1,5 meses de facturación, 1 % por encima de 3 meses · Otras direcciones: 1 %/mes',
  ...
  'run-node-title':'Ejecute su propio nodo — ayude a asegurar la red',
  ...
  'bootstrap-title':'Conectar un Nuevo Nodo','bootstrap-desc':'Para ejecutar su propio nodo no necesita configurar ningún punto de entrada — las direcciones de validador vienen integradas. Su nodo se registra solo y sincroniza automáticamente el estado completo de la cadena. Establezca PRIMARY_NODE_URL solo si quiere fijar deliberadamente un punto de entrada concreto.',
  ...
  'ca-desc':'AequitasV7 define las reglas de la economía Aequitas y mantiene el registro que las hace exigibles: cada nullifier reclamado, cada registro, el límite de riqueza y la fórmula de demurrage. Es inmutable — no hay clave de administrador, ni proxy de actualización, ni votación de gobernanza que pueda cambiar una línea. Lo que liquida una transferencia real, sin embargo, es la capa de cadena: el nodo intercepta la llamada ERC-20 antes de que llegue a la EVM y la aplica a su propio libro mayor, que es lo que hace las transferencias instantáneas sin gas EVM (0,1% comisión de protocolo). El contrato es el reglamento y el registro; la cadena es el motor que los ejecuta, y su código es público.<br><br>El contrato BioVerifier recibe pruebas de conocimiento cero Groth16 generadas completamente en el dispositivo Android del usuario. Verifica matemáticamente on-chain en ~10 ms que el nullifier enviado se derivó correctamente de un secreto que posee el registrante, y la cadena rechaza cualquier nullifier que ya haya visto — sin conocer jamás su nombre, identidad o datos biométricos. Eso descarta un segundo registro desde la misma fuente de identidad; si esa fuente es una persona o un dispositivo depende de si el modo biométrico está activo. El registro no necesita gas EVM; las transferencias llevan 0,1% de comisión de protocolo — la prueba es lo que sale del dispositivo.<br><br>Esa combinación es lo verdaderamente nuevo: las reglas y el registro de nullifiers por fuente de identidad (Fase 0: dispositivo/fuente; galería facial = hoja de ruta) viven en un contrato que el operador no puede reescribir a la ligera, y el código que las ejecuta es abierto y reproducible desde este repositorio. Todo ello es verificable por cualquiera. Lo que sigue requiriendo confianza es la operación de los propios nodos, y la forma honesta de reducirla son más validadores independientes, no una frase más rotunda aquí.',
  ...
  'h-zkp':'Sistema de Prueba ZK','h-zkp-t':'Aequitas usa Groth16 en BN128 — la misma curva que Ethereum y Zcash. Prueba: ~200 bytes. Verificación: ~10 ms. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). El nulificador procede del rostro, no del teléfono: un segundo dispositivo no permite a la misma persona registrarse otra vez, y perder el teléfono no cuesta el registro. Se usa Poseidon en lugar de una multiplicación porque el nulificador del circuito anterior era invertible: cualquiera podía recuperar el bioHash a partir de él.',
  'h-sybil':'Resistencia Sybil — Estado Actual','h-sybil-t':'Desde el 25/08/2026 el servidor de pruebas rechaza un registro sin las atestaciones firmadas de los dos servicios de comparación — así el mismo rostro no puede registrarse dos veces, tampoco en distintos dispositivos, algo que una clave de dispositivo nunca pudo. Dos límites declarados: las cuentas anteriores a esa fecha solo quedan cubiertas cuando su titular añade el rostro en la app, y el umbral de comparación no se ha calibrado con capturas reales: la criptografía es exacta, la biometría que hay debajo es una medición cuya tasa de error no se ha cuantificado. Prueba de vida: hoy solo es vinculante la tarea de la mirada; los destellos de color, el pulso y el paralaje se miden y decidirán una vez calibrados.',
  ...
  'h-bio-hw':'Hoja de Ruta de Verificación de Identidad','h-bio-hw-t':'Hoy (beta): una verificación facial por dos servicios de comparación independientes que deben coincidir ambos, y un servidor de pruebas que rechaza los registros sin sus atestaciones firmadas. Solo se guarda un extracto de 64 bytes, nunca la foto ni una plantilla completa. El umbral aún no está calibrado con capturas reales — hacen falta unos 1000 pares de impostores antes de dar ninguna cifra. Previsto: esa calibración, una prueba de vida vinculante a partir de las señales que ya se miden (destellos de color, pulso, paralaje), una asignación escalonada para capturas dudosas y una comprobación de duplicados en la que ningún servicio tenga ni siquiera el extracto completo. A largo plazo, Aequitas apostará por el escaneo de iris para garantizar de verdad una persona, un registro. Ahora se trabaja en cómo implementarlo de forma fiable y respetuosa con la privacidad; el hardware y los plazos aún no están decididos.',
  ...
  'dem-title':'3. GRAVAMEN POR DINERO PARADO: mecanismo contra el acaparamiento',
  'dem-box':'Personas: 0,5 %/mes solo sobre la parte por encima de 5.000 AEQ; la vida diaria y el ahorro quedan intactos<br>Empresas: hasta 1,5 meses de facturación libre (mínimo 2.000 AEQ), luego 0,5 %/mes, por encima de 3 meses 1 %/mes<br>Otras direcciones: 1 %/mes, máximo 250 AEQ<br>Se liquida a diario, 100 % a la renta básica (no se quema)',
  'dem-text':'<p>Precedente histórico: el experimento de Wörgl (Austria, 1932) usó una moneda con oxidación y redujo el desempleo un 25 % en un año. El Chiemgauer (Alemania, 2003) funciona con éxito desde hace más de 20 años con un mecanismo similar.</p><p>Estas reglas rigen desde el 26 de septiembre de 2026. Hasta entonces vale la regla anterior: 0,5 %/mes sobre la parte que supera la parte justa tras 3 meses sin actividad.</p>',
  'cap-title':'4. LÍMITE DE RIQUEZA — Aplicación de Justicia Matemática','cap-box':'Límite para personas: max(5,min(N,25))× la parte justa (1.000 AEQ)<br>1–4 personas: 5× · +1× por persona · desde 25: 25× para siempre<br>El excedente se redistribuye al instante · Empresas: sin límite fijo, gravamen por dinero parado · Otras direcciones: como máximo 250 AEQ',
  'ubi-title':'5. RENTA BÁSICA UNIVERSAL — Redistribución Diaria','ubi-box':'Fuentes: comisiones de transferencia (100 %) · comisiones de swap (30 %) · gravamen por dinero parado · gravamen de salida (2 %) · excedente sobre el límite · depósito por inactividad<br><br>A diario: el fondo UBI se reparte por igual entre todas las personas registradas. Tras cada reparto queda en cero y se vuelve a llenar.',
  ...
  'guard-set-lbl':'Establecer / Cambiar Guardian','guard-set-hint':'Debe ser un humano registrado en Aequitas · Bloqueo de 7 días · El Guardian solo puede confirmar su vitalidad, no acceder a fondos · Máximo 3 protegidos por Guardian',
  'guard-confirm-lbl':'Confirmar Vivo (Como Guardian)','guard-confirm-hint':'Si su protegido no puede acceder a su wallet, confirme su vitalidad para evitar que sus fondos vayan al escrow después de 910 días de inactividad.','guard-recover-btn':'🔓 RECUPERAR DEL ESCROW',
  'faq-title':'❓ Preguntas Frecuentes','faq-q1':'¿Están seguros mis datos biométricos?','faq-a1':'Su rostro se captura y se envía a dos servicios de comparación independientes — es la única forma de comprobar «una persona, una cuenta». La foto y la descripción facial completa se descartan en segundos; no se guardan. Lo que se conserva es un extracto de 64 bytes (512 valores sí/no): no permite reconstruir el rostro, pero reconoce a quien vuelve, por eso se trata como dato biométrico. Un límite honesto, dicho y no ocultado: cada servicio guarda el extracto completo. Un modo repartido en el que ningún servicio lo tiene entero está construido y probado, pero aún no es la comprobación vinculante.',
  'faq-q1b':'¿El registro demuestra que soy una persona real y única?','faq-a1b':'Mejor de lo que una clave de dispositivo pudo nunca, y aún no demostrable con una cifra. Desde el 25/08/2026 el rostro lo comparan dos servicios independientes que deben coincidir ambos, y el servidor de pruebas rechaza un registro sin sus atestaciones firmadas — así se detecta a la misma persona en un segundo teléfono, algo que una clave de dispositivo nunca pudo. Dos límites declarados: las cuentas anteriores a esa fecha solo quedan cubiertas cuando su titular añade el rostro en la app (sin nueva asignación), y la tasa de error no está establecida: el umbral no se ha calibrado con capturas reales, para lo que hacen falta unos 1.000 pares de impostores. Prueba de vida: hoy solo es vinculante la tarea de la mirada; las señales más fuertes se miden y se están calibrando. A largo plazo, Aequitas apostará por el escaneo de iris para garantizar de verdad una persona, un registro. Ahora se trabaja en cómo implementarlo de forma fiable y respetuosa con la privacidad; el hardware y los plazos aún no están decididos.',
  'faq-q2':'¿Puedo registrarme con una wallet diferente más adelante?','faq-a2':'No. Un registro queda ligado de forma permanente a una dirección wallet. Es intencionado: el nullifier derivado de su rostro se gasta una sola vez, así que registrarse de nuevo con otra wallet sería una segunda identidad para la misma persona.',
  'faq-q3':'¿Qué pasa si pierdo mi teléfono?','faq-a3':'Sus AEQ permanecen en su cartera — están ligados a su clave privada, no a su teléfono. Puede seguir accediendo a su cartera con MetaMask y su frase semilla. Su registro está ligado a su rostro, no al dispositivo, así que un teléfono nuevo no le hace perder el registro.',
  'path-title':'Elija su camino','path-human-title':'Soy un Humano','path-human-desc':'Quiero registrarme, recibir 1.000 AEQ y unirme a la red de ingreso básico.','path-human-steps':'1. Descargue la app Aequitas para Android<br>2. Haga la breve verificación facial en vivo en la app<br>3. Conecte MetaMask<br>4. Reciba 1.000 AEQ en cuanto se supere la verificación',
...
ru:{
  ...
  'x-phase-2-10-000-humans':'Этап 2 (от 10 000 человек):',
  'x-phase-3-1m-humans-gini':'Этап 3 (от 1 млн человек и Джини ниже 0,30):',
  'nr-intro':'Сейчас сеть работает на 2 активных валидаторах, каждый на своём сервере со своей базой данных, с событиями MERGE от обоих. Узлы-валидаторы могут вести только зарегистрированные люди — это требование безопасности. Шаги ниже — цели, привязанные к фазам протокола: протокол определяет фазу автоматически, но пока не требует минимального числа узлов.',
  'nr-0':'Два независимых сервера Contabo, у каждого своя база данных и свой сервер доказательств. Доверие через открытый код. Любой зарегистрированный человек уже сейчас может стать валидатором — без заявки и без залога.',
  'nr-1':'Больше независимых операторов узлов; каждый получает долю пула валидаторов (40 % комиссий за обмен).',
  'nr-2':'Цель: не менее 10 независимых операторов узлов.',
  'nr-3':'Цель: полностью децентрализованный BlockDAG — ни один оператор не может цензурировать или остановить цепь.',
  'nr-outro':'Руководство для операторов узлов (PDF) находится на вкладке «Сеть». Каждый новый оператор получает долю пула валидаторов — чем больше узлов, тем устойчивее сеть.',
  ...
  'bv-desc':'Валидатор обеспечивает, что <strong style="color:var(--text)">цифры сходятся</strong>. Он не обеспечивает того единственного, на чём держится всё остальное: что <strong style="color:var(--text)">никто не регистрируется дважды</strong>. Без этого «один человек — один доход» лишь лозунг: реестр был бы совершенно верным и совершенно бесполезным. Сегодня это обещание держится на очень немногих машинах, и каждая добавленная делает его труднее сломать. Две роли, которые его несут, — <strong style="color:var(--text)">верификатор</strong>, решающий, зарегистрировано ли уже это лицо, и <strong style="color:var(--text)">координатор</strong>, собирающий эти решения, — работают на одном сервере. Это руководство настраивает обе.',
  'bv-guide-sub':'Шаг за шагом · Знание криптографии не нужно · Около 45 минут, в основном ожидание',
  ...
  'bv-title':'Одного валидатора мало — и вот почему',
  'bv-guide-lang-note':'Шаги ниже на английском. Разделы выше — что это, что оно защищает и за что вы отвечаете — на вашем языке.',
  'bv-what-d':'Лицо никогда не приходит к вам как изображение: снимок удаляется после проверки, а ваша машина хранит только 64-байтовый отпечаток (512 значений «да/нет») — достаточно, чтобы узнать вернувшегося, недостаточно, чтобы восстановить лицо. Есть разделённый режим, в котором ваша машина хранила бы лишь аддитивную долю этого отпечатка — сама по себе неотличимую от шума, сравниваемую совместно с вашим комитетом так, что никто не узнаёт больше ответа. Он создан и протестирован, но <strong style="color:var(--text)">ещё не включён</strong>, потому что его порог так и не откалиброван. До тех пор каждый верификатор хранит отпечаток целиком, и мы лучше скажем это прямо, чем намекнём на защиту, которой вы пока не даёте.',
  ...
  'x-0-1-split-40-30':'0,1 % · распределение 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10 000 &#8211; 1 млн человек. Цель: не менее 10 независимых операторов узлов.',
  'x-100-8211-10-000-humans':'100 &#8211; 10 000 человек. Потолок 25×. Цель: больше независимых операторов узлов.',
  'x-100-maximum-concentration':'100 = предельная концентрация',
  'x-1m-humans-global-ubi-at':'От 1 млн человек и Джини ниже 0,30 — нужны оба условия. Всемирный базовый доход в большом масштабе.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas реализует это математически. Каждый верифицированный человек получает ровно 1 000 AEQ — миллиардер или фермер, без исключений. Фиксированные правила — сбор с простаивающих денег, лимит богатства и ежедневный базовый доход — не дают неравенству накапливаться бесконечно. Коэффициент Джини вычисляется по текущим балансам, и его может проверить каждый.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'Сравнимо с США (~0,41) или Францией (~0,32). В пределах большинства развитых экономик.',
  ...
  'x-demurrage-0-5-mo':'Сбор с простаивающих денег (0,5–1 %/мес.)',
  ...
  'x-healthier-than-most-nations-on':'Здоровее, чем в большинстве стран мира. Сравнимо со Скандинавией (~0,27) и Германией (~0,31).',
  'x-higher-than-most-european-nations':'Выше, чем в большинстве европейских стран, — сравнимо с Бразилией (~0,53). Правила не меняются вместе с индексом; сбор с простаивающих денег и лимит богатства действуют постоянно.',
  'x-honest-limitation':'Признанное ограничение:',
  'x-why-sybil-resistance':'Зачем защита от Sybil?','x-how-it-works':'Как это работает',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'случайное значение, выдаётся после проверки лица (не выводится из лица)',
  ...
  'x-phase-transitions-are-automatic-8212':'Протокол определяет фазу автоматически: фазы 0–2 по числу людей, фаза 3 — только при 1 млн человек и Джини ниже 0,30. Без голосования, без ключа администратора. Фаза — это статус: потолок богатства и сбор за простаивающие деньги от неё не зависят, а цели по узлам пока не обеспечиваются кодом.',
  ...
  'x-swap-fees-0-1':'Комиссии переводов и свопа (0,1%)',
  'x-sybil-resistance-8212-current-state':'Защита от Sybil &#8212; как обстоит дело на самом деле',
  'x-the-4-redistribution-mechanisms':'Три фонда перераспределения',
  ...
  'x-ubi-pool-20':'Фонд базового дохода',
  ...
  'x-worse-than-any-country-on':'Хуже, чем в любой стране мира (рекорд ЮАР: ~0,63). Приближается к Bitcoin (~0,85). При малом числе зарегистрированных людей это происходит быстро; правила остаются прежними.',
  ...
  'reg-sub':'Присоединяйтесь к сети Aequitas и получите стартовое начисление 1 000 AEQ. Регистрация однократная и постоянная. Это бета-версия: проверено, с названными ограничениями — см. оговорку ниже.',
  'app-title':'РЕГИСТРАЦИЯ ТОЛЬКО ЧЕРЕЗ ANDROID-ПРИЛОЖЕНИЕ',
  'app-text':'Регистрация проходит только в Android-приложении: короткий снимок лица, который проверяют две независимые службы сравнения. После этого <strong style="color:var(--gold)">1 000 AEQ начисляются автоматически</strong>. Что хранится и что нет — в шаге 1 и в оговорке ниже.',
  's1t':'Подключить','s1d':'Приложение снимает ваше лицо и короткую последовательность проверки живости (моргание, взгляд в случайную сторону, цветовые вспышки) и отправляет их двум независимым службам сравнения. Они сравнивают лицо со всеми, кто зарегистрирован с лицом. Фото удаляется через несколько секунд; хранится только 64-байтовый отпечаток.',
  's2t':'Доказать','s2d':'Доказательство Groth16 ZK связывает ваш bio_hash в commitment (Poseidon от bio_hash, кошелька и соли), не раскрывая его. Сервер доказательств выдаёт его только при привязке кошелька и подписанных подтверждениях обеих служб, а нуллификатор можно использовать один раз — одно лицо не считается дважды.',
  ...
  'priv-bar':'🔒 Бета · Проверка лица 2 независимыми службами · Обязательны 2 подписанных подтверждения · Groth16 ZKP · Хранится только 64-байтовый отпечаток',
  'conn-wallet':'ПОДКЛЮЧЁННЫЙ КОШЕЛЁК','proof-recv':'⚡ ZK-ДОКАЗАТЕЛЬСТВО ПОЛУЧЕНО','proof-hint':'Подключите кошелёк для регистрации',
  'btn-conn':'🦊 ПОДКЛЮЧИТЬ METAMASK','btn-reg':'🔐 ЗАРЕГИСТРИРОВАТЬ ОН-ЧЕЙН','reg-apk-note':'Для регистрации нужно приложение с проверкой лица (app.apk с этого сайта; используйте текущую версию, чтобы при отказе был виден код для возражения).',
  'btn-wc':'🔗 ПОДКЛЮЧИТЬ WALLETCONNECT',
  'reg-log-hint':'// Приложение регистрирует вас само. Кнопки выше нужны, только если вы пришли сюда по ссылке с готовым доказательством.',
  'reg-details':'Детали Регистрации','k-network':'Сеть','k-chainid':'ID Цепи','k-grant':'Субсидия UBI',
  'k-fee':'Комиссия Gas','free':'0,1% протокольная комиссия — без EVM-газа','k-limit':'Регистрации','k-limit-v':'Один раз на человека · навсегда · неизменно',
  'k-bio':'Лицо','never-stored':'Фото удаляются через секунды — каждая служба сравнения хранит только 64-байтовый отпечаток',
  ...
  'h-zkp':'Система ZK-Доказательств','h-zkp-t':'Aequitas использует Groth16 на BN128 — та же кривая, что у Ethereum и Zcash. Доказательство: ~200 байт. Проверка: ~10 мс. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). Нулификатор происходит от лица, а не от телефона: второе устройство не даёт тому же человеку зарегистрироваться снова, а потеря телефона не стоит регистрации. Poseidon вместо умножения потому, что нулификатор прежней схемы был обратим — из него можно было восстановить bioHash.',
  'h-sybil':'Устойчивость к Sybil — Текущее Состояние','h-sybil-t':'С 25.08.2026 сервер доказательств отклоняет регистрацию без подписанных подтверждений двух служб сравнения — поэтому одно и то же лицо нельзя зарегистрировать дважды, в том числе на разных устройствах, чего ключ устройства никогда не мог. Два названных ограничения: счета, созданные до этой даты, охвачены только после того, как владелец добавит лицо в приложении, а порог сравнения не откалиброван на реальных снимках: криптография точна, биометрия под ней — измерение, частота ошибок которого не установлена. Живость: сегодня обязательна только задача со взглядом; цветовые вспышки, пульс и параллакс измеряются и начнут решать после калибровки.',
  ...
  'h-bio-hw':'Дорожная Карта Верификации Личности','h-bio-hw-t':'Сегодня (бета): проверка лица двумя независимыми службами сравнения, которые обе должны согласиться, и сервер доказательств, отклоняющий регистрации без их подписанных подтверждений. Хранится только 64-байтовый отпечаток, никогда не фото и не полный шаблон. Порог ещё не откалиброван на реальных снимках — для этого нужно около 1000 импостор-пар, прежде чем называть какие-либо числа. В планах: эта калибровка, обязательная проверка живости по уже измеряемым сигналам (цветовые вспышки, пульс, параллакс), поэтапное начисление при сомнительных снимках и проверка дубликатов, при которой ни одна служба не хранит даже полного отпечатка. В долгосрочной перспективе Aequitas будет опираться на сканирование радужной оболочки глаза, чтобы действительно гарантировать: один человек — одна регистрация. Сейчас идёт работа над тем, как реализовать это надёжно и с защитой данных; оборудование и сроки ещё не определены.',
  'reg-humans':'Зарегистрированные Люди','h-desc':'Каждый адрес ниже принадлежит человеку, чьё лицо независимые службы сверили со всеми существующими регистрациями, подтвердили ZK-доказательством и зачислили ровно 1000 AEQ. Реестр постоянный, неизменяемый и в цепочке. Что порог сегодня гарантирует, а что нет — в FAQ. Известное ограниченное исключение: у счетов, созданных до проверки лица (25.08.2026), нет шаблона лица.',
  ...
  'pools-desc':'Комиссии за переводы идут на 100 % в UBI. Комиссии свопа делятся: 40 % валидаторам / 30 % поставщикам ликвидности / 30 % UBI. Сбор за лежащие деньги, сбор за выход 2 % и превышение предела идут на 100 % в UBI. Никто не может платить из пула, даже имея его ключ; распределяет только протокол, ежедневно.',
  'vel-pool':'Пул Валидаторов','vel-pool-desc':'40% комиссий свопа → каждый верифицированный человек, запускающий валидатор, получает равную долю, взвешенную только по минутам работы его узла в этот день.',
  'liq-pool':'Пул Ликвидности','liq-pool-desc':'30% комиссий свопа → поставщикам ликвидности AEQ/tUSD пропорционально их доле LP. Больше ликвидности = меньше влияние на цену для всех.',
  'ubi-pool':'Пул UBI','ubi-pool-desc':'100 % комиссий за переводы + 30 % комиссий свопа + 100 % сбора за лежащие деньги, сбора за выход и превышения предела → каждые 24 часа поровну всем проверенным людям.',
  ...
  'p3':'Зрелость · от 1 млн человек и Джини ниже 0,30 · Лимит богатства: 25× справедливой доли = 25 000 AEQ',
  'demurrage-title':'Сбор за лежащие деньги: стимул к обороту',
  'demurrage-desc':'С 26 сентября 2026 года деньги, которые лежат без движения, платят небольшой сбор, зависящий от типа счёта. Повседневная жизнь и обычные сбережения не затрагиваются, а сбор на 100 % идёт в базовый доход.',
  'dem-rate-k':'Ставки','dem-rate-v':'Люди: 0,5 %/мес. сверх 5 000 AEQ · Бизнес: 0,5 %/мес. сверх 1,5 месячного оборота, 1 % сверх 3 месячных оборотов · Прочие адреса: 1 %/мес.',
  ...
  'dem-title':'3. СБОР ЗА ЛЕЖАЩИЕ ДЕНЬГИ: защита от накопительства',
  'dem-box':'Люди: 0,5 %/мес. только на часть сверх 5 000 AEQ; повседневная жизнь и сбережения не затрагиваются<br>Бизнес: до 1,5 месячного оборота бесплатно (не меньше 2 000 AEQ), затем 0,5 %/мес., сверх 3 месячных оборотов 1 %/мес.<br>Прочие адреса: 1 %/мес., не более 250 AEQ<br>Рассчитывается ежедневно, 100 % в базовый доход (не сжигается)',
  'dem-text':'<p>Исторический пример: эксперимент в Вёргле (Австрия, 1932) использовал деньги с демерреджем и за год снизил безработицу на 25 %. Кимгауэр (Германия, 2003) успешно работает более 20 лет по похожему принципу.</p><p>Эти правила действуют с 26 сентября 2026 года. До тех пор действует прежнее правило: 0,5 %/мес с части выше справедливой доли после 3 месяцев без активности.</p>',
  'cap-title':'4. ЛИМИТ БОГАТСТВА — Математическое Обеспечение Справедливости','cap-box':'Предел для людей: max(5,min(N,25))× справедливая доля (1 000 AEQ)<br>1–4 человека: 5× · +1× на человека · с 25: навсегда 25×<br>Превышение сразу перераспределяется · Компании: без фиксированного предела, вместо него сбор за лежащие деньги · Иные адреса: не более 250 AEQ',
  'ubi-title':'5. УНИВЕРСАЛЬНЫЙ БАЗОВЫЙ ДОХОД — Ежедневное Перераспределение','ubi-box':'Источники: комиссии за переводы (100 %) · комиссии свопа (30 %) · сбор за лежащие деньги · сбор за выход (2 %) · превышение предела · доверительное хранение неактивных<br><br>Ежедневно: пул UBI делится поровну между всеми зарегистрированными людьми. После каждого распределения он обнуляется и снова наполняется.',
  ...
  'phases-desc':'Предел для людей в Фазе 0 использует стартовый множитель: max(5, min(N, 25))× справедливая доля (1 000 AEQ на человека). При 1–4 людях: 5×. Каждый новый человек добавляет 1×. С 25 людей: навсегда 25× = 25 000 AEQ. Все переходы происходят автоматически по числу людей. Предел действует только для людей: у компаний нет фиксированного предела, вместо него они платят сбор за лежащие деньги; иные адреса держат не более 1 000 AEQ.',
  'p0':'Bootstrap · &lt;100 людей · Лимит богатства: max(5,min(N,25))× средний · Скользит 5×→25× до 25-го человека · Сейчас активен',
  'p1':'Рост · 100–10 000 людей · Лимит богатства: 25× справедливой доли = 25 000 AEQ',
  'p2':'Стабильность · 10 000–1M людей · Лимит богатства: 25× (планируемое снижение: 10×)',
  
  'wealth-cap-explain':'Предел для людей в Фазе 0 (старт) равен max(5, min(N, 25))× справедливой доле 1 000 AEQ, где N — число зарегистрированных людей. 1–4 человека: 5×. Каждый новый добавляет 1×. С 25: навсегда 25× = 25 000 AEQ. У компаний нет фиксированного предела (они платят сбор за лежащие деньги); иные адреса держат не более 1 000 AEQ.',
  'btn-download-app':'СКАЧАТЬ ПРИЛОЖЕНИЕ AEQUITAS',
  'swap-title':'🔄 Обмен AEQ ↔ tUSD','swap-sub':'Обменивайте AEQ на tUSD (симулированный тестовый доллар) через нативный пул ликвидности. За свопы взимается комиссия 0,1%; обычные переводы AEQ также платят протокольную комиссию 0,1%, которая целиком идёт в базовый доход (без EVM-газа).',
  'swap-priv-bar':'🔒 0,1% комиссия свопа · Переводы AEQ: 0,1% протокольная (без EVM-газа) · tUSD тестовая валюта',
  ...
  'swap-validators':'Валидаторы (40%)','swap-lps':'Провайдеры Ликвидности (30%)','swap-ubi':'Пул UBI (30%)','swap-treasury':'Казначейство (0%)',
  ...
  'ubi-hero-sub-empty':'Пул пуст после последней выплаты в 20:00. Он наполняется из комиссий за переводы, комиссий свопа (30 % от 0,1 %), сбора за лежащие деньги, сбора за выход и превышения предела.',
  'ubi-time-bar-lbl':'Время до ежедневной выплаты (20:00 по Берлину)',
  ...
  'ubi-src-swap':'Комиссии Свопов','ubi-src-swap-d':'Каждый своп AEQ↔tUSD вносит 30% своей комиссии 0,1%. Больше торговли = быстрее заполнение.',
  'ubi-src-dem':'Сбор за лежащие деньги','ubi-src-dem-d':'Люди сверх 5 000 AEQ (0,5 %/мес.), бизнес сверх 1,5 месячного оборота (0,5–1 %/мес.) и прочие адреса (1 %/мес.). Рассчитывается ежедневно, 100 % идёт в базовый доход. С 26 сент. 2026.',
  'ubi-src-cap':'Превышение Лимита Богатства','ubi-src-cap-d':'У людей выше лимита (25× справедливая доля = 25 000 AEQ; ниже, пока зарегистрировано меньше 25 человек: 1 000 AEQ на человека, минимум 5 000) излишек сразу перераспределяется. 100 % идёт в базовый доход. У компаний нет фиксированного лимита.',
  'pools4-header':'ТРИ ПУЛА ПЕРЕРАСПРЕДЕЛЕНИЯ',
  'ubi-see-above':'см. обратный отсчёт выше','ubi-timer-above':'⏰ обратный отсчёт показан выше',
  ...
  'usp-c1-title':'Комиссия 0,1 % · без газа EVM','usp-c1-desc':'Для регистрации не нужен газ ETH/MATIC. За переводы взимается протокольная комиссия 0,1 % (данные с узла), а не «бесплатно навсегда».',
  'usp-c2-title':'1 000 AEQ для каждого человека','usp-c2-desc':'Миллиардер или фермер, живущий натуральным хозяйством, — каждый получает ровно 1 000 AEQ. Не больше и не меньше. Одинаковый старт для всех, закреплённый в коде.',
  ...
  'gini-what-title':'Что такое коэффициент Джини?','gini-what-text':'Разработан итальянским статистиком Коррадо Джини (1912). Измеряет распределение богатства, сравнивая фактические балансы с гипотетически равным базовым уровнем. Шкала: 0 (у всех одинаково) до 1 (у одного всё). Используется Всемирным банком, ОЭСР, ООН для сравнения стран. Справочные значения: Bitcoin ≈ 0,85 · ЮАР (мировой рекорд) ≈ 0,63 · США ≈ 0,41 · Германия ≈ 0,31 · Скандинавия ≈ 0,27 · Долгосрочная цель Aequitas: Джини ниже 0,30. Фаза 3 (зрелость) наступает только при 1 млн человек и Джини ниже 0,30.','gini-calc-title':'Как рассчитывается Индекс Aequitas','gini-calc-text':'Собираются все балансы AEQ верифицированных людей. Формула вычисляет среднюю абсолютную разницу между всеми возможными парами балансов, нормированную на квадрат численности (n²) и средний баланс (x̄). Результат 0–1, умноженный на 100, = индекс Aequitas. Узел вычисляет его по текущим балансам; после каждой ежедневной выплаты базового дохода сохраняется снимок для графика истории.','gini-why-title':'Почему Gini','gini-why-text':'Простое соотношение «самый богатый к самому бедному» легко обмануть: 10 000 кошельков могут показывать небольшой разброс, а 90 % AEQ при этом находятся в 100 руках — Джини это видит, соотношение нет. Он охватывает всё распределение среди верифицированных людей одним числом, которое может пересчитать каждый. Это измерение, а не рычаг управления: фазы и лимит богатства зависят от числа зарегистрированных людей, а правила перераспределения закреплены в протоколе. Никто не может изменить показание.',
  ...
  'faq-title':'❓ Вопросы и Ответы','faq-q1':'Мои биометрические данные в безопасности?','faq-a1':'Ваше лицо снимается и отправляется двум независимым службам сравнения — только так вообще можно проверить «один человек — один счёт». Фото и полное описание лица удаляются через секунды и не хранятся. Остаётся 64-байтовый отпечаток (512 значений «да/нет»): восстановить по нему лицо нельзя, но он узнаёт вернувшегося, поэтому считается биометрическими данными. Одно честное ограничение, названное, а не скрытое: каждая служба хранит отпечаток целиком. Разделённый режим, в котором ни одна служба не имеет его полностью, создан и протестирован, но пока не является обязательной проверкой.',
  'faq-q1b':'Доказывает ли регистрация, что я уникальный реальный человек?','faq-a1b':'Лучше, чем когда-либо мог ключ устройства, но пока не доказуемо числом. С 25.08.2026 лицо сравнивают две независимые службы, которые обе должны согласиться, и сервер доказательств отклоняет регистрацию без их подписанных подтверждений — поэтому того же человека на втором телефоне обнаруживают, чего ключ устройства никогда не мог. Два названных ограничения: счета, созданные до этой даты, охвачены только после того, как владелец добавит лицо в приложении (без нового начисления), а частота ошибок не установлена: порог не откалиброван на реальных снимках, для этого нужно около 1 000 импостор-пар. Живость: сегодня обязательна только задача со взглядом; более сильные сигналы измеряются и калибруются. В долгосрочной перспективе Aequitas будет опираться на сканирование радужной оболочки глаза, чтобы действительно гарантировать: один человек — одна регистрация. Сейчас идёт работа над тем, как реализовать это надёжно и с защитой данных; оборудование и сроки ещё не определены.',
  ...
  'faq-q3':'Что произойдёт, если я потеряю телефон?','faq-a3':'Ваши AEQ остаются в вашем кошельке — они привязаны к вашему приватному ключу, а не к телефону. Вы по-прежнему можете открыть кошелёк в MetaMask с помощью seed-фразы. Ваша регистрация привязана к вашему лицу, а не к устройству, поэтому новый телефон не лишает вас регистрации.',
  'path-title':'Выберите Свой Путь','path-human-title':'Я Человек','path-human-desc':'Хочу зарегистрироваться, получить 1 000 AEQ и присоединиться к сети базового дохода.','path-human-steps':'1. Скачайте Android-приложение Aequitas<br>2. Пройдите в приложении короткую живую проверку лица<br>3. Подключите MetaMask<br>4. Получите 1 000 AEQ после успешной проверки',
...
zh:{
  ...
  'x-phase-2-10-000-humans':'第 2 阶段（1 万人以上）：',
  'x-phase-3-1m-humans-gini':'第 3 阶段（100 万人以上且基尼系数低于 0.30）：',
  'nr-intro':'目前网络由 2 个活跃验证者运行，各自拥有独立服务器和数据库，两者都产生 MERGE 事件。只有已注册的人类才能运行验证节点——这是安全要求。以下步骤是与协议阶段挂钩的目标：协议自动确定阶段，但尚未强制要求最低节点数量。',
  'nr-0':'两台独立的 Contabo 服务器，各有自己的数据库和证明服务器。信任来自代码透明。任何已注册的人现在就可以作为验证者加入——无需申请，无需质押。',
  'nr-1':'更多独立的节点运营者；每人获得验证者池的一份（兑换手续费的 40%）。',
  'nr-2':'目标：至少 10 个独立的节点运营者。',
  'nr-3':'目标：完全去中心化的 BlockDAG——任何单一运营者都无法审查或停止链。',
  'nr-outro':'节点运营者指南（PDF）位于“网络”标签页。每位新的节点运营者都能从验证者池获得收益——节点越多，网络越稳健。',
  ...
  'bv-bind':'🔗 生成绑定签名',
  'bv-desc':'验证节点保证<strong style="color:var(--text)">账目对得上</strong>。它并不保证其他一切所依赖的那一件事：<strong style="color:var(--text)">没有人注册两次</strong>。没有这一条，“一人一份收入”只是一句口号——账本完全正确，却完全没有价值。今天这个承诺只落在极少数机器上，你每加入一台，它就更难被攻破。承担它的两个角色——判断某张脸是否已登记的<strong style="color:var(--text)">验证者</strong>，以及汇总这些判断的<strong style="color:var(--text)">协调器</strong>——运行在同一台服务器上。本指南把两者都装好。',
  'bv-guide-sub':'一步一步 · 无需密码学知识 · 约 45 分钟，大部分是等待',
  ...
  'bv-title':'只运行验证节点还不够 —— 原因在此',
  'bv-guide-lang-note':'以下步骤为英文。上方各节——这是什么、它保护什么、你要承担什么——是你所用的语言。',
  'bv-what-d':'人脸从不会以图像形式发送给你：图像在核验后即被丢弃，你的机器只存储一份 64 字节的摘要（512 个是/否值）——足以识别回来的人，却不足以还原一张脸。另有一种拆分模式，你的机器只持有该摘要的一个加法分片——单独看与噪声无异，与委员会共同比对，任何人得到的都不会超过答案本身。它已构建并测试，但<strong style="color:var(--text)">尚未启用</strong>，因为其阈值从未校准。在此之前，每个验证者都持有完整摘要——我们宁愿直说，也不暗示一种你尚未提供的保护。',
  ...
  'x-0-1-split-40-30':'0.1 % · 按 40/30/30 分配',
  ...
  'x-10-000-8211-1m-humans':'1 万 &#8211; 100 万人。目标：至少 10 个独立的节点运营者。',
  'x-100-8211-10-000-humans':'100 &#8211; 1 万人。上限 25 倍。目标：更多独立的节点运营者。',
  'x-100-maximum-concentration':'100 = 集中度最高',
  'x-1m-humans-global-ubi-at':'100 万人以上且基尼系数低于 0.30——两者须同时满足。大规模的全球基本收入。',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas 以数学方式实现这一点。每个已验证真人都恰好获得 1,000 AEQ——亿万富翁或自给农民，无一例外。固定的规则——闲置资金费、财富上限和每日基本收入——防止不平等无限累积。基尼系数根据实时余额计算，任何人都可以核查。',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-hash-wallet':'哈希 / 钱包',
  'x-healthier-than-most-nations-on':'比世界上大多数国家更健康。与斯堪的纳维亚（~0.27）和德国（~0.31）相当。',
  'x-higher-than-most-european-nations':'高于大多数欧洲国家——与巴西（~0.53）相当。规则不随指数变化；闲置资金费和财富上限持续起作用。',
  'x-honest-limitation':'坦承的局限：',
  'x-why-sybil-resistance':'为何需要抗女巫？','x-how-it-works':'运作方式',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'随机值，在人脸核验后签发（并非由人脸推导）',
  ...
  'x-phase-transitions-are-automatic-8212':'协议自动确定阶段——第 0 至 2 阶段取决于人数，第 3 阶段须达到 100 万人且基尼系数低于 0.30。无需治理投票，没有管理员密钥。阶段只是一个状态：财富上限和闲置资金费不取决于它，节点目标目前也没有代码强制执行。',
  ...
  'x-swap-fees-0-1':'转账和兑换手续费（0.1%）',
  'x-sybil-resistance-8212-current-state':'女巫攻击防护 —— 如实说明现状',
  'x-the-4-redistribution-mechanisms':'三个再分配资金池',
  ...
  'x-worse-than-any-country-on':'比世界上任何国家都差（南非纪录：~0.63）。接近比特币（~0.85）。注册人数很少时这很容易出现；规则保持不变。',
  ...
  'logo-sub':'人类证明','phase0-badge':'Beta · 人脸核验','nav-register':'注册','foot-launched':'2026 年 6 月上线','foot-phase':'Beta','foot-quote':'金钱之所以存在，是因为人存在。不多，也不少。',
  'nav-home':'首页','nav-why':'为什么是 Aequitas','nav-biz':'企业','nav-how':'运作方式','nav-join':'加入','nav-trans':'透明','nav-explorer':'浏览器','nav-equality':'平等','nav-network':'网络','nav-exchange':'兑换',
  'reg-title':'🔐 注册成为经过验证的人类',
  'reg-disclaimer':'Beta：自 2026-08-25 起，证明服务器拒绝任何没有两个比对服务签名证明的注册——换一部手机不再能让同一张脸获得第二个账户。尚未成立的部分：该日期之前注册的账户，只有在持有人于应用中补录人脸后才被覆盖（不会再次发放）；在此之前，原则上仍可用新钱包再次注册。错误率尚未校准（需要约 1,000 组冒名配对）。活体检测：目前只有视线任务具有约束力；颜色闪光、脉搏和视差会被测量，但尚不参与决定。请将「一人一账户」理解为「已核验、并明示限制」，而非「无法绕过」。 从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何可靠且保护隐私地实现；硬件和时间表尚未确定。',
  'reg-disc-sum':'Beta 声明：哪些已经成立，哪些尚未成立（展开）',
  ...
  'reg-sub':'加入 Aequitas 网络，领取 1,000 AEQ 起步发放。注册一次性且永久。目前处于 Beta：已核验，并明示限制——见下方的 Beta 声明。',
  'app-title':'仅通过安卓应用注册',
  'app-text':'注册只能在 Android 应用中完成：一次简短的人脸采集，由两个独立的比对服务核验。之后 <strong style="color:var(--gold)">1,000 AEQ 自动入账</strong>。存储什么、不存储什么：见第 1 步和下方的 Beta 声明。',
  's1t':'连接','s1d':'应用录制你的人脸和一段简短的活体序列（眨眼、随机向一侧看、颜色闪光），并发送给两个独立的比对服务。它们将这张脸与所有带人脸注册的人进行比对。照片在几秒内丢弃，只保留 64 字节的摘要。',
  's2t':'证明','s2d':'Groth16 零知识证明把你的 bio_hash 绑定进一个 commitment（bio_hash、钱包和盐值的 Poseidon 哈希），而不泄露它。证明服务器只在钱包绑定和两个服务的签名证明齐备时才签发，nullifier 只能使用一次——同一张脸不会被计算两次。',
  's3t':'领取','s3d':'在 Aequitas BlockDAG 上约 1 秒内确认注册 · 立即记入 1,000 AEQ · 身份永久记录为经过验证的人类',
  'priv-bar':'🔒 Beta · 由 2 个独立服务进行人脸核验 · 必须有 2 份签名证明 · Groth16 零知识证明 · 只保留 64 字节摘要',
  'conn-wallet':'已连接钱包','proof-recv':'⚡ 已收到ZK证明','proof-hint':'连接钱包以注册',
  'btn-conn':'🦊 连接 METAMASK','btn-reg':'🔐 链上注册','reg-apk-note':'注册需要带人脸核验的应用（本站 app.apk；请使用最新版本，这样被拒绝时会显示申诉编号）。',
  'btn-wc':'🔗 连接 WALLETCONNECT',
  'reg-log-hint':'// 应用会自行为你完成注册。只有当你通过带有已生成证明的链接来到这里时，才需要上面的按钮。',
  'reg-details':'注册详情','k-network':'网络','k-chainid':'链ID','k-grant':'UBI补贴',
  'k-fee':'Gas费','free':'0.1% 协议费 — 无 EVM Gas','k-limit':'注册','k-limit-v':'每人一次 · 永久 · 不可更改',
  'k-bio':'面部','never-stored':'照片几秒内丢弃——每个比对服务只保留 64 字节摘要',
  ...
  'h-zkp':'零知识证明系统','h-zkp-t':'Aequitas 在 BN128 上使用 Groth16 —— 与以太坊和 Zcash 相同的曲线。证明约 200 字节，验证约 10 毫秒。commitment = Poseidon(bioHash, wallet, deviceSalt)，nullifier = Poseidon(bioHash)。作废标识来自面部而非手机：换一台设备并不能让同一个人再注册一次，丢失手机也不会失去注册。之所以用 Poseidon 而非乘法，是因为早先电路的作废标识可逆——任何人都能由它反推出 bioHash。',
  'h-sybil':'女巫攻击抵御——当前状态','h-sybil-t':'自 2026-08-25 起，证明服务器拒绝没有两个比对服务签名证明的注册——因此同一张脸无法注册两次，跨设备也不行，这是设备密钥从未做到的。两项明示的限制：该日期之前注册的账户，只有在持有人于应用中补录人脸后才被覆盖；比对阈值尚未用真实采集校准：密码学是精确的，其下的生物识别是一种错误率尚未量化的测量。活体检测：目前只有视线任务具有约束力；颜色闪光、脉搏和视差会被测量，校准后将参与决定。',
  'h-global':'全球金融包容','h-global-t':'无需银行账户、无需信用卡、无需任何加密货币经验。只要一部带摄像头的安卓智能手机。Aequitas 的设计目标是让地球上的每个人都能使用。',
  'h-bio-hw':'身份验证路线图','h-bio-hw-t':'当前（测试版）：由两个独立比对服务进行人脸核验，两者须同时同意；证明服务器拒绝没有其签名证明的注册。只存储 64 字节的摘要，从不存储照片或完整模板。阈值尚未用真实采集校准——在给出任何数字之前需要约 1000 组冒名配对。计划：完成这一校准；基于已在测量的信号（颜色闪光、脉搏、视差）使活体检测具有约束力；对不确定的采集分阶段发放；以及一种任何服务都不持有完整摘要的查重方式。从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何可靠且保护隐私地实现；硬件和时间表尚未确定。',
  'reg-humans':'已注册人类','h-desc':'下面每个地址都属于这样一个人：其面部由独立服务与所有既有注册进行了核验，以零知识证明加以证实，并获得了恰好 1,000 AEQ。该登记册是永久、不可更改且上链的。比对阈值今天能保证什么、不能保证什么，见常见问题。 已知且有限的例外：人脸核验启用前（2026-08-25）注册的账户没有人脸模板。',
  ...
  'pools-title':'再分配池',
  'pools-desc':'转账手续费 100% 进入 UBI。兑换手续费分配为 40% 验证者 / 30% 流动性提供者 / 30% UBI。闲置资金费、2% 退出费和超出上限的部分 100% 进入 UBI。任何人都不能从资金池中支出，即使拥有其密钥也不行；只有协议每天进行分配。',
  'vel-pool':'验证者池','vel-pool-desc':'40% 的兑换手续费 → 每位运行验证节点的已验证真人获得相同份额，仅按其节点当天在线分钟数加权。',
  'liq-pool':'流动性池','liq-pool-desc':'30% 的兑换手续费 → AEQ/tUSD 流动性提供者，按其 LP 份额分配。流动性越深，所有人的价格影响越小。',
  'ubi-pool':'UBI池','ubi-pool-desc':'100% 转账手续费 + 30% 兑换手续费 + 100% 闲置资金费、退出费和超出上限部分 → 每 24 小时平均分配给所有已验证的个人。',
  'phases-title':'协议阶段',
  'p0':'启动 · &lt;100人类 · 财富上限：50×平均余额 · 当前活跃',
  'p1':'增长 · 100–10,000人类 · 财富上限：20×公平份额（每人 1,000 AEQ）',
  'p2':'稳定 · 10,000–100万人类 · 财富上限：10×平均余额',
  'p3':'成熟期 · 100 万人以上且基尼系数低于 0.30 · 财富上限：25×公平份额 = 25,000 AEQ',
  'demurrage-title':'闲置资金费：促进流通的激励',
  'demurrage-desc':'自 2026 年 9 月 26 日起，闲置的资金根据账户类型缴纳少量费用。日常生活和正常储蓄不受影响，费用 100% 进入基本收入。',
  'dem-rate-k':'费率','dem-rate-v':'个人：超过 5,000 AEQ 的部分每月 0.5% · 企业：超过 1.5 个月营业额的部分每月 0.5%，超过 3 个月营业额的部分 1% · 其他地址：每月 1%',
  ...
  'ca-desc':'AequitasV7 定义了 Aequitas 经济的规则，并持有使这些规则可执行的登记簿：每一个被使用过的 nullifier、每一次注册、财富上限与需求损耗公式。合约不可变更——没有管理员密钥、没有升级代理、没有治理投票能改动其中一行。但真正结算一笔转账的是链层：节点在 ERC-20 调用抵达 EVM 之前将其拦截，并记入自己的账本，这正是转账能做到亚秒级且无 EVM Gas（0.1% 协议费） 的原因。合约是规则书与登记簿；链是执行它们的引擎，其源代码公开。<br><br>BioVerifier合约接收完全在用户Android设备上生成的Groth16零知识证明。它在约10毫秒内在链上数学验证所提交的 nullifier 是由注册者持有的秘密正确推导而来，并且链会拒绝任何已经见过的 nullifier——而不会泄露他们的姓名、身份或生物特征数据。这排除了同一身份来源的第二次注册；该来源是人还是设备，取决于生物识别模式是否启用。注册无需 EVM Gas；转账收取 0.1% 协议费——证明是离开设备的内容。<br><br>真正新的正是这个组合：规则与身份来源 nullifier（阶段 0：设备/来源绑定；面部图库为路线图）的登记簿位于运营者无法随意改写的合约中——而执行它们的代码是开源的，可从本仓库复现。这一切任何人都能核验。仍然需要信任的是节点本身的运行，而减少这种信任的诚实方式是更多独立验证者，而不是在此处写一句更强硬的话。',
  ...
  'guard-text':'<p>如果有人住院或因其他原因数月无法访问其设备怎么办？监护人系统允许可信任的人——另一个经过验证的人类——确认钱包所有者仍然活着。监护人拥有严格为零的财务访问权限：只能调用重置非活跃计时器的单一函数。在任何情况下都不能移动、花费或访问资金。</p>',
  ...
  'dem-title':'3. 闲置资金费：反囤积机制',
  'dem-box':'个人：只对超过 5,000 AEQ 的部分每月收 0.5%；日常生活和储蓄不受影响<br>企业：1.5 个月营业额以内免费（至少 2,000 AEQ），之后每月 0.5%，超过 3 个月营业额的部分每月 1%<br>其他地址：每月 1%，最多 250 AEQ<br>每日结算，100% 进入基本收入（不销毁）',
  'dem-text':'<p>历史先例：沃尔格尔实验（奥地利，1932 年）使用带滞期费的货币，一年内将失业率降低了 25%。基姆高尔币（德国，2003 年）采用类似机制成功运行了 20 多年。</p><p>这些规则自 2026 年 9 月 26 日起生效。在此之前沿用原规则：3 个月无活动后，对超过公平份额的部分每月收取 0.5%。</p>',
  'cap-title':'4. 财富上限 — 数学公平执行','cap-box':'个人上限：max(5,min(N,25))× 公平份额（1,000 AEQ）<br>1–4 人：5× · 每人 +1× · 25 人起：永久 25×<br>超出部分立即再分配 · 企业：无固定上限，改缴闲置资金费 · 其他地址：最多 250 AEQ',
  'ubi-title':'5. 普遍基本收入 — 每日再分配','ubi-box':'来源：转账手续费（100%）· 兑换手续费（30%）· 闲置资金费 · 退出费（2%）· 超出上限部分 · 不活跃托管<br><br>每日：UBI 池平均分配给所有已注册的个人。每次分配后归零并持续重新累积。',
  ...
  'phases-desc':'个人上限在第 0 阶段使用启动乘数：max(5, min(N, 25))× 公平份额（每人 1,000 AEQ）。1–4 人时：5×。每新增一人增加 1×。达到 25 人后：永久为 25× = 25,000 AEQ。所有过渡均按人数自动触发。上限仅适用于个人：企业没有固定上限，改为缴纳闲置资金费；其他地址最多持有 1,000 AEQ。',
  ...
  'wealth-cap-explain':'第 0 阶段（启动）个人上限为 max(5, min(N, 25))× 1,000 AEQ 的公平份额，N = 已注册人数。1–4 人：5×。每新增一人增加 1×。25 人起：永久 25× = 25,000 AEQ。企业没有固定上限（缴纳闲置资金费）；其他地址最多持有 1,000 AEQ。',
  'btn-download-app':'下载 AEQUITAS 应用',
  'swap-title':'🔄 兑换 AEQ ↔ tUSD','swap-sub':'通过原生流动性池将AEQ兑换为tUSD（模拟测试美元）。兑换收取0.1%手续费；普通AEQ转账同样支付0.1%协议费，全部进入基本收入（无EVM Gas）。',
  'swap-priv-bar':'🔒 0.1%兑换费 · AEQ转账另收0.1%协议费（无EVM Gas） · tUSD测试货币',
  ...
  'swap-validators':'验证者 (40%)','swap-lps':'流动性提供者 (30%)','swap-ubi':'UBI 池 (30%)','swap-treasury':'国库 (0%)',
  'ubi-hero-title':'普遍基本收入 — UBI 池',
  'ubi-hero-sub':'累积中 — 下次平等分配给所有验证人类：',
  'ubi-hero-sub-empty':'自上次 20:00 发放后资金池为空。它由转账手续费、兑换手续费（0.1% 的 30%）、闲置资金费、退出费和超出上限的部分填充。',
  'ubi-time-bar-lbl':'距每日发放还有（柏林时间 20:00）',
  'ubi-bal-lbl':'当前池余额','ubi-hero-desc':'在所有验证人类中平等分配 · 每24小时支付 · 支付后池归零 · 无最低余额要求',
  'ubi-how-fills':'UBI 池如何填充',
  'ubi-src-swap':'兑换手续费','ubi-src-swap-d':'每次AEQ↔tUSD兑换贡献其0.1%手续费的30%。更多交易 = 更快填充。',
  'ubi-src-dem':'闲置资金费','ubi-src-dem-d':'超过 5,000 AEQ 的个人（每月 0.5%）、超过 1.5 个月营业额的企业（每月 0.5–1%）和其他地址（每月 1%）。每日结算，100% 进入基本收入。自 2026 年 9 月 26 日起。',
  'ubi-src-cap':'财富上限溢出','ubi-src-cap-d':'个人超出上限（公平份额的 25 倍 = 25,000 AEQ；注册人数少于 25 人时更低：每人 1,000 AEQ，至少 5,000）的部分会立即再分配。100% 流入基本收入。企业没有固定上限。',
  'pools4-header':'三个再分配资金池',
  'ubi-see-above':'见上方倒计时','ubi-timer-above':'⏰ 倒计时显示在上方',
  'usp-headline':'历史上首次 — 所有人在平等条件下起步',
  'usp-sub':'只需拥有一部Android智能手机即可参与。无需银行账户，无需加密货币知识，无需任何投资。',
  'usp-c1-title':'0.1% 手续费 · 无 EVM Gas','usp-c1-desc':'注册无需 ETH/MATIC Gas。转账收取 0.1% 协议手续费（节点实时数据），而不是“永久免费”。',
  'usp-c2-title':'每人1,000 AEQ','usp-c2-desc':'亿万富翁还是自给农民——每个人都正好获得 1,000 AEQ。不多也不少。所有人起点相同，写在代码里。',
  ...
  'gini-what-title':'什么是基尼系数？','gini-what-text':'由意大利统计学家科拉多·基尼于1912年提出。通过将实际余额与假设的完全平等基线进行比较来衡量财富分配。范围：0（人人均等）到1（一人独占）。世界银行、经合组织、联合国用于比较各国。参考值：比特币≈0.85 · 南非（世界纪录）≈0.63 · 美国≈0.41 · 德国≈0.31 · 北欧≈0.27 · Aequitas长期目标：基尼系数低于0.30。第 3 阶段（成熟期）须达到 100 万人且基尼系数低于 0.30 才会开始。','gini-calc-title':'如何计算Aequitas指数','gini-calc-text':'收集所有已验证真人的 AEQ 余额。公式计算所有可能余额对之间的平均绝对差，并以人口平方（n²）和平均余额（x̄）归一化。结果 0–1 乘以 100 = Aequitas 指数。节点根据实时余额计算；每次每日基本收入发放后都会保存一个快照，用于历史图表。','gini-why-title':'为什么选择基尼系数','gini-why-text':'简单的“最富与最穷之比”很容易被操纵：10,000 个钱包可能显示差距很小，而 90% 的 AEQ 却集中在 100 人手中——基尼系数能发现这一点，比值却不能。它用一个任何人都能复算的数字概括全部已验证真人的分布。它是测量值，而不是调节杠杆：阶段和财富上限取决于注册人数，再分配规则固定在协议中。任何人都无法改动读数。',
  ...
  'faq-title':'❓ 常见问题','faq-q1':'我的生物特征数据安全吗？','faq-a1':'你的人脸被采集并发送给两个独立的比对服务——这是检查“一人一账户”的唯一途径。照片和完整的人脸描述在几秒内丢弃，不会被存储。保留的是一份 64 字节的摘要（512 个是/否值）：无法从中还原人脸，但它能认出回来的人，因此被视为生物识别数据。一个坦率说明而非隐藏的限制：每个服务都持有完整摘要。任何单一服务都不持有完整摘要的拆分模式已构建并测试，但还不是具有约束力的检查。',
  'faq-q1b':'注册能证明我是独特的真实人类吗？','faq-a1b':'比设备密钥所能做到的更好，但尚无法用数字证明。自 2026-08-25 起，人脸由两个须同时同意的独立服务比对，证明服务器拒绝没有其签名证明的注册——因此同一个人在第二部手机上会被发现，这是设备密钥从未做到的。两项明示的限制：该日期之前注册的账户，只有在持有人于应用中补录人脸后才被覆盖（不会再次发放）；错误率尚未确定：阈值尚未用真实采集校准，这需要约 1,000 组冒名配对。活体检测：目前只有视线任务具有约束力；更强的信号正在测量和校准。从长远看，Aequitas 将依靠虹膜扫描来真正保证“一人一次注册”。目前正在研究如何可靠且保护隐私地实现；硬件和时间表尚未确定。',
  'faq-q2':'我以后可以用不同的钱包注册吗？','faq-a2':'不能。一次注册永久绑定到一个钱包地址。这是有意为之：由你的面部派生的 nullifier 只能使用一次，因此换一个钱包再次注册就等于同一个人拥有第二个身份。',
  'faq-q3':'如果我丢失手机会怎样？','faq-a3':'您的 AEQ 仍在您的钱包中——它与您的私钥绑定，而不是与手机绑定。您仍可通过 MetaMask 和助记词访问钱包。您的注册与您的面部绑定，而不是与设备绑定，因此换新手机不会让您失去注册。',
  'path-title':'选择您的路径','path-human-title':'我是人类','path-human-desc':'我想注册、获得1,000 AEQ并加入基本收入网络。','path-human-steps':'1. 下载 Aequitas 安卓应用<br>2. 在应用中完成简短的实时人脸检查<br>3. 连接 MetaMask<br>4. 检查通过后获得 1,000 AEQ',
...
id:{
  ...
  'x-phase-2-10-000-humans':'Tahap 2 (10.000+ orang):',
  'x-phase-3-1m-humans-gini':'Tahap 3 (1 juta+ orang dan Gini &lt; 0,30):',
  'nr-intro':'Saat ini jaringan berjalan di 2 validator aktif, masing-masing di server sendiri dengan basis data sendiri, dengan peristiwa MERGE dari keduanya. Hanya manusia terdaftar yang dapat menjalankan node validator — ini persyaratan keamanan. Langkah di bawah adalah target yang terkait dengan fase protokol: protokol menetapkan fase secara otomatis, tetapi belum mewajibkan jumlah node minimum.',
  'nr-0':'Dua server Contabo independen, masing-masing dengan basis data dan server bukti sendiri. Kepercayaan lewat kode yang transparan. Setiap manusia terdaftar sudah bisa bergabung sebagai validator — tanpa permohonan, tanpa jaminan.',
  'nr-1':'Lebih banyak operator node independen; masing-masing mendapat bagian dari pool validator (40% biaya tukar).',
  'nr-2':'Target: minimal 10 operator node independen.',
  'nr-3':'Target: BlockDAG yang sepenuhnya terdesentralisasi — tidak ada satu operator pun yang bisa menyensor atau menghentikan rantai.',
  'nr-outro':'Panduan operator node (PDF) ada di tab Jaringan. Setiap operator node baru mendapat bagian dari pool validator — makin banyak node, makin tangguh jaringannya.',
  ...
  'bv-desc':'Validator menjamin bahwa <strong style="color:var(--text)">angkanya cocok</strong>. Ia tidak menjamin satu hal yang menopang segalanya: bahwa <strong style="color:var(--text)">tak seorang pun mendaftar dua kali</strong>. Tanpa itu, “satu manusia, satu penghasilan” hanyalah slogan — buku besarnya benar sempurna dan sama sekali tak berharga. Hari ini janji itu bertumpu pada sangat sedikit mesin, dan setiap mesin yang Anda tambahkan membuatnya lebih sulit dipatahkan. Dua peran yang memikulnya — <strong style="color:var(--text)">verifier</strong> yang memutuskan apakah sebuah wajah sudah terdaftar, dan <strong style="color:var(--text)">koordinator</strong> yang mengumpulkan keputusan itu — berjalan di server yang sama. Panduan ini menyiapkan keduanya.',
  'bv-guide-sub':'Langkah demi langkah · Tanpa perlu tahu kriptografi · Sekitar 45 menit, sebagian besar menunggu',
  'bv-honest-d':'Bagian ini masih beta dan batasannya nyata. Perbandingan bersama memakai bahan kriptografis sekali pakai, dan satu pasokan saat ini menutup beberapa puluh pendaftaran sebelum perlu tambahan — jadi jalur rahasia ini membuktikan diri dulu dalam skala kecil, bukan jutaan. Bebannya juga tumbuh seiring jumlah orang yang terdaftar. Kami menerbitkan angka-angka ini alih-alih membulatkannya: sistem yang meminta wajah Anda tak berhak bersikap kabur tentang apa yang bisa dan belum bisa dilakukannya.',
  'bv-honest-t':'Di mana posisinya hari ini — terus terang',
  'bv-status-d':'Kode sumber verifier <strong style="color:var(--text)">belum publik</strong>, jadi langkah-langkah di bawah belum bisa dijalankan semua orang hari ini. Kami tetap menerbitkannya karena sebuah rancangan seharusnya bisa diperiksa sebelum dijalankan, bukan sesudahnya. Kalau Anda ingin menjalankan satu, tanyakan di grup Telegram yang tertaut di halaman depan. Membuka repositori inilah yang akan mengubah panduan ini dari rencana menjadi undangan, dan itu hal berikutnya yang kami utang kepada Anda.',
  'bv-status-t':'Status: beta tertutup — baca sebelum mulai',
  'bv-title':'Menjalankan validator saja belum cukup — inilah alasannya',
  'bv-guide-lang-note':'Langkah-langkah di bawah dalam bahasa Inggris. Bagian di atas — apa ini, apa yang dilindunginya, dan apa yang Anda tanggung — ada dalam bahasa Anda.',
  'bv-what-d':'Wajah tidak pernah dikirim kepada Anda sebagai gambar: gambar dibuang setelah pemeriksaan, dan mesin Anda hanya menyimpan cuplikan 64 byte (512 nilai ya/tidak) — cukup untuk mengenali orang yang kembali, tidak cukup untuk membangun ulang wajah. Ada mode terbagi di mana mesin Anda hanya memegang satu bagian aditif dari cuplikan itu — sendiri tak bisa dibedakan dari derau, dibandingkan bersama komite Anda sehingga tak seorang pun tahu lebih dari jawabannya. Mode itu sudah dibangun dan diuji tetapi <strong style="color:var(--text)">belum aktif</strong>, karena ambangnya belum pernah dikalibrasi. Sampai saat itu setiap verifier memegang cuplikan utuh, dan kami lebih suka mengatakannya daripada menyiratkan perlindungan yang belum Anda berikan.',
  'bv-what-t':'Apa yang akan Anda simpan — dan apa yang tak pernah Anda lihat',
  ...
  'x-0-1-split-40-30':'0,1 % · pembagian 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10.000 &#8211; 1 juta orang. Target: minimal 10 operator node independen.',
  'x-100-8211-10-000-humans':'100 &#8211; 10.000 orang. Batas 25×. Target: lebih banyak operator node independen.',
  'x-100-maximum-concentration':'100 = pemusatan maksimum',
  'x-1m-humans-global-ubi-at':'1 juta+ orang dan Gini di bawah 0,30 — keduanya harus terpenuhi. Pendapatan dasar global berskala besar.',
  
  
  
  'x-active-validators':'Validator aktif',
  'x-add-aequitas-chain-to-metamask':'Tambahkan rantai Aequitas ke MetaMask untuk melihat saldo AEQ, mengirim transaksi, dan berinteraksi dengan kontrak V7 langsung dari peramban atau dompet ponsel Anda.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas menerapkannya secara matematis. Setiap manusia terverifikasi menerima tepat 1.000 AEQ — miliarder atau petani subsisten, tanpa pengecualian. Aturan tetap — pungutan uang menganggur, batas kekayaan, dan pendapatan dasar harian — mencegah ketimpangan menumpuk tanpa batas. Koefisien Gini dihitung dari saldo terkini dan bisa diperiksa siapa pun.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'Sebanding dengan AS (~0,41) atau Prancis (~0,32). Dalam kisaran kebanyakan ekonomi maju.',
  ...
  'x-demurrage-0-5-mo':'Pungutan uang menganggur (0,5–1%/bln)',
  ...
  'co-pernode-d':'Pengesahan yang ditulis ke satu node tidak berpindah ke yang lain — tidak ada transaksi untuk itu dan tidak ada gosip. Daftar kepercayaan yang direplikasi justru akan menjadi otoritas pusat yang sengaja tidak ada di sistem ini: setiap operator memutuskan sendiri atestasi siapa yang diterima nodenya. Biayanya, pengesahan Anda harus dikirim ke setiap node yang harus menghormatinya. Tanda tangannya sendiri dapat dipindahkan: tanda tangani sekali, kirim ke mana-mana; node yang Anda lewati akan terus menolak Anda.',
  'co-law-t':'Apa yang Anda ketahui tentang orang lain — dan konsekuensinya',
  'co-law-d':'Tangkapan itu lewat pada Anda; Anda meneruskannya dan tidak menyimpan apa pun. Tetapi hanya Anda yang memegang pemetaan antara alamat dompet dan penanda bagi orang-orang yang mendaftar melalui Anda — itulah sebabnya kunci penanda Anda harus tetap milik Anda: jika dibagi, operator mana pun dapat menghitung penanda untuk alamat publik mana pun dan menelusuri wajah siapa itu. Artinya juga Anda menjadi <strong style="color:var(--text)">pengendali data</strong> bagi orang-orang itu menurut GDPR. Bukan kami. Permintaan akses, penghapusan dan keberatan sampai kepada Anda, dan itu bukan formalitas.',
  'co-limit-t':'Satu batasan yang timbul darinya',
  'co-limit-d':'Penghapusan berdasarkan alamat dompet hanya berhasil di koordinator tempat pendaftaran dibuat: penanda Anda bergantung pada kunci Anda, dan koordinator lain menurunkan penanda berbeda untuk alamat yang sama. Maka "tidak ditemukan" dari tempat lain berarti "tidak terdaftar di sini", bukan "tidak terdaftar" — dan jawabannya menyatakan itu. Jalur melalui bio_hash sendiri, yang menjadi milik orang itu dan tidak butuh operator sama sekali, bekerja di setiap koordinator, karena pengenal itu tetap sama.',
  ...
  'x-healthier-than-most-nations-on':'Lebih sehat daripada kebanyakan negara di dunia. Sebanding dengan Skandinavia (~0,27) dan Jerman (~0,31).',
  'x-higher-than-most-european-nations':'Lebih tinggi daripada kebanyakan negara Eropa — sebanding dengan Brasil (~0,53). Aturan tidak berubah mengikuti indeks; pungutan uang menganggur dan batas kekayaan bekerja terus-menerus.',
  'x-honest-limitation':'Keterbatasan yang diakui:',
  'x-why-sybil-resistance':'Mengapa resistensi Sybil?','x-how-it-works':'Cara kerjanya',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'nilai acak, diterbitkan setelah pemeriksaan wajah (tidak diturunkan dari wajah)',
  ...
  'x-phase-transitions-are-automatic-8212':'Protokol menetapkan fase secara otomatis — fase 0 sampai 2 menurut jumlah manusia, fase 3 hanya bila ada 1 juta manusia dan Gini di bawah 0,30. Tanpa voting tata kelola, tanpa kunci admin. Fase hanyalah status: batas kekayaan dan pungutan uang menganggur tidak bergantung padanya, dan target node belum ditegakkan oleh kode.',
  ...
  'x-swap-fees-0-1':'Biaya transfer & swap (0,1%)',
  'x-sybil-resistance-8212-current-state':'Ketahanan Sybil &#8212; keadaan sekarang, sejujurnya',
  'x-the-4-redistribution-mechanisms':'3 dana redistribusi',
  ...
  'x-ubi-pool-20':'Dana pendapatan dasar',
  ...
  'x-worse-than-any-country-on':'Lebih buruk daripada negara mana pun (rekor Afrika Selatan: ~0,63). Mendekati Bitcoin (~0,85). Dengan sedikit manusia terdaftar hal ini cepat terjadi; aturannya tetap sama.',
  ...
  'reg-sub':'Bergabunglah dengan jaringan Aequitas dan terima hibah awal 1.000 AEQ. Pendaftaran sekali dan permanen. Ini masih beta: diperiksa, dengan batas yang disebutkan — lihat peringatan beta di bawah.',
  'app-title':'PENDAFTARAN HANYA MELALUI APLIKASI ANDROID',
  'app-text':'Pendaftaran hanya berjalan di aplikasi Android: tangkapan wajah singkat, diperiksa oleh dua layanan pencocokan independen. Setelah itu <strong style="color:var(--gold)">1.000 AEQ dikreditkan otomatis</strong>. Apa yang disimpan dan tidak: langkah 1 dan peringatan beta di bawah.',
  's1t':'Hubungkan','s1d':'Aplikasi merekam wajah Anda dan urutan singkat deteksi kehidupan (berkedip, melirik ke sisi acak, kilatan warna) lalu mengirimkannya ke dua layanan pencocokan independen. Keduanya membandingkan wajah itu dengan semua yang terdaftar dengan wajah. Foto dibuang dalam hitungan detik; hanya cuplikan 64 byte yang disimpan.',
  's2t':'Buktikan','s2d':'Bukti ZK Groth16 mengikat bio_hash Anda ke dalam commitment (Poseidon dari bio_hash, dompet, dan salt) tanpa mengungkapkannya. Server bukti hanya menerbitkannya dengan pengikatan dompet dan atestasi bertanda tangan dari kedua layanan, dan nullifier hanya bisa dipakai sekali — wajah yang sama tidak dihitung dua kali.',
  ...
  'priv-bar':'🔒 Beta · Pemeriksaan wajah oleh 2 layanan independen · Wajib 2 atestasi bertanda tangan · ZKP Groth16 · Hanya cuplikan 64 byte yang disimpan',
  'conn-wallet':'DOMPET TERHUBUNG','proof-recv':'⚡ BUKTI ZK DITERIMA','proof-hint':'Hubungkan dompet untuk mendaftar',
  'btn-conn':'🦊 HUBUNGKAN METAMASK','btn-reg':'🔐 DAFTAR ON-CHAIN','reg-apk-note':'Pendaftaran memerlukan aplikasi dengan pemeriksaan wajah (app.apk dari situs ini; gunakan versi terbaru agar penolakan menampilkan kode keberatannya).',
  'btn-wc':'🔗 HUBUNGKAN WALLETCONNECT',
  'reg-log-hint':'// Aplikasi mendaftarkan Anda sendiri. Tombol di atas hanya diperlukan jika Anda tiba di sini lewat tautan berisi bukti yang sudah jadi.',
  'reg-details':'Detail Pendaftaran','k-network':'Jaringan','k-chainid':'ID Rantai','k-grant':'Hibah UBI',
  'k-fee':'Biaya Gas','free':'Biaya protokol 0,1% — tanpa gas EVM','k-limit':'Pendaftaran','k-limit-v':'Sekali per orang · permanen · tidak dapat diubah',
  'k-bio':'Wajah','never-stored':'Foto dibuang dalam hitungan detik — setiap layanan pencocokan hanya menyimpan cuplikan 64 byte',
  ...
  'h-zkp':'Sistem Bukti ZK','h-zkp-t':'Aequitas memakai Groth16 di BN128 — kurva yang sama dengan Ethereum dan Zcash. Bukti: ~200 byte. Verifikasi: ~10 ms. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). Nullifier berasal dari wajah, bukan dari ponsel: perangkat kedua tidak membuat orang yang sama bisa mendaftar lagi, dan kehilangan ponsel tidak menghilangkan pendaftaran Anda. Poseidon dipakai alih-alih perkalian karena nullifier sirkuit terdahulu dapat dibalik — siapa pun bisa memulihkan bioHash darinya.',
  'h-sybil':'Ketahanan Sybil — Kondisi Saat Ini','h-sybil-t':'Sejak 25-08-2026 server bukti menolak pendaftaran tanpa atestasi bertanda tangan dari kedua layanan pencocokan — sehingga wajah yang sama tidak bisa didaftarkan dua kali, juga lintas perangkat, hal yang tak pernah bisa dilakukan kunci perangkat. Dua batas yang disebutkan: akun dari sebelum tanggal itu baru tercakup setelah pemiliknya menambahkan wajah di aplikasi, dan ambang pencocokan belum dikalibrasi dengan tangkapan nyata: kriptografinya pasti, biometri di bawahnya adalah pengukuran yang laju kesalahannya belum dihitung. Deteksi kehidupan: saat ini hanya tugas lirikan yang mengikat; kilatan warna, denyut, dan paralaks diukur dan akan ikut menentukan setelah dikalibrasi.',
  ...
  'h-bio-hw':'Peta Jalan Verifikasi Identitas','h-bio-hw-t':'Saat ini (beta): pemeriksaan wajah oleh dua layanan pencocokan independen yang keduanya harus setuju, dan server bukti yang menolak pendaftaran tanpa atestasi bertanda tangan mereka. Yang disimpan hanya cuplikan 64 byte, tidak pernah foto atau templat utuh. Ambangnya belum dikalibrasi dengan tangkapan nyata — perlu sekitar 1000 pasangan impostor sebelum angka apa pun disebut. Direncanakan: kalibrasi itu, deteksi kehidupan yang mengikat dari sinyal yang sudah diukur (kilatan warna, denyut, paralaks), hibah bertahap untuk tangkapan yang meragukan, dan pemeriksaan duplikat di mana tidak ada layanan yang memegang bahkan cuplikan utuh. Dalam jangka panjang, Aequitas akan mengandalkan pemindaian iris untuk benar-benar menjamin satu orang, satu pendaftaran. Cara menerapkannya secara andal dan menjaga privasi sedang dikerjakan saat ini; perangkat keras dan jadwalnya belum ditentukan.',
  'reg-humans':'Manusia Terdaftar','h-desc':'Setiap alamat di bawah milik seseorang yang wajahnya diperiksa oleh layanan independen terhadap semua pendaftaran yang ada, dibuktikan dengan bukti ZK, dan dikreditkan tepat 1.000 AEQ. Registri bersifat permanen, tidak dapat diubah, dan on-chain. Apa yang dijamin dan tidak dijamin ambang saat ini ada di FAQ. Pengecualian yang diketahui dan terbatas: akun yang didaftarkan sebelum pemeriksaan wajah (25-08-2026) tidak punya templat wajah.',
  ...
  'pools-desc':'Biaya transfer 100% masuk UBI. Biaya swap dibagi 40% validator / 30% penyedia likuiditas / 30% UBI. Pungutan uang mengendap, pungutan keluar 2% dan kelebihan di atas batas 100% masuk UBI. Tidak ada yang bisa membayar dari pool, bahkan dengan kuncinya; hanya protokol yang membagikan, setiap hari.',
  'vel-pool':'Pool Validator','vel-pool-desc':'40% biaya swap → setiap manusia terverifikasi yang menjalankan validator mendapat bagian yang sama, hanya ditimbang menurut menit node-nya online hari itu.',
  'liq-pool':'Pool Likuiditas','liq-pool-desc':'30% biaya swap → penyedia likuiditas AEQ/tUSD, sebanding dengan bagian LP mereka. Likuiditas lebih dalam = dampak harga lebih kecil bagi semua.',
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100% biaya transfer + 30% biaya swap + 100% pungutan uang mengendap, pungutan keluar, dan kelebihan di atas batas → dibagi rata kepada semua manusia terverifikasi setiap 24 jam.',
  'phases-title':'Fase Protokol',
  'demurrage-title':'Pungutan uang mengendap: dorongan untuk berputar',
  'demurrage-desc':'Mulai 26 September 2026 uang yang mengendap membayar pungutan kecil menurut jenis akun. Kehidupan sehari-hari dan tabungan biasa tidak tersentuh, dan pungutannya 100% masuk ke pendapatan dasar.',
  'dem-rate-k':'Tarif','dem-rate-v':'Orang: 0,5%/bulan di atas 5.000 AEQ · Usaha: 0,5%/bulan di atas 1,5 bulan omzet, 1% di atas 3 bulan omzet · Alamat lain: 1%/bulan',
  ...
  'dem-title':'3. PUNGUTAN UANG MENGENDAP: mekanisme anti-penimbunan',
  'dem-box':'Orang: 0,5%/bulan hanya atas bagian di atas 5.000 AEQ; kehidupan sehari-hari dan tabungan tetap utuh<br>Usaha: hingga 1,5 bulan omzet bebas (minimal 2.000 AEQ), lalu 0,5%/bulan, di atas 3 bulan omzet 1%/bulan<br>Alamat lain: 1%/bulan, paling banyak 250 AEQ<br>Diselesaikan setiap hari, 100% ke pendapatan dasar (tidak dibakar)',
  'dem-text':'<p>Preseden sejarah: eksperimen Wörgl (Austria, 1932) memakai mata uang demurrage dan menurunkan pengangguran 25% dalam setahun. Chiemgauer (Jerman, 2003) telah berjalan sukses lebih dari 20 tahun dengan mekanisme serupa.</p><p>Aturan ini berlaku sejak 26 September 2026. Sebelum itu berlaku aturan lama: 0,5%/bln atas bagian di atas bagian adil setelah 3 bulan tanpa aktivitas.</p>',
  'cap-title':'4. BATAS KEKAYAAN — Penerapan Keadilan Matematis','cap-box':'Batas untuk manusia: max(5,min(N,25))× bagian adil (1.000 AEQ)<br>1–4 orang: 5× · +1× per orang · mulai 25: 25× selamanya<br>Kelebihan langsung didistribusikan ulang · Bisnis: tanpa batas tetap, membayar pungutan uang mengendap · Alamat lain: paling banyak 250 AEQ',
  'ubi-title':'5. PENDAPATAN DASAR UNIVERSAL — Redistribusi Harian','ubi-box':'Sumber: biaya transfer (100%) · biaya swap (30%) · pungutan uang mengendap · pungutan keluar (2%) · kelebihan di atas batas · escrow tidak aktif<br><br>Harian: pool UBI dibagi rata kepada semua manusia terdaftar. Setelah setiap pembagian pool kembali nol dan terisi lagi terus-menerus.',
  ...
  'phases-desc':'Batas untuk manusia pada Fase 0 memakai pengali awal: max(5, min(N, 25))× bagian adil (1.000 AEQ per orang). Dengan 1–4 orang: 5×. Setiap orang baru menambah 1×. Mulai 25 orang: tetap 25× = 25.000 AEQ selamanya. Semua transisi berjalan otomatis menurut jumlah manusia. Batas ini hanya berlaku bagi manusia: bisnis tidak punya batas tetap dan membayar pungutan uang mengendap; alamat lain paling banyak memegang 1.000 AEQ.',
  ...
  'p3':'Kematangan · 1 juta+ orang dan Gini di bawah 0,30 · Batas Kekayaan: 25× bagian adil = 25.000 AEQ',
  'wealth-cap-explain':'Batas untuk manusia pada Fase 0 (awal) adalah max(5, min(N, 25))× bagian adil 1.000 AEQ, dengan N = manusia terdaftar. 1–4 orang: 5×. Setiap orang baru menambah 1×. Mulai 25: 25× = 25.000 AEQ selamanya. Bisnis tidak punya batas tetap (membayar pungutan uang mengendap); alamat lain paling banyak 1.000 AEQ.',
  'btn-download-app':'UNDUH APLIKASI AEQUITAS',
  'swap-title':'🔄 Tukar AEQ ↔ tUSD','swap-sub':'Tukarkan AEQ dengan tUSD (dolar uji simulasi) melalui pool likuiditas asli. Pertukaran dikenakan biaya 0,1%; transfer AEQ biasa juga membayar biaya protokol 0,1% yang seluruhnya masuk ke pendapatan dasar (tanpa gas EVM).',
  'swap-priv-bar':'🔒 0,1% biaya swap · Transfer AEQ 0,1% protokol (tanpa gas EVM) · tUSD mata uang uji',
  ...
  'swap-validators':'Validator (40%)','swap-lps':'Penyedia Likuiditas (30%)','swap-ubi':'Pool UBI (30%)','swap-treasury':'Perbendaharaan (0%)',
  ...
  'ubi-hero-sub-empty':'Pool kosong sejak pembayaran terakhir pukul 20:00. Pool terisi dari biaya transfer, biaya swap (30% dari 0,1%), pungutan uang mengendap, pungutan keluar, dan kelebihan di atas batas.',
  'ubi-time-bar-lbl':'Waktu hingga pembayaran harian (20.00 waktu Berlin)',
  ...
  'ubi-src-swap':'Biaya Swap','ubi-src-swap-d':'Setiap swap AEQ↔tUSD berkontribusi 30% dari biaya 0,1%-nya. Lebih banyak trading = pengisian lebih cepat.',
  'ubi-src-dem':'Pungutan uang mengendap','ubi-src-dem-d':'Orang di atas 5.000 AEQ (0,5%/bulan), usaha di atas 1,5 bulan omzet (0,5–1%/bulan), dan alamat lain (1%/bulan). Diselesaikan setiap hari, 100% masuk ke pendapatan dasar. Mulai 26 Sep 2026.',
  'ubi-src-cap':'Overflow Batas Kekayaan','ubi-src-cap-d':'Orang di atas batas (25× bagian adil = 25.000 AEQ; lebih rendah selama kurang dari 25 manusia terdaftar: 1.000 AEQ per manusia, minimal 5.000) kelebihannya langsung diredistribusi. 100% masuk ke pendapatan dasar. Usaha tidak punya batas tetap.',
  'pools4-header':'TIGA POOL REDISTRIBUSI',
  'ubi-see-above':'lihat hitung mundur di atas','ubi-timer-above':'⏰ hitung mundur ditampilkan di atas',
  ...
  'usp-c1-title':'Biaya 0,1% · tanpa gas EVM','usp-c1-desc':'Tidak perlu gas ETH/MATIC untuk mendaftar. Transfer dikenai biaya protokol 0,1% (langsung dari node) — bukan “gratis selamanya”.',
  'usp-c2-title':'1.000 AEQ untuk setiap manusia','usp-c2-desc':'Miliarder atau petani subsisten — setiap orang mendapat tepat 1.000 AEQ. Tidak lebih, tidak kurang. Awal yang sama untuk semua, ditetapkan dalam kode.',
  ...
  'gini-what-title':'Apa itu Koefisien Gini?','gini-what-text':'Dikembangkan oleh ahli statistik Italia Corrado Gini (1912). Mengukur distribusi kekayaan dengan membandingkan saldo aktual dengan basis yang secara hipotetis sepenuhnya setara. Skala: 0 (semua sama) hingga 1 (satu orang menguasai semua). Digunakan oleh Bank Dunia, OECD, PBB untuk membandingkan negara. Nilai referensi: Bitcoin ≈ 0,85 · Afrika Selatan (rekor dunia) ≈ 0,63 · AS ≈ 0,41 · Jerman ≈ 0,31 · Skandinavia ≈ 0,27 · Target jangka panjang Aequitas: Gini di bawah 0,30. Fase 3 (kematangan) baru tercapai dengan 1 juta manusia dan Gini di bawah 0,30.','gini-calc-title':'Bagaimana Indeks Aequitas dihitung','gini-calc-text':'Semua saldo AEQ manusia terverifikasi dikumpulkan. Rumus menghitung selisih absolut rata-rata antara semua pasangan saldo yang mungkin, dinormalisasi dengan kuadrat populasi (n²) dan saldo rata-rata (x̄). Hasil 0–1 dikali 100 = Indeks Aequitas. Node menghitungnya dari saldo terkini; setelah setiap pembayaran pendapatan dasar harian, satu cuplikan disimpan untuk grafik riwayat.','gini-why-title':'Mengapa Gini','gini-why-text':'Rasio sederhana terkaya-vs-termiskin mudah dimanipulasi: 10.000 dompet bisa menunjukkan sebaran kecil sementara 90% AEQ ada di 100 tangan — Gini mendeteksinya, rasio tidak. Gini merangkum seluruh distribusi semua manusia terverifikasi dalam satu angka yang bisa dihitung ulang siapa pun. Ini adalah pengukuran, bukan tuas kendali: fase dan batas kekayaan mengikuti jumlah manusia terdaftar, dan aturan redistribusi ditetapkan dalam protokol. Tidak ada yang bisa mengubah hasil ukurnya.',
  ...
  'faq-title':'❓ Pertanyaan Umum','faq-q1':'Apakah data biometrik saya aman?','faq-a1':'Wajah Anda direkam dan dikirim ke dua layanan pencocokan independen — hanya dengan cara itu “satu orang, satu akun” bisa diperiksa. Foto dan deskripsi wajah lengkap dibuang dalam hitungan detik; tidak disimpan. Yang disimpan adalah cuplikan 64 byte (512 nilai ya/tidak): wajah tidak bisa direkonstruksi darinya, tetapi ia mengenali orang yang kembali, sehingga diperlakukan sebagai data biometrik. Satu batas jujur, disebutkan bukan disembunyikan: setiap layanan memegang cuplikan utuh. Mode terbagi di mana tidak ada layanan yang memegangnya utuh sudah dibangun dan diuji, tetapi belum menjadi pemeriksaan yang mengikat.',
  'faq-q1b':'Apakah pendaftaran membuktikan saya orang unik yang nyata?','faq-a1b':'Lebih baik daripada yang pernah bisa dilakukan kunci perangkat, dan belum bisa dibuktikan dengan angka. Sejak 25-08-2026 wajah dibandingkan oleh dua layanan independen yang keduanya harus setuju, dan server bukti menolak pendaftaran tanpa atestasi bertanda tangan mereka — sehingga orang yang sama di ponsel kedua tertangkap, hal yang tak pernah bisa dilakukan kunci perangkat. Dua batas yang disebutkan: akun dari sebelum tanggal itu baru tercakup setelah pemiliknya menambahkan wajah di aplikasi (tanpa hibah baru), dan laju kesalahan belum ditetapkan: ambang belum dikalibrasi dengan tangkapan nyata, yang memerlukan sekitar 1.000 pasangan impostor. Deteksi kehidupan: saat ini hanya tugas lirikan yang mengikat; sinyal yang lebih kuat sedang diukur dan dikalibrasi. Dalam jangka panjang, Aequitas akan mengandalkan pemindaian iris untuk benar-benar menjamin satu orang, satu pendaftaran. Cara menerapkannya secara andal dan menjaga privasi sedang dikerjakan saat ini; perangkat keras dan jadwalnya belum ditentukan.',
  ...
  'faq-q3':'Apa yang terjadi jika saya kehilangan ponsel?','faq-a3':'AEQ Anda tetap di dompet Anda — terikat pada kunci privat Anda, bukan pada ponsel. Anda tetap bisa mengakses dompet lewat MetaMask dengan frasa pemulihan. Pendaftaran Anda terikat pada wajah Anda, bukan pada perangkat, jadi ponsel baru tidak membuat Anda kehilangan pendaftaran.',
  'path-title':'Pilih Jalur Anda','path-human-title':'Saya adalah Manusia','path-human-desc':'Saya ingin mendaftar, menerima 1.000 AEQ, dan bergabung dengan jaringan penghasilan dasar.','path-human-steps':'1. Unduh aplikasi Android Aequitas<br>2. Lakukan pemeriksaan wajah langsung yang singkat di aplikasi<br>3. Hubungkan MetaMask<br>4. Terima 1.000 AEQ setelah pemeriksaan lolos',
  'path-node-title':'Saya adalah Operator Node','path-node-desc':'Saya ingin menjalankan node penuh, berpartisipasi dalam produksi blok, dan menghasilkan dari pool validator 40%.','path-node-steps':'1. Daftar sebagai manusia (wajib)<br>2. Tidak ada titik masuk yang perlu dikonfigurasi — alamat validator sudah tertanam<br>3. Deploy di Contabo/Hetzner/VPS mana pun<br>4. Hasilkan harian dari pool validator',
...
it:{
  ...
  'x-phase-2-10-000-humans':'Fase 2 (oltre 10.000 persone):',
  'x-phase-3-1m-humans-gini':'Fase 3 (oltre 1 mln di persone e Gini &lt; 0,30):',
  'nr-intro':'Attualmente la rete gira su 2 validatori attivi, ognuno sul proprio server con il proprio database, con eventi MERGE da entrambi. Solo persone registrate possono gestire nodi validatori: è un requisito di sicurezza. I passi seguenti sono obiettivi legati alle fasi del protocollo: il protocollo stabilisce la fase automaticamente, ma non impone ancora un numero minimo di nodi.',
  'nr-0':'Due server Contabo indipendenti, ognuno con il proprio database e il proprio server delle prove. Fiducia tramite codice trasparente. Ogni persona registrata può già unirsi come validatore, senza domanda e senza deposito.',
  'nr-1':'Più operatori di nodo indipendenti; ognuno riceve una quota del fondo validatori (40% delle commissioni di scambio).',
  'nr-2':'Obiettivo: almeno 10 operatori di nodo indipendenti.',
  'nr-3':'Obiettivo: un BlockDAG del tutto decentralizzato; nessun singolo operatore può censurare o fermare la catena.',
  'nr-outro':'La guida per gli operatori di nodo (PDF) è nella scheda Rete. Ogni nuovo operatore guadagna dal fondo validatori: più nodi, più resistente la rete.',
  ...
  'bv-desc':'Un validatore garantisce che <strong style="color:var(--text)">i conti tornino</strong>. Non garantisce l\'unica cosa su cui poggia tutto il resto: che <strong style="color:var(--text)">nessuno si registri due volte</strong>. Senza quello, «una persona, un reddito» è solo uno slogan: il registro sarebbe perfettamente corretto e completamente inutile. Oggi quella promessa poggia su pochissime macchine, e ognuna che Lei aggiunge la rende più difficile da spezzare. I due ruoli che la reggono — il <strong style="color:var(--text)">verificatore</strong>, che decide se un volto è già iscritto, e il <strong style="color:var(--text)">coordinatore</strong>, che raccoglie quelle decisioni — girano sullo stesso server. Questa guida configura entrambi.',
  'bv-guide-sub':'Passo dopo passo · Nessuna conoscenza di crittografia · Circa 45 minuti, per lo più attesa',
  'bv-honest-d':'Questa parte è in beta e i limiti sono reali. Il confronto congiunto consuma materiale crittografico monouso, e una fornitura copre per ora poche decine di registrazioni prima che ne serva altro: la via riservata si dimostra prima su piccola scala, non su milioni. Il lavoro cresce inoltre con il numero di persone iscritte. Pubblichiamo queste cifre invece di arrotondarle: un sistema che chiede il Suo volto non ha alcun diritto di restare vago su ciò che sa fare e ciò che ancora non sa.',
  'bv-honest-t':'A che punto siamo oggi — senza giri di parole',
  'bv-status-d':'Il codice del verificatore <strong style="color:var(--text)">non è ancora pubblico</strong>, quindi oggi non tutti possono completare i passi qui sotto. Li pubblichiamo comunque perché un progetto dovrebbe poter essere verificato prima di essere messo in funzione, non dopo. Se desidera gestirne uno, chieda nel gruppo Telegram indicato in home page. Aprire questo repository è ciò che trasformerà questa guida da progetto a invito, ed è la prossima cosa che Vi dobbiamo.',
  'bv-status-t':'Stato: beta chiusa — da leggere prima di iniziare',
  'bv-title':'Un validatore da solo non basta, ed ecco perché',
  'bv-guide-lang-note':'I passaggi qui sotto sono in inglese. Le sezioni sopra — che cos\'è, che cosa protegge e di che cosa Lei si fa carico — sono nella Sua lingua.',
  'bv-what-d':'Un volto non Le arriva mai come immagine: l\'immagine viene scartata dopo la verifica e la Sua macchina conserva solo un estratto di 64 byte (512 valori sì/no) — abbastanza per riconoscere chi ritorna, non abbastanza per ricostruire un volto. Esiste una modalità ripartita in cui la Sua macchina terrebbe solo una quota additiva di quell\'estratto — da sola indistinguibile dal rumore, confrontata insieme al Suo comitato così che nessuno sappia più della risposta. È costruita e testata ma <strong style="color:var(--text)">non ancora attiva</strong>, perché la sua soglia non è mai stata tarata. Fino ad allora ogni verificatore detiene l\'estratto intero, e preferiamo dirlo piuttosto che lasciar intendere una protezione che Lei non sta ancora dando.',
  'bv-what-t':'Che cosa avrebbe — e che cosa non vedrebbe mai',
  ...
  'x-0-1-split-40-30':'0,1 % · ripartizione 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10.000 &#8211; 1 mln di persone. Obiettivo: almeno 10 operatori di nodo indipendenti.',
  'x-100-8211-10-000-humans':'100 &#8211; 10.000 persone. Tetto 25×. Obiettivo: più operatori di nodo indipendenti.',
  'x-100-maximum-concentration':'100 = concentrazione massima',
  'x-1m-humans-global-ubi-at':'Oltre 1 mln di persone e Gini sotto 0,30: servono entrambe. Reddito di base mondiale su larga scala.',
  
  
  
  'x-active-validators':'Validatori attivi',
  'x-add-aequitas-chain-to-metamask':'Aggiunga la catena Aequitas a MetaMask per vedere il saldo AEQ, inviare transazioni e interagire con il contratto V7 dal browser o dal portafoglio mobile.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas lo realizza in modo matematico. Ogni umano verificato riceve esattamente 1.000 AEQ — miliardario o agricoltore di sussistenza, senza eccezioni. Regole fisse — prelievo sul denaro inattivo, tetto di ricchezza e reddito di base giornaliero — impediscono che la disuguaglianza si accumuli senza limiti. Il coefficiente di Gini è calcolato dai saldi attuali e chiunque può verificarlo.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'Paragonabile agli USA (~0,41) o alla Francia (~0,32). Nell’intervallo della maggior parte delle economie sviluppate.',
  ...
  'x-demurrage-0-5-mo':'Prelievo sul denaro inattivo (0,5–1 %/mese)',
  ...
  'co-pernode-d':'Un\'autorizzazione scritta su un nodo non viaggia verso gli altri: non esiste una transazione per farlo né alcun gossip. Una lista di fiducia replicata sarebbe esattamente l\'autorità centrale senza la quale questo sistema è costruito: ogni operatore decide da sé quali attestazioni il suo nodo accetta. Il costo è che la Sua autorizzazione va inviata a ogni nodo che debba riconoscerla. La firma è trasferibile: si firma una volta e la si manda ovunque; un nodo saltato continuerà semplicemente a rifiutarLa.',
  'co-law-t':'Cosa viene a sapere sugli altri — e cosa ne consegue',
  'co-law-d':'L\'acquisizione passa attraverso di Lei; Lei la inoltra e non trattiene nulla. Ma è l\'unico a possedere la corrispondenza tra indirizzo del portafoglio e marcatore per chi si registra tramite Lei — ed è per questo che la Sua chiave dei marcatori deve restare Sua: se condivisa, qualsiasi operatore potrebbe calcolare il marcatore per qualsiasi indirizzo pubblico e risalire a chi appartiene quel volto. Significa anche che Lei diventa <strong style="color:var(--text)">titolare del trattamento</strong> per quelle persone secondo il GDPR. Non noi. Richieste di accesso, cancellazione e opposizione arrivano a Lei, e non è una formalità.',
  'co-limit-t':'L\'unica limitazione che ne deriva',
  'co-limit-d':'La cancellazione tramite indirizzo del portafoglio funziona solo presso il coordinatore dove l\'iscrizione è avvenuta: il Suo marcatore dipende dalla Sua chiave, e un altro coordinatore ne deriva uno diverso per lo stesso indirizzo. Un «non trovato» da altrove significa quindi «non registrato qui», non «non registrato» — e la risposta lo dice. La via attraverso il proprio bio_hash, quella che appartiene alla persona stessa e non richiede alcun operatore, funziona presso ogni coordinatore, perché quell\'identificativo resta lo stesso.',
  ...
  'x-healthier-than-most-nations-on':'Più sano della maggior parte dei paesi al mondo. Paragonabile alla Scandinavia (~0,27) e alla Germania (~0,31).',
  'x-higher-than-most-european-nations':'Più alto della maggior parte dei paesi europei — paragonabile al Brasile (~0,53). Le regole non cambiano con l’indice; il prelievo sul denaro inattivo e il tetto di ricchezza agiscono di continuo.',
  'x-honest-limitation':'Limite dichiarato:',
  'x-why-sybil-resistance':'Perché resistenza Sybil?','x-how-it-works':'Come funziona',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'valore casuale, emesso dopo la verifica del volto (non derivato dal volto)',
  ...
  'x-metamask-mobile-if-aeq-shows':'📱 MetaMask Mobile: se dopo l’aggiunta AEQ risulta 0, elimini la rete e la riaggiunga con il pulsante qui sopra.',
  ...
  'x-phase-transitions-are-automatic-8212':'Il protocollo stabilisce la fase automaticamente: dalla 0 alla 2 in base al numero di persone, la 3 solo con 1 mln di persone e un Gini sotto 0,30. Nessun voto di governance, nessuna chiave di amministratore. La fase è uno stato: il tetto patrimoniale e il contributo sul denaro inattivo non dipendono da essa, e gli obiettivi sui nodi non sono ancora imposti dal codice.',
  'x-postgresql-persistent':'PostgreSQL (persistente)',
  'x-protocol-v7':'📜 Protocol V7',
  'x-provide-aeq-tusd-liquidity-to':'Fornisca liquidità AEQ / tUSD per guadagnare il 30 % di tutte le commissioni di scambio, distribuite ogni giorno.',
  ...
  'x-swap-fees-0-1':'Commissioni trasferimento e swap (0,1%)',
  'x-sybil-resistance-8212-current-state':'Resistenza Sybil &#8212; lo stato attuale, con franchezza',
  'x-the-4-redistribution-mechanisms':'I 3 fondi di redistribuzione',
  ...
  'x-ubi-pool-20':'Fondo reddito di base',
  ...
  'x-worse-than-any-country-on':'Peggio di qualsiasi paese al mondo (record del Sudafrica: ~0,63). Si avvicina a Bitcoin (~0,85). Con pochi umani registrati succede in fretta; le regole restano le stesse.',
  ...
  'reg-sub':'Entri nella rete Aequitas e riceva il Suo accredito iniziale di 1.000 AEQ. La registrazione è unica e permanente. È in beta: verificata, con limiti dichiarati — veda l\'avvertenza beta qui sotto.',
  'app-title':'REGISTRAZIONE SOLO VIA APP ANDROID',
  'app-text':'La registrazione avviene solo nell\'app Android: una breve acquisizione del volto, verificata da due servizi di confronto indipendenti. Poi <strong style="color:var(--gold)">vengono accreditati automaticamente 1.000 AEQ</strong>. Cosa viene conservato e cosa no: passo 1 e l\'avvertenza beta qui sotto.',
  's1t':'Connettere','s1d':'L\'app registra il Suo volto e una breve sequenza di vitalità (battito di ciglia, uno sguardo verso un lato casuale, lampi di colore) e li invia a due servizi di confronto indipendenti. Questi confrontano il volto con tutte le persone registrate con il volto. La foto viene scartata in pochi secondi; resta solo un estratto di 64 byte.',
  's2t':'Prova','s2d':'Una prova ZK Groth16 lega il Suo bio_hash in un commitment (Poseidon di bio_hash, wallet e un sale) senza rivelarlo. Il server delle prove la rilascia solo con il vincolo al wallet e le attestazioni firmate dei due servizi, e il nullifier si può usare una sola volta: lo stesso volto non conta due volte.',
  's3t':'Ricevere','s3d':'Registrazione confermata su Aequitas BlockDAG entro 1 secondo · 1.000 AEQ accreditati istantaneamente · la Sua identità è registrata permanentemente come umano verificato',
  'priv-bar':'🔒 Beta · Verifica del volto da 2 servizi indipendenti · 2 attestazioni firmate obbligatorie · ZKP Groth16 · Resta solo un estratto di 64 byte',
  'conn-wallet':'WALLET CONNESSO','proof-recv':'⚡ PROVA ZK RICEVUTA','proof-hint':'Connetta il wallet per registrarsi',
  'btn-conn':'🦊 CONNETTI METAMASK','btn-reg':'🔐 REGISTRA ON-CHAIN','reg-apk-note':'La registrazione richiede l\'app con verifica del volto (app.apk da questo sito; usi la versione attuale, così un rifiuto mostra il codice per l\'opposizione).',
  'btn-wc':'🔗 CONNETTI WALLETCONNECT',
  'reg-log-hint':'// L\'app La registra da sola. I pulsanti qui sopra servono solo se è arrivato qui tramite un link con una prova già pronta.',
  'reg-details':'Dettagli Registrazione','k-network':'Rete','k-chainid':'ID Catena','k-grant':'Sussidio UBI',
  'k-fee':'Commissione Gas','free':'0,1% commissione di protocollo — nessun gas EVM','k-limit':'Registrazioni','k-limit-v':'Una volta per persona · permanente · immutabile',
  'k-bio':'Volto','never-stored':'Foto scartate in pochi secondi — ogni servizio di confronto conserva solo un estratto di 64 byte',
  ...
  'h-zkp':'Sistema di Prova a Conoscenza Zero','h-zkp-t':'Aequitas usa Groth16 su BN128 — la stessa curva di Ethereum e Zcash. Prova: ~200 byte. Verifica: ~10 ms. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). Il nullificatore deriva dal volto, non dal telefono: un secondo dispositivo non consente alla stessa persona di registrarsi di nuovo, e perdere il telefono non costa la registrazione. Si usa Poseidon anziché una moltiplicazione perché il nullificatore del circuito precedente era invertibile: chiunque poteva risalire al bioHash.',
  'h-sybil':'Resistenza Sybil — Stato Attuale','h-sybil-t':'Dal 25/08/2026 il server delle prove rifiuta una registrazione senza le attestazioni firmate dei due servizi di confronto — così lo stesso volto non può essere registrato due volte, nemmeno su dispositivi diversi, cosa che una chiave di dispositivo non ha mai potuto garantire. Due limiti dichiarati: gli account precedenti a quella data sono coperti solo quando il titolare aggiunge il volto nell\'app, e la soglia di confronto non è stata tarata su acquisizioni reali: la crittografia è esatta, la biometria sottostante è una misura il cui tasso di errore non è stato quantificato. Vitalità: oggi è vincolante solo il compito dello sguardo; lampi di colore, polso e parallasse vengono misurati e decideranno una volta tarati.',
  ...
  'h-bio-hw':'Roadmap di Verifica dell\'Identità','h-bio-hw-t':'Oggi (beta): una verifica del volto da parte di due servizi di confronto indipendenti che devono concordare entrambi, e un server delle prove che rifiuta le registrazioni senza le loro attestazioni firmate. Si conserva solo un estratto di 64 byte, mai la foto o un modello completo. La soglia non è ancora tarata su acquisizioni reali — servono circa 1000 coppie impostore prima di citare qualsiasi numero. Previsto: quella taratura, una vitalità vincolante dai segnali già misurati (lampi di colore, polso, parallasse), un accredito graduale per acquisizioni incerte e un controllo dei duplicati in cui nessun servizio detenga nemmeno l\'estratto intero. Nel lungo periodo Aequitas punterà sulla scansione dell’iride per garantire davvero una persona, una registrazione. Si sta lavorando ora a come realizzarla in modo affidabile e rispettoso della privacy; hardware e tempi non sono ancora decisi.',
  'reg-humans':'Umani Registrati','h-desc':'Ogni indirizzo qui sotto appartiene a una persona il cui volto è stato confrontato da servizi indipendenti con tutte le registrazioni esistenti, dimostrato con una prova ZK e accreditato di esattamente 1.000 AEQ. Il registro è permanente, immutabile e on-chain. Cosa garantisce oggi la soglia e cosa no è nelle FAQ. Eccezione nota e limitata: gli account registrati prima della verifica del volto (25/08/2026) non hanno un modello del volto.',
  'no-humans':'Nessun umano registrato ancora.\n\nScarichi l\'App Android Aequitas e sia il primo umano sulla chain!',
  ...
  'pools-desc':'Le commissioni di trasferimento vanno al 100% all’UBI. Le commissioni di swap sono ripartite 40% validatori / 30% fornitori di liquidità / 30% UBI. Il prelievo sul denaro fermo, il prelievo di uscita del 2% e l’eccedenza oltre il limite vanno al 100% all’UBI. Nessuno può pagare da un fondo, nemmeno con la sua chiave; solo il protocollo distribuisce, ogni giorno.',
  'vel-pool':'Pool Validatori','vel-pool-desc':'40% delle commissioni di swap → ogni umano verificato che gestisce un validatore riceve la stessa quota, ponderata solo sui minuti in cui il suo nodo è stato online quel giorno.',
  'liq-pool':'Pool Liquidità','liq-pool-desc':'30% delle commissioni di swap → fornitori di liquidità AEQ/tUSD, in proporzione alla loro quota LP. Più liquidità = minore impatto sul prezzo per tutti.',
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100% delle commissioni di trasferimento + 30% delle commissioni di swap + 100% del prelievo sul denaro fermo, del prelievo di uscita e dell’eccedenza → diviso in parti uguali tra tutte le persone verificate ogni 24 ore.',
  'phases-title':'Fasi del Protocollo',
  'demurrage-title':'Prelievo sul denaro fermo: un incentivo a circolare',
  'demurrage-desc':'Dal 26 settembre 2026 il denaro che resta fermo paga un piccolo prelievo che dipende dal tipo di conto. La vita quotidiana e il normale risparmio restano intatti, e il prelievo va al 100% al reddito di base.',
  'dem-rate-k':'Aliquote','dem-rate-v':'Persone: 0,5 %/mese oltre 5.000 AEQ · Imprese: 0,5 %/mese oltre 1,5 mesi di fatturato, 1 % oltre 3 mesi · Altri indirizzi: 1 %/mese',
  ...
  'run-node-title':'Esegua il Suo nodo — contribuisca a proteggere la rete',
  ...
  'bootstrap-title':'Connettere un Nuovo Node','bootstrap-desc':'Per eseguire il Suo nodo non occorre configurare alcun punto di ingresso — gli indirizzi dei validatori sono integrati. Il Suo nodo si registra da solo e si sincronizza automaticamente con lo stato completo della chain. Imposti PRIMARY_NODE_URL solo se vuole deliberatamente fissare un punto di ingresso specifico.',
  ...
  'dem-title':'3. PRELIEVO SUL DENARO FERMO: meccanismo anti-accumulo',
  'dem-box':'Persone: 0,5 %/mese solo sulla parte oltre 5.000 AEQ; vita quotidiana e risparmio restano intatti<br>Imprese: fino a 1,5 mesi di fatturato gratis (almeno 2.000 AEQ), poi 0,5 %/mese, oltre 3 mesi di fatturato 1 %/mese<br>Altri indirizzi: 1 %/mese, al massimo 250 AEQ<br>Regolato ogni giorno, 100 % al reddito di base (non bruciato)',
  'dem-text':'<p>Precedente storico: l’esperimento di Wörgl (Austria, 1932) usò una moneta con demurrage e ridusse la disoccupazione del 25% in un anno. Il Chiemgauer (Germania, 2003) funziona con successo da oltre 20 anni con un meccanismo simile.</p><p>Queste regole valgono dal 26 settembre 2026. Fino ad allora vale la regola precedente: 0,5%/mese sulla parte oltre la giusta quota dopo 3 mesi senza attività.</p>',
  'cap-title':'4. LIMITE DI RICCHEZZA — Applicazione dell\'Equità Matematica','cap-box':'Limite per le persone: max(5,min(N,25))× la giusta quota (1.000 AEQ)<br>1–4 persone: 5× · +1× per persona · da 25: 25× per sempre<br>Eccedenza ridistribuita subito · Imprese: nessun limite fisso, prelievo sul denaro fermo · Altri indirizzi: al massimo 250 AEQ',
  'ubi-title':'5. REDDITO UNIVERSALE DI BASE — Ridistribuzione Giornaliera','ubi-box':'Fonti: commissioni di trasferimento (100%) · commissioni di swap (30%) · prelievo sul denaro fermo · prelievo di uscita (2%) · eccedenza oltre il limite · deposito per inattività<br><br>Ogni giorno: il fondo UBI viene diviso in parti uguali tra tutte le persone registrate. Dopo ogni distribuzione torna a zero e si riempie di continuo.',
  ...
  'phases-desc':'Il limite per le persone usa nella Fase 0 un moltiplicatore di avvio: max(5, min(N, 25))× la giusta quota (1.000 AEQ per persona). Con 1–4 persone: 5×. Ogni nuova persona aggiunge 1×. Da 25 persone: fisso a 25× = 25.000 AEQ per sempre. Tutti i passaggi avvengono automaticamente in base al numero di persone. Il limite vale solo per le persone: le imprese non hanno un limite fisso e pagano invece il prelievo sul denaro fermo; gli altri indirizzi detengono al massimo 1.000 AEQ.',
  ...
  'p3':'Maturità · oltre 1 mln di persone e Gini sotto 0,30 · Limite di Ricchezza: 25× la quota equa = 25.000 AEQ',
  'wealth-cap-explain':'Il limite per le persone nella Fase 0 (avvio) è max(5, min(N, 25))× la giusta quota di 1.000 AEQ, dove N = persone registrate. 1–4 persone: 5×. Ogni nuova persona aggiunge 1×. Da 25: 25× = 25.000 AEQ per sempre. Le imprese non hanno un limite fisso (pagano il prelievo sul denaro fermo); gli altri indirizzi detengono al massimo 1.000 AEQ.',
  'btn-download-app':'SCARICA L\'APP AEQUITAS',
  'swap-title':'🔄 Scambia AEQ ↔ tUSD','swap-sub':'Scambi AEQ con tUSD (un dollaro di test simulato) attraverso il pool di liquidità nativo. Gli scambi pagano una commissione dello 0,1%; anche i normali trasferimenti AEQ pagano una commissione di protocollo dello 0,1%, che va interamente al reddito di base (nessun gas EVM).',
  'swap-priv-bar':'🔒 0,1% commissione swap · Transfer AEQ 0,1% protocollo (niente gas EVM) · tUSD valuta di test',
  'swap-your-aeq':'Il Suo AEQ','swap-your-tusd':'Il Suo tUSD',
  'swap-fee-est':'Commissione protocollo (0,1%)','swap-details-hdr':'Dettagli Scambio',
  'swap-out-lbl':'Riceve (stima)','swap-impact-lbl':'Impatto sul prezzo','swap-rate-lbl':'Tasso di cambio',
  ...
  'swap-btn-go':'🔄 SCAMBIA',
  'swap-log-hint':'// Colleghi il wallet per scambiare...',
  ...
  'swap-addliq-title':'Fornire Liquidità','swap-addliq-desc':'Sia il primo a depositare — il Suo rapporto imposta il prezzo iniziale.','swap-btn-addliq':'💧 AGGIUNGI LIQUIDITÀ',
  'swap-lp-title':'La Sua posizione LP','swap-lp-share':'Quota del Pool','swap-lp-withdrawable':'Prelevabile',
  'swap-lp-pct-label':'% della Sua posizione','swap-lp-youget':'Riceverà','swap-btn-removeliq':'🔥 RIMUOVI LIQUIDITÀ',
  ...
  'swap-validators':'Validatori (40%)','swap-lps':'Fornitori di Liquidità (30%)','swap-ubi':'Pool UBI (30%)','swap-treasury':'Tesoreria (0%)',
  ...
  'ubi-hero-sub-empty':'Fondo vuoto dall’ultimo pagamento delle 20:00. Si riempie con commissioni di trasferimento, commissioni di swap (30% dello 0,1%), prelievo sul denaro fermo, prelievo di uscita ed eccedenza oltre il limite.',
  'ubi-time-bar-lbl':'Tempo al pagamento giornaliero (20:00 ora di Berlino)',
  ...
  'ubi-src-swap':'Commissioni Swap','ubi-src-swap-d':'Ogni swap AEQ↔tUSD contribuisce il 30% della sua commissione dello 0,1%. Più trading = riempimento più rapido.',
  'ubi-src-dem':'Prelievo sul denaro fermo','ubi-src-dem-d':'Persone oltre 5.000 AEQ (0,5 %/mese), imprese oltre 1,5 mesi di fatturato (0,5–1 %/mese) e altri indirizzi (1 %/mese). Regolato ogni giorno, il 100 % va al reddito di base. Dal 26 sett. 2026.',
  'ubi-src-cap':'Overflow Limite di Ricchezza','ubi-src-cap-d':'Per le persone oltre il tetto (25× la quota equa = 25.000 AEQ; più basso finché sono registrati meno di 25 umani: 1.000 AEQ per umano, almeno 5.000) l’eccedenza viene ridistribuita subito. Il 100 % va al reddito di base. Le imprese non hanno un tetto fisso.',
  'pools4-header':'I TRE POOL DI REDISTRIBUZIONE',
  'ubi-see-above':'vedi conto alla rovescia sopra','ubi-timer-above':'⏰ conto alla rovescia mostrato sopra',
  'usp-headline':'Per la prima volta nella storia — tutti iniziano alla pari',
  'usp-sub':'Se possiede uno smartphone Android, ha i requisiti. Senza banca, senza conoscenze crypto, senza investimento.',
  'usp-c1-title':'Commissione 0,1% · niente gas EVM','usp-c1-desc':'Nessun gas ETH/MATIC per registrarsi. I trasferimenti pagano una commissione di protocollo dello 0,1% (in tempo reale dal nodo), non «gratis per sempre».',
  'usp-c2-title':'1.000 AEQ per ogni umano','usp-c2-desc':'Miliardario o agricoltore di sussistenza: ognuno riceve esattamente 1.000 AEQ. Né più né meno. Lo stesso inizio per tutti, fissato nel codice.',
  'usp-c3-title':'Accessibile a tutti','usp-c3-desc':'Nessun conto bancario, nessuna carta di credito, nessun documento, nessun hardware aggiuntivo — solo la fotocamera che il Suo telefono Android ha già.',
  'usp-c4-title':'UBI quotidiano per sempre','usp-c4-desc':'Una volta registrato, riceve automaticamente una quota giornaliera dei pagamenti UBI — ogni giorno, senza alcuna azione richiesta.',
  ...
  'swap-sell-label':'Vendi','swap-receive-label':'Riceve',
  'gini-what-title':'Cos e il Coefficiente di Gini?','gini-what-text':'Sviluppato dallo statistico italiano Corrado Gini (1912). Misura la distribuzione della ricchezza confrontando i saldi reali con una linea di base ipoteticamente perfettamente equa. Scala: 0 (tutti hanno lo stesso) a 1 (una persona ha tutto). Utilizzato da Banca Mondiale, OCSE, ONU per confrontare i paesi. Valori di riferimento: Bitcoin ≈ 0,85 · Sudafrica (record mondiale) ≈ 0,63 · USA ≈ 0,41 · Germania ≈ 0,31 · Scandinavia ≈ 0,27 · Obiettivo a lungo termine di Aequitas: Gini sotto 0,30. La fase 3 (maturità) si raggiunge solo con 1 mln di persone e un Gini sotto 0,30.','gini-calc-title':'Come si calcola l indice','gini-calc-text':'Vengono raccolti tutti i saldi AEQ degli umani verificati. La formula calcola la differenza assoluta media tra tutte le possibili coppie di saldi, normalizzata per la popolazione al quadrato (n²) e il saldo medio (x̄). Risultato 0–1 moltiplicato per 100 = Indice Aequitas. Il nodo lo calcola dai saldi attuali; dopo ogni pagamento giornaliero del reddito di base viene salvata un’istantanea per il grafico storico.','gini-why-title':'Perche Gini','gini-why-text':'Un semplice rapporto tra il più ricco e il più povero è facile da aggirare: 10.000 wallet potrebbero mostrare poca dispersione mentre il 90 % degli AEQ è in 100 mani — il Gini lo rileva, un rapporto no. Riassume l’intera distribuzione tra tutti gli umani verificati in un numero che chiunque può ricalcolare. È una misura, non una leva di controllo: le fasi e il tetto di ricchezza seguono il numero di umani registrati e le regole di redistribuzione sono fissate nel protocollo. Nessuno può modificare la lettura.',
  'guard-title':'🛡 Sistema Guardian','guard-my-lbl':'Il mio Guardian','guard-none':'Nessuno',
  'guard-set-lbl':'Impostare / cambiare Guardian','guard-set-hint':'Deve essere un umano registrato su Aequitas · Blocco temporale di 7 giorni · Il Guardian può solo confermare la Sua vitalità, non accedere ai fondi · Max 3 assistiti per Guardian',
  'guard-confirm-lbl':'Confermare in vita (come Guardian)','guard-confirm-hint':'Se il Suo assistito non riesce ad accedere al proprio wallet, confermi la sua vitalità per evitare che i fondi vengano trasferiti in escrow dopo 910 giorni di inattività.','guard-recover-btn':'🔓 RECUPERA DALL\'ESCROW',
  'faq-title':'❓ FAQ','faq-q1':'I miei dati biometrici sono al sicuro?','faq-a1':'Il Suo volto viene acquisito e inviato a due servizi di confronto indipendenti — è l\'unico modo per verificare «una persona, un account». La foto e la descrizione completa del volto vengono scartate in pochi secondi; non vengono conservate. Ciò che resta è un estratto di 64 byte (512 valori sì/no): da esso il volto non si può ricostruire, ma riconosce chi ritorna, per questo è trattato come dato biometrico. Un limite onesto, detto e non nascosto: ogni servizio detiene l\'estratto intero. Una modalità ripartita in cui nessun servizio lo detiene intero è costruita e testata, ma non è ancora il controllo vincolante.',
  'faq-q1b':'La registrazione dimostra che sono una persona reale e unica?','faq-a1b':'Meglio di quanto una chiave di dispositivo abbia mai potuto, e non ancora dimostrabile con un numero. Dal 25/08/2026 il volto viene confrontato da due servizi indipendenti che devono concordare entrambi, e il server delle prove rifiuta una registrazione senza le loro attestazioni firmate — così la stessa persona su un secondo telefono viene individuata, cosa che una chiave di dispositivo non ha mai potuto fare. Due limiti dichiarati: gli account precedenti a quella data sono coperti solo quando il titolare aggiunge il volto nell\'app (senza nuovo accredito), e il tasso di errore non è stabilito: la soglia non è stata tarata su acquisizioni reali, per cui servono circa 1.000 coppie impostore. Vitalità: oggi è vincolante solo il compito dello sguardo; i segnali più forti vengono misurati e tarati. Nel lungo periodo Aequitas punterà sulla scansione dell’iride per garantire davvero una persona, una registrazione. Si sta lavorando ora a come realizzarla in modo affidabile e rispettoso della privacy; hardware e tempi non sono ancora decisi.',
  'faq-q2':'Posso registrarmi con un wallet diverso in seguito?','faq-a2':'No. Una registrazione è legata in modo permanente a un indirizzo wallet. È voluto: il nullifier derivato dal Suo volto si consuma una sola volta, quindi registrarsi di nuovo con un altro wallet sarebbe una seconda identità per la stessa persona.',
  'faq-q3':'Cosa succede se perdo il telefono?','faq-a3':'I Suoi AEQ restano nel Suo wallet — sono legati alla Sua chiave privata, non al telefono. Può continuare ad accedere al wallet con MetaMask e la Sua seed phrase. La Sua registrazione è legata al Suo volto, non al dispositivo: un telefono nuovo non Le fa perdere la registrazione.',
  'path-title':'Scelga il Suo percorso','path-human-title':'Sono un Umano','path-human-desc':'Voglio registrarmi, ricevere 1.000 AEQ e unirmi alla rete di reddito di base.','path-human-steps':'1. Scarichi l’app Android Aequitas<br>2. Faccia nell’app il breve controllo del volto dal vivo<br>3. Colleghi MetaMask<br>4. Riceva 1.000 AEQ appena il controllo è superato',
...
tr:{
  ...
  'x-phase-2-10-000-humans':'Aşama 2 (10.000+ kişi):',
  'x-phase-3-1m-humans-gini':'Aşama 3 (1 milyon+ kişi ve Gini &lt; 0,30):',
  'nr-intro':'Şu anda ağ, her biri kendi sunucusunda ve kendi veritabanıyla çalışan 2 etkin doğrulayıcı üzerinde işliyor; ikisinden de MERGE olayları geliyor. Doğrulayıcı düğümleri yalnızca kayıtlı insanlar çalıştırabilir — bu bir güvenlik şartıdır. Aşağıdaki adımlar protokol aşamalarına bağlı hedeflerdir: protokol aşamayı otomatik belirler ama henüz asgari düğüm sayısı dayatmaz.',
  'nr-0':'Her biri kendi veritabanı ve kanıt sunucusuna sahip iki bağımsız Contabo sunucusu. Güven, şeffaf kodla sağlanır. Her kayıtlı insan şimdiden doğrulayıcı olarak katılabilir — başvuru yok, teminat yok.',
  'nr-1':'Daha çok bağımsız düğüm işletmecisi; her biri doğrulayıcı havuzundan pay alır (takas ücretlerinin %40’ı).',
  'nr-2':'Hedef: en az 10 bağımsız düğüm işletmecisi.',
  'nr-3':'Hedef: tümüyle merkezsiz bir BlockDAG — hiçbir tek işletmeci zinciri sansürleyemez ya da durduramaz.',
  'nr-outro':'Düğüm işletmecisi kılavuzu (PDF) Ağ sekmesinde. Her yeni işletmeci doğrulayıcı havuzundan kazanır — düğüm arttıkça ağ dayanıklılaşır.',
  ...
  'bv-desc':'Bir doğrulayıcı <strong style="color:var(--text)">sayıların tutmasını</strong> güvence altına alır. Diğer her şeyin dayandığı tek şeyi güvence altına almaz: <strong style="color:var(--text)">kimsenin iki kez kaydolmamasını</strong>. O olmadan “bir insan, bir gelir” yalnızca bir slogandır — defter kusursuz doğru ve tamamen değersiz olurdu. Bugün bu söz çok az makineye dayanıyor ve eklediğiniz her makine onu kırmayı zorlaştırıyor. Onu taşıyan iki rol — bir yüzün zaten kayıtlı olup olmadığına karar veren <strong style="color:var(--text)">doğrulayıcı</strong> ve bu kararları toplayan <strong style="color:var(--text)">koordinatör</strong> — aynı sunucuda çalışır. Bu kılavuz ikisini de kurar.',
  'bv-guide-sub':'Adım adım · Kriptografi bilgisi gerekmez · Yaklaşık 45 dakika, çoğu bekleme',
  ...
  'bv-status-d':'Doğrulayıcının kaynak kodu <strong style="color:var(--text)">henüz açık değil</strong>, bu yüzden aşağıdaki adımları bugün herkes tamamlayamaz. Yine de yayımlıyoruz, çünkü bir tasarım devreye alınmadan önce denetlenebilmeli, sonrasında değil. Bir tane çalıştırmak isterseniz ana sayfadaki Telegram grubunda sorun. Bu depoyu açmak, bu kılavuzu bir plandan bir davete dönüştürecek şeydir ve size borçlu olduğumuz bir sonraki adımdır.',
  'bv-status-t':'Durum: kapalı beta — başlamadan önce okuyun',
  'bv-title':'Yalnızca doğrulayıcı çalıştırmak yetmez — nedeni şu',
  'bv-guide-lang-note':'Aşağıdaki adımlar İngilizcedir. Yukarıdaki bölümler — bunun ne olduğu, neyi koruduğu ve neyi üstlendiğiniz — sizin dilinizdedir.',
  'bv-what-d':'Bir yüz size asla resim olarak gönderilmez: görüntü kontrolden sonra atılır ve makineniz yalnızca 64 baytlık bir özet (512 evet/hayır değeri) saklar — geri dönen birini tanımaya yeter, bir yüzü yeniden kurmaya yetmez. Makinenizin bu özetin yalnızca toplamsal bir payını tutacağı bölünmüş bir mod vardır — tek başına gürültüden ayırt edilemez, komitenizle birlikte karşılaştırılır, böylece kimse yanıttan fazlasını öğrenmez. Yapıldı ve test edildi ama <strong style="color:var(--text)">henüz etkin değil</strong>, çünkü eşiği hiç ayarlanmadı. O zamana kadar her doğrulayıcı özetin tamamını tutar ve henüz vermediğiniz bir korumayı ima etmektense bunu söylemeyi tercih ederiz.',
  'bv-what-t':'Neyi tutardınız — ve neyi asla görmezdiniz',
  ...
  'x-0-1-split-40-30':'%0,1 · dağılım 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10.000 &#8211; 1 milyon kişi. Hedef: en az 10 bağımsız düğüm işletmecisi.',
  'x-100-8211-10-000-humans':'100 &#8211; 10.000 kişi. Tavan 25×. Hedef: daha çok bağımsız düğüm işletmecisi.',
  'x-100-maximum-concentration':'100 = en yüksek yoğunlaşma',
  'x-1m-humans-global-ubi-at':'1 milyon+ kişi ve 0,30 altında Gini — ikisi birden gerekir. Büyük ölçekte küresel temel gelir.',
  
  
  
  'x-active-validators':'Etkin doğrulayıcılar',
  'x-add-aequitas-chain-to-metamask':'AEQ bakiyenizi görmek, işlem göndermek ve V7 sözleşmesiyle tarayıcınızdan ya da mobil cüzdanınızdan doğrudan çalışmak için Aequitas zincirini MetaMask’e ekleyin.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas bunu matematiksel olarak uygular. Her doğrulanmış insan tam olarak 1.000 AEQ alır — milyarder ya da geçimlik çiftçi, istisnasız. Sabit kurallar — atıl para kesintisi, servet tavanı ve günlük temel gelir — eşitsizliğin sınırsızca birikmesini önler. Gini katsayısı güncel bakiyelerden hesaplanır ve herkes tarafından kontrol edilebilir.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'ABD (~0,41) veya Fransa (~0,32) ile karşılaştırılabilir. Gelişmiş ekonomilerin çoğunun aralığında.',
  ...
  'x-demurrage-0-5-mo':'Atıl para kesintisi (%0,5–1/ay)',
  ...
  'x-healthier-than-most-nations-on':'Dünyadaki çoğu ülkeden daha sağlıklı. İskandinavya (~0,27) ve Almanya (~0,31) ile karşılaştırılabilir.',
  'x-higher-than-most-european-nations':'Çoğu Avrupa ülkesinden yüksek — Brezilya (~0,53) ile karşılaştırılabilir. Kurallar endekse göre değişmez; atıl para kesintisi ve servet tavanı sürekli işler.',
  'x-honest-limitation':'Açıkça belirtilen sınır:',
  'x-why-sybil-resistance':'Neden Sybil direnci?','x-how-it-works':'Nasıl çalışır',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'rastgele değer, yüz doğrulamasından sonra verilir (yüzden türetilmez)',
  ...
  'x-metamask-mobile-if-aeq-shows':'📱 MetaMask Mobile: ekledikten sonra AEQ 0 görünüyorsa ağı silin ve yukarıdaki düğmeyle yeniden ekleyin.',
  ...
  'x-phase-transitions-are-automatic-8212':'Protokol aşamayı otomatik belirler — 0 ile 2 arası insan sayısına göre, 3. aşama ancak 1 milyon insan ve 0,30 altında Gini ile. Yönetişim oylaması yok, yönetici anahtarı yok. Aşama bir durumdur: servet tavanı ve atıl para kesintisi ona bağlı değildir, düğüm hedefleri henüz kodla uygulanmaz.',
  'x-postgresql-persistent':'PostgreSQL (kalıcı)',
  'x-protocol-v7':'📜 Protocol V7',
  'x-provide-aeq-tusd-liquidity-to':'AEQ / tUSD likiditesi sağlayın ve her gün dağıtılan tüm takas ücretlerinin %30’unu kazanın.',
  ...
  'x-swap-fees-0-1':'Transfer ve takas ücretleri (%0,1)',
  'x-sybil-resistance-8212-current-state':'Sybil direnci &#8212; bugünkü durum, dürüstçe',
  'x-the-4-redistribution-mechanisms':'3 yeniden dağıtım havuzu',
  ...
  'x-ubi-pool-20':'Temel gelir havuzu',
  ...
  'x-worse-than-any-country-on':'Dünyadaki her ülkeden kötü (Güney Afrika rekoru: ~0,63). Bitcoin\'e (~0,85) yaklaşıyor. Az sayıda kayıtlı insanla bu hızla olabilir; kurallar aynı kalır.',
  ...
  'reg-sub':'Aequitas ağına katılın ve 1.000 AEQ başlangıç ödemenizi alın. Kayıt tek seferlik ve kalıcıdır. Beta aşamasında: doğrulanmış, belirtilen sınırlarla — aşağıdaki beta uyarısına bakın.',
  'app-title':'KAYIT YALNIZCA ANDROİD UYGULAMASI İLE',
  'app-text':'Kayıt yalnızca Android uygulamasında yapılır: iki bağımsız eşleştirme servisinin denetlediği kısa bir yüz çekimi. Ardından <strong style="color:var(--gold)">1.000 AEQ otomatik olarak hesabınıza geçer</strong>. Neyin saklandığı ve saklanmadığı: 1. adım ve aşağıdaki beta uyarısı.',
  's1t':'Bağlan','s1d':'Uygulama yüzünüzü ve kısa bir canlılık dizisini (göz kırpma, rastgele bir yana bakış, renk flaşları) kaydeder ve iki bağımsız eşleştirme servisine gönderir. Bunlar yüzü, yüzüyle kayıtlı herkesle karşılaştırır. Fotoğraf saniyeler içinde atılır; yalnızca 64 baytlık bir özet kalır.',
  's2t':'Kanıtla','s2d':'Bir Groth16 ZK kanıtı, bio_hash\'inizi açığa çıkarmadan bir commitment\'a (bio_hash, cüzdan ve tuzun Poseidon\'u) bağlar. Kanıt sunucusu onu yalnızca cüzdan bağlaması ve iki servisin imzalı onaylarıyla verir; nullifier yalnızca bir kez harcanabilir — aynı yüz iki kez sayılmaz.',
  's3t':'Al','s3d':'Kayıt 1 saniye içinde Aequitas BlockDAG\'da onaylandı · 1.000 AEQ anında yatırıldı · kimliğiniz kalıcı olarak doğrulanmış insan olarak kaydedildi',
  'priv-bar':'🔒 Beta · 2 bağımsız servisle yüz doğrulama · 2 imzalı onay zorunlu · Groth16 ZKP · Yalnızca 64 baytlık özet saklanır',
  'conn-wallet':'BAĞLI CÜZDAN','proof-recv':'⚡ ZK KANITI ALINDI','proof-hint':'Kayıt için cüzdanınızı bağlayın',
  'btn-conn':'🦊 METAMASK BAĞLA','btn-reg':'🔐 ZİNCİRE KAYIT OL','reg-apk-note':'Kayıt için yüz doğrulamalı uygulama gerekir (bu sitedeki app.apk; bir ret durumunda itiraz kodunun görünmesi için güncel sürümü kullanın).',
  'btn-wc':'🔗 WALLETCONNECT BAĞLA',
  'reg-log-hint':'// Uygulama kaydınızı kendisi yapar. Yukarıdaki düğmeler yalnızca buraya hazır bir kanıt içeren bir bağlantıyla geldiyseniz gerekir.',
  'reg-details':'Kayıt Detayları','k-network':'Ağ','k-chainid':'Zincir ID','k-grant':'UBI Hibesi',
  'k-fee':'Gas Ücreti','free':'%0,1 protokol ücreti — EVM gas yok','k-limit':'Kayıtlar','k-limit-v':'Kişi başına bir kez · kalıcı · değiştirilemez',
  'k-bio':'Yüz','never-stored':'Fotoğraflar saniyeler içinde atılır — her eşleştirme servisi yalnızca 64 baytlık bir özet saklar',
  ...
  'h-zkp':'Sıfır Bilgi Kanıtı Sistemi','h-zkp-t':'Aequitas, BN128 üzerinde Groth16 kullanır — Ethereum ve Zcash ile aynı eğri. Kanıt: ~200 bayt. Doğrulama: ~10 ms. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). Nullifier yüzden gelir, telefondan değil: ikinci bir cihaz aynı kişinin yeniden kaydolmasını sağlamaz, telefonu kaybetmek de kaydınıza mal olmaz. Çarpma yerine Poseidon kullanılır, çünkü önceki devrenin nullifier\'ı tersine çevrilebilirdi — herkes ondan bioHash\'i geri hesaplayabilirdi.',
  'h-sybil':'Sybil Direnci — Mevcut Durum','h-sybil-t':'25.08.2026\'dan beri kanıt sunucusu, iki eşleştirme servisinin imzalı onayları olmadan bir kaydı reddeder — böylece aynı yüz, farklı cihazlarda da iki kez kaydedilemez; bir cihaz anahtarı bunu asla yapamazdı. Belirtilen iki sınır: bu tarihten önceki hesaplar ancak sahibi yüzünü uygulamada eklediğinde kapsanır ve eşleştirme eşiği gerçek çekimlerle ayarlanmadı: kriptografi kesindir, altındaki biyometri hata oranı henüz belirlenmemiş bir ölçümdür. Canlılık: bugün yalnızca bakış görevi bağlayıcıdır; renk flaşları, nabız ve paralaks ölçülür ve ayarlandıktan sonra karara katılır.',
  ...
  'h-bio-hw':'Kimlik Doğrulama Yol Haritası','h-bio-hw-t':'Bugün (beta): ikisinin de onaylaması gereken iki bağımsız eşleştirme servisiyle yüz denetimi ve onların imzalı onayları olmayan kayıtları reddeden bir kanıt sunucusu. Yalnızca 64 baytlık bir özet saklanır, asla fotoğraf ya da tam şablon değil. Eşik henüz gerçek çekimlerle ayarlanmadı — herhangi bir sayı söylenmeden önce yaklaşık 1000 sahte çift gerekiyor. Planlanan: bu ayarlama, zaten ölçülen sinyallerden (renk flaşları, nabız, paralaks) bağlayıcı canlılık, belirsiz çekimler için kademeli ödeme ve hiçbir servisin özetin tamamını bile tutmadığı bir kopya denetimi. Uzun vadede Aequitas, gerçekten bir insan = bir kayıt ilkesini güvence altına almak için iris taramasına dayanacak. Bunun güvenilir ve gizliliği koruyarak nasıl uygulanacağı şu anda üzerinde çalışılıyor; donanım ve zamanlama henüz belli değil.',
  'reg-humans':'Kayıtlı İnsanlar','h-desc':'Aşağıdaki her adres, yüzü bağımsız servislerce mevcut tüm kayıtlara karşı denetlenmiş, ZK kanıtıyla belgelenmiş ve tam olarak 1.000 AEQ yatırılmış bir kişiye aittir. Kayıt defteri kalıcı, değiştirilemez ve zincir üzerindedir. Eşiğin bugün neyi garanti edip etmediği SSS bölümündedir. Bilinen ve sınırlı istisna: yüz doğrulamadan (25.08.2026) önce kaydedilen hesapların yüz şablonu yoktur.',
  'no-humans':'Henüz kayıtlı insan yok.\n\nAequitas Android Uygulamasını indirin ve zincirdeki ilk insan olun!',
  ...
  'gini-what-text':'İtalyan istatistikçi Corrado Gini tarafından 1912\'de geliştirilmiştir. Lorenz eğrisi ile görselleştirilen gerçek dağılımı mükemmel eşit dağılımla karşılaştırarak servet dağılımını ölçer. Ölçek: 0 (herkes aynı miktarı tutar) ile 1 (bir kişi her şeyi tutar). Dünya Bankası, OECD ve BM tarafından kullanılır. 3. aşamaya (olgunluk) ancak 1 milyon insan ve 0,30 altında Gini ile ulaşılır.',
  'gini-calc-title':'Aequitas Endeksi Nasıl Hesaplanır?',
  'gini-calc-text':'Doğrulanmış insanların tüm AEQ bakiyeleri toplanır. Formül, olası tüm bakiye çiftleri arasındaki ortalama mutlak farkı hesaplar; nüfusun karesi (n²) ve ortalama bakiye (x̄) ile normalleştirir. 0–1 sonucu 100 ile çarpılır = Aequitas Endeksi. Düğüm bunu güncel bakiyelerden hesaplar; her günlük temel gelir ödemesinden sonra geçmiş grafiği için bir anlık görüntü kaydedilir.',
  'gini-why-title':'Neden Gini — Daha Basit Bir Metrik Değil?',
  'gini-why-text':'Basit bir en zengin/en yoksul oranı kolayca kandırılabilir: 10.000 cüzdan küçük bir fark gösterirken AEQ\'nin %90\'ı 100 elde olabilir — Gini bunu görür, oran görmez. Tüm doğrulanmış insanlar arasındaki dağılımı herkesin yeniden hesaplayabileceği tek bir sayıda toplar. Bu bir ölçümdür, bir kontrol kolu değil: aşamalar ve servet tavanı kayıtlı insan sayısına göre belirlenir, yeniden dağıtım kuralları protokolde sabittir. Kimse ölçümü değiştiremez.',
  ...
  'pools-desc':'Transfer ücretleri %100 UBI\'ye gider. Takas ücretleri %40 doğrulayıcılar / %30 likidite sağlayıcılar / %30 UBI olarak bölünür. Bekleyen para kesintisi, %2 çıkış kesintisi ve sınır aşımı %100 UBI\'ye gider. Kimse bir havuzdan ödeme yapamaz, anahtarına sahip olsa bile; yalnızca protokol her gün dağıtır.',
  'vel-pool':'Doğrulayıcı Havuzu','vel-pool-desc':'Takas ücretlerinin %40 kadarı → validator çalıştıran her doğrulanmış insan eşit pay alır; yalnızca düğümünün o gün çevrimiçi kaldığı dakikalara göre ağırlıklandırılır.',
  'liq-pool':'Likidite Havuzu','liq-pool-desc':'Takas ücretlerinin %30 kadarı → AEQ/tUSD likidite sağlayıcılarına, LP paylarıyla orantılı. Daha derin likidite = herkes için daha az fiyat etkisi.',
  'ubi-pool':'UBI Havuzu','ubi-pool-desc':'Transfer ücretlerinin %100\'ü + takas ücretlerinin %30\'u + bekleyen para kesintisi, çıkış kesintisi ve sınır aşımının %100\'ü → her 24 saatte doğrulanmış tüm insanlara eşit olarak.',
  'phases-title':'Protokol Aşamaları',
  'phases-desc':'İnsanlar için sınır Aşama 0\'da bir başlangıç çarpanı kullanır: max(5, min(N, 25))× adil pay (kişi başı 1.000 AEQ). 1–4 kişide: 5×. Her yeni insan 1× ekler. 25 kişiden itibaren: kalıcı olarak 25× = 25.000 AEQ. Tüm geçişler insan sayısına göre otomatik gerçekleşir. Sınır yalnızca insanlar için geçerlidir: işletmelerin sabit sınırı yoktur ve bunun yerine bekleyen para kesintisi öderler; diğer adresler en fazla 1.000 AEQ tutar.',
  ...
  'p3':'Olgunluk · 1 milyon+ kişi ve 0,30 altında Gini · Servet Tavanı: 25× adil pay = 25.000 AEQ',
  'wealth-cap-explain':'Aşama 0\'da (başlangıç) insanlar için sınır max(5, min(N, 25))× 1.000 AEQ\'luk adil paydır; N = kayıtlı insan sayısı. 1–4 kişi: 5×. Her yeni insan 1× ekler. 25\'ten itibaren: kalıcı 25× = 25.000 AEQ. İşletmelerin sabit sınırı yoktur (bekleyen para kesintisi öderler); diğer adresler en fazla 1.000 AEQ tutar.',
  'demurrage-title':'Bekleyen para kesintisi: dolaşım için bir teşvik',
  'demurrage-desc':'26 Eylül 2026\'dan itibaren bekleyen para, hesap türüne bağlı küçük bir kesinti öder. Günlük hayat ve normal birikim etkilenmez ve kesinti %100 temel gelire gider.',
  'dem-rate-k':'Oranlar','dem-rate-v':'İnsanlar: 5.000 AEQ üzeri ayda %0,5 · İşletmeler: 1,5 aylık ciro üzeri ayda %0,5, 3 aylık ciro üzeri %1 · Diğer adresler: ayda %1',
  ...
  'run-node-title':'Kendi düğümünüzü çalıştırın — ağın güvenliğine katkıda bulunun',
  ...
  'dem-title':'3. BEKLEYEN PARA KESİNTİSİ: istiflemeye karşı mekanizma',
  'dem-box':'İnsanlar: yalnızca 5.000 AEQ üzerindeki kısma ayda %0,5; günlük hayat ve birikim etkilenmez<br>İşletmeler: 1,5 aylık ciroya kadar ücretsiz (en az 2.000 AEQ), sonra ayda %0,5, 3 aylık ciro üzeri ayda %1<br>Diğer adresler: ayda %1, en fazla 250 AEQ<br>Her gün hesaplanır, %100 temel gelire gider (yakılmaz)',
  'dem-text':'<p>Tarihsel örnek: Wörgl deneyi (Avusturya, 1932) demurajlı bir para kullandı ve bir yılda işsizliği %25 azalttı. Chiemgauer (Almanya, 2003) benzer bir mekanizmayla 20 yılı aşkın süredir başarıyla işliyor.</p><p>Bu kurallar 26 Eylül 2026\'dan itibaren geçerlidir. O zamana kadar önceki kural geçerlidir: 3 ay hareketsizlikten sonra adil payın üzerindeki kısım için ayda %0,5.</p>',
  'cap-title':'4. SERVET TAVANI — Matematiksel Adalet Uygulaması','cap-box':'İnsanlar için sınır: max(5,min(N,25))× adil pay (1.000 AEQ)<br>1–4 kişi: 5× · kişi başı +1× · 25\'ten itibaren: kalıcı 25×<br>Fazlası anında yeniden dağıtılır · İşletmeler: sabit sınır yok, bekleyen para kesintisi · Diğer adresler: en fazla 250 AEQ',
  'ubi-title':'5. EVRENSEL TEMEL GELİR — Günlük Yeniden Dağıtım','ubi-box':'Kaynaklar: transfer ücretleri (%100) · takas ücretleri (%30) · bekleyen para kesintisi · çıkış kesintisi (%2) · sınır aşımı · hareketsizlik emaneti<br><br>Her gün: UBI havuzu kayıtlı tüm insanlara eşit olarak bölünür. Her dağıtımdan sonra sıfırlanır ve sürekli yeniden dolar.',
  ...
  'swap-title':'🔄 AEQ ↔ tUSD Takas Et','swap-sub':'Yerel likidite havuzu üzerinden AEQ\'yu tUSD (simüle edilmiş test doları) ile takas edin. Takaslar %0,1 ücret öder; normal AEQ transferleri de tamamı temel gelire giden %0,1 protokol ücreti öder (EVM gas yok).',
  'swap-priv-bar':'🔒 %0,1 takas ücreti · AEQ transferlerinde %0,1 protokol (EVM gas yok) · tUSD test para birimi',
  'swap-your-aeq':'AEQ bakiyeniz','swap-your-tusd':'tUSD bakiyeniz',
  'swap-fee-est':'Protokol ücreti (%0,1)','swap-details-hdr':'Takas Detayları',
  'swap-out-lbl':'Alacağınız (tahmini)','swap-impact-lbl':'Fiyat etkisi','swap-rate-lbl':'Döviz kuru',
  ...
  'swap-log-hint':'// Takas yapmak için cüzdanınızı bağlayın...',
  ...
  'swap-addliq-title':'Likidite Sağla','swap-addliq-desc':'İlk yatıran siz olun — oranınız başlangıç fiyatını belirler.','swap-btn-addliq':'💧 LİKİDİTE EKLE',
  'swap-lp-title':'LP pozisyonunuz','swap-lp-share':'Havuz Payı','swap-lp-withdrawable':'Çekilebilir',
  'swap-lp-pct-label':'% pozisyonunuz','swap-lp-youget':'Alacağınız','swap-btn-removeliq':'🔥 LİKİDİTE KALDIR',
  ...
  'swap-validators':'Doğrulayıcılar (%40)','swap-lps':'Likidite Sağlayıcıları (%30)','swap-ubi':'UBI Havuzu (%30)','swap-treasury':'Hazine (%0)',
  ...
  'ubi-hero-sub-empty':'Havuz, son 20:00 ödemesinden beri boş. Transfer ücretleri, takas ücretleri (%0,1\'in %30\'u), bekleyen para kesintisi, çıkış kesintisi ve sınır aşımıyla dolar.',
  'ubi-time-bar-lbl':'Günlük ödemeye kalan süre (Berlin saatiyle 20:00)',
  ...
  'ubi-src-swap':'Takas Ücretleri','ubi-src-swap-d':'Her AEQ↔tUSD takası, %0,1 ücretinin %30\'sini katkıda bulunur. Daha fazla işlem = daha hızlı dolma.',
  'ubi-src-dem':'Bekleyen para kesintisi','ubi-src-dem-d':'5.000 AEQ üzerindeki insanlar (ayda %0,5), 1,5 aylık ciro üzerindeki işletmeler (ayda %0,5–1) ve diğer adresler (ayda %1). Her gün hesaplanır, %100 temel gelire gider. 26 Eylül 2026\'dan itibaren.',
  'ubi-src-cap':'Servet Tavanı Taşması','ubi-src-cap-d':'Tavanın üzerindeki kişilerde (adil payın 25 katı = 25.000 AEQ; 25\'ten az insan kayıtlıyken daha düşük: insan başına 1.000 AEQ, en az 5.000) fazlası anında yeniden dağıtılır. %100\'ü temel gelire gider. İşletmelerin sabit tavanı yoktur.',
  'pools4-header':'ÜÇ YENİDEN DAĞITIM HAVUZU',
  'ubi-see-above':'yukarıdaki geri sayımı gör','ubi-timer-above':'⏰ geri sayım yukarıda gösterildi',
  'usp-headline':'Tarihte ilk kez — herkes eşit başlıyor',
  'usp-sub':'Android akıllı telefonunuz varsa katılabilirsiniz. Banka yok, kripto bilgisi yok, yatırım yok.',
  'usp-c1-title':'%0,1 ücret · EVM gazı yok','usp-c1-desc':'Kayıt için ETH/MATIC gazı gerekmez. Transferler %0,1 protokol ücreti öder (düğümden canlı) — “sonsuza dek ücretsiz” değil.',
  'usp-c2-title':'Her insan için 1.000 AEQ','usp-c2-desc':'Milyarder ya da geçimlik çiftçi — herkes tam 1.000 AEQ alır. Ne fazla ne eksik. Herkes için aynı başlangıç, kodda sabit.',
  ...
  'usp-c4-title':'Sonsuza kadar günlük UBI','usp-c4-desc':'Kaydolduktan sonra, her gün otomatik olarak UBI ödemelerinden pay alırsınız — her gün, hiçbir işlem gerektirmez.',
  ...
  'guard-set-lbl':'Koruyucu belirleyin / değiştirin','guard-set-hint':'Kayıtlı bir Aequitas insanı olmalıdır · 7 günlük zaman kilidi · Koruyucu yalnızca canlılığınızı onaylayabilir, fonlara erişemez · Koruyucu başına maks. 3 korunan',
  'guard-confirm-lbl':'Hayatta olduğunu onaylayın (koruyucu olarak)','guard-confirm-hint':'Korunanınız cüzdanına erişemiyorsa, 910 günlük hareketsizlik sonrasında fonlarının emanete geçmesini önlemek için canlılığını onaylayın.','guard-recover-btn':'🔓 EMANETTEN GERİ AL',
  'faq-title':'❓ Sık Sorulan Sorular','faq-q1':'Biyometrik verilerim güvende mi?','faq-a1':'Yüzünüz kaydedilir ve iki bağımsız eşleştirme servisine gönderilir — “bir insan, bir hesap” ancak böyle denetlenebilir. Fotoğraf ve tam yüz tanımı saniyeler içinde atılır; saklanmaz. Saklanan 64 baytlık bir özettir (512 evet/hayır değeri): yüz ondan yeniden oluşturulamaz ama geri döneni tanır, bu yüzden biyometrik veri sayılır. Gizlenmeyen, açıkça söylenen bir sınır: her servis özetin tamamını tutar. Hiçbir servisin onu bütün tutmadığı bölünmüş bir mod yapıldı ve test edildi, ama henüz bağlayıcı denetim değil.',
  'faq-q1b':'Kayıt, benzersiz gerçek bir insan olduğumu kanıtlıyor mu?','faq-a1b':'Bir cihaz anahtarının yapabileceğinden daha iyi, ama henüz bir sayıyla kanıtlanamıyor. 25.08.2026\'dan beri yüzü, ikisinin de onaylaması gereken iki bağımsız servis karşılaştırır ve kanıt sunucusu onların imzalı onayları olmadan bir kaydı reddeder — böylece ikinci bir telefondaki aynı kişi yakalanır; bir cihaz anahtarı bunu asla yapamazdı. Belirtilen iki sınır: bu tarihten önceki hesaplar ancak sahibi yüzünü uygulamada eklediğinde kapsanır (yeni ödeme yok) ve hata oranı belli değil: eşik gerçek çekimlerle ayarlanmadı, bunun için yaklaşık 1.000 sahte çift gerekir. Canlılık: bugün yalnızca bakış görevi bağlayıcıdır; daha güçlü sinyaller ölçülüyor ve ayarlanıyor. Uzun vadede Aequitas, gerçekten bir insan = bir kayıt ilkesini güvence altına almak için iris taramasına dayanacak. Bunun güvenilir ve gizliliği koruyarak nasıl uygulanacağı şu anda üzerinde çalışılıyor; donanım ve zamanlama henüz belli değil.',
  ...
  'faq-q3':'Telefonumu kaybedersem ne olur?','faq-a3':'AEQ\'leriniz cüzdanınızda kalır — telefonunuza değil, özel anahtarınıza bağlıdır. Cüzdanınıza MetaMask ve kurtarma ifadenizle erişmeye devam edebilirsiniz. Kaydınız cihaza değil yüzünüze bağlıdır; yeni bir telefon kaydınızı kaybettirmez.',
  'path-title':'Yolunuzu Seçin','path-human-title':'Ben bir İnsanım','path-human-desc':'Kayıt olmak, 1.000 AEQ almak ve temel gelir ağına katılmak istiyorum.','path-human-steps':'1. Aequitas Android uygulamasını indirin<br>2. Uygulamada kısa canlı yüz kontrolünü yapın<br>3. MetaMask\'i bağlayın<br>4. Kontrol geçince 1.000 AEQ alın',
  'path-node-title':'Ben bir Node Operatörüyüm','path-node-desc':'Tam bir node çalıştırmak, blok üretimine katılmak ve %40 doğrulayıcı havuzundan kazanmak istiyorum.','path-node-steps':'1. İnsan olarak kaydolun (zorunlu)<br>2. Yapılandırılacak giriş noktası yok — doğrulayıcı adresleri yerleşiktir<br>3. Contabo/Hetzner/VPS\'de dağıtın<br>4. Doğrulayıcı havuzundan günlük kazanın',
...
fr:{
  ...
  'x-phase-2-10-000-humans':'Phase 2 (10 000 personnes et plus) :',
  'x-phase-3-1m-humans-gini':'Phase 3 (1 M+ de personnes et Gini &lt; 0,30) :',
  'nr-intro':'Actuellement, le réseau tourne sur 2 validateurs actifs, chacun sur son propre serveur avec sa propre base de données, avec des événements MERGE des deux. Seuls des humains inscrits peuvent exploiter des nœuds validateurs — c’est une exigence de sécurité. Les étapes ci-dessous sont des objectifs liés aux phases du protocole : le protocole fixe la phase automatiquement, mais n’impose pas encore de nombre minimal de nœuds.',
  'nr-0':'Deux serveurs Contabo indépendants, chacun avec sa propre base de données et son propre serveur de preuves. Confiance par la transparence du code. Tout humain inscrit peut déjà rejoindre comme validateur — sans candidature, sans mise.',
  'nr-1':'Davantage d’opérateurs de nœud indépendants ; chacun reçoit une part du pool des validateurs (40 % des frais d’échange).',
  'nr-2':'Objectif : au moins 10 opérateurs de nœud indépendants.',
  'nr-3':'Objectif : un BlockDAG entièrement décentralisé — aucun opérateur seul ne peut censurer ou arrêter la chaîne.',
  'nr-outro':'Le guide de l’opérateur de nœud (PDF) se trouve dans l’onglet Réseau. Chaque nouvel opérateur gagne sur le pool des validateurs — plus il y a de nœuds, plus le réseau est résistant.',
  ...
  'bv-desc':'Un validateur garantit que <strong style="color:var(--text)">les comptes sont justes</strong>. Il ne garantit pas la seule chose sur laquelle tout le reste repose : que <strong style="color:var(--text)">personne ne s\'inscrive deux fois</strong>. Sans cela, « un humain, un revenu » n\'est qu\'un slogan : le registre serait parfaitement exact et parfaitement inutile. Aujourd\'hui cette promesse repose sur très peu de machines, et chacune que vous ajoutez la rend plus difficile à briser. Les deux rôles qui la portent — le <strong style="color:var(--text)">vérificateur</strong>, qui décide si un visage est déjà inscrit, et le <strong style="color:var(--text)">coordinateur</strong>, qui rassemble ces décisions — tournent sur le même serveur. Ce guide installe les deux.',
  'bv-guide-sub':'Étape par étape · Aucune connaissance en cryptographie · Environ 45 minutes, surtout de l’attente',
  ...
  'bv-title':'Un validateur ne suffit pas — et voici pourquoi',
  'bv-guide-lang-note':'Les étapes ci-dessous sont en anglais. Les sections au-dessus — ce que c\'est, ce que cela protège et ce que vous assumez — sont dans votre langue.',
  'bv-what-d':'Un visage ne vous est jamais envoyé sous forme d\'image : l\'image est supprimée après le contrôle et votre machine ne stocke qu\'un extrait de 64 octets (512 valeurs oui/non) — assez pour reconnaître quelqu\'un qui revient, pas assez pour reconstruire un visage. Il existe un mode réparti dans lequel votre machine ne détiendrait qu\'une part additive de cet extrait — seule, indiscernable du bruit, comparée conjointement avec votre comité pour que personne n\'apprenne plus que la réponse. Il est construit et testé mais <strong style="color:var(--text)">pas encore actif</strong>, car son seuil n\'a jamais été étalonné. D\'ici là, chaque vérificateur détient l\'extrait entier, et nous préférons le dire plutôt que de suggérer une protection que vous n\'apportez pas encore.',
  ...
  'x-0-1-split-40-30':'0,1 % · répartition 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10 000 &#8211; 1 M de personnes. Objectif : au moins 10 opérateurs de nœud indépendants.',
  'x-100-8211-10-000-humans':'100 &#8211; 10 000 personnes. Plafond 25×. Objectif : davantage d’opérateurs de nœud indépendants.',
  'x-100-maximum-concentration':'100 = concentration maximale',
  'x-1m-humans-global-ubi-at':'1 M+ de personnes et un Gini sous 0,30 — les deux sont requis. Revenu de base mondial à grande échelle.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas le met en œuvre mathématiquement. Chaque humain vérifié reçoit exactement 1 000 AEQ — milliardaire ou agriculteur de subsistance, sans exception. Des règles fixes — la taxe sur l’argent dormant, le plafond de richesse et le revenu de base quotidien — empêchent l’inégalité de s’accumuler indéfiniment. Le coefficient de Gini est calculé à partir des soldes actuels et chacun peut le vérifier.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'Comparable aux États-Unis (~0,41) ou à la France (~0,32). Dans la fourchette de la plupart des économies développées.',
  ...
  'x-demurrage-0-5-mo':'Taxe sur l’argent dormant (0,5–1 %/mois)',
  ...
  'x-healthier-than-most-nations-on':'Plus sain que la plupart des pays du monde. Comparable à la Scandinavie (~0,27) et à l’Allemagne (~0,31).',
  'x-higher-than-most-european-nations':'Plus élevé que dans la plupart des pays européens — comparable au Brésil (~0,53). Les règles ne changent pas avec l’indice ; la taxe sur l’argent dormant et le plafond de richesse agissent en permanence.',
  'x-honest-limitation':'Limite assumée :',
  'x-why-sybil-resistance':'Pourquoi la résistance Sybil ?','x-how-it-works':'Comment cela fonctionne',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'valeur aléatoire, délivrée après le contrôle du visage (non dérivée du visage)',
  ...
  'x-phase-transitions-are-automatic-8212':'Le protocole fixe la phase automatiquement — les phases 0 à 2 selon le nombre d’humains, la phase 3 seulement avec 1 million d’humains et un Gini sous 0,30. Pas de vote de gouvernance, pas de clé d’administrateur. La phase est un statut : le plafond de richesse et la taxe sur l’argent dormant n’en dépendent pas, et aucun code n’impose encore les objectifs de nœuds.',
  ...
  'x-swap-fees-0-1':'Frais de virement et de swap (0,1 %)',
  'x-sybil-resistance-8212-current-state':'Résistance Sybil &#8212; l’état actuel, honnêtement',
  'x-the-4-redistribution-mechanisms':'Les 3 fonds de redistribution',
  ...
  'x-ubi-pool-20':'Fonds de revenu de base',
  ...
  'x-worse-than-any-country-on':'Pire que n’importe quel pays (record de l’Afrique du Sud : ~0,63). Proche de Bitcoin (~0,85). Avec peu d’humains enregistrés, cela arrive vite ; les règles restent les mêmes.',
  ...
  'logo-sub':'PREUVE D\'HUMANITÉ','phase0-badge':'Bêta · contrôle du visage','nav-register':'S\'inscrire','foot-launched':'Lancée en juin 2026','foot-phase':'Bêta','foot-quote':'L\'argent existe parce que les gens existent. Rien de plus, rien de moins.',
  'nav-home':'Accueil','nav-why':'Pourquoi Aequitas','nav-biz':'Pour les entreprises','nav-how':'Comment ça marche','nav-join':'Participer','nav-trans':'Transparence','nav-explorer':'Explorateur','nav-equality':'Égalité','nav-network':'Réseau','nav-exchange':'Échange',
  'reg-title':'🔐 S\'inscrire en tant qu\'humain vérifié',
  'reg-disclaimer':'Bêta : depuis le 25/08/2026, le serveur de preuves refuse toute inscription sans les attestations signées des deux services de comparaison — un second téléphone ne donne plus un second compte au même visage. Ce qui n\\\'est pas encore vrai : les comptes antérieurs à cette date ne sont couverts qu\\\'une fois que leur titulaire ajoute son visage dans l\\\'app (sans nouvelle allocation) ; d\\\'ici là, ils pourraient en principe se réinscrire avec un nouveau portefeuille. Les taux d\\\'erreur ne sont pas étalonnés (il faut ~1 000 paires d\\\'imposteurs). Preuve de vie : seule la consigne du regard est contraignante aujourd\\\'hui ; flashs de couleur, pouls et parallaxe sont mesurés mais ne décident pas encore. Lisez « un humain, un compte » comme « vérifié, avec des limites nommées » — pas comme « impossible à contourner ». À long terme, Aequitas misera sur le scan de l’iris pour garantir réellement une personne, une inscription. La manière de le mettre en œuvre de façon fiable et respectueuse de la vie privée est en cours d’élaboration ; le matériel et le calendrier ne sont pas encore fixés.',
  'reg-disc-sum':'Avertissement bêta : ce qui vaut déjà et ce qui pas encore (ouvrir)',
  ...
  'reg-sub':'Rejoignez le réseau Aequitas et recevez votre allocation de départ de 1 000 AEQ. L\'inscription est unique et permanente. Elle est en bêta : vérifiée, avec des limites nommées — voir l\'avertissement bêta ci-dessous.',
  'app-title':'INSCRIPTION VIA L\'APPLICATION ANDROID',
  'app-text':'L\'inscription se fait uniquement dans l\'app Android : une courte capture du visage, vérifiée par deux services de comparaison indépendants. Ensuite, <strong style="color:var(--gold)">1 000 AEQ sont crédités automatiquement</strong>. Ce qui est conservé et ce qui ne l\'est pas : étape 1 et l\'avertissement bêta ci-dessous.',
  's1t':'Connecter','s1d':'L\'app enregistre votre visage et une courte séquence de preuve de vie (un clignement, un regard vers un côté au hasard, des flashs de couleur) et les envoie à deux services de comparaison indépendants. Ceux-ci comparent le visage à toutes les personnes inscrites avec leur visage. La photo est supprimée en quelques secondes ; seul un extrait de 64 octets est conservé.',
  's2t':'Prouver','s2d':'Une preuve ZK Groth16 lie votre bio_hash dans un commitment (Poseidon de bio_hash, du portefeuille et d\'un sel) sans le révéler. Le serveur de preuves ne la délivre qu\'avec la liaison au portefeuille et les attestations signées des deux services, et le nullifier ne peut servir qu\'une fois — le même visage ne compte pas deux fois.',
  ...
  'priv-bar':'🔒 Bêta · Contrôle du visage par 2 services indépendants · 2 attestations signées obligatoires · ZKP Groth16 · Seul un extrait de 64 octets est conservé',
  'conn-wallet':'PORTEFEUILLE CONNECTÉ','proof-recv':'⚡ PREUVE ZK REÇUE','proof-hint':'Connecter un portefeuille pour s\'inscrire',
  'btn-conn':'🦊 CONNECTER METAMASK','btn-reg':'🔐 INSCRIPTION ON-CHAIN','reg-apk-note':'L\'inscription nécessite l\'app avec contrôle du visage (app.apk de ce site ; utilisez la version actuelle pour qu\'un refus affiche son code de contestation).',
  'btn-wc':'🔗 CONNECTER WALLETCONNECT',
  'reg-log-hint':'// L\'app vous inscrit elle-même. Les boutons ci-dessus ne servent que si un lien avec une preuve déjà générée vous a amené ici.',
  'reg-details':'Détails d\'inscription','k-network':'Réseau','k-chainid':'ID de chaîne','k-grant':'Allocation UBI',
  'k-fee':'Frais de gaz','free':'0,1 % de frais de protocole — pas de gas EVM','k-limit':'Inscriptions','k-limit-v':'Une fois par personne · permanent · immuable',
  'k-bio':'Visage','never-stored':'Photos supprimées en quelques secondes — chaque service de comparaison ne garde qu\'un extrait de 64 octets',
  ...
  'h-zkp':'Système de preuve ZK','h-zkp-t':'Aequitas utilise Groth16 sur BN128 — la même courbe qu\'Ethereum et Zcash. Preuve : ~200 octets. Vérification : ~10 ms. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). Le nullificateur vient du visage, pas du téléphone : un second appareil ne permet pas à la même personne de s\'inscrire à nouveau, et perdre son téléphone ne coûte pas l\'inscription. Poseidon plutôt qu\'une multiplication, car le nullificateur du circuit précédent était inversible : n\'importe qui pouvait en retrouver le bioHash.',
  'h-sybil':'Résistance Sybil — État Actuel','h-sybil-t':'Depuis le 25/08/2026, le serveur de preuves refuse une inscription sans les attestations signées des deux services de comparaison — le même visage ne peut donc pas être inscrit deux fois, y compris sur des appareils différents, ce qu\'une clé d\'appareil n\'a jamais pu faire. Deux limites nommées : les comptes antérieurs à cette date ne sont couverts qu\'une fois que leur titulaire ajoute son visage dans l\'app, et le seuil de comparaison n\'a pas été étalonné sur de vraies captures : la cryptographie est exacte, la biométrie en dessous est une mesure dont le taux d\'erreur n\'est pas chiffré. Preuve de vie : seule la consigne du regard est contraignante aujourd\'hui ; flashs de couleur, pouls et parallaxe sont mesurés et décideront une fois étalonnés.',
  ...
  'h-bio-hw':'Feuille de Route de Vérification d\'Identité','h-bio-hw-t':'Aujourd\'hui (bêta) : un contrôle du visage par deux services de comparaison indépendants qui doivent tous deux être d\'accord, et un serveur de preuves qui refuse les inscriptions sans leurs attestations signées. Seul un extrait de 64 octets est conservé, jamais la photo ni un gabarit complet. Le seuil n\'est pas encore étalonné sur de vraies captures — il faut environ 1000 paires d\'imposteurs avant d\'avancer le moindre chiffre. Prévu : cet étalonnage, une preuve de vie contraignante à partir des signaux déjà mesurés (flashs de couleur, pouls, parallaxe), une allocation échelonnée pour les captures incertaines et un contrôle des doublons dans lequel aucun service ne détient même l\'extrait entier. À long terme, Aequitas misera sur le scan de l’iris pour garantir réellement une personne, une inscription. La manière de le mettre en œuvre de façon fiable et respectueuse de la vie privée est en cours d’élaboration ; le matériel et le calendrier ne sont pas encore fixés.',
  'reg-humans':'Humains inscrits','h-desc':'Chaque adresse ci-dessous appartient à une personne dont le visage a été comparé par des services indépendants à tous les enregistrements existants, prouvé par une preuve ZK, et créditée d\'exactement 1 000 AEQ. Le registre est permanent, immuable et on-chain. Ce que le seuil garantit aujourd\'hui, et ce qu\'il ne garantit pas, est dans la FAQ. Exception connue et bornée : les comptes inscrits avant le contrôle du visage (25/08/2026) n\'ont pas de gabarit du visage.',
  ...
  'gini-what-text':'Développé par Corrado Gini (1912). Mesure la distribution des richesses. Échelle : 0 (tous égaux) à 1 (une personne détient tout). Utilisé par la Banque mondiale, l\'OCDE, l\'ONU. La phase 3 (maturité) n’est atteinte qu’avec 1 million d’humains et un Gini sous 0,30.',
  'gini-calc-title':'Comment l\'Index est-il calculé ?',
  'gini-calc-text':'Tous les soldes AEQ des humains vérifiés sont collectés. La formule calcule la différence absolue moyenne entre toutes les paires de soldes possibles, normalisée par la population au carré (n²) et le solde moyen (x̄). Résultat 0–1 multiplié par 100 = Indice Aequitas. Le nœud le calcule à partir des soldes actuels ; après chaque versement quotidien du revenu de base, un instantané est enregistré pour le graphique historique.',
  'gini-why-title':'Pourquoi le Gini ?',
  'gini-why-text':'Un simple rapport entre le plus riche et le plus pauvre se contourne facilement : 10 000 portefeuilles pourraient afficher un faible écart alors que 90 % des AEQ sont entre 100 mains — le Gini le détecte, un rapport non. Il résume toute la distribution entre les humains vérifiés en un nombre que chacun peut recalculer. C’est une mesure, pas un levier de pilotage : les phases et le plafond de richesse dépendent du nombre d’humains enregistrés, et les règles de redistribution sont fixées dans le protocole. Personne ne peut modifier la mesure.',
  ...
  'pools-desc':'Les frais de transfert vont à 100 % à l’UBI. Les frais de swap sont répartis 40 % validateurs / 30 % fournisseurs de liquidité / 30 % UBI. Le prélèvement sur l’argent dormant, le prélèvement de sortie de 2 % et l’excédent au-delà du plafond vont à 100 % à l’UBI. Personne ne peut payer depuis un fonds, même avec sa clé ; seul le protocole distribue, chaque jour.',
  'vel-pool':'Pool des validateurs','vel-pool-desc':'40 % des frais de swap → chaque humain vérifié qui exploite un validateur reçoit la même part, pondérée uniquement par les minutes où son nœud était en ligne ce jour-là.',
  'liq-pool':'Pool de liquidité','liq-pool-desc':'30 % des frais de swap → fournisseurs de liquidité AEQ/tUSD, au prorata de leur part LP. Plus de liquidité = moins d’impact sur le prix pour tous.',
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100 % des frais de transfert + 30 % des frais de swap + 100 % du prélèvement sur l’argent dormant, du prélèvement de sortie et de l’excédent → partagés à parts égales entre toutes les personnes vérifiées toutes les 24 heures.',
  'phases-title':'Phases du protocole',
  'phases-desc':'Le plafond pour les personnes utilise en phase 0 un multiplicateur de démarrage : max(5, min(N, 25))× la juste part (1 000 AEQ par personne). Avec 1–4 personnes : 5×. Chaque nouvelle personne ajoute 1×. À partir de 25 personnes : fixé à 25× = 25 000 AEQ pour toujours. Toutes les transitions sont déclenchées automatiquement selon le nombre de personnes. Le plafond ne vaut que pour les personnes : les entreprises n’ont pas de limite fixe et paient à la place le prélèvement sur l’argent dormant ; les autres adresses détiennent au plus 1 000 AEQ.',
  ...
  'p3':'Maturité · 1 M+ de personnes et Gini sous 0,30 · Plafond : 25× la part équitable = 25 000 AEQ',
  'wealth-cap-explain':'Le plafond pour les personnes en phase 0 (démarrage) est max(5, min(N, 25))× la juste part de 1 000 AEQ, où N = personnes enregistrées. 1–4 personnes : 5×. Chaque nouvelle personne ajoute 1×. À partir de 25 : 25× = 25 000 AEQ pour toujours. Les entreprises n’ont pas de limite fixe (elles paient le prélèvement sur l’argent dormant) ; les autres adresses détiennent au plus 1 000 AEQ.',
  'demurrage-title':'Prélèvement sur l’argent dormant : une incitation à circuler',
  'demurrage-desc':'À partir du 26 septembre 2026, l’argent qui dort paie un petit prélèvement qui dépend du type de compte. La vie quotidienne et l’épargne normale ne sont pas touchées, et le prélèvement va à 100 % au revenu de base.',
  'dem-rate-k':'Taux','dem-rate-v':'Personnes : 0,5 %/mois au-delà de 5 000 AEQ · Entreprises : 0,5 %/mois au-delà de 1,5 mois de chiffre d’affaires, 1 % au-delà de 3 mois · Autres adresses : 1 %/mois',
  ...
  'guard-text':'<p>Un Gardien de confiance (autre humain vérifié) peut confirmer qu\'une personne est encore en vie, sans aucun droit de transaction.</p>',
  ...
  'dem-title':'3. PRÉLÈVEMENT SUR L’ARGENT DORMANT : mécanisme anti-thésaurisation',
  'dem-box':'Personnes : 0,5 %/mois seulement sur la part au-delà de 5 000 AEQ ; la vie quotidienne et l’épargne restent intactes<br>Entreprises : jusqu’à 1,5 mois de chiffre d’affaires sans frais (au moins 2 000 AEQ), puis 0,5 %/mois, au-delà de 3 mois 1 %/mois<br>Autres adresses : 1 %/mois, au plus 250 AEQ<br>Réglé chaque jour, 100 % au revenu de base (rien n’est brûlé)',
  'dem-text':'<p>Précédent historique : l’expérience de Wörgl (Autriche, 1932) a utilisé une monnaie à démurrage et réduit le chômage de 25 % en un an. Le Chiemgauer (Allemagne, 2003) fonctionne avec succès depuis plus de 20 ans selon un mécanisme similaire.</p><p>Ces règles s’appliquent à partir du 26 septembre 2026. D’ici là, l’ancienne règle vaut : 0,5 %/mois sur la part au-delà de la juste part après 3 mois sans activité.</p>',
  'cap-title':'4. PLAFOND DE RICHESSE','cap-box':'Plafond pour les personnes : max(5,min(N,25))× la juste part (1 000 AEQ)<br>1–4 personnes : 5× · +1× par personne · à partir de 25 : 25× pour toujours<br>Excédent redistribué aussitôt · Entreprises : pas de limite fixe, prélèvement sur l’argent dormant · Autres adresses : au plus 250 AEQ',
  'ubi-title':'5. REVENU DE BASE UNIVERSEL','ubi-box':'Sources : frais de transfert (100 %) · frais de swap (30 %) · prélèvement sur l’argent dormant · prélèvement de sortie (2 %) · excédent au-delà du plafond · séquestre d’inactivité<br><br>Chaque jour : le fonds UBI est partagé à parts égales entre toutes les personnes enregistrées. Après chaque distribution, il revient à zéro et se remplit en continu.',
  ...
  'swap-title':'🔄 Échanger AEQ ↔ tUSD','swap-sub':'Échangez AEQ contre tUSD (dollar test) via le pool de liquidité natif. Les swaps paient 0,1 % de frais ; les transferts AEQ ordinaires paient aussi 0,1 % de frais de protocole, versés intégralement au revenu de base (pas de gas EVM).',
  'swap-priv-bar':'🔒 0,1% de frais swap · Transferts AEQ 0,1% protocole (pas de gas EVM) · tUSD monnaie test',
  ...
  'swap-validators':'Validateurs (40%)','swap-lps':'Fournisseurs de Liquidité (30%)','swap-ubi':'Pool UBI (30%)','swap-treasury':'Trésorerie (0%)',
  ...
  'ubi-hero-sub-empty':'Fonds vide depuis le dernier versement de 20 h. Il se remplit avec les frais de transfert, les frais de swap (30 % de 0,1 %), le prélèvement sur l’argent dormant, le prélèvement de sortie et l’excédent au-delà du plafond.',
  'ubi-time-bar-lbl':'Temps jusqu\'au versement quotidien (20 h, heure de Berlin)',
  ...
  'ubi-src-swap':'Frais de Swap','ubi-src-swap-d':'Chaque swap AEQ↔tUSD contribue 30% de ses frais. Plus d\'échanges = remplissage plus rapide.',
  'ubi-src-dem':'Prélèvement sur l’argent dormant','ubi-src-dem-d':'Personnes au-delà de 5 000 AEQ (0,5 %/mois), entreprises au-delà de 1,5 mois de chiffre d’affaires (0,5–1 %/mois) et autres adresses (1 %/mois). Réglé chaque jour, 100 % vont au revenu de base. À partir du 26 sept. 2026.',
  'ubi-src-cap':'Dépassement du Plafond','ubi-src-cap-d':'Pour les personnes au-dessus du plafond (25× la part équitable = 25 000 AEQ ; plus bas tant que moins de 25 humains sont inscrits : 1 000 AEQ par humain, au moins 5 000), l’excédent est redistribué immédiatement. 100 % vont au revenu de base. Les entreprises n’ont pas de plafond fixe.',
  'pools4-header':'LES TROIS POOLS DE REDISTRIBUTION',
  'ubi-see-above':'voir compte à rebours ci-dessus','ubi-timer-above':'⏰ compte à rebours affiché ci-dessus',
  ...
  'usp-c1-title':'Frais de 0,1 % · pas de gas EVM','usp-c1-desc':'Aucun gas ETH/MATIC pour s\'inscrire. Les transferts paient des frais de protocole de 0,1 % (en direct depuis le nœud), pas « gratuit pour toujours ».',
  'usp-c2-title':'1 000 AEQ pour chaque humain','usp-c2-desc':'Milliardaire ou agriculteur de subsistance — chacun reçoit exactement 1 000 AEQ. Ni plus, ni moins. Le même départ pour tous, inscrit dans le code.',
  'usp-c3-title':'Accessible à tous','usp-c3-desc':'Pas de compte bancaire, pas de carte de crédit, pas de pièce d\'identité, aucun matériel supplémentaire à acheter — juste la caméra déjà présente dans votre téléphone Android.',
  ...
  'faq-title':'❓ FAQ','faq-q1':'Mes données biométriques sont-elles sécurisées ?','faq-a1':'Votre visage est capturé et envoyé à deux services de comparaison indépendants — c\'est la seule façon de vérifier « une personne, un compte ». La photo et la description complète du visage sont supprimées en quelques secondes ; elles ne sont pas conservées. Ce qui reste est un extrait de 64 octets (512 valeurs oui/non) : le visage ne peut pas en être reconstruit, mais il reconnaît quelqu\'un qui revient, c\'est pourquoi il est traité comme une donnée biométrique. Une limite honnête, dite plutôt que cachée : chaque service détient l\'extrait entier. Un mode réparti dans lequel aucun service ne le détient entier est construit et testé, mais n\'est pas encore le contrôle contraignant.',
  'faq-q1b':'L\'inscription prouve-t-elle que je suis une personne réelle et unique ?','faq-a1b':'Mieux que ce qu\'une clé d\'appareil n\'a jamais pu faire, et pas encore démontrable par un chiffre. Depuis le 25/08/2026, le visage est comparé par deux services indépendants qui doivent tous deux être d\'accord, et le serveur de preuves refuse une inscription sans leurs attestations signées — la même personne sur un second téléphone est donc détectée, ce qu\'une clé d\'appareil n\'a jamais pu faire. Deux limites nommées : les comptes antérieurs à cette date ne sont couverts qu\'une fois que leur titulaire ajoute son visage dans l\'app (sans nouvelle allocation), et le taux d\'erreur n\'est pas établi : le seuil n\'a pas été étalonné sur de vraies captures, ce qui demande environ 1 000 paires d\'imposteurs. Preuve de vie : seule la consigne du regard est contraignante aujourd\'hui ; des signaux plus forts sont mesurés et en cours d\'étalonnage. À long terme, Aequitas misera sur le scan de l’iris pour garantir réellement une personne, une inscription. La manière de le mettre en œuvre de façon fiable et respectueuse de la vie privée est en cours d’élaboration ; le matériel et le calendrier ne sont pas encore fixés.',
  'faq-q2':'Puis-je m\'inscrire avec un portefeuille différent plus tard ?','faq-a2':'Non. Une inscription est liée de façon permanente à une seule adresse de portefeuille. C\'est voulu : le nullifier dérivé de votre visage n\'est dépensé qu\'une fois, donc se réinscrire avec un autre portefeuille serait une seconde identité pour la même personne.',
  'faq-q3':'Que se passe-t-il si je perds mon téléphone ?','faq-a3':'Vos AEQ restent dans votre portefeuille — ils sont liés à votre clé privée, pas à votre téléphone. Vous pouvez toujours accéder à votre portefeuille via MetaMask avec votre phrase de récupération. Votre inscription est liée à votre visage, pas à l’appareil : un nouveau téléphone ne vous fait pas perdre votre inscription.',
  'path-title':'Choisissez Votre Voie','path-human-title':'Je suis un Humain','path-human-desc':'Je veux m\'inscrire, recevoir 1 000 AEQ et rejoindre le réseau de revenu de base.','path-human-steps':'1. Téléchargez l’app Android Aequitas<br>2. Faites le court contrôle facial en direct dans l’app<br>3. Connectez MetaMask<br>4. Recevez 1 000 AEQ dès que le contrôle est réussi',
...
pt:{
  ...
  'x-phase-2-10-000-humans':'Fase 2 (mais de 10.000 pessoas):',
  'x-phase-3-1m-humans-gini':'Fase 3 (mais de 1 M de pessoas e Gini &lt; 0,30):',
  'nr-intro':'Atualmente a rede funciona com 2 validadores ativos, cada um no seu próprio servidor com a sua própria base de dados, com eventos MERGE de ambos. Só pessoas registadas podem operar nós validadores — é um requisito de segurança. Os passos abaixo são metas ligadas às fases do protocolo: o protocolo define a fase automaticamente, mas ainda não impõe um número mínimo de nós.',
  'nr-0':'Dois servidores Contabo independentes, cada um com a sua própria base de dados e o seu próprio servidor de provas. Confiança através de código transparente. Qualquer pessoa registada já pode aderir como validador — sem candidatura, sem caução.',
  'nr-1':'Mais operadores de nó independentes; cada um recebe uma parte do fundo de validadores (40% das taxas de troca).',
  'nr-2':'Meta: pelo menos 10 operadores de nó independentes.',
  'nr-3':'Meta: um BlockDAG totalmente descentralizado — nenhum operador sozinho pode censurar ou parar a cadeia.',
  'nr-outro':'O guia para operadores de nó (PDF) está no separador Rede. Cada novo operador ganha do fundo de validadores — quanto mais nós, mais resistente a rede.',
  ...
  'bv-desc':'Um validador garante que as <strong style="color:var(--text)">contas batem certo</strong>. Não garante aquilo em que tudo o resto assenta: que <strong style="color:var(--text)">ninguém se regista duas vezes</strong>. Sem isso, «uma pessoa, um rendimento» é apenas um slogan — o registo estaria perfeitamente correto e seria completamente inútil. Hoje essa promessa assenta em pouquíssimas máquinas, e cada uma que acrescentar torna-a mais difícil de quebrar. Os dois papéis que a sustentam — o <strong style="color:var(--text)">verificador</strong>, que decide se um rosto já está inscrito, e o <strong style="color:var(--text)">coordenador</strong>, que reúne essas decisões — correm no mesmo servidor. Este guia instala ambos.',
  'bv-guide-sub':'Passo a passo · Sem conhecimentos de criptografia · Cerca de 45 minutos, sobretudo de espera',
  'bv-honest-d':'Esta parte está em beta e os limites são reais. A comparação conjunta consome material criptográfico de uso único, e uma entrega cobre por agora algumas dezenas de registos antes de ser preciso mais — a via confidencial prova-se primeiro em pequena escala, não em milhões. O trabalho cresce também com o número de pessoas inscritas. Publicamos estes números em vez de os arredondar: um sistema que pede o seu rosto não tem o direito de ser vago sobre o que consegue e o que ainda não.',
  'bv-honest-t':'Onde isto está hoje — sem rodeios',
  'bv-status-d':'O código do verificador <strong style="color:var(--text)">ainda não é público</strong>, por isso nem todos conseguem hoje cumprir os passos abaixo. São publicados na mesma porque um desenho deve poder ser verificado antes de entrar em funcionamento, não depois. Se quiser manter um, pergunte no grupo de Telegram ligado na página inicial. Abrir este repositório é o que transformará este guia de um plano num convite, e é a próxima coisa que lhes devemos.',
  'bv-status-t':'Estado: beta fechada — leia antes de começar',
  'bv-title':'Um validador não chega — e eis porquê',
  'bv-guide-lang-note':'Os passos abaixo estão em inglês. As secções acima — o que é isto, o que protege e aquilo por que passa a responder — estão na sua língua.',
  'bv-what-d':'Um rosto nunca lhe chega como imagem: a imagem é descartada após a verificação e a sua máquina guarda apenas um extrato de 64 bytes (512 valores sim/não) — suficiente para reconhecer quem regressa, insuficiente para reconstruir um rosto. Existe um modo repartido em que a sua máquina teria apenas uma parte aditiva desse extrato — sozinha indistinguível de ruído, comparada em conjunto com o seu comité para que ninguém saiba mais do que a resposta. Está construído e testado, mas <strong style="color:var(--text)">ainda não está ativo</strong>, porque o seu limiar nunca foi calibrado. Até lá, cada verificador guarda o extrato inteiro, e preferimos dizê-lo a sugerir uma proteção que ainda não está a dar.',
  'bv-what-t':'O que teria — e o que nunca veria',
  ...
  'x-0-1-split-40-30':'0,1 % · repartição 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10.000 &#8211; 1 M de pessoas. Meta: pelo menos 10 operadores de nó independentes.',
  'x-100-8211-10-000-humans':'100 &#8211; 10.000 pessoas. Teto 25×. Meta: mais operadores de nó independentes.',
  'x-100-maximum-concentration':'100 = concentração máxima',
  'x-1m-humans-global-ubi-at':'Mais de 1 M de pessoas e Gini abaixo de 0,30 — ambos têm de se verificar. Rendimento básico mundial em larga escala.',
  
  
  
  'x-active-validators':'Validadores ativos',
  'x-add-aequitas-chain-to-metamask':'Adicione a cadeia Aequitas ao MetaMask para ver o seu saldo AEQ, enviar transações e interagir com o contrato V7 a partir do navegador ou da carteira no telemóvel.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'A Aequitas implementa isto matematicamente. Cada humano verificado recebe exatamente 1.000 AEQ — bilionário ou agricultor de subsistência, sem exceções. Regras fixas — a taxa sobre dinheiro parado, o limite de riqueza e o rendimento básico diário — impedem que a desigualdade se acumule sem limite. O coeficiente de Gini é calculado a partir dos saldos atuais e qualquer pessoa o pode verificar.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'Comparável aos EUA (~0,41) ou à França (~0,32). Dentro do intervalo da maioria das economias desenvolvidas.',
  ...
  'x-demurrage-0-5-mo':'Taxa sobre dinheiro parado (0,5–1 %/mês)',
  ...
  'x-healthier-than-most-nations-on':'Mais saudável do que a maioria dos países do mundo. Comparável à Escandinávia (~0,27) e à Alemanha (~0,31).',
  'x-higher-than-most-european-nations':'Mais alto do que na maioria dos países europeus — comparável ao Brasil (~0,53). As regras não mudam com o índice; a taxa sobre dinheiro parado e o limite de riqueza atuam continuamente.',
  'x-honest-limitation':'Limitação assumida:',
  'x-why-sybil-resistance':'Porquê resistência Sybil?','x-how-it-works':'Como funciona',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'valor aleatório, emitido após a verificação facial (não derivado do rosto)',
  ...
  'x-phase-transitions-are-automatic-8212':'O protocolo define a fase automaticamente — as fases 0 a 2 pelo número de pessoas, a fase 3 só com 1 M de pessoas e um Gini abaixo de 0,30. Sem votação de governança, sem chave de administrador. A fase é um estado: o teto de riqueza e a taxa sobre dinheiro parado não dependem dela, e nenhum código impõe ainda as metas de nós.',
  'x-postgresql-persistent':'PostgreSQL (persistente)',
  'x-protocol-v7':'📜 Protocol V7',
  'x-provide-aeq-tusd-liquidity-to':'Forneça liquidez AEQ / tUSD para ganhar 30 % de todas as comissões de troca, distribuídas diariamente.',
  ...
  'x-swap-fees-0-1':'Taxas de transferência e swap (0,1%)',
  'x-sybil-resistance-8212-current-state':'Resistência Sybil &#8212; o estado atual, com franqueza',
  'x-the-4-redistribution-mechanisms':'Os 3 fundos de redistribuição',
  ...
  'x-ubi-pool-20':'Fundo de rendimento básico',
  ...
  'x-worse-than-any-country-on':'Pior do que qualquer país do mundo (recorde da África do Sul: ~0,63). Aproxima-se da Bitcoin (~0,85). Com poucos humanos registados isto acontece depressa; as regras mantêm-se.',
  ...
  'logo-sub':'PROVA DE HUMANIDADE','phase0-badge':'Beta · verificação facial','nav-register':'Registar','foot-launched':'Lançada em junho de 2026','foot-phase':'Beta','foot-quote':'O dinheiro existe porque as pessoas existem. Nada mais, nada menos.',
  'nav-home':'Início','nav-why':'Porquê a Aequitas','nav-biz':'Para empresas','nav-how':'Como funciona','nav-join':'Participar','nav-trans':'Transparência','nav-explorer':'Explorador','nav-equality':'Igualdade','nav-network':'Rede','nav-exchange':'Câmbio',
  'reg-title':'🔐 Registrar como Humano Verificado',
  'reg-disclaimer':'Beta: desde 25/08/2026 o servidor de provas recusa qualquer registo sem as atestações assinadas dos dois serviços de comparação — um segundo telemóvel já não dá uma segunda conta ao mesmo rosto. O que ainda não se verifica: as contas anteriores a essa data só ficam abrangidas quando o titular adiciona o rosto na app (sem nova atribuição); até lá poderiam, em princípio, registar-se de novo noutra carteira. As taxas de erro não estão calibradas (são precisos ~1.000 pares de impostores). Prova de vida: hoje só a tarefa do olhar é vinculativa; flashes de cor, pulso e paralaxe são medidos, mas ainda não decidem. Leia «um humano, uma conta» como «verificado, com limites declarados» — não como «impossível de contornar». A longo prazo, a Aequitas vai apostar no scan da íris para garantir de facto uma pessoa, um registo. Está-se a trabalhar agora em como implementá-lo de forma fiável e respeitadora da privacidade; o hardware e o calendário ainda não estão decididos.',
  'reg-disc-sum':'Aviso beta: o que já se verifica e o que ainda não (abrir)',
  ...
  'reg-sub':'Junte-se à rede Aequitas e receba a sua atribuição inicial de 1.000 AEQ. O registo é único e permanente. Está em beta: verificado, com limites declarados — veja o aviso beta abaixo.',
  'app-title':'REGISTRO VIA APLICATIVO ANDROID',
  'app-text':'O registo só funciona na app Android: uma curta captura do rosto, verificada por dois serviços de comparação independentes. Depois, <strong style="color:var(--gold)">1.000 AEQ são creditados automaticamente</strong>. O que é guardado e o que não é: passo 1 e o aviso beta abaixo.',
  's1t':'Conectar','s1d':'A app grava o seu rosto e uma curta sequência de prova de vida (piscar, um olhar para um lado aleatório, flashes de cor) e envia-os a dois serviços de comparação independentes. Estes comparam o rosto com todas as pessoas registadas com rosto. A foto é descartada em segundos; só fica um extrato de 64 bytes.',
  's2t':'Provar','s2d':'Uma prova ZK Groth16 vincula o seu bio_hash a um commitment (Poseidon de bio_hash, carteira e um sal) sem o revelar. O servidor de provas só a emite com a ligação à carteira e as atestações assinadas dos dois serviços, e o nullifier só pode ser usado uma vez — o mesmo rosto não conta duas vezes.',
  ...
  'priv-bar':'🔒 Beta · Verificação facial por 2 serviços independentes · 2 atestações assinadas obrigatórias · ZKP Groth16 · Só fica um extrato de 64 bytes',
  'conn-wallet':'CARTEIRA CONECTADA','proof-recv':'⚡ PROVA ZK RECEBIDA','proof-hint':'Conectar carteira para registrar',
  'btn-conn':'🦊 CONECTAR METAMASK','btn-reg':'🔐 REGISTRAR ON-CHAIN','reg-apk-note':'O registo requer a app com verificação facial (app.apk deste site; use a versão atual para que uma recusa mostre o seu código de reclamação).',
  'btn-wc':'🔗 CONECTAR WALLETCONNECT',
  'reg-log-hint':'// A app regista-o sozinha. Os botões acima só são precisos se chegou aqui através de uma ligação com uma prova já gerada.',
  'reg-details':'Detalhes do Registro','k-network':'Rede','k-chainid':'ID da Cadeia','k-grant':'Concessão UBI',
  'k-fee':'Taxa de Gás','free':'0,1% taxa de protocolo — sem gas EVM','k-limit':'Registros','k-limit-v':'Uma vez por pessoa · permanente · imutável',
  'k-bio':'Rosto','never-stored':'Fotos descartadas em segundos — cada serviço de comparação guarda apenas um extrato de 64 bytes',
  ...
  'h-zkp':'Sistema de Prova ZK','h-zkp-t':'A Aequitas usa Groth16 em BN128 — a mesma curva do Ethereum e do Zcash. Prova: ~200 bytes. Verificação: ~10 ms. commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash). O nulificador vem do rosto, não do telemóvel: um segundo dispositivo não permite que a mesma pessoa se registe de novo, e perder o telemóvel não custa o registo. Usa-se Poseidon em vez de uma multiplicação porque o nulificador do circuito anterior era invertível — qualquer pessoa podia recuperar dele o bioHash.',
  'h-sybil':'Resistência Sybil — Estado Atual','h-sybil-t':'Desde 25/08/2026 o servidor de provas recusa um registo sem as atestações assinadas dos dois serviços de comparação — assim o mesmo rosto não pode ser registado duas vezes, também entre dispositivos, algo que uma chave de dispositivo nunca conseguiu. Dois limites declarados: as contas anteriores a essa data só ficam abrangidas quando o titular adiciona o rosto na app, e o limiar de comparação não foi calibrado com capturas reais: a criptografia é exata, a biometria por baixo é uma medição cuja taxa de erro não foi quantificada. Prova de vida: hoje só a tarefa do olhar é vinculativa; flashes de cor, pulso e paralaxe são medidos e passarão a decidir depois de calibrados.',
  ...
  'h-bio-hw':'Roteiro de Verificação de Identidade','h-bio-hw-t':'Hoje (beta): uma verificação do rosto por dois serviços de comparação independentes que têm ambos de concordar, e um servidor de provas que recusa registos sem as suas atestações assinadas. Guarda-se apenas um extrato de 64 bytes, nunca a foto nem um modelo completo. O limiar ainda não está calibrado com capturas reais — são precisos cerca de 1000 pares de impostores antes de citar qualquer número. Previsto: essa calibração, prova de vida vinculativa a partir dos sinais já medidos (flashes de cor, pulso, paralaxe), uma atribuição escalonada para capturas incertas e uma verificação de duplicados em que nenhum serviço detém sequer o extrato inteiro. A longo prazo, a Aequitas vai apostar no scan da íris para garantir de facto uma pessoa, um registo. Está-se a trabalhar agora em como implementá-lo de forma fiável e respeitadora da privacidade; o hardware e o calendário ainda não estão decididos.',
  'reg-humans':'Humanos Registrados','h-desc':'Cada endereço abaixo pertence a alguém cujo rosto foi comparado por serviços independentes com todos os registos existentes, provado com uma prova ZK e creditado com exatamente 1.000 AEQ. O registo é permanente, imutável e on-chain. O que o limiar garante hoje e o que não garante está nas perguntas frequentes. Exceção conhecida e limitada: as contas registadas antes da verificação facial (25/08/2026) não têm modelo facial.',
  ...
  'gini-what-text':'Desenvolvido por Corrado Gini (1912). Mede a distribuição de riqueza. Escala: 0 (todos iguais) a 1 (uma pessoa detém tudo). Banco Mundial, OCDE, ONU. A fase 3 (maturidade) só é atingida com 1 M de pessoas e um Gini abaixo de 0,30.',
  'gini-calc-title':'Como o Índice é calculado?',
  'gini-calc-text':'São recolhidos todos os saldos de AEQ dos humanos verificados. A fórmula calcula a diferença absoluta média entre todos os pares possíveis de saldos, normalizada pela população ao quadrado (n²) e pelo saldo médio (x̄). Resultado 0–1 multiplicado por 100 = Índice Aequitas. O nó calcula-o a partir dos saldos atuais; após cada pagamento diário do rendimento básico é guardado um registo para o gráfico histórico.',
  'gini-why-title':'Por que Gini?',
  'gini-why-text':'Uma simples razão entre o mais rico e o mais pobre é fácil de contornar: 10.000 carteiras podem mostrar pouca dispersão enquanto 90 % dos AEQ estão em 100 mãos — o Gini deteta isso, uma razão não. Resume toda a distribuição entre os humanos verificados num número que qualquer pessoa pode recalcular. É uma medição, não uma alavanca de controlo: as fases e o limite de riqueza seguem o número de humanos registados, e as regras de redistribuição estão fixadas no protocolo. Ninguém pode alterar a leitura.',
  ...
  'pools-desc':'As taxas de transferência vão 100% para a UBI. As taxas de swap são divididas 40% validadores / 30% provedores de liquidez / 30% UBI. O encargo sobre dinheiro parado, o encargo de saída de 2% e o excedente acima do teto vão 100% para a UBI. Ninguém pode pagar a partir de um fundo, nem mesmo com sua chave; só o protocolo distribui, diariamente.',
  'vel-pool':'Pool de Validadores','vel-pool-desc':'40% das taxas de swap → cada humano verificado que opera um validador recebe a mesma parte, ponderada apenas pelos minutos em que seu nó esteve online naquele dia.',
  'liq-pool':'Pool de Liquidez','liq-pool-desc':'30% das taxas de swap → provedores de liquidez AEQ/tUSD, proporcional à sua participação LP. Mais liquidez = menor impacto no preço para todos.',
  'ubi-pool':'Pool UBI','ubi-pool-desc':'100% das taxas de transferência + 30% das taxas de swap + 100% do encargo sobre dinheiro parado, do encargo de saída e do excedente → divididos igualmente entre todas as pessoas verificadas a cada 24 horas.',
  'phases-title':'Fases do Protocolo',
  'phases-desc':'O teto para pessoas usa na Fase 0 um multiplicador inicial: max(5, min(N, 25))× a parte justa (1.000 AEQ por pessoa). Com 1–4 pessoas: 5×. Cada nova pessoa acrescenta 1×. A partir de 25 pessoas: fixo em 25× = 25.000 AEQ para sempre. Todas as transições ocorrem automaticamente pelo número de pessoas. O teto vale só para pessoas: empresas não têm limite fixo e pagam em vez disso o encargo sobre dinheiro parado; outros endereços mantêm no máximo 1.000 AEQ.',
  ...
  'p3':'Maturidade · mais de 1 M de pessoas e Gini abaixo de 0,30 · Teto: 25× a parte justa = 25.000 AEQ',
  'wealth-cap-explain':'O teto para pessoas na Fase 0 (início) é max(5, min(N, 25))× a parte justa de 1.000 AEQ, com N = pessoas registradas. 1–4 pessoas: 5×. Cada nova pessoa acrescenta 1×. A partir de 25: 25× = 25.000 AEQ para sempre. Empresas não têm limite fixo (pagam o encargo sobre dinheiro parado); outros endereços mantêm no máximo 1.000 AEQ.',
  'demurrage-title':'Encargo sobre dinheiro parado: um incentivo à circulação',
  'demurrage-desc':'A partir de 26 de setembro de 2026, o dinheiro que fica parado paga um pequeno encargo que depende do tipo de conta. O dia a dia e a poupança normal ficam intocados, e o encargo vai 100% para a renda básica.',
  'dem-rate-k':'Taxas','dem-rate-v':'Pessoas: 0,5 %/mês acima de 5.000 AEQ · Empresas: 0,5 %/mês acima de 1,5 mês de faturação, 1 % acima de 3 meses · Outros endereços: 1 %/mês',
  ...
  'guard-text':'<p>Um Guardião de confiança (outro humano verificado) pode confirmar que alguém está vivo, sem nenhum direito de transação.</p>',
  ...
  'dem-title':'3. ENCARGO SOBRE DINHEIRO PARADO: mecanismo contra o acúmulo',
  'dem-box':'Pessoas: 0,5 %/mês só sobre a parte acima de 5.000 AEQ; o dia a dia e a poupança ficam intactos<br>Empresas: até 1,5 mês de faturação livre (mínimo 2.000 AEQ), depois 0,5 %/mês, acima de 3 meses 1 %/mês<br>Outros endereços: 1 %/mês, no máximo 250 AEQ<br>Liquidado diariamente, 100 % para a renda básica (não é queimado)',
  'dem-text':'<p>Precedente histórico: o experimento de Wörgl (Áustria, 1932) usou uma moeda com demurrage e reduziu o desemprego em 25% em um ano. O Chiemgauer (Alemanha, 2003) funciona com sucesso há mais de 20 anos com um mecanismo semelhante.</p><p>Estas regras valem a partir de 26 de setembro de 2026. Até lá vale a regra anterior: 0,5%/mês sobre a parte acima da parte justa após 3 meses sem atividade.</p>',
  'cap-title':'4. TETO DE RIQUEZA','cap-box':'Teto para pessoas: max(5,min(N,25))× a parte justa (1.000 AEQ)<br>1–4 pessoas: 5× · +1× por pessoa · a partir de 25: 25× para sempre<br>Excedente redistribuído na hora · Empresas: sem limite fixo, encargo sobre dinheiro parado · Outros endereços: no máximo 250 AEQ',
  'ubi-title':'5. RENDA BÁSICA UNIVERSAL','ubi-box':'Fontes: taxas de transferência (100%) · taxas de swap (30%) · encargo sobre dinheiro parado · encargo de saída (2%) · excedente acima do teto · custódia por inatividade<br><br>Diariamente: o fundo UBI é dividido igualmente entre todas as pessoas registradas. Após cada distribuição ele volta a zero e se enche continuamente.',
  ...
  'swap-title':'🔄 Trocar AEQ ↔ tUSD','swap-sub':'Troque AEQ por tUSD (dólar de teste) via pool de liquidez nativo. Swaps pagam taxa de 0,1%; transferências AEQ comuns também pagam 0,1% de taxa de protocolo, destinada integralmente à renda básica (sem gas EVM).',
  'swap-priv-bar':'🔒 0,1% taxa de swap · Transferências AEQ 0,1% protocolo (sem gas EVM) · tUSD moeda de teste',
  ...
  'swap-validators':'Validadores (40%)','swap-lps':'Provedores de Liquidez (30%)','swap-ubi':'Pool UBI (30%)','swap-treasury':'Tesouro (0%)',
  ...
  'ubi-hero-sub-empty':'Fundo vazio desde o último pagamento das 20:00. Ele se enche com taxas de transferência, taxas de swap (30% de 0,1%), o encargo sobre dinheiro parado, o encargo de saída e o excedente acima do teto.',
  'ubi-time-bar-lbl':'Tempo até ao pagamento diário (20:00, hora de Berlim)',
  ...
  'ubi-src-swap':'Taxas de Swap','ubi-src-swap-d':'Cada swap AEQ↔tUSD contribui 30% de suas taxas. Mais trading = enchimento mais rápido.',
  'ubi-src-dem':'Encargo sobre dinheiro parado','ubi-src-dem-d':'Pessoas acima de 5.000 AEQ (0,5 %/mês), empresas acima de 1,5 mês de faturação (0,5–1 %/mês) e outros endereços (1 %/mês). Liquidado diariamente, 100 % vai para a renda básica. A partir de 26 set. 2026.',
  'ubi-src-cap':'Excesso do Teto','ubi-src-cap-d':'Às pessoas acima do limite (25× a parte justa = 25.000 AEQ; mais baixo enquanto houver menos de 25 humanos registados: 1.000 AEQ por humano, pelo menos 5.000) o excedente é redistribuído de imediato. 100 % vai para o rendimento básico. As empresas não têm limite fixo.',
  'pools4-header':'OS TRÊS POOLS DE REDISTRIBUIÇÃO',
  'ubi-see-above':'ver contagem regressiva acima','ubi-timer-above':'⏰ contagem regressiva exibida acima',
  ...
  'usp-c1-title':'Taxa de 0,1% · sem gás EVM','usp-c1-desc':'Registar-se não custa gás ETH/MATIC. As transferências pagam uma taxa de protocolo de 0,1% (em direto do nó), não «grátis para sempre».',
  'usp-c2-title':'1.000 AEQ para cada humano','usp-c2-desc':'Bilionário ou agricultor de subsistência — cada um recebe exatamente 1.000 AEQ. Nem mais, nem menos. O mesmo começo para todos, fixado no código.',
  ...
  'faq-title':'❓ Perguntas Frequentes','faq-q1':'Os meus dados biométricos estão seguros?','faq-a1':'O seu rosto é captado e enviado a dois serviços de comparação independentes — é a única forma de verificar «uma pessoa, uma conta». A foto e a descrição facial completa são descartadas em segundos; não são guardadas. O que fica é um extrato de 64 bytes (512 valores sim/não): não permite reconstruir o rosto, mas reconhece quem regressa, por isso é tratado como dado biométrico. Um limite honesto, dito e não escondido: cada serviço guarda o extrato inteiro. Um modo repartido em que nenhum serviço o tem inteiro está construído e testado, mas ainda não é a verificação vinculativa.',
  'faq-q1b':'O registo prova que sou uma pessoa real e única?','faq-a1b':'Melhor do que uma chave de dispositivo alguma vez conseguiu, e ainda não demonstrável com um número. Desde 25/08/2026 o rosto é comparado por dois serviços independentes que têm ambos de concordar, e o servidor de provas recusa um registo sem as suas atestações assinadas — assim a mesma pessoa num segundo telemóvel é detetada, algo que uma chave de dispositivo nunca conseguiu. Dois limites declarados: as contas anteriores a essa data só ficam abrangidas quando o titular adiciona o rosto na app (sem nova atribuição), e a taxa de erro não está estabelecida: o limiar não foi calibrado com capturas reais, o que exige cerca de 1.000 pares de impostores. Prova de vida: hoje só a tarefa do olhar é vinculativa; sinais mais fortes estão a ser medidos e calibrados. A longo prazo, a Aequitas vai apostar no scan da íris para garantir de facto uma pessoa, um registo. Está-se a trabalhar agora em como implementá-lo de forma fiável e respeitadora da privacidade; o hardware e o calendário ainda não estão decididos.',
  ...
  'faq-q3':'O que acontece se perder o telemóvel?','faq-a3':'Os seus AEQ ficam na sua carteira — estão ligados à sua chave privada, não ao telemóvel. Pode continuar a aceder à carteira com o MetaMask e a sua frase-semente. O seu registo está ligado ao seu rosto, não ao dispositivo, por isso um telemóvel novo não o faz perder o registo.',
  'path-title':'Escolha o Seu Caminho','path-human-title':'Sou um Humano','path-human-desc':'Quero registar-me, receber 1.000 AEQ e juntar-me à rede de rendimento básico.','path-human-steps':'1. Descarregue a app Android Aequitas<br>2. Faça na app a breve verificação facial ao vivo<br>3. Ligue o MetaMask<br>4. Receba 1.000 AEQ assim que a verificação for aprovada',
...
ar:{
  ...
  'x-phase-2-10-000-humans':'المرحلة 2 (أكثر من 10,000 شخص):',
  'x-phase-3-1m-humans-gini':'المرحلة 3 (أكثر من مليون شخص وجيني أقل من 0.30):',
  'nr-intro':'تعمل الشبكة حالياً على مدقّقَين نشطَين، لكلٍّ منهما خادمه وقاعدة بياناته، مع أحداث MERGE من كليهما. لا يمكن تشغيل عُقد التحقق إلا لبشر مسجّلين — وهذا شرط أمني. الخطوات أدناه أهداف مرتبطة بمراحل البروتوكول: يحدد البروتوكول المرحلة تلقائياً، لكنه لا يفرض بعد حداً أدنى لعدد العُقد.',
  'nr-0':'خادمان مستقلان لدى Contabo، لكلٍّ منهما قاعدة بياناته وخادم البراهين الخاص به. الثقة عبر شفافية الكود. يمكن لأي إنسان مسجّل الانضمام الآن كمدقّق — بلا طلب وبلا رهن.',
  'nr-1':'مزيد من مشغّلي العُقد المستقلين؛ يحصل كلٌّ منهم على حصة من مجمع المدقّقين (40% من رسوم المبادلة).',
  'nr-2':'الهدف: عشرة مشغّلي عُقد مستقلين على الأقل.',
  'nr-3':'الهدف: BlockDAG لامركزي بالكامل — لا يستطيع أي مشغّل منفرد حجب السلسلة أو إيقافها.',
  'nr-outro':'دليل مشغّلي العُقد (PDF) متاح في تبويب الشبكة. يكسب كل مشغّل جديد من مجمع المدقّقين — كلما زادت العُقد زادت متانة الشبكة.',
  ...
  'bv-desc':'المُصادِق يضمن أن <strong style="color:var(--text)">الأرقام متطابقة</strong>. وهو لا يضمن الشيء الوحيد الذي يقوم عليه كل ما عداه: ألّا <strong style="color:var(--text)">يسجّل أحد مرتين</strong>. من دون ذلك يبقى «إنسان واحد، دخل واحد» شعارًا فحسب — سجلّ صحيح تمامًا وعديم القيمة تمامًا. اليوم يستند هذا الوعد إلى آلات قليلة جدًا، وكل آلة تضيفها تجعل كسره أصعب. الدوران اللذان يحملانه — <strong style="color:var(--text)">المدقق</strong> الذي يقرّر ما إذا كان الوجه مسجَّلًا، و<strong style="color:var(--text)">المنسّق</strong> الذي يجمع تلك القرارات — يعملان على الخادم نفسه. هذا الدليل يُعِدّ كليهما.',
  'bv-guide-sub':'خطوة بخطوة · لا حاجة لمعرفة بالتعمية · نحو 45 دقيقة، معظمها انتظار',
  ...
  'bv-title':'تشغيل مُصادِق وحده لا يكفي — وهذا السبب',
  'bv-guide-lang-note':'الخطوات أدناه بالإنجليزية. أما الأقسام أعلاه — ما هذا، وما الذي يحميه، وما الذي تتحمّله — فهي بلغتك.',
  'bv-what-d':'لا يصلك الوجه أبداً كصورة: تُتلف الصورة بعد الفحص، ولا تخزن آلتك منه إلا مستخلصاً من 64 بايت (512 قيمة نعم/لا) — يكفي للتعرّف على من يعود، ولا يكفي لإعادة بناء وجه. يوجد وضع مجزّأ لا تحمل فيه آلتك إلا حصة جمعية من ذلك المستخلص — لا تتميّز وحدها عن الضجيج، وتُقارن مع لجنتك مجتمعةً بحيث لا يعرف أحد أكثر من الجواب. إنه مبني ومختبر لكنه <strong style="color:var(--text)">غير مفعّل بعد</strong>، لأن عتبته لم تُعايَر قط. وحتى ذلك الحين يحمل كل مدقّق المستخلص كاملاً، ونفضّل قول ذلك على الإيحاء بحماية لا تقدّمها بعد.',
  ...
  'x-0-1-split-40-30':'0.1 % · توزيع 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10,000 &#8211; مليون شخص. الهدف: عشرة مشغّلي عُقد مستقلين على الأقل.',
  'x-100-8211-10-000-humans':'100 &#8211; 10,000 شخص. السقف 25×. الهدف: مزيد من مشغّلي العُقد المستقلين.',
  'x-100-maximum-concentration':'100 = أقصى تركّز',
  'x-1m-humans-global-ubi-at':'أكثر من مليون شخص ومعامل جيني أقل من 0.30 — يجب تحقق الشرطين معاً. دخل أساسي عالمي على نطاق واسع.',
  ...
  'x-aequitas-implements-this-mathematically-ever':'تطبّق Aequitas ذلك رياضياً. كل إنسان مُتحقَّق منه يحصل على 1,000 AEQ بالضبط — مليارديراً كان أو مزارعاً بسيطاً، بلا استثناء. قواعد ثابتة — رسم المال الراكد وسقف الثروة والدخل الأساسي اليومي — تمنع تراكم اللامساواة بلا حدود. يُحسب معامل جيني من الأرصدة الحالية ويمكن لأي أحد التحقق منه.',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'يماثل الولايات المتحدة (~0.41) أو فرنسا (~0.32). ضمن نطاق معظم الاقتصادات المتقدمة.',
  ...
  'x-demurrage-0-5-mo':'رسم المال الراكد (0.5–1%/شهر)',
  ...
  'x-healthier-than-most-nations-on':'أفضل من معظم دول العالم. يماثل الدول الإسكندنافية (~0.27) وألمانيا (~0.31).',
  'x-higher-than-most-european-nations':'أعلى من معظم الدول الأوروبية — يماثل البرازيل (~0.53). القواعد لا تتغير مع المؤشر؛ رسم المال الراكد وسقف الثروة يعملان باستمرار.',
  'x-honest-limitation':'قيدٌ نُقرّ به:',
  'x-why-sybil-resistance':'لماذا مقاومة Sybil؟','x-how-it-works':'كيف يعمل',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'قيمة عشوائية تصدر بعد التحقق من الوجه (غير مشتقة من الوجه)',
  ...
  'x-phase-transitions-are-automatic-8212':'يحدد البروتوكول المرحلة تلقائياً — المراحل من 0 إلى 2 حسب عدد البشر، والمرحلة 3 فقط عند مليون إنسان ومعامل جيني أقل من 0.30. لا تصويت حوكمة ولا مفتاح مسؤول. المرحلة حالةٌ فقط: سقف الثروة ورسم المال الخامل لا يعتمدان عليها، وأهداف العُقد لا يفرضها أي كود بعد.',
  ...
  'x-swap-fees-0-1':'رسوم التحويل والمبادلة (0.1٪)',
  'x-sybil-resistance-8212-current-state':'مقاومة سيبيل &#8212; الوضع الحالي بصراحة',
  'x-the-4-redistribution-mechanisms':'صناديق إعادة التوزيع الثلاثة',
  ...
  'x-ubi-pool-20':'صندوق الدخل الأساسي',
  ...
  'x-worse-than-any-country-on':'أسوأ من أي دولة في العالم (رقم جنوب أفريقيا القياسي: ~0.63). يقترب من بيتكوين (~0.85). مع قلة البشر المسجّلين يحدث هذا بسرعة؛ والقواعد تبقى كما هي.',
  ...
  'reg-sub':'انضم إلى شبكة Aequitas واحصل على منحة البداية 1,000 AEQ. التسجيل لمرة واحدة ودائم. إنه في النسخة التجريبية: مُتحقَّق منه بحدود مُعلنة — انظر التنبيه أدناه.',
  'app-title':'التسجيل عبر تطبيق أندرويد',
  'app-text':'يتم التسجيل في تطبيق Android فقط: التقاط قصير للوجه تتحقق منه خدمتا مطابقة مستقلتان. بعد ذلك <strong style="color:var(--gold)">تُضاف 1000 AEQ تلقائياً</strong>. ما يُخزَّن وما لا يُخزَّن: الخطوة 1 والتنبيه أدناه.',
  's1t':'ربط','s1d':'يسجّل التطبيق وجهك وتسلسلاً قصيراً لفحص الحيوية (رمشة، نظرة إلى جانب عشوائي، ومضات ألوان) ويرسلها إلى خدمتَي مطابقة مستقلتين. تقارنان الوجه بكل من سُجّل بوجهه. تُتلف الصورة خلال ثوانٍ؛ ولا يبقى إلا مستخلص من 64 بايت.',
  's2t':'إثبات','s2d':'يربط برهان Groth16 ZK قيمة bio_hash الخاصة بك في commitment (دالة Poseidon لـ bio_hash والمحفظة وقيمة ملح) دون كشفها. لا يصدره خادم البراهين إلا مع ربط المحفظة والشهادتين الموقَّعتين من الخدمتين، ولا يُستخدم الـ nullifier إلا مرة واحدة — فلا يُحسب الوجه نفسه مرتين.',
  's3t':'استلام','s3d':'تأكيد التسجيل على BlockDAG Aequitas خلال ثانية · إيداع 1,000 AEQ فوراً · هويتك مسجّلة دائماً كإنسان موثّق',
  'priv-bar':'🔒 النسخة التجريبية · تحقق من الوجه عبر خدمتين مستقلتين · شهادتان موقَّعتان إلزاميتان · Groth16 ZKP · لا يُحفظ إلا مستخلص من 64 بايت',
  'conn-wallet':'المحفظة المتصلة','proof-recv':'⚡ تم استلام دليل ZK','proof-hint':'ربط محفظة للتسجيل',
  'btn-conn':'🦊 ربط METAMASK','btn-reg':'🔐 التسجيل ON-CHAIN','reg-apk-note':'يتطلب التسجيل التطبيق مع التحقق من الوجه (app.apk من هذا الموقع؛ استخدم الإصدار الحالي كي يظهر رمز الاعتراض عند الرفض).',
  'btn-wc':'🔗 ربط WALLETCONNECT',
  'reg-log-hint':'// يسجّلك التطبيق بنفسه. لا تحتاج إلى الأزرار أعلاه إلا إذا أوصلك إلى هنا رابط يحمل برهاناً جاهزاً.',
  'reg-details':'تفاصيل التسجيل','k-network':'الشبكة','k-chainid':'معرّف السلسلة','k-grant':'منحة UBI',
  'k-fee':'رسوم الغاز','free':'رسوم بروتوكول 0.1٪ — بدون غاز EVM','k-limit':'التسجيلات','k-limit-v':'مرة واحدة لكل شخص · دائم · غير قابل للتغيير',
  'k-bio':'الوجه','never-stored':'تُتلف الصور خلال ثوانٍ — لا تحتفظ كل خدمة مطابقة إلا بمستخلص من 64 بايت',
  ...
  'h-zkp':'نظام أدلة ZK','h-zkp-t':'تستخدم Aequitas خوارزمية Groth16 على منحنى BN128 — المنحنى نفسه الذي تستخدمه إيثيريوم وزيكاش. حجم الإثبات نحو 200 بايت، والتحقق نحو 10 أجزاء من الألف من الثانية. commitment = Poseidon(bioHash, wallet, deviceSalt) و nullifier = Poseidon(bioHash). المُبطِل مشتق من الوجه لا من الهاتف: جهاز ثانٍ لا يتيح للشخص نفسه التسجيل مرة أخرى، وفقدان الهاتف لا يكلّفك تسجيلك. واستُخدمت Poseidon بدل الضرب لأن مُبطِل الدارة السابقة كان قابلاً للعكس — إذ كان بوسع أي أحد أن يستخرج منه bioHash.',
  'h-sybil':'مقاومة Sybil — الوضع الحالي','h-sybil-t':'منذ 2026-08-25 يرفض خادم البراهين أي تسجيل بلا الشهادتين الموقَّعتين من خدمتَي المطابقة — فلا يمكن تسجيل الوجه نفسه مرتين، ولا عبر أجهزة مختلفة، وهو ما لم يستطعه مفتاح الجهاز قط. حدّان مُعلنان: الحسابات السابقة لذلك التاريخ لا تُشمل إلا بعد أن يضيف صاحبها وجهه في التطبيق، وعتبة المطابقة لم تُعايَر على التقاطات حقيقية: التشفير دقيق، والقياس الحيوي تحته قياسٌ لم يُحدَّد معدل خطئه. الحيوية: مهمة النظر وحدها ملزمة اليوم؛ ومضات الألوان والنبض واختلاف المنظر تُقاس وستشارك في القرار بعد المعايرة.',
  ...
  'h-bio-hw':'خارطة طريق التحقق من الهوية','h-bio-hw-t':'اليوم (إصدار تجريبي): تحقق من الوجه عبر خدمتَي مطابقة مستقلتين يجب أن تتفقا معاً، وخادم براهين يرفض التسجيلات بلا شهادتيهما الموقَّعتين. لا يُخزَّن إلا مستخلص من 64 بايت، لا الصورة ولا قالب كامل أبداً. لم تُعايَر العتبة بعد على التقاطات حقيقية — يلزم نحو 1000 زوج منتحل قبل ذكر أي رقم. المخطط: تلك المعايرة، وفحص حيوية ملزم من الإشارات المقيسة أصلاً (ومضات الألوان، النبض، اختلاف المنظر)، ومنحة متدرجة للالتقاطات غير المؤكدة، وفحص تكرار لا تحمل فيه أي خدمة حتى المستخلص كاملاً. على المدى البعيد ستعتمد Aequitas على مسح قزحية العين لضمان مبدأ شخص واحد = تسجيل واحد فعلاً. يجري العمل حالياً على كيفية تنفيذ ذلك بشكل موثوق يحمي الخصوصية؛ ولم يُحسم بعد أمر الأجهزة ولا الجدول الزمني.',
  'reg-humans':'البشر المسجلون','h-desc':'كل عنوان أدناه يعود لشخص تم التحقق من وجهه عبر خدمات مستقلة مقابل جميع التسجيلات القائمة، وأُثبت بإثبات ZK، وقُيّد له 1000 AEQ بالضبط. السجل دائم وغير قابل للتغيير وعلى السلسلة. وما تضمنه العتبة اليوم وما لا تضمنه مذكور في الأسئلة الشائعة. استثناء معروف ومحدود: الحسابات المسجَّلة قبل التحقق من الوجه (2026-08-25) لا تملك قالب وجه.',
  ...
  'gini-what-text':'طوّره كورادو جيني (1912). يقيس توزيع الثروة. المقياس: 0 (الجميع متساوون) إلى 1 (شخص واحد يملك كل شيء). يُستخدم من قِبل البنك الدولي وOECD والأمم المتحدة. لا تُبلغ المرحلة 3 (النضج) إلا بمليون إنسان ومعامل جيني أقل من 0.30.',
  'gini-calc-title':'كيف يتم حساب مؤشر Aequitas؟','gini-calc-text':'تُجمع كل أرصدة AEQ للبشر المُتحقَّق منهم. تحسب الصيغة متوسط الفرق المطلق بين كل أزواج الأرصدة الممكنة، مُطبَّعاً بمربع عدد السكان (n²) ومتوسط الرصيد (x̄). النتيجة 0–1 مضروبة في 100 = مؤشر Aequitas. تحسبه العقدة من الأرصدة الحالية؛ وبعد كل صرف يومي للدخل الأساسي تُحفظ لقطة للرسم البياني التاريخي.',
  'gini-why-title':'لماذا جيني — ولا مقياس أبسط؟','gini-why-text':'نسبة بسيطة بين الأغنى والأفقر سهلة التلاعب: قد تُظهر 10,000 محفظة تفاوتاً ضئيلاً بينما 90% من AEQ في 100 يد — معامل جيني يكشف ذلك والنسبة لا تكشفه. إنه يلخّص التوزيع الكامل بين جميع البشر المُتحقَّق منهم في رقم واحد يمكن لأي أحد إعادة حسابه. إنه قياس لا أداة تحكّم: المراحل وسقف الثروة تتبع عدد البشر المسجّلين، وقواعد إعادة التوزيع ثابتة في البروتوكول. لا يستطيع أحد تغيير القراءة.',
  ...
  'phases-desc':'يستخدم حد الأفراد في المرحلة 0 مضاعِف بدء: max(5, min(N, 25))× الحصة العادلة (1,000 AEQ لكل شخص). مع 1–4 أشخاص: 5×. كل شخص جديد يضيف 1×. من 25 شخصًا: ثابت عند 25× = 25,000 AEQ إلى الأبد. كل الانتقالات تتم تلقائيًا حسب عدد الأشخاص. الحد يسري على الأفراد فقط: الشركات ليس لها حد ثابت وتدفع بدلًا منه اقتطاع المال الراكد؛ والعناوين الأخرى تحتفظ بـ 1,000 AEQ كحد أقصى.',
  'wealth-cap-explain':'حد الأفراد في المرحلة 0 (البدء) هو max(5, min(N, 25))× الحصة العادلة البالغة 1,000 AEQ، حيث N = عدد الأشخاص المسجلين. 1–4 أشخاص: 5×. كل شخص جديد يضيف 1×. من 25: 25× = 25,000 AEQ إلى الأبد. الشركات ليس لها حد ثابت (تدفع اقتطاع المال الراكد)؛ والعناوين الأخرى تحتفظ بـ 1,000 AEQ كحد أقصى.',
  ...
  'p3':'النضج · أكثر من مليون شخص ومعامل جيني أقل من 0.30 · سقف الثروة: 25× الحصة العادلة = 25,000 AEQ',
  ...
  'pools-desc':'تذهب رسوم التحويل بنسبة 100% إلى الدخل الأساسي. تُقسم رسوم المبادلة: 40% للمدققين / 30% لمزودي السيولة / 30% للدخل الأساسي. واقتطاع المال الراكد واقتطاع الخروج البالغ 2% وما يتجاوز الحد تذهب بنسبة 100% إلى الدخل الأساسي. لا يمكن لأحد الدفع من صندوق، ولو بمفتاحه؛ البروتوكول وحده يوزّع، يوميًا.',
  'vel-pool':'مجمع المدققين','vel-pool-desc':'40٪ من رسوم المبادلة → يحصل كل إنسان موثّق يشغّل مدققًا على حصة متساوية، مرجّحة فقط بعدد الدقائق التي كانت فيها عقدته متصلة في ذلك اليوم.',
  'liq-pool':'مجمع السيولة','liq-pool-desc':'30٪ من رسوم المبادلة → لمزوّدي سيولة AEQ/tUSD بنسبة حصتهم. سيولة أعمق = أثر سعري أقل على الجميع.',
  'ubi-pool':'مجمع UBI','ubi-pool-desc':'100% من رسوم التحويل + 30% من رسوم المبادلة + 100% من اقتطاع المال الراكد واقتطاع الخروج وما يتجاوز الحد ← يُقسم بالتساوي على جميع الأشخاص الموثَّقين كل 24 ساعة.',
  'phases-title':'مراحل البروتوكول',
  'demurrage-title':'اقتطاع المال الراكد: حافز على التداول',
  'demurrage-desc':'اعتبارًا من 26 سبتمبر 2026 يدفع المال الراكد اقتطاعًا صغيرًا يعتمد على نوع الحساب. الحياة اليومية والادخار العادي لا يُمسّان، ويذهب الاقتطاع بنسبة 100% إلى الدخل الأساسي.',
  'dem-rate-k':'النسب','dem-rate-v':'الأفراد: 0.5%/شهريًا فوق 5,000 AEQ · الشركات: 0.5%/شهريًا فوق 1.5 شهر من المبيعات، و1% فوق 3 أشهر · العناوين الأخرى: 1%/شهريًا',
  ...
  'ca-desc':'يحدّد AequitasV7 قواعد اقتصاد Aequitas ويحتفظ بالسجل الذي يجعلها قابلة للإنفاذ: كل nullifier استُخدم، وكل تسجيل، وسقف الثروة، ومعادلة الاندثار. العقد غير قابل للتغيير — لا مفتاح إدارة ولا وكيل ترقية ولا تصويت حوكمة يستطيع تغيير سطر واحد منه. أما ما ينفّذ التحويل الفعلي فهو طبقة السلسلة: تعترض العقدة نداء ERC-20 قبل وصوله إلى EVM وتقيّده في دفترها الخاص، وهذا ما يجعل التحويلات فورية بلا غاز EVM (رسوم بروتوكول 0.1٪). العقد هو كتاب القواعد والسجل؛ والسلسلة هي المحرّك الذي ينفّذهما، وشيفرتها مفتوحة.',
  ...
  'guard-text':'<p>حارس موثوق (إنسان موثق آخر) يمكنه تأكيد أن شخصاً ما لا يزال حياً، دون أي حقوق مالية.</p>',
  ...
  'dem-title':'3. اقتطاع المال الراكد: آلية ضد الاكتناز',
  'dem-box':'الأفراد: 0.5%/شهريًا فقط على الجزء فوق 5,000 AEQ؛ الحياة اليومية والادخار لا يُمسّان<br>الشركات: حتى 1.5 شهر من المبيعات مجانًا (2,000 AEQ على الأقل)، ثم 0.5%/شهريًا، وفوق 3 أشهر من المبيعات 1%/شهريًا<br>العناوين الأخرى: 1%/شهريًا، بحد أقصى 250 AEQ<br>تُسوّى يوميًا، 100% إلى الدخل الأساسي (لا تُحرق)',
  'dem-text':'<p>سابقة تاريخية: استخدمت تجربة فورغل (النمسا، 1932) عملة برسوم ركود وخفّضت البطالة بنسبة 25% في عام واحد. وتعمل عملة كيمغاور (ألمانيا، 2003) بنجاح منذ أكثر من 20 عامًا بآلية مماثلة.</p><p>تسري هذه القواعد اعتبارًا من 26 سبتمبر 2026. وحتى ذلك الحين تسري القاعدة السابقة: 0.5% شهريًا على الجزء فوق الحصة العادلة بعد 3 أشهر دون نشاط.</p>',
  'cap-title':'4. سقف الثروة','cap-box':'حد الأفراد: max(5,min(N,25))× الحصة العادلة (1,000 AEQ)<br>1–4 أشخاص: 5× · +1× لكل شخص · من 25: 25× إلى الأبد<br>يُعاد توزيع الفائض فورًا · الشركات: لا حد ثابت، بل اقتطاع المال الراكد · العناوين الأخرى: 250 AEQ كحد أقصى',
  'ubi-title':'5. الدخل الأساسي الشامل','ubi-box':'المصادر: رسوم التحويل (100%) · رسوم المبادلة (30%) · اقتطاع المال الراكد · اقتطاع الخروج (2%) · ما يتجاوز الحد · أمانة الخمول<br><br>يوميًا: يُقسم صندوق الدخل الأساسي بالتساوي على جميع الأشخاص المسجلين. بعد كل توزيع يعود إلى الصفر ويمتلئ باستمرار.',
  ...
  'swap-title':'🔄 تبادل AEQ ↔ tUSD','swap-sub':'تبادل AEQ مع tUSD (دولار اختبار محاكى) عبر مجمع السيولة الأصلي. رسوم المبادلات 0.1%؛ والتحويلات العادية تدفع أيضاً رسوم بروتوكول 0.1% تذهب كاملة إلى الدخل الأساسي (بدون غاز EVM).',
  'swap-priv-bar':'🔒 رسوم مبادلة 0.1% · تحويلات AEQ برسوم بروتوكول 0.1% (بدون غاز EVM) · tUSD اختبار',
  ...
  'swap-validators':'المدققون (40%)','swap-lps':'مزودو السيولة (30%)','swap-ubi':'مجمع UBI (30%)','swap-treasury':'الخزينة (0%)',
  ...
  'ubi-hero-sub-empty':'الصندوق فارغ منذ آخر صرف في الساعة 20:00. يمتلئ من رسوم التحويل ورسوم المبادلة (30% من 0.1%) واقتطاع المال الراكد واقتطاع الخروج وما يتجاوز الحد.',
  'ubi-time-bar-lbl':'الوقت حتى الدفعة اليومية (20:00 بتوقيت برلين)',
  ...
  'ubi-src-swap':'رسوم المبادلة','ubi-src-swap-d':'كل مبادلة AEQ↔tUSD تساهم بـ 30% من رسومها. المزيد من التداول = امتلاء أسرع.',
  'ubi-src-dem':'اقتطاع المال الراكد','ubi-src-dem-d':'الأفراد فوق 5,000 AEQ (0.5%/شهريًا)، والشركات فوق 1.5 شهر من المبيعات (0.5–1%/شهريًا)، والعناوين الأخرى (1%/شهريًا). تُسوّى يوميًا، و100% تذهب إلى الدخل الأساسي. اعتبارًا من 26 سبتمبر 2026.',
  'ubi-src-cap':'فائض السقف','ubi-src-cap-d':'الأشخاص فوق السقف (25 ضعف الحصة العادلة = 25,000 AEQ؛ وأقل ما دام عدد المسجّلين أقل من 25: ‏1,000 AEQ لكل إنسان، و5,000 على الأقل) يُعاد توزيع الفائض لديهم فوراً. 100% يذهب إلى الدخل الأساسي. الشركات ليس لها سقف ثابت.',
  'pools4-header':'مجمعات إعادة التوزيع الثلاثة',
  'ubi-see-above':'انظر العد التنازلي أعلاه','ubi-timer-above':'⏰ العد التنازلي معروض أعلاه',
  ...
  'usp-c1-title':'رسوم 0.1% · بلا غاز EVM','usp-c1-desc':'لا حاجة إلى غاز ETH/MATIC للتسجيل. تدفع التحويلات رسوم بروتوكول 0.1% (مباشرة من العقدة) — وليست «مجانية إلى الأبد».',
  'usp-c2-title':'1,000 AEQ لكل إنسان','usp-c2-desc':'مليارديراً كنت أو مزارع كفاف — يحصل الجميع على 1,000 AEQ بالضبط. لا أكثر ولا أقل. البداية نفسها للجميع، مثبتة في الكود.',
  ...
  'faq-title':'❓ الأسئلة الشائعة','faq-q1':'هل بياناتي البيومترية آمنة؟','faq-a1':'يُلتقط وجهك ويُرسل إلى خدمتَي مطابقة مستقلتين — فهذه هي الطريقة الوحيدة للتحقق من مبدأ «شخص واحد، حساب واحد». تُتلف الصورة والوصف الكامل للوجه خلال ثوانٍ ولا تُخزَّن. ما يبقى مستخلص من 64 بايت (512 قيمة نعم/لا): لا يمكن إعادة بناء الوجه منه، لكنه يتعرّف على من يعود، ولذلك يُعامل كبيانات حيوية. حدٌّ صادق نذكره ولا نخفيه: كل خدمة تحتفظ بالمستخلص كاملاً. الوضع المجزّأ الذي لا تملكه فيه أي خدمة كاملاً مبني ومختبر، لكنه ليس بعد الفحص الملزم.',
  'faq-q1b':'هل يثبت التسجيل أنني شخص حقيقي وفريد؟','faq-a1b':'أفضل مما استطاعه مفتاح الجهاز يوماً، لكن لا يمكن إثباته برقم بعد. منذ 2026-08-25 تقارن الوجهَ خدمتان مستقلتان يجب أن تتفقا معاً، ويرفض خادم البراهين أي تسجيل بلا شهادتيهما الموقَّعتين — فيُكشف الشخص نفسه على هاتف ثانٍ، وهو ما لم يستطعه مفتاح الجهاز قط. حدّان مُعلنان: الحسابات السابقة لذلك التاريخ لا تُشمل إلا بعد أن يضيف صاحبها وجهه في التطبيق (دون منحة جديدة)، ومعدل الخطأ غير محدد: لم تُعايَر العتبة على التقاطات حقيقية، وهذا يتطلب نحو 1,000 زوج منتحل. الحيوية: مهمة النظر وحدها ملزمة اليوم؛ وإشارات أقوى تُقاس وتُعايَر. على المدى البعيد ستعتمد Aequitas على مسح قزحية العين لضمان مبدأ شخص واحد = تسجيل واحد فعلاً. يجري العمل حالياً على كيفية تنفيذ ذلك بشكل موثوق يحمي الخصوصية؛ ولم يُحسم بعد أمر الأجهزة ولا الجدول الزمني.',
  ...
  'faq-q3':'ماذا يحدث إذا فقدت هاتفي؟','faq-a3':'تبقى AEQ في محفظتك — فهي مرتبطة بمفتاحك الخاص لا بهاتفك. يمكنك الوصول إلى محفظتك عبر MetaMask بعبارة الاسترداد. تسجيلك مرتبط بوجهك لا بالجهاز، لذلك لا يُفقدك الهاتف الجديد تسجيلك.',
  'path-title':'اختر مسارك','path-human-title':'أنا إنسان','path-human-desc':'أريد التسجيل وتلقي 1,000 AEQ والانضمام إلى شبكة الدخل الأساسي.','path-human-steps':'1. نزّل تطبيق Aequitas لأندرويد<br>2. أجرِ فحص الوجه الحي القصير في التطبيق<br>3. اربط MetaMask<br>4. استلم 1,000 AEQ فور اجتياز الفحص',
...
hi:{
  ...
  'x-phase-2-10-000-humans':'चरण 2 (10,000+ लोग):',
  'x-phase-3-1m-humans-gini':'चरण 3 (10 लाख+ लोग और जिनी 0.30 से कम):',
  'nr-intro':'फ़िलहाल नेटवर्क 2 सक्रिय वैलिडेटरों पर चलता है, हर एक अपने सर्वर और अपने डेटाबेस के साथ, और दोनों से MERGE घटनाएँ आती हैं। वैलिडेटर नोड केवल पंजीकृत लोग चला सकते हैं — यह सुरक्षा की शर्त है। नीचे के कदम प्रोटोकॉल चरणों से जुड़े लक्ष्य हैं: प्रोटोकॉल चरण अपने आप तय करता है, पर अभी नोडों की न्यूनतम संख्या लागू नहीं करता।',
  'nr-0':'दो स्वतंत्र Contabo सर्वर, हर एक का अपना डेटाबेस और अपना प्रूफ़ सर्वर। भरोसा खुले कोड से। कोई भी पंजीकृत व्यक्ति अभी से वैलिडेटर बन सकता है — न आवेदन, न जमानत।',
  'nr-1':'अधिक स्वतंत्र नोड संचालक; हर एक को वैलिडेटर पूल से हिस्सा मिलता है (स्वैप शुल्क का 40%)।',
  'nr-2':'लक्ष्य: कम से कम 10 स्वतंत्र नोड संचालक।',
  'nr-3':'लक्ष्य: पूरी तरह विकेंद्रित BlockDAG — कोई अकेला संचालक चेन को सेंसर या बंद नहीं कर सकता।',
  'nr-outro':'नोड संचालक गाइड (PDF) नेटवर्क टैब में है। हर नया नोड संचालक वैलिडेटर पूल से कमाता है — जितने अधिक नोड, नेटवर्क उतना मज़बूत।',
  ...
  'bv-desc':'एक वैलिडेटर यह सुनिश्चित करता है कि <strong style="color:var(--text)">आँकड़े मिलते हैं</strong>। वह उस एक चीज़ को सुनिश्चित नहीं करता जिस पर बाकी सब टिका है: कि <strong style="color:var(--text)">कोई दो बार पंजीकरण न करे</strong>। इसके बिना “एक मनुष्य, एक आय” केवल एक नारा है — बही पूरी तरह सही होगी और पूरी तरह बेकार। आज यह वादा बहुत थोड़ी मशीनों पर टिका है, और आप जो भी जोड़ते हैं उसे तोड़ना उतना ही कठिन हो जाता है। इसे उठाने वाली दो भूमिकाएँ — <strong style="color:var(--text)">सत्यापक</strong>, जो तय करता है कि चेहरा पहले से दर्ज है या नहीं, और <strong style="color:var(--text)">समन्वयक</strong>, जो उन निर्णयों को इकट्ठा करता है — एक ही सर्वर पर चलती हैं। यह मार्गदर्शिका दोनों को स्थापित करती है।',
  'bv-guide-sub':'चरण दर चरण · क्रिप्टोग्राफ़ी का ज्ञान आवश्यक नहीं · लगभग 45 मिनट, अधिकतर प्रतीक्षा',
  ...
  'bv-title':'केवल वैलिडेटर चलाना काफ़ी नहीं — और यही कारण है',
  'bv-guide-lang-note':'नीचे के चरण अंग्रेज़ी में हैं। ऊपर के खंड — यह क्या है, यह किसकी रक्षा करता है, और आप किसकी ज़िम्मेदारी लेते हैं — आपकी भाषा में हैं।',
  'bv-what-d':'चेहरा आपको कभी तस्वीर के रूप में नहीं भेजा जाता: जाँच के बाद छवि हटा दी जाती है, और आपकी मशीन उसका केवल 64 बाइट का अंश (512 हाँ/ना मान) रखती है — लौटने वाले को पहचानने के लिए पर्याप्त, चेहरा दोबारा बनाने के लिए अपर्याप्त। एक बँटा हुआ मोड मौजूद है जिसमें आपकी मशीन उस अंश का केवल एक योगात्मक हिस्सा रखेगी — अकेले में शोर से अलग न पहचाना जा सके, अपनी समिति के साथ मिलकर तुलना किया जाए ताकि किसी को उत्तर से अधिक पता न चले। यह बना और परखा गया है, पर <strong style="color:var(--text)">अभी सक्रिय नहीं</strong>, क्योंकि इसकी सीमा कभी कैलिब्रेट नहीं हुई। तब तक हर सत्यापक पूरा अंश रखता है, और हम ऐसी सुरक्षा का संकेत देने के बजाय यह कहना पसंद करेंगे जो आप अभी नहीं दे रहे।',
  ...
  'x-0-1-split-40-30':'0.1 % · बँटवारा 40/30/30',
  ...
  'x-10-000-8211-1m-humans':'10,000 &#8211; 10 लाख लोग। लक्ष्य: कम से कम 10 स्वतंत्र नोड संचालक।',
  'x-100-8211-10-000-humans':'100 &#8211; 10,000 लोग। सीमा 25×। लक्ष्य: अधिक स्वतंत्र नोड संचालक।',
  'x-100-maximum-concentration':'100 = अधिकतम संकेंद्रण',
  'x-1m-humans-global-ubi-at':'10 लाख+ लोग और जिनी 0.30 से कम — दोनों ज़रूरी हैं। बड़े पैमाने पर वैश्विक मूल आय।',
  ...
  'x-aequitas-implements-this-mathematically-ever':'Aequitas इसे गणितीय रूप से लागू करता है। हर सत्यापित मनुष्य को ठीक 1,000 AEQ मिलते हैं — अरबपति हो या छोटा किसान, बिना अपवाद। निश्चित नियम — निष्क्रिय धन शुल्क, धन-सीमा और दैनिक मूल आय — असमानता को असीमित रूप से जमा होने से रोकते हैं। गिनी गुणांक मौजूदा बैलेंस से गणना किया जाता है और कोई भी इसे जाँच सकता है।',
  'x-aequitas-index-g-100':'Aequitas Index = G × 100',
  'x-aequitas-now':'Aequitas Now',
  ...
  'x-comparable-to-the-usa-0':'अमेरिका (~0.41) या फ़्रांस (~0.32) के समान। अधिकांश विकसित अर्थव्यवस्थाओं की सीमा में।',
  ...
  'x-demurrage-0-5-mo':'निष्क्रिय धन शुल्क (0.5–1%/माह)',
  ...
  'x-healthier-than-most-nations-on':'दुनिया के अधिकांश देशों से बेहतर। स्कैंडिनेविया (~0.27) और जर्मनी (~0.31) के समान।',
  'x-higher-than-most-european-nations':'अधिकांश यूरोपीय देशों से अधिक — ब्राज़ील (~0.53) के समान। नियम सूचकांक के साथ नहीं बदलते; निष्क्रिय धन शुल्क और धन-सीमा लगातार काम करते हैं।',
  'x-honest-limitation':'स्वीकृत सीमा:',
  'x-why-sybil-resistance':'Sybil प्रतिरोध क्यों?','x-how-it-works':'यह कैसे काम करता है',
  ...
  'x-ip4-188-172-229-121':'/ip4/188.172.229.121/tcp/4001/p2p/12D3KooWFQyUpthkkVAii4ayMX4wpFGjDaGJxkNQXRBrmC2kx1gc',
  'x-ip4-194-163-188-71':'/ip4/194.163.188.71/tcp/4001/p2p/12D3KooWBv34kuVcmNDxZT4kCZFvNVGhy4zgkBZDGMtp7YSx2UUN',
  'x-bio-hash-random':'यादृच्छिक मान, चेहरा-जाँच के बाद जारी (चेहरे से व्युत्पन्न नहीं)',
  ...
  'x-phase-transitions-are-automatic-8212':'प्रोटोकॉल चरण अपने आप तय करता है — चरण 0 से 2 लोगों की संख्या से, चरण 3 तभी जब 10 लाख लोग हों और जिनी 0.30 से कम हो। कोई गवर्नेंस वोट नहीं, कोई एडमिन कुंजी नहीं। चरण केवल एक स्थिति है: धन सीमा और निष्क्रिय धन शुल्क इस पर निर्भर नहीं करते, और नोड लक्ष्य अभी कोड से लागू नहीं होते।',
  ...
  'x-swap-fees-0-1':'ट्रांसफ़र व स्वैप शुल्क (0.1%)',
  'x-sybil-resistance-8212-current-state':'सिबिल प्रतिरोध &#8212; वर्तमान स्थिति, ईमानदारी से',
  'x-the-4-redistribution-mechanisms':'3 पुनर्वितरण पूल',
  ...
  'x-worse-than-any-country-on':'दुनिया के किसी भी देश से बदतर (दक्षिण अफ़्रीका रिकॉर्ड: ~0.63)। बिटकॉइन (~0.85) के क़रीब। कम पंजीकृत मनुष्यों के साथ ऐसा जल्दी हो जाता है; नियम वही रहते हैं।',
  ...
  'reg-sub':'Aequitas नेटवर्क से जुड़ें और अपना 1,000 AEQ प्रारंभिक अनुदान पाएँ। पंजीकरण एक बार और स्थायी है। यह बीटा में है: जाँचा गया, बताई गई सीमाओं के साथ — नीचे बीटा सूचना देखें।',
  'app-title':'एंड्रॉयड ऐप के माध्यम से रजिस्ट्रेशन',
  'app-text':'पंजीकरण केवल Android ऐप में होता है: चेहरे का एक छोटा कैप्चर, जिसे दो स्वतंत्र मिलान सेवाएँ जाँचती हैं। उसके बाद <strong style="color:var(--gold)">1,000 AEQ स्वतः जमा हो जाते हैं</strong>। क्या संग्रहीत होता है और क्या नहीं: चरण 1 और नीचे की बीटा सूचना।',
  's1t':'कनेक्ट','s1d':'ऐप आपका चेहरा और एक छोटा जीवंतता क्रम (पलक झपकाना, किसी यादृच्छिक दिशा में देखना, रंग-चमक) रिकॉर्ड करता है और उन्हें दो स्वतंत्र मिलान सेवाओं को भेजता है। वे चेहरे की तुलना चेहरे के साथ पंजीकृत सभी लोगों से करती हैं। फ़ोटो कुछ सेकंड में हटा दी जाती है; केवल 64 बाइट का अंश रहता है।',
  's2t':'सिद्ध करें','s2d':'एक Groth16 ZK प्रमाण आपके bio_hash को बिना उजागर किए एक commitment (bio_hash, वॉलेट और एक salt का Poseidon) में बाँधता है। प्रूफ़ सर्वर इसे केवल वॉलेट-बंधन और दोनों सेवाओं के हस्ताक्षरित सत्यापनों के साथ जारी करता है, और nullifier केवल एक बार खर्च हो सकता है — एक ही चेहरा दो बार नहीं गिना जाता।',
  ...
  'priv-bar':'🔒 बीटा · 2 स्वतंत्र सेवाओं द्वारा चेहरा जाँच · 2 हस्ताक्षरित सत्यापन अनिवार्य · Groth16 ZKP · केवल 64 बाइट का अंश रखा जाता है',
  'conn-wallet':'कनेक्टेड वॉलेट','proof-recv':'⚡ ZK प्रमाण प्राप्त','proof-hint':'रजिस्टर करने के लिए वॉलेट कनेक्ट करें',
  'btn-conn':'🦊 METAMASK कनेक्ट करें','btn-reg':'🔐 ON-CHAIN रजिस्टर करें','reg-apk-note':'पंजीकरण के लिए चेहरा-जाँच वाला ऐप चाहिए (इस साइट से app.apk; मौजूदा संस्करण लें ताकि अस्वीकृति पर आपत्ति कोड दिखे)।',
  'btn-wc':'🔗 WALLETCONNECT कनेक्ट करें',
  'reg-log-hint':'// ऐप आपका पंजीकरण खुद करता है। ऊपर के बटन तभी चाहिए जब आप तैयार प्रमाण वाले लिंक से यहाँ आए हों।',
  'reg-details':'रजिस्ट्रेशन विवरण','k-network':'नेटवर्क','k-chainid':'चेन ID','k-grant':'UBI अनुदान',
  'k-fee':'गैस शुल्क','free':'0.1% प्रोटोकॉल शुल्क — कोई EVM गैस नहीं','k-limit':'रजिस्ट्रेशन','k-limit-v':'प्रति व्यक्ति एक बार · स्थायी · अपरिवर्तनीय',
  'k-bio':'चेहरा','never-stored':'फ़ोटो कुछ सेकंड में हटा दी जाती हैं — हर मिलान सेवा केवल 64 बाइट का अंश रखती है',
  ...
  'h-zkp':'ZK प्रमाण प्रणाली','h-zkp-t':'Aequitas BN128 पर Groth16 का उपयोग करता है — वही वक्र जो Ethereum और Zcash उपयोग करते हैं। प्रमाण: ~200 बाइट। सत्यापन: ~10 ms। commitment = Poseidon(bioHash, wallet, deviceSalt), nullifier = Poseidon(bioHash)। नलिफ़ायर चेहरे से आता है, फ़ोन से नहीं: दूसरा उपकरण उसी व्यक्ति को दोबारा पंजीकरण नहीं करने देता, और फ़ोन खोने से आपका पंजीकरण नहीं जाता। गुणा के बजाय Poseidon इसलिए, क्योंकि पहले के परिपथ का नलिफ़ायर उलटा जा सकता था — कोई भी उससे bioHash निकाल सकता था।',
  'h-sybil':'Sybil प्रतिरोध — वर्तमान स्थिति','h-sybil-t':'25.08.2026 से प्रूफ़ सर्वर दोनों मिलान सेवाओं के हस्ताक्षरित सत्यापनों के बिना पंजीकरण अस्वीकार करता है — इसलिए एक ही चेहरा दो बार पंजीकृत नहीं हो सकता, अलग-अलग डिवाइस पर भी नहीं, जो डिवाइस कुंजी कभी नहीं कर सकती थी। दो बताई गई सीमाएँ: उस तारीख़ से पहले के खाते तभी शामिल होते हैं जब मालिक ऐप में चेहरा जोड़ दे, और मिलान सीमा असली कैप्चर पर कैलिब्रेट नहीं है: क्रिप्टोग्राफ़ी सटीक है, उसके नीचे की बायोमेट्रिक एक माप है जिसकी त्रुटि दर तय नहीं हुई। जीवंतता: आज केवल नज़र वाला कार्य बाध्यकारी है; रंग-चमक, नाड़ी और पैरालैक्स मापे जाते हैं और कैलिब्रेशन के बाद निर्णय में शामिल होंगे।',
  ...
  'h-bio-hw':'पहचान सत्यापन रोडमैप','h-bio-hw-t':'आज (बीटा): दो स्वतंत्र मिलान सेवाओं द्वारा चेहरा जाँच, जिनका दोनों का सहमत होना ज़रूरी है, और एक प्रूफ़ सर्वर जो उनके हस्ताक्षरित सत्यापनों के बिना पंजीकरण अस्वीकार करता है। केवल 64 बाइट का अंश रखा जाता है, कभी फ़ोटो या पूरा टेम्पलेट नहीं। सीमा अभी असली कैप्चर पर कैलिब्रेट नहीं है — कोई भी संख्या बताने से पहले लगभग 1000 इम्पोस्टर जोड़े चाहिए। योजना: वह कैलिब्रेशन, पहले से मापे जा रहे संकेतों (रंग-चमक, नाड़ी, पैरालैक्स) से बाध्यकारी जीवंतता, अनिश्चित कैप्चर के लिए चरणबद्ध अनुदान, और ऐसी डुप्लिकेट जाँच जिसमें कोई सेवा पूरा अंश भी न रखे। दीर्घकाल में Aequitas आइरिस स्कैन पर निर्भर करेगा, ताकि सचमुच एक व्यक्ति = एक पंजीकरण सुनिश्चित हो सके। इसे भरोसेमंद और निजता-सुरक्षित तरीके से कैसे लागू किया जाए, इस पर अभी काम चल रहा है; हार्डवेयर और समय-सीमा अभी तय नहीं हैं।',
  'reg-humans':'रजिस्टर्ड मनुष्य','h-desc':'नीचे का हर पता ऐसे व्यक्ति का है जिसके चेहरे की स्वतंत्र सेवाओं ने सभी मौजूदा पंजीकरणों से तुलना की, ZK प्रमाण से सिद्ध किया, और ठीक 1,000 AEQ जमा किए। रजिस्ट्री स्थायी, अपरिवर्तनीय और ऑन-चेन है। सीमा आज क्या सुनिश्चित करती है और क्या नहीं, यह FAQ में है। ज्ञात और सीमित अपवाद: चेहरा जाँच (25.08.2026) से पहले पंजीकृत खातों के पास चेहरे का टेम्पलेट नहीं है।',
  ...
  'gini-what-text':'इतालवी सांख्यिकीविद् कोर्राडो जिनी (1912) द्वारा विकसित। धन वितरण मापता है। पैमाना: 0 (सब समान) से 1 (एक व्यक्ति के पास सब कुछ)। विश्व बैंक, OECD, UN उपयोग करते हैं। चरण 3 (परिपक्वता) तभी आता है जब 10 लाख लोग हों और जिनी 0.30 से कम हो।',
  'gini-calc-title':'Aequitas इंडेक्स की गणना कैसे होती है?','gini-calc-text':'सत्यापित मनुष्यों के सभी AEQ बैलेंस एकत्र किए जाते हैं। सूत्र बैलेंस के सभी संभव जोड़ों के बीच औसत निरपेक्ष अंतर निकालता है, जिसे जनसंख्या के वर्ग (n²) और औसत बैलेंस (x̄) से सामान्यीकृत किया जाता है। 0–1 परिणाम को 100 से गुणा = Aequitas सूचकांक। नोड इसे मौजूदा बैलेंस से गणना करता है; हर दैनिक मूल आय भुगतान के बाद इतिहास चार्ट के लिए एक स्नैपशॉट सहेजा जाता है।',
  'gini-why-title':'जिनी ही क्यों — कोई सरल मेट्रिक नहीं?','gini-why-text':'सबसे अमीर बनाम सबसे गरीब का सरल अनुपात आसानी से धोखा खा जाता है: 10,000 वॉलेट कम अंतर दिखा सकते हैं जबकि 90% AEQ 100 हाथों में हो — गिनी इसे पकड़ लेता है, अनुपात नहीं। यह सभी सत्यापित मनुष्यों के पूरे वितरण को एक ऐसी संख्या में समेटता है जिसे कोई भी दोबारा गणना कर सकता है। यह एक माप है, नियंत्रण का लीवर नहीं: चरण और धन-सीमा पंजीकृत मनुष्यों की संख्या पर चलते हैं, और पुनर्वितरण के नियम प्रोटोकॉल में तय हैं। कोई भी माप को बदल नहीं सकता।',
  ...
  'phases-desc':'लोगों की सीमा चरण 0 में एक शुरुआती गुणक का उपयोग करती है: max(5, min(N, 25))× उचित हिस्सा (प्रति व्यक्ति 1,000 AEQ)। 1–4 लोगों पर: 5×। हर नया व्यक्ति 1× जोड़ता है। 25 लोगों से: हमेशा के लिए 25× = 25,000 AEQ। सभी बदलाव लोगों की संख्या से अपने आप होते हैं। सीमा सिर्फ़ लोगों पर लागू है: व्यवसायों की कोई तय सीमा नहीं, वे इसके बदले रुके पैसे की कटौती देते हैं; अन्य पते अधिकतम 1,000 AEQ रखते हैं।',
  'wealth-cap-explain':'चरण 0 (शुरुआत) में लोगों की सीमा max(5, min(N, 25))× 1,000 AEQ का उचित हिस्सा है, जहाँ N = पंजीकृत लोग। 1–4 लोग: 5×। हर नया व्यक्ति 1× जोड़ता है। 25 से: हमेशा के लिए 25× = 25,000 AEQ। व्यवसायों की कोई तय सीमा नहीं (वे रुके पैसे की कटौती देते हैं); अन्य पते अधिकतम 1,000 AEQ रखते हैं।',
  ...
  'p3':'परिपक्वता · 10 लाख+ लोग और जिनी 0.30 से कम · धन सीमा: 25× उचित हिस्सा = 25,000 AEQ',
  ...
  'pools-desc':'ट्रांसफ़र शुल्क 100% UBI में जाता है। स्वैप शुल्क 40% वैलिडेटर / 30% तरलता प्रदाता / 30% UBI में बँटता है। रुके पैसे की कटौती, 2% निकासी कटौती और सीमा से ज़्यादा राशि 100% UBI में जाती है। कोई भी पूल से भुगतान नहीं कर सकता, उसकी चाबी होने पर भी नहीं; सिर्फ़ प्रोटोकॉल रोज़ बाँटता है।',
  'vel-pool':'वैलिडेटर पूल','vel-pool-desc':'स्वैप शुल्क का 40% → वैलिडेटर चलाने वाले हर सत्यापित इंसान को बराबर हिस्सा, केवल उस दिन उसके नोड के ऑनलाइन रहने के मिनटों के अनुसार।',
  'liq-pool':'लिक्विडिटी पूल','liq-pool-desc':'स्वैप शुल्क का 30% → AEQ/tUSD तरलता प्रदाताओं को, उनके LP हिस्से के अनुपात में। गहरी तरलता = सभी के लिए कम मूल्य प्रभाव।',
  'ubi-pool':'UBI पूल','ubi-pool-desc':'100% ट्रांसफ़र शुल्क + 30% स्वैप शुल्क + 100% रुके पैसे की कटौती, निकासी कटौती और सीमा से ज़्यादा राशि → हर 24 घंटे सभी सत्यापित लोगों में बराबर।',
  'phases-title':'प्रोटोकॉल चरण',
  'demurrage-title':'रुके पैसे की कटौती: प्रवाह के लिए प्रोत्साहन',
  'demurrage-desc':'26 सितंबर 2026 से रुका हुआ पैसा खाते के प्रकार के अनुसार एक छोटी कटौती देता है। रोज़मर्रा की ज़िंदगी और सामान्य बचत अछूती रहती है, और कटौती 100% बुनियादी आय में जाती है।',
  'dem-rate-k':'दरें','dem-rate-v':'लोग: 5,000 AEQ से ऊपर 0.5%/महीना · व्यवसाय: 1.5 महीने के कारोबार से ऊपर 0.5%/महीना, 3 महीने के कारोबार से ऊपर 1% · अन्य पते: 1%/महीना',
  ...
  'guard-text':'<p>एक विश्वसनीय Guardian (दूसरा सत्यापित मानव) पुष्टि कर सकता है कि कोई अभी भी जीवित है, बिना किसी वित्तीय अधिकार के।</p>',
  ...
  'dem-title':'3. रुके पैसे की कटौती: जमाखोरी-रोधी तंत्र',
  'dem-box':'लोग: सिर्फ़ 5,000 AEQ से ऊपर वाले हिस्से पर 0.5%/महीना; रोज़मर्रा का जीवन और बचत अछूते रहते हैं<br>व्यवसाय: 1.5 महीने के कारोबार तक मुफ़्त (कम से कम 2,000 AEQ), फिर 0.5%/महीना, 3 महीने के कारोबार से ऊपर 1%/महीना<br>अन्य पते: 1%/महीना, अधिकतम 250 AEQ<br>रोज़ाना निपटाया जाता है, 100% बुनियादी आय में (जलाया नहीं जाता)',
  'dem-text':'<p>ऐतिहासिक उदाहरण: वर्गल प्रयोग (ऑस्ट्रिया, 1932) ने डेमरेज मुद्रा का उपयोग किया और एक साल में बेरोज़गारी 25% घटाई। कीमगाउअर (जर्मनी, 2003) इसी तरह के तंत्र के साथ 20 से ज़्यादा वर्षों से सफलता से चल रहा है।</p><p>ये नियम 26 सितंबर 2026 से लागू हैं। तब तक पुराना नियम लागू है: 3 महीने की निष्क्रियता के बाद उचित हिस्से से ऊपर के भाग पर 0.5%/माह।</p>',
  'cap-title':'4. धन सीमा — गणितीय निष्पक्षता','cap-box':'लोगों की सीमा: max(5,min(N,25))× उचित हिस्सा (1,000 AEQ)<br>1–4 लोग: 5× · प्रति व्यक्ति +1× · 25 से: हमेशा 25×<br>अतिरिक्त राशि तुरंत बाँटी जाती है · व्यवसाय: कोई तय सीमा नहीं, रुके पैसे की कटौती · अन्य पते: अधिकतम 250 AEQ',
  'ubi-title':'5. यूनिवर्सल बेसिक इनकम','ubi-box':'स्रोत: ट्रांसफ़र शुल्क (100%) · स्वैप शुल्क (30%) · रुके पैसे की कटौती · निकासी कटौती (2%) · सीमा से ज़्यादा राशि · निष्क्रियता एस्क्रो<br><br>रोज़: UBI पूल सभी पंजीकृत लोगों में बराबर बाँटा जाता है। हर वितरण के बाद वह शून्य हो जाता है और लगातार फिर भरता है।',
  ...
  'swap-title':'🔄 AEQ ↔ tUSD स्वैप करें','swap-sub':'नेटिव लिक्विडिटी पूल के माध्यम से AEQ को tUSD (सिमुलेटेड टेस्ट डॉलर) से बदलें। स्वैप पर 0.1% शुल्क; सामान्य AEQ ट्रांसफर भी 0.1% प्रोटोकॉल शुल्क देते हैं, जो पूरा बुनियादी आय में जाता है (कोई EVM गैस नहीं)।',
  'swap-priv-bar':'🔒 0.1% स्वैप शुल्क · AEQ ट्रांसफर पर 0.1% प्रोटोकॉल (बिना EVM गैस) · tUSD टेस्ट मुद्रा',
  ...
  'swap-validators':'वैलिडेटर (40%)','swap-lps':'लिक्विडिटी प्रदाता (30%)','swap-ubi':'UBI पूल (30%)','swap-treasury':'ट्रेजरी (0%)',
  ...
  'ubi-hero-sub-empty':'पिछले 20:00 भुगतान के बाद से पूल खाली है। यह ट्रांसफ़र शुल्क, स्वैप शुल्क (0.1% का 30%), रुके पैसे की कटौती, निकासी कटौती और सीमा से ज़्यादा राशि से भरता है।',
  'ubi-time-bar-lbl':'दैनिक भुगतान तक का समय (बर्लिन समय 20:00)',
  ...
  'ubi-src-swap':'स्वैप शुल्क','ubi-src-swap-d':'प्रत्येक AEQ↔tUSD स्वैप अपने 0.1% शुल्क का 30% योगदान देता है।',
  'ubi-src-dem':'रुके पैसे की कटौती','ubi-src-dem-d':'5,000 AEQ से ऊपर लोग (0.5%/महीना), 1.5 महीने के कारोबार से ऊपर व्यवसाय (0.5–1%/महीना) और अन्य पते (1%/महीना)। रोज़ाना निपटाया जाता है, 100% बुनियादी आय में जाता है। 26 सितंबर 2026 से।',
  'ubi-src-cap':'सीमा अधिशेष','ubi-src-cap-d':'सीमा से ऊपर वाले व्यक्तियों (उचित हिस्से का 25 गुना = 25,000 AEQ; जब तक 25 से कम मनुष्य पंजीकृत हैं तब तक कम: प्रति मनुष्य 1,000 AEQ, कम से कम 5,000) का अतिरिक्त तुरंत पुनर्वितरित होता है। 100% मूल आय में जाता है। व्यवसायों की कोई निश्चित सीमा नहीं है।',
  'pools4-header':'तीन पुनर्वितरण पूल',
  'ubi-see-above':'ऊपर काउंटडाउन देखें','ubi-timer-above':'⏰ काउंटडाउन ऊपर दिखाया गया',
  ...
  'usp-c1-title':'0.1% शुल्क · कोई EVM गैस नहीं','usp-c1-desc':'पंजीकरण के लिए ETH/MATIC गैस नहीं चाहिए। ट्रांसफ़र पर 0.1% प्रोटोकॉल शुल्क लगता है (नोड से लाइव) — «हमेशा मुफ़्त» नहीं।',
  'usp-c2-title':'प्रत्येक मानव के लिए 1,000 AEQ','usp-c2-desc':'अरबपति हो या निर्वाह किसान — हर किसी को ठीक 1,000 AEQ मिलते हैं। न ज़्यादा, न कम। सबके लिए एक जैसी शुरुआत, कोड में तय।',
  ...
  'faq-title':'❓ सामान्य प्रश्न','faq-q1':'क्या मेरा बायोमेट्रिक डेटा सुरक्षित है?','faq-a1':'आपका चेहरा कैप्चर करके दो स्वतंत्र मिलान सेवाओं को भेजा जाता है — «एक व्यक्ति, एक खाता» जाँचने का यही एकमात्र तरीका है। फ़ोटो और चेहरे का पूरा विवरण कुछ सेकंड में हटा दिया जाता है; संग्रहीत नहीं होता। जो रहता है वह 64 बाइट का अंश है (512 हाँ/ना मान): इससे चेहरा दोबारा नहीं बनाया जा सकता, पर यह लौटने वाले को पहचानता है, इसलिए इसे बायोमेट्रिक डेटा माना जाता है। एक ईमानदार सीमा, छिपाई नहीं गई: हर सेवा पूरा अंश रखती है। ऐसा बँटा हुआ मोड जिसमें कोई सेवा इसे पूरा न रखे, बना और परखा गया है, पर अभी बाध्यकारी जाँच नहीं है।',
  'faq-q1b':'क्या पंजीकरण साबित करता है कि मैं एक अद्वितीय वास्तविक व्यक्ति हूं?','faq-a1b':'डिवाइस कुंजी जितना कभी कर सकती थी उससे बेहतर, पर अभी किसी संख्या से सिद्ध नहीं। 25.08.2026 से चेहरे की तुलना दो स्वतंत्र सेवाएँ करती हैं जिनका दोनों का सहमत होना ज़रूरी है, और प्रूफ़ सर्वर उनके हस्ताक्षरित सत्यापनों के बिना पंजीकरण अस्वीकार करता है — इसलिए दूसरे फ़ोन पर वही व्यक्ति पकड़ा जाता है, जो डिवाइस कुंजी कभी नहीं कर सकती थी। दो बताई गई सीमाएँ: उस तारीख़ से पहले के खाते तभी शामिल होते हैं जब मालिक ऐप में चेहरा जोड़ दे (कोई नया अनुदान नहीं), और त्रुटि दर तय नहीं है: सीमा असली कैप्चर पर कैलिब्रेट नहीं हुई, जिसके लिए लगभग 1,000 इम्पोस्टर जोड़े चाहिए। जीवंतता: आज केवल नज़र वाला कार्य बाध्यकारी है; मज़बूत संकेत मापे और कैलिब्रेट किए जा रहे हैं। दीर्घकाल में Aequitas आइरिस स्कैन पर निर्भर करेगा, ताकि सचमुच एक व्यक्ति = एक पंजीकरण सुनिश्चित हो सके। इसे भरोसेमंद और निजता-सुरक्षित तरीके से कैसे लागू किया जाए, इस पर अभी काम चल रहा है; हार्डवेयर और समय-सीमा अभी तय नहीं हैं।',
  ...
  'faq-q3':'अगर मैं अपना फोन खो दूं तो क्या होगा?','faq-a3':'आपके AEQ आपके वॉलेट में रहते हैं — वे आपकी निजी कुंजी से जुड़े हैं, फ़ोन से नहीं। आप अपने सीड फ़्रेज़ के साथ MetaMask से वॉलेट तक पहुँच सकते हैं। आपका पंजीकरण आपके चेहरे से जुड़ा है, डिवाइस से नहीं, इसलिए नया फ़ोन लेने से आपका पंजीकरण नहीं जाता।',
  'path-title':'अपना रास्ता चुनें','path-human-title':'मैं एक मानव हूं','path-human-desc':'मैं पंजीकरण करना, 1,000 AEQ प्राप्त करना और बेसिक इनकम नेटवर्क में शामिल होना चाहता/चाहती हूं।','path-human-steps':'1. Aequitas Android ऐप डाउनलोड करें<br>2. ऐप में छोटी लाइव चेहरा जाँच करें<br>3. MetaMask कनेक्ट करें<br>4. जाँच पास होते ही 1,000 AEQ पाएँ',
...
async function loadStatus() {
  ...
  try {
    ...
    const setChrome = (id, val) => { const el = document.getElementById(id); if (el) el.textContent = val; };
    setChrome('chrome-height', fmt(d.height));
    setChrome('chrome-humans', fmt(d.total_humans));
    setChrome('chrome-supply', d.total_supply || '—');
    setChrome('chrome-gini', typeof d.gini === 'number' ? d.gini.toFixed(4) : '—');
    ...
    if (d.index !== undefined) {
      ...
      const phases = ['Phase 0: Bootstrap — sliding wealth cap 5×→25× (active)', 'Phase 1: Growth — 100+ humans (cap: 25×)', 'Phase 2: Stability — 10,000+ humans (cap: 25×)', 'Phase 3: Maturity — 1M+ humans and Gini < 0.30 (cap: 25×)'];
...
function drawWcapSlideChart() {
  ...
  for (var n=1;n<=maxN;n++) {
    ...
    // Math.max(0, ...): auf schmalen Bildschirmen (vor dem ersten Layout)
    // wird bw < 2, dann waere der Radius negativ -- arcTo wirft, und das
    // ganze Diagramm bricht ab.
    var bh=cH*(mult/25), bx=pad.l+(n-1)*bw+1, bw2=Math.max(0,bw-2);
    var y=H-pad.b-bh, r=Math.max(0,Math.min(3,bw2/2));
    var barGrad;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Noch keine Wahl: die Sprache des Browsers (wie auf der Startseite).
  if (!(storedLang && T[storedLang])) {
    storedLang = 'en';
    var wuensche = (navigator.languages && navigator.languages.length) ? navigator.languages : [navigator.language || ''];
    for (var wi = 0; wi < wuensche.length; wi++) {
      var wl = String(wuensche[wi]).slice(0, 2).toLowerCase();
      if (T[wl]) { storedLang = wl; break; }
    }
  }
  setLang(storedLang);
