...
<!--
SCHREIBHILFE — Ziel: 1 Seite. Das Erleichterungskapitel.

Nach "Vierunddreißig" und dem Dankeskapitel braucht das Buch Luft.
Das hier ist die Stelle, an der es aufatmet — und es ist trotzdem
kein belangloses Kapitel, weil es von Freiheit handelt.
...
ZU PRÜFEN, bevor das gedruckt wird:
  ...
  - Welche Farbe hatte Herbie? Welches Baujahr?
  - Wer hat ihn Herbie getauft — sie oder ihr?
  - Wie oft ist sie durch die Prüfung gefallen? (Frag vorsichtig,
    aber frag. Wenn die Antwort "beim ersten Mal bestanden" ist,
    ist das auch eine Zeile wert.)
  - Wohin ist sie als Erstes gefahren, ganz allein?
  - Was ist aus Herbie geworden?

TIPP: Wenn du ein Foto von dem Auto hast — das gehört hier hin.
Notfalls tut es auch ein Bild aus dem Internet vom selben Modell,
...
spätere in "Wir zwei". Wenn du willst, dass sie beim Namen genannt
werden, sag Bescheid, das ist jeweils eine Zeile. Ich habe es
weggelassen, weil das Buch zwanzig Jahre im Regal steht und der
Erzählung nichts fehlt.
-->
